...
|$enemy_goblinshaman|Goblinu šamanis|
|$enemy_greydwarf|Grejdvarfs|
|$enemy_greydwarfbrute|Bruņots Grejdvarfs|
|$enemy_greydwarfshaman|Grejdvarfu šamanis|
...
|$event_bats_start|Tu apmaisīji katlu|
...
|$guardianstone_hook_power_activate|Aktivizēts|
|$guardianstone_hook_power_deactivate|Dektivizēts|
...
|$hud_switchcategory|Mainīt kategoriju|
...
|$inventory_stationlevel|Darba galda līmenis (Veic uzlabojumus, lai paceltu līmeni)|
|$inventory_stationlevelreq|Nepieciešamais darba galda līmenis|
|$inventory_style|Izskats|
|$inventory_tabs|Change window|
|$inventory_takeall|Paņemt visu|
|$inventory_texts|Valheimas Zinības|
...
|$item_arrow_needle_description|Pēdējā šuve.|
...
|$item_atgeir_iron|Dzelzs atgeir|
|$item_atgeir_iron_description|Asiņšķaidis, Galvskaldis, Nāvnesis.|
|$item_axe_blackmetal|Melnmetāla cirvis|
|$item_axe_blackmetal_description|Perfekta līdzsvarots cirvis, taisīts no tumša metāla, un ar smaragda krāsas atspīdumu.|
...
|$item_bloodpudding_description|Gards, taisīts no asinsdesām.|
|$item_blueberries|Mellenes|
|$item_blueberries_description|Mazas, bet garšīgas ogas.|
...
|$item_boarjerky_description|Salīta liesas gaļa.|
...
|$item_bow_draugrfang|Draugera ilknis|
...
|$item_fish_cooked|Kūpināta zivs|
...
|$item_greydwarfeye_description|Pienainains Grejdvarfa acsābols.|
|$item_guck|Guks|
...
|$item_iron|Dzelzs|
|$item_iron_description|Tīras dzelzs stienis, gatavs pārstrādei.|
|$item_ironnails|Dzelzs naglas|
|$item_ironnails_description|Nepieciešami lielākiem būvniecības projektiem.|
...
|$item_loxmeat_cooked|Pagatavota loksu gaļa|
|$item_loxmeat_cooked_description|Burvīgs maigs gaļas gabals, kā radīts Valhallai!|
|$item_loxmeat_description|Jēla marmora gaļas šķēle.|
...
|$item_mead_hp_medium|Pudele medusala, atjauno dzīvības|
|$item_mead_hp_medium_description|Atjauno Dzīvības.|
|$item_mead_hp_minor|Mazā pudele medusala, atjauno dzīvības|
|$item_mead_hp_minor_description|Nedaudz atjauno Dzīvības.|
|$item_mead_poisonres|Medalus indes pretestībai|
|$item_mead_poisonres_description|Pasargā tavu organismu no indēm.|
|$item_mead_stamina_lingering|Lingering stamina mead|
|$item_mead_stamina_lingering_description|Increases stamina regeneration.|
|$item_mead_stamina_medium|Pudele medusala, atjauno Izturību|
|$item_mead_stamina_medium_description|Atjauno izturību.|
|$item_mead_stamina_minor|Mazā pudele medusala, atjauno Izturību|
...
|$item_pickable_bogiron|Purva dzelzs|
...
|$item_pickaxe_iron_description|Izturīgs rūdīta dzelzs darbarīks.|
...
|$item_repairlevel|Salabot esošo darba galda līmeni|
|$item_resin|Sveķi|
...
|$item_serpentmeatcooked_description|Cepta šķēle jūras čūskas gaļas, smaržo labi.|
|$item_serpentscale|Jūrasčūskas zvīņa|
|$item_serpentscale_description|Spīdīga metāla nokrāsas zvīņa no jūras čūskas.|
...
|$item_shield_bronzebuckler|Bronzas vairogs|
...
|$item_shield_ironbuckler|Dzelzs vairogs|
...
|$item_silver|Sudrabs|
|$item_silver_description|Tīra sudraba stienis, gatavs pārstrādei.|
...
|$item_surtlingcore|Sūrtlinga kodols|
...
|$item_trophy_boar_description|Šī mežacūkas galva būs smuks dekors jebkurai mājai.|
|$item_trophy_boar_lore|Šī mežacūkas galva būs smuks dekors jebkurai mājai.|
|$item_trophy_bonemass|Purvbriesmoņa trofeja|
|$item_trophy_bonemass_description|Kauli un staipīga masa, ko kopā satur kaut kāds neredzams spēks. <br/><br/>Vari upurēt to pie Upurakmeņiem.|
...
|$item_trophy_dragonqueen_description|Pūķa galva, pat pēc nāves tikpat majestātiska kā vienmēr. <br/><br/>Vari upurēt to pie Upurakmeņiem.|
...
|$item_trophy_eikthyr_description|Šī nocirstā galvā izstaro kaut kādu spēku.<br/><br/>Vari upurēt to pie Upurakmeņiem.|
|$item_trophy_eikthyr_lore|Savulaik bija meža karalis, tā ragu izmērs ir tiešām iespaidīgs.|
|$item_trophy_elder|Vecajā trofeja|
|$item_trophy_elder_description|Šī nocirstā galvā izstaro kaut kādu spēku.<br/><br/>Vari upurēt to pie Upurakmeņiem.|
...
|$item_trophy_foresttroll_description|Uz cietās troļļa ādas var redzēt izbalējušus aizvēsturiskus simbolus.|
|$item_trophy_foresttroll_lore|Uz cietās troļļa ādas var redzēt izbalējušus aizvēsturiskus simbolus.|
...
|$item_trophy_greydwarfbrute|Broņotā Grejdvarfa trofeja|
...
|$item_trophy_hatchling_description|Aizvien auksts kā ledus.|
|$item_trophy_hatchling_lore|Aizvien auksts kā ledus.|
|$item_trophy_leech|Dēles trofeja|
|$item_trophy_leech_description|Lai arī pretīgi gļotaina, bet tā āda ir dabīgi skaisti sarkanā un melnā krāsā.|
|$item_trophy_leech_lore|Lai arī pretīgi gļotaina, bet tā āda ir dabīgi skaisti sarkanā un melnā krāsā.|
...
|$item_trophy_sgolem_description|No šī kristāliem izrotātā akmeņa sanāktu iespaidīga grīdas rota.|
|$item_trophy_sgolem_lore|No šī kristāliem izrotātā akmeņa sanāktu iespaidīga grīdas rota.|
|$item_trophy_skeleton|Skeletona trofeja|
|$item_trophy_skeleton_description|Neizteiksmīgais smīns šī galvaskausa sejā atgādina tev par nav nāves nenovēršamību.|
|$item_trophy_skeleton_lore|Neizteiksmīgais smīns šī galvaskausa sejā atgādina tev par nav nāves nenovēršamību.|
...
|$item_trophy_surtling_description|Vēl aizvien vīta liesmās, bet bālās un kūp kā ogle.|
|$item_trophy_surtling_lore|Vēl aizvien vīta liesmās, bet bālās un kūp kā ogle.|
...
|$item_trophy_troll_description|Uz cietās troļļa ādas var redzēt izbalējušus aizvēsturiskus simbolus.|
|$item_trophy_troll_lore|Uz cietās troļļa ādas var redzēt izbalējušus aizvēsturiskus simbolus.|
...
|$item_turnipstew_description|Barojošs un veselīgs.|
...
|$loadscreen_tip03|Uzlaboti darba galdi dod iespējas uztaisīt jaunas mantas un ļauj uzlabot esošo ekipējumu.|
...
|$loadscreen_tip07|Pēc ierašanās Valheimā, vispirms mēģini sameklēt zarus un akmeņus un zemes, lai uztaisītu savu pirmo ieroci.|
...
|$lore_draugr|Senos laikos, Valheimas pasaule bija mājas lepnai un cēlai cilvēku rasei. Viņi cēla torņus, kas skāra debesis, un viņi rakās dziļi, dziļi zemē, sniedzoties pēc vērtīgiem metāliem. Bet lepnums nāk pirms bojāejas. Viņi izaicināja Dievus un devās karā pret Āsiem un Vāniem, kas noveda viņus pašus pie viņu bojāejas. Visu tēvs Odins nolīdzināja viņu pilsētas līdz ar zemi, Loki pielaida uguni un viņu raktuves tika aprītas liesmās. Varenais Tors nogāza garos torņus un Freijs nosēja viņu laukus ar sāli. <br/><br/>Nu jau simtiem gadu viņi ir dziļi zemes. Par viņiem nav neviena stāsta, nedzied nevienas dziesmas, tāpat arī viņu pilsētas ir dziļi zem zemes. Bet lepnumu nevar piebeigt tik viegli, un karavīri, kuri cīnījās pēdējā kaujā nepadosies līdz viņu ķermeņi nebūs zeme un pelni un aizpūsti vējā. Viņi atgriezās kā Draugeri, nesvētas, izmisušas radības aizvēsturiskās, sarūsējušās bruņās. <br/><br/>Sakauj un aproc viņus. Atgādini viņiem, ka viņi ir miruši.|
...
|$lore_meadows_random02|Senos laikos, kad visu tēvs Odins apvienoja pasaules, viņš gāza arī Vānus, milžus un vēl citas, pašas vecākās būtnes. Paši varenākie no tiem, kurus nevarēja nogalināt, tika uz mūžu izsūtīti trimdā uz Valheimu, šodien viņus sauc par Pamestajiem.<br/><br/>Mīdot zemi, mazākas radībās lēkā kā drupatas uz bungu ādas. Kad ieraudzīsi, tad atpazīsi viņus.<br/>|
...
|$lore_swamp_random02|Nekavējies, ceļotāj. Gaiss šeit ir kaitīgs un ūdens indīgs. Šeit vazājas Draugeri, un kāds, kura vārda neuzdrošinos piesaukt, arī rosās zem zemes, nikna un nelaba kaulu masa. Kusties ātri, bet uzmanīgi, līdz atkal jūti saules gaismu spīdam uz sejas.|
...
|$lore_swamp_random04|Visiem, kuri šķērso šo vietu, atcerieties mani! Es reiz dzīvoju kalnos, biju parasts cilvēks. Kad tiku atnests šeit, domāju, ka biju nopelnījis savu atdusu pēc dzīves Midgardā, bet nekā. Izrādās, ka man priekšā bija viena dzīve pēc otras šeit Valheimā. Mūsu bija septiņu, pirms šeit ieradās Grejdvarfi. Odins mani neuzklausa un esmu viens. Drīz šis akmens būs viss, kas palicis no manis.|
...
|$menu_loading|Ielādē...|
|$menu_logout|Izlogoties|
|$menu_logoutconfirm|Izlogoties?|
...
|$msg_incompleteoffering|Nepabeigts ziedojums|
...
|$msg_newstation_level|Jauns darba galda līmenis|
|$msg_newtext|$1 pievienots pie Valheimas Zinības|
...
|$msg_noprocessableitems|Tev nav rūdas|
...
|$msg_skills_lowered|Zaudēta prasme|
...
|$npc_haldor_smalltalk01|Mēs visi esam šeit iesprūduši. Dievi jau sen nav vērsuši nevienu skatienu Valheimas virzienā.|
...
|$piece_banner01|Melns baneris|
|$piece_banner02|Zils baneris|
|$piece_banner03|Balti un sarkani strīpains baneris|
|$piece_banner04|Sarkans baneris|
|$piece_banner05|Zaļš baneris|
|$piece_banner06|Zils, sarkans un balts baneris|
|$piece_banner07|Balti un zili strīpains baneris|
...
|$piece_cookingstation|Ārējā plīts|
|$piece_cookingstation_iron|Dzelzs ārējā plīts|
...
|$piece_portal|Portāls|
|$piece_portal_connected|SAVIENOTS|
|$piece_portal_description|Savieno ar citu portālu ar tādu pašu nosaukumu.|
...
|$piece_sapling_seedonion_description|Iestādi sīpola sēklas, lai iegūtu vēl vairāk sēklu.|
...
|$piece_woodironbeam|Dzelzs stiprināta koka brusa|
...
|$se_freezing_start|Tu esi nosalis|
...
|$se_spirit_name|Gars|
|$se_spirit_tooltip|Papildus bojājumi pret nemirušajiem.|
|$se_stamina|Izturība|
...
|$se_theelder_start|Vecajā īpašas spējas plūst cauri tavām venām.|
...
|$settings_buildcat|Būvniecības kategorija|
...
|$skill_frostmagic|Ledus burības|
...
|$skill_pickaxes|Cērte|
|$skill_pickaxes_description|Cērtes bojājumi.|
|$skill_polearms|Staba ieroči|
|$skill_polearms_description|Stabu ieroču bojājumi.|
|$skill_ride|Jāšana|
...
|$skill_sneak_description|Izturības patēriņš, lavoties.|
|$skill_spears|Šķēpi|
...
|$tutorial_bed_label|Hjūgins: Iekārtojas|
|$tutorial_bed_text|Pavadi nakti gultā un pamosties no rīta pilns enerģijas.<br/><br/>Vēls viens ieteikums mājai būtu kastes mantu glabāšanai. <color=yellow>Vienmēr ieteicams tajās uzglabāt rezerves aprīkojumu</color>, gadījumā, ja notiek kas slikts, esot vienam un tālu no mājām...|
...
|$tutorial_death_label|Hjūgins: Beigts|
...
|$tutorial_food_topic|Garšīgs morss!|
...
|$tutorial_hunger_label|Hjūgins: Bads|
...
|$tutorial_maptable_text|Uz šī galda tu vari atzīmēt un dalīties ar citiem savām gaitās un atklājumos 10. pasaulē. Izmanto instrumentu kasti, lai atzīmētu jaunāko atklāto, un uzmet aci kartei, lai redzētu, kas citiem jauns.|
|$tutorial_maptable_topic|Atzīmēt jaunākos atklājumus|
|$tutorial_ore_label|Hjūgins: Rūda|
|$tutorial_ore_text|Rūdu vispirms ir nepieciešams pārstrādāt <color=yellow>Kausētāvā</color> un pēc tam vari ar to strādāt <color=yellow>Kalvē</color>. <br/><br/>Lai uztaisītu Kausētāju, tev nepieciešami <color=yellow>Sūrtlingu akmeņi</color>. Meklē tos tumšās vietās zem zemes.|
|$tutorial_ore_topic|Tu esi atradi rūdu|
...
|$tutorial_portal_label|Hjūgins: Portāls|
|$tutorial_portal_text|Portāli lieliski noder ātrai ceļošanai no vienas pasaules malas uz otru. <br/><br/>Tev, protams, nepieciešams uztaisīt portālu arī otrā galā. Un piešķirot tam tādu pašu nosaukumu, abi tiks automātiski savienoti!|
|$tutorial_portal_topic|Tu uztaisīji portālu|
...
|$tutorial_start_topic|Laipni lūgti Valheimā|
...
|$tutorial_wishbone_text|Izskatās, ka starp daudzajām atliekām ko šī plīvojošā, dzīvā urna slēpa savās iekšās, ir Vēlmju kauls. <br/><br/>Šis kauls ir apburts ar spēku, kas tevi vadīs un palīdzēs atrast zemē paslēptas lietas. Tas palīdzēt atrast sudraba dzīslas, kā arī apraktus dārgumus...|
