...
|$enemy_wraith|Wraith|
|$error_alreadyconnected|Jau pievienots|
|$error_banned|Liegta pieeja|
|$error_disconnected|Atvienots|
|$error_failedconnect|Neizdevās pievienoties|
|$error_incompatibleversion|Nesaderīga versija|
|$error_password|Nederīga parole|
...
|$inventory_veryresistant|Ļoti izturīgs|
|$inventory_veryweak|Ļoti vājš|
|$inventory_weak|Vājš|
|$item_amber|Amber|
...
|$menu_passwordinvalid|Nederīga parole|
...
|$settings_attack|Uzbrukšana|
|$settings_audio|Skaņa|
|$settings_autopickup|Toggle Auto-Pickup|
|$settings_autorun|Automātiska kustība|
...
|$settings_run|Skriešana|
|$settings_secondaryattack|Otra uzbrukšana|
...
|$tutorial_start_topic|Sveicināti Valheimā|
