...
|$menu_vulkancrashwarning_header|Vulkanを使用すると、Valheimがあなたのシステムでクラッシュする可能性があります|
|$menu_vulkancrashwarning_text|現在Vulkanを使用しています。特定のシステムでVulkanを使用すると発生する既知のクラッシュについて調査中であり、お使いのシステムが影響を受ける可能性があると検出されました。安定性に問題が発生した場合は、代わりにデフォルトのレンダリングAPI（DirectX 11）を使用してください。ご不便をおかけして申し訳ありません！|
