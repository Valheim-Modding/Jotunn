...
|$online_kickedfromsession_header|セッションから切断されました|
...
|$settings_console|コンソールを有効にする|
|$settings_console_desc|ゲーム内でコンソールを開き、特殊なデバッグコマンドや機能を利用できるようにします。コマンドライン引数の「-console」はこの設定よりも優先されます。|
