...
|$menu_vulkancrashwarning_header|Vulkan을 사용할 경우 Valheim이 시스템에서 충돌할 수 있습니다|
|$menu_vulkancrashwarning_text|현재 Vulkan을 사용 중입니다. 특정 시스템에서 Vulkan을 사용할 때 발생하는 알려진 충돌 문제를 조사 중이며, 귀하의 시스템이 잠재적으로 영향을 받을 수 있음이 감지되었습니다. 안정성 문제를 겪으신다면 기본 렌더링 API(DirectX 11)를 대신 사용해 주세요. 불편을 드려 죄송합니다!|
