...
|$error_platformexcluded|해당 서버의 서버장이 자신의 플랫폼과 다른 플랫폼의 사용자가 자신의 서버에서 플레이하는 것을 허용하지 않습니다.|
...
|$item_helmet_fishinghat_description|이 매력적인 모자는 가장 노련한 모함가들만 낚아낼 수 있습니다.|
...
|$menu_addserverfaileddnslookup|DNS 룩업 실패!|
...
|$menu_loading|불러오는 중...|
|$menu_loginfailedtext|로그인에 실패하였습니다. 인터넷에 연결되어 있는지 확인하십시오.|
|$menu_loginheader|후단부 서비스에 로그인하는 중...|
|$menu_loginretrycountdowntext|$1 초 후에 재시도...|
|$menu_logintext|로그인하는 중...|
|$menu_logout|로그아웃|
...
|$wolf_statue|펜리스의 신전|
|$xbox_error_crossplayprivilege|플랫폼 권한 설정으로 인하여 다른 플랫폼과의 크로스플레이를 허용하는 서버에서 플레이할 수 없습니다.|
