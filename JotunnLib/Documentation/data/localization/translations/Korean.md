...
|$ach_allbosses|바이킹|
|$ach_allbosses_desc|아무 난이도에서 모든 보스를 물리치세요.|
|$ach_allbosseshard|가장 거친 바이킹|
|$ach_allbosseshard_desc|어려움 난이도에서 모든 보스를 물리치세요.|
|$ach_allbossesnormal|거친 바이킹|
|$ach_allbossesnormal_desc|일반 난이도 이상에서 모든 보스를 물리치세요.|
|$ach_allbossesunarmed|권투 선수|
|$ach_allbossesunarmed_desc|주먹만을 사용해 모든 보스를 물리치세요.|
|$ach_allbuildpieces|목수|
|$ach_allbuildpieces_desc|모든 것을 건설하세요.|
|$ach_allfoodcooked|대가 요리사|
|$ach_allfoodcooked_desc|모든 종류의 음식을 조리하세요.|
|$ach_allfoodeaten|미식가|
|$ach_allfoodeaten_desc|먹을 수 있는 모든 종류의 아이템을 먹으세요.|
|$ach_allitemcraft|장인|
|$ach_allitemcraft_desc|모든 종류의 아이템을 제작하세요.|
|$ach_allminibosses|오딘께서 기꺼워 하셨다|
|$ach_allminibosses_desc|모든 미니보스를 물리치세요.|
|$ach_allweaponcraft|대장장이|
|$ach_allweaponcraft_desc|모든 종류의 무기를 제작하세요.|
|$ach_arrived|내가 왔다!|
|$ach_arrived_desc|열 번째 세계에 입장하세요.|
|$ach_bigfish|니오르드에 걸맞은 어획물|
|$ach_bigfish_desc|별 네 개인 물고기를 잡으세요.|
|$ach_boss1eikthyr|에이크쉬르|
|$ach_boss1eikthyr_desc|번개 수사슴을 물리치세요.|
|$ach_boss2elder|엘더|
|$ach_boss2elder_desc|살아있는 숲을 물리치세요.|
|$ach_boss3bonemass|본매스|
|$ach_boss3bonemass_desc|몸부림치는 망자를 물리치세요.|
|$ach_boss4moder|모더|
|$ach_boss4moder_desc|어머니 드래곤을 물리치세요.|
|$ach_boss5yagluth|야글루스|
|$ach_boss5yagluth_desc|뒤틀린 영혼을 물리치세요.|
|$ach_boss6queen|추적자 여왕|
|$ach_boss6queen_desc|기어다니는 대모를 물리치세요.|
|$ach_boss7fader|파더|
|$ach_boss7fader_desc|에메랄드 화염을 물리치세요.|
|$ach_boss8frozenking|칼 핌불브링거|
|$ach_boss8frozenking_desc|속박된 자를 물리치세요.|
|$ach_builddyrnwyn|선택받은 자|
|$ach_builddyrnwyn_desc|던원을 조립하세요.|
|$ach_buildhigh|웅장한 홀|
|$ach_buildhigh_desc|굉장히 높은 구조물을 세우세요.|
|$ach_buildhighworld|세상의 꼭대기|
|$ach_buildhighworld_desc|굉장히 높은 곳에 무언가를 건설하세요.|
|$ach_buildhouse|정착민|
|$ach_buildhouse_desc|집을 건설하세요.|
|$ach_buildvillage|건축가|
|$ach_buildvillage_desc|마을을 건설하세요.|
|$ach_childofodin|오딘의 아이|
|$ach_childofodin_desc|가장 거친 바이킹과 대가 사냥꾼의 정신을 품고, 생존자이자 길잡이가 되세요.|
|$ach_deathbyalltypes|괜찮아?|
|$ach_deathbyalltypes_desc|가능한 모든 방식으로 사망하세요.|
|$ach_deathbyobliterator|소각 완료|
|$ach_deathbyobliterator_desc|너무 가까이에 서 있었습니다.|
|$ach_deathbytree|사고 발생|
|$ach_deathbytree_desc|나무에 의해 사망하세요.|
|$ach_deathbytreeall|사고일 수가 없어|
|$ach_deathbytreeall_desc|모든 종류의 나무에 의해 사망하세요.|
|$ach_everyachievement|가장 가치 있는 자|
|$ach_everyachievement_desc|모든 도전과제를 잠금 해제하세요.|
|$ach_explorensew|탐험가|
|$ach_explorensew_desc|모든 네 방향으로 멀리 여행하세요.|
|$ach_explorensewnomap|길잡이|
|$ach_explorensewnomap_desc|지도를 사용하지 않고 모든 네 방향으로 멀리 여행하세요.|
|$ach_findalltrophies|트로피 수집가|
|$ach_findalltrophies_desc|모든 트로피를 수집하세요.|
|$ach_firstdeath|많은 이들 중 최초|
|$ach_firstdeath_desc|최후를 맞이하고 다시 시작할 준비하세요...|
|$ach_grindbuild|건설자|
|$ach_grindbuild_desc|조각을 500개 건설하세요.|
|$ach_grindcomfort|편안함이 생명이다|
|$ach_grindcomfort_desc|편안함 레벨 20에 도달하세요.|
|$ach_grindcook|요리사|
|$ach_grindcook_desc|요리를 100개 조리하세요.|
|$ach_grinddays|생존자|
|$ach_grinddays_desc|연속으로 30일 동안 생존하세요.|
|$ach_grindeat|빈속으로 모험은 안 되지|
|$ach_grindeat_desc|음식 500개를 먹으세요.|
|$ach_grindfish|어부|
|$ach_grindfish_desc|모든 종류의 물고기를 잡으세요.|
|$ach_grindforager|채집가|
|$ach_grindforager_desc|베리 250개, 버섯 250개를 수집하세요.|
|$ach_grindharvest|농부|
|$ach_grindharvest_desc|작물을 500개 수확하세요.|
|$ach_grindhoney|양봉가|
|$ach_grindhoney_desc|꿀을 500개 수확하세요.|
|$ach_grindleviathan|자고 있을 때가 아니야|
|$ach_grindleviathan_desc|바다의 생명체를 깨우세요.|
|$ach_grindsail|선원|
|$ach_grindsail_desc|세상을 두 번 돌 정도로 멀리 항해하세요.|
|$ach_grindsailhelm|선장|
|$ach_grindsailhelm_desc|조타를 맡은 동안 세상을 돌 정도로 멀리 항해하세요.|
|$ach_grindtreasure|보물 사냥꾼|
|$ach_grindtreasure_desc|파묻힌 보물 상자를 10개 발견하세요.|
|$ach_grindtrees|나무꾼|
|$ach_grindtrees_desc|나무를 500그루 벌목하세요.|
|$ach_killallcreatures|사냥꾼|
|$ach_killallcreatures_desc|모든 종류의 생명체를 처치하세요.|
|$ach_killallcreatureshard|대가 사냥꾼|
|$ach_killallcreatureshard_desc|어려움 난이도에서 모든 종류의 생명체를 처치하세요.|
|$ach_kingsqueens|발헤임의 왕과 여왕들|
|$ach_kingsqueens_desc|바이킹과 사냥꾼의 정신을 품고, 장인과 대가 요리사와 목수처럼 뛰어난 모습을 보이며, 탐험가가 되세요.|
|$ach_multiplayerboss|함께라면 더욱 강하다|
|$ach_multiplayerboss_desc|친구와 함께 보스를 처치하세요.|
|$ach_sailedge|전설은 사실이다|
|$ach_sailedge_desc|세상의 가장자리로 항해하세요.|
|$ach_soloboss|고독한 늑대|
|$ach_soloboss_desc|혼자서 보스를 처치하세요.|
|$achievement_details|도전과제 세부정보|
|$achievements_cheated_item_inventory|이 아이템은 치트 수단을 통해 소환되었습니다.|
|$achievements_confirm_cheat|해당 명령어는 치트입니다. 치트를 사용하려면 콘솔 메뉴에서 'confirmcheats'를 입력하세요. <color=red>치트를 사용하면 해당 캐릭터와 해당 세계에서 영구적으로 도전과제를 해제할 수 없게 됩니다.</color>|
|$achievements_permanently_cheated_character|치트를 사용하여 해당 캐릭터의 도전과제 진행이 영구적으로 비활성화되었습니다.|
|$achievements_permanently_cheated_world|치트 세계 수정자를 사용하고 있어 해당 세계의 도전과제 진행이 영구적으로 비활성화되었습니다.|
|$achievements_picked_up_cheated_item|치트 아이템을 획득했습니다. 도전과제 진행이 일시적으로 비활성화됩니다.|
|$achievements_temporarily_cheated|치트 아이템을 소유하고 있어 해당 캐릭터의 도전과제 진행이 일시적으로 비활성화되었습니다.|
...
|$biome_plains|평원|
|$biome_swamp|늪지대|
|$black_ice_combo|악의 서린 얼음|
|$blackice_core|악의 서린 얼음|
|$blackice_triggeritem|악의 서린 얼음|
|$blocking_joined_world_with_blocked_player|이 월드에는 귀하가 차단한 플레이어의 사용자 생성 콘텐츠(UGC)가 포함되어 있습니다. 이 월드에서 플레이하려면 차단을 해제해야 합니다. 차단 해제를 진행하시겠습니까? 해당 사용자:|
|$boss_hive_end|우리는 흩어졌다.|
|$boss_hive_start|우리가 모였다.|
|$build_piece_author_built_by|제작자:|
|$build_piece_author_unknown|알 수 없음|
|$button_a|A|
|$button_b|B|
|$button_back|뒤로|
|$button_lalt|좌측 알트 키|
|$button_lb|LB|
|$button_lcommand|L-커맨드|
...
|$chat_shout|소리치기|
|$chat_whisper|귓속말|
|$cinematics_end_credits|엔딩 크레딧|
|$cinematics_intro|오프닝|
|$cinematics_outro|엔딩|
|$codeofconduct_ban_appeals_body|본인의 차단 제재가 잘못되었다고 판단되는 경우, 고객지원에 검토를 요청하실 수 있습니다. 다만, 최종 결정은 당사의 정책 및 플랫폼 운영 기준에 따라 이루어집니다.|
|$codeofconduct_ban_appeals_header|차단 이의 제기|
|$codeofconduct_bodytext_first|크로스플레이 플랫폼을 통해 플레이할 경우, 당사의 모든 규정과 커뮤니티 가이드라인을 준수해야 합니다. 항상 모범적인 태도를 지향해 주십시오.|
|$codeofconduct_enforcement_and_bans_body|당사는 본 규칙을 위반한 플레이어에 대해 다음과 같은 조치를 취할 권리를 보유합니다.<br/><br/>• 온라인 플레이에 대한 일시적 또는 영구적인 차단<br/><br/>• 크로스플레이 기능 제한|
|$codeofconduct_enforcement_and_bans_header|제재 및 차단 조치|
|$codeofconduct_header|플레이어 행동 및 차단 제재 안내 - 책임감 있게 플레이하세요|
|$codeofconduct_prohibited_behavior_body|다음과 같은 행동은 온라인 플레이에 대한 일시적 또는 영구적인 차단 조치로 이어질 수 있습니다.<br/><br/>• 괴롭힘, 증오 발언, 협박, 차별 행위<br/><br/>• 채팅, 게임 내 건축 혹은 기타 수단을 통한 부적절하거나 불쾌감을 주는 콘텐츠 공유|
|$codeofconduct_prohibited_behavior_header|금지된 행동|
|$codeofconduct_reporting_violations_body|허용되지 않는 행위를 목격한 경우:<br/><br/><br/><br/>• 게임 내: 자체 "플레이어 신고" 기능을 활용해 주세요. (옵션 -> 플레이어 목록 -> 신고)<br/><br/>• 게임 외부: 온라인 양식(https://valheim.com/report-a-player)을 사용해 주세요|
|$codeofconduct_reporting_violations_header|위반 신고|
...
|$customization_beard22|콧수염|
|$customization_beard23|주름 수염|
|$customization_beard24|왁스 바른 수염|
|$customization_beard25|다듬은 수염|
|$customization_beard26|팔자 수염|
...
|$customization_hair32|멀릿|
|$customization_hair33|빈란드식 면도|
|$customization_hair34|성주|
|$customization_hair35|용사|
|$customization_hair36|기록자|
|$customization_hair37|태양빛|
|$customization_hair38|남성|
...
|$dream_deepnorth01|꿈속에서 당신은 너무나도 투명해 눈으로는 볼 수 없고 허리춤을 감싸며 일렁이는 허리띠처럼 느껴지는 웅덩이 속에 나체로 서 있습니다. 물가에는 세 명이 침묵 속에서 당신을 지켜보고 있습니다. 맨 앞에 선 여성의 발가락이 수면에 닿자, 파문이 꿈을 씻어내리고 당신은 깨어납니다.|
|$dream_deepnorth02|당신은 불안정한 꿈의 터널을 미끄러져 내려가며 어떤 말로도 설명할 수 없는 완벽한 무의 세계로 빨려 들어갑니다…|
|$dream_deepnorth03|당신은 눈이 내리는 한밤중의 반짝이는 빛과 웃음으로 가득한 겨울의 홀을 꿈꿉니다. 당신이 다가가자 불빛은 일렁이며 치솟은 불길로 변했고 웃음소리는 비명이 되었습니다. 당신은 홀을 향해 달려가지만, 다가갈수록 눈 속으로 파묻힙니다.|
|$dream_deepnorth04|끝을 모르는 언덕을 달려가는 당신의 가슴은 기쁨으로 가득 채워지고 심장은 두근거립니다. 두 개의 어두운 형태가 당신 옆에서 날아다니며 그들의 날갯소리는 깨어날 때까지 귓가에 맴돕니다.|
|$dream_deepnorth05|당신은 웃는 동시에 울고 있는 아이의 얼굴을 보았습니다. 눈물을 흘리는 눈동자는 맑고 푸른색이며, 입에는 작은 이가 어수선하게 나 있습니다. 꿈속에서 아이는 당신에게 무언가를 말해주었지만, <br/><br/>깨어난 순간 그 말은 이미 사라졌습니다.|
|$dream_deepnorth06|당신의 꿈속에 자물쇠도 빗장도 없는 문이 보입니다. 당신은 문을 밀어서 열 수 있을 것 같다고 생각했지만, 몸은 차갑게 휘몰아치는 바람 속에 얼어붙었습니다. 문 뒤로 당신이 사랑하지만, 이름을 기억할 수 없는 이의 목소리가 들립니다. 당신은 공허한 기상을 향해 몸을 내밉니다.|
|$dream_deepnorth07|당신의 손에 죽은 모든 이들의 귀신이 당신의 꿈으로 찾아와 꿈의 경계에 머무릅니다. 그들은 아무것도 원하지 않고, 아무것도 필요로 하지 않으며, 아무 말도 하지 않습니다.|
|$dream_deepnorth08|당신은 여러 계층의 꿈을 뚫고 가라앉으며, 무거운 사슬에 얽힌 어두운 형체가 있는 거대한 방에 도착합니다. 형체가 당신을 향해 고개를 돌리자, 푸른 눈동자가 꿈을 꿰뚫었고, 당신은 땀에 흠뻑 젖은 채로 잠에서 깨어납니다.|
|$dream_deepnorth09|오늘 밤의 꿈 내용은 아무것도 기억나지 않지만, 꿈이 풍기는 무지개 같은 분위기에 입가에 미소를 띄며 잠에서 깨어났습니다.|
|$dream_deepnorth10|오딘이 당신의 꿈을 방문해 거품이 일렁이는 술이 가득 찬 뿔잔을 내밉니다. 당신은 술을 크게 한 입 마시고 상쾌한 기분으로 새로운 하루를 맞이합니다.|
...
|$dream_yagluth01|황금 커튼이 달린 방 안에서, 베일에 가려진 왕의 옥좌 앞에 무릎을 꿇고 있습니다. 그는 "잠은 가면일 뿐"이라며 베일을 천천히 들어 올립니다. <br/><br/>비명을 지르며 잠에서 깨어납니다.|
|$dvergr_buff|드베르그의 힘|
|$dvergr_buff_description|기묘한 드베르그의 권능을 얻어 힘이 강해집니다.|
|$elaking_trashpile|잔해 더미|
|$enemy_abomination|어보미네이션|
|$enemy_asksvin|애스크스빈|
|$enemy_asksvin_hatchling|새끼 애스크스빈|
|$enemy_aspect_bonemass|몸부림치는 망자의 형상|
|$enemy_aspect_dragon|어머니 드래곤의 형상|
|$enemy_aspect_eikthyr|번개 수사슴의 형상|
|$enemy_aspect_fader|에메랄드 화염의 형상|
|$enemy_aspect_gdking|살아있는 숲의 형상|
|$enemy_aspect_goblinking|뒤틀린 영혼의 형상|
|$enemy_aspect_seekerqueen|기어다니는 대모의 형상|
|$enemy_babyseeker|새끼 추적자|
|$enemy_barka|바르카|
|$enemy_bat|박쥐|
|$enemy_bigblob|육면체 펄프|
|$enemy_bjorn|곰|
|$enemy_blob|블롭|
|$enemy_blobelite|우저|
|$enemy_blobfrost|얼음 블롭|
|$enemy_bloblava|용암 블롭|
|$enemy_blobmork|무형의 펄프|
|$enemy_blobmorkmini|작은 펄프|
|$enemy_blobtar|그로쓰|
|$enemy_boar|멧돼지|
...
|$enemy_boss_frozenking_alertmessage|그의 분노가 모든 것을 타락시킵니다!|
|$enemy_boss_frozenking_deathmessage|세상에 평화가 찾아옵니다|
...
|$enemy_dvergr_deepnorth|수감된 드베르그|
|$enemy_dvergr_mage|드베르그 마법사|
|$enemy_dvergrs|드베르그|
|$enemy_eikthyr|에이크쉬르|
|$enemy_eikthyr_alertmessage|에이크쉬르가 폭풍을 소환합니다|
|$enemy_eikthyr_deathmessage|에이크쉬르를 처치했습니다|
|$enemy_elaking|엘라킹|
|$enemy_elakingmole|눈 없는 자|
|$enemy_fader|파더|
|$enemy_fader_codename|에메랄드 화염|
|$enemy_fallenvalkyrie|타락한 발키리|
|$enemy_fallenwarrior|쓰러진 전사|
|$enemy_fenring|펜링|
|$enemy_fenringcultist|광신자|
|$enemy_fenringcultist_hildir|<color=orange>게이르하파</color>|
|$enemy_frozenking|칼 핌불브링거|
|$enemy_frozenking_p3|칼 핌불브링거|
|$enemy_frysling|프라이슬링|
|$enemy_gdking|엘더|
|$enemy_gdking_alertmessage|엘더가 숲에서 깨어납니다|
|$enemy_gdking_deathmessage|엘더가 쓰러졌습니다|
|$enemy_gemgoblin|릭티그 풀링|
|$enemy_ghost|유령|
|$enemy_ghost_void|공허|
|$enemy_gjall|걀|
|$enemy_goblin|풀링|
|$enemy_goblin_deepnorth|사로잡힌 풀링|
...
|$enemy_hare|토끼|
|$enemy_hen|암탉|
|$enemy_holespawner|옷장 통로|
|$enemy_jotun_warrior|크리겐|
|$enemy_jotun_witch|헥센|
|$enemy_kvastur|크바스투르|
...
|$enemy_mistile|미스틸|
|$enemy_moose|무스|
|$enemy_moosecalf|무스 새끼|
|$enemy_morgen|모르겐|
|$enemy_neck|넥|
|$enemy_seal|물개|
|$enemy_seal_baby|새끼 물개|
|$enemy_seeker|추적자|
|$enemy_seekerbrute|추적자 병사|
|$enemy_seekerqueen|여왕|
|$enemy_serpent|바다뱀|
|$enemy_shadowperson|그림자|
|$enemy_skeleton|해골|
...
|$eula_acceptance|“수락”을 선택하거나 제품을 사용함으로써, 귀하는 본 EULA를 읽고 이해하였으며 그 내용에 구속받는 데 동의하는 것으로 간주됩니다.|
|$eula_header|최종 사용자 라이선스 협정|
|$eula_important_first_text|중요: VALHEIM.COM/EULA에서 최종 사용자 라이선스 협정을 주의 깊게 읽어 주시길 바랍니다. 본인이 소유하거나 통제하는 시스템에서 “VALHEIM”(이하 “제품”)을 다운로드, 설치 또는 사용함으로써 귀하는 본 최종 사용자 라이선스 협정(이하 “EULA”)의 모든 약관에 동의하게 됩니다. 이에 동의하지 않으실 경우, 제품을 사용하지 마십시오.|
...
|$event_elakingarmy_end|그들이 다시 구덩이로 돌아갑니다...|
|$event_elakingarmy_start|아래에서 그들이 등장합니다...|
...
|$event_ghosts_end|그들은 추방되었다, 당분간은...|
|$event_ghosts_start|당신은 등골이 오싹해지는 것을 느낍니다.|
...
|$event_jotunarmy_end|요툰이 물러납니다|
|$event_jotunarmy_start|요툰이 당신을 발견했습니다|
...
|$fallen_viking_randomend_1|너에겐 자격이 있다.|
|$fallen_viking_randomend_10|너에겐 자격이 있는 것 같군.|
|$fallen_viking_randomend_11|네 실력을 잘 알겠다.|
|$fallen_viking_randomend_12|선조께서 네게 미소 지으신다.|
|$fallen_viking_randomend_13|발키리가 잘 선택했군.|
|$fallen_viking_randomend_14|드디어, 마침내.|
|$fallen_viking_randomend_15|이제 쉴 수 있겠어.|
|$fallen_viking_randomend_16|훌륭한 전투였다.|
|$fallen_viking_randomend_17|이제 우리의 축복을 받고 떠나라.|
|$fallen_viking_randomend_18|넌 이제 우리 모두를 위해 싸우는 거다.|
|$fallen_viking_randomend_19|너의 발전을 흥미롭게 지켜보마.|
|$fallen_viking_randomend_2|넌 자격을 증명했다.|
|$fallen_viking_randomend_20|정말로 뛰어나군.|
|$fallen_viking_randomend_3|잘 싸웠다, 전사여.|
|$fallen_viking_randomend_4|진정한 챔피언이군.|
|$fallen_viking_randomend_5|승리는 너의 운명이다.|
|$fallen_viking_randomend_6|정말 가치 있는 전투였다.|
|$fallen_viking_randomend_7|영광이었다.|
|$fallen_viking_randomend_8|잘 싸우더군.|
|$fallen_viking_randomend_9|너는 강력한 전사다.|
|$fallen_viking_randomstart_1|너의 실력을 좀 볼까!|
|$fallen_viking_randomstart_10|내게 도전할 셈이냐?|
|$fallen_viking_randomstart_11|나는 이 순간을 기다리고 있었지!|
|$fallen_viking_randomstart_12|그렇다면 나와 싸워라!|
|$fallen_viking_randomstart_13|네 힘을 증명해라!|
|$fallen_viking_randomstart_14|피를 원하나?|
|$fallen_viking_randomstart_15|승리를 위하여!|
|$fallen_viking_randomstart_16|그렇다면 덤벼라!|
|$fallen_viking_randomstart_17|이게 네가 원하던 싸움인가?|
|$fallen_viking_randomstart_18|드디어!|
|$fallen_viking_randomstart_19|결투하지 그래?|
|$fallen_viking_randomstart_2|네 솜씨를 보여라!|
|$fallen_viking_randomstart_20|부끄러워하지 말고 나와 싸우자고!|
|$fallen_viking_randomstart_3|네 자격을 증명해라!|
|$fallen_viking_randomstart_4|너에겐 자격이 있는가?|
|$fallen_viking_randomstart_5|우리가 너의 자격을 확인하겠다!|
|$fallen_viking_randomstart_6|날 물리칠 수 있다 생각하는가?|
|$fallen_viking_randomstart_7|최고의 전사가 승리하리라!|
|$fallen_viking_randomstart_8|누가 더 강한지 볼까?|
|$fallen_viking_randomstart_9|드디어 도전자가 등장했군!|
|$fallen_viking_randomtaunt_1|그게 네 전력인가?|
|$fallen_viking_randomtaunt_10|이거 장난인가?|
|$fallen_viking_randomtaunt_11|이게 네 전부라고?|
|$fallen_viking_randomtaunt_12|또 뭘 할 수 있지?|
|$fallen_viking_randomtaunt_13|이제야 좀 싸움 같군!|
|$fallen_viking_randomtaunt_14|피로 땅을 적셔라!|
|$fallen_viking_randomtaunt_15|그렇다면 증명해라! 어서!|
|$fallen_viking_randomtaunt_16|온 힘을 다해 공격해!|
|$fallen_viking_randomtaunt_17|쥐새끼도 너보다는 사납겠군!|
|$fallen_viking_randomtaunt_18|낡은 숟가락으로 맞아도 이보다는 아플 거다!|
|$fallen_viking_randomtaunt_19|챔피언치고는 보잘것없는 변명이군!|
|$fallen_viking_randomtaunt_2|어서! 나와 싸우자!|
|$fallen_viking_randomtaunt_20|기껏 긁어모아 보낸 전력이 너란 말이냐?|
|$fallen_viking_randomtaunt_21|정말 요즘은 아무나 무기를 휘두르게 하는군!|
|$fallen_viking_randomtaunt_22|네 선조를 모욕하지 마라!|
|$fallen_viking_randomtaunt_23|애송이도 너보다는 잘 싸울 거다!|
|$fallen_viking_randomtaunt_24|정말 바이킹이 맞기는 한가?|
|$fallen_viking_randomtaunt_25|자 어서, 그게 전부는 아니겠지?|
|$fallen_viking_randomtaunt_26|한심하군! 다시!|
|$fallen_viking_randomtaunt_27|그것도 싸움이라고 하나?|
|$fallen_viking_randomtaunt_28|그런 실력으로 챔피언을 자칭해?|
|$fallen_viking_randomtaunt_29|제대로 된 발놀림을 배우기는 한 건가?|
|$fallen_viking_randomtaunt_3|그것보단 잘 할 수 있을 텐데!|
|$fallen_viking_randomtaunt_30|정말 그런 무기를 들고 이 싸움에 나설 건가?|
|$fallen_viking_randomtaunt_31|난쟁이가 너보다는 더 뛰어나겠군!|
|$fallen_viking_randomtaunt_32|발키리가 널 고르다니, 실수한 건가?|
|$fallen_viking_randomtaunt_33|주저하지 마라!|
|$fallen_viking_randomtaunt_34|챔피언이라면 제대로 때려야지!|
|$fallen_viking_randomtaunt_35|여긴 약자를 위한 곳이 아니다!|
|$fallen_viking_randomtaunt_36|오랫동안 이걸 기다려왔지!|
|$fallen_viking_randomtaunt_37|내가 널 죽여주길 원하는가?|
|$fallen_viking_randomtaunt_38|이것보다는 더 뛰어나야지!|
|$fallen_viking_randomtaunt_39|헛되이 여기까지 온 건 아닐 텐데!|
|$fallen_viking_randomtaunt_4|정말 전력이 아닌 게 확실한가?|
|$fallen_viking_randomtaunt_40|무기와 하나가 되어야 한다!|
|$fallen_viking_randomtaunt_5|그게 전부인가?|
|$fallen_viking_randomtaunt_6|이것보단 더 강해야 할 거다!|
|$fallen_viking_randomtaunt_7|너에게 자격이 있다고?|
|$fallen_viking_randomtaunt_8|우릴 수치스럽게 하지 마라!|
|$fallen_viking_randomtaunt_9|네 주제를 알아야지!|
|$fallenwarrior_title1_f|{name}, 모험가|
|$fallenwarrior_title1_m|{name}, 모험가|
|$fallenwarrior_title10_f|{name}, 용맹한 자|
|$fallenwarrior_title10_m|{name}, 용맹한 자|
|$fallenwarrior_title100_f|{name}, 늑대|
|$fallenwarrior_title100_m|{name}, 늑대|
|$fallenwarrior_title101_f|{name}, 젊은 자|
|$fallenwarrior_title101_m|{name}, 젊은 자|
|$fallenwarrior_title11_f|{name}, 총명한 자|
|$fallenwarrior_title11_m|{name}, 총명한 자|
|$fallenwarrior_title12_f|{name}, 꺾인 자|
|$fallenwarrior_title12_m|{name}, 꺾인 자|
|$fallenwarrior_title13_f|{name}, 도시를 세운 자|
|$fallenwarrior_title13_m|{name}, 도시를 세운 자|
|$fallenwarrior_title14_f|{name}, 평온한 자|
|$fallenwarrior_title14_m|{name}, 평온한 자|
|$fallenwarrior_title15_f|{name}, 용사|
|$fallenwarrior_title15_m|{name}, 용사|
|$fallenwarrior_title16_f|{name}, 명랑한 자|
|$fallenwarrior_title16_m|{name}, 명랑한 자|
|$fallenwarrior_title17_f|{name}, 선택받은 자|
|$fallenwarrior_title17_m|{name}, 선택받은 자|
|$fallenwarrior_title18_f|{name}, 영리한 자|
|$fallenwarrior_title18_m|{name}, 영리한 자|
|$fallenwarrior_title19_f|{name}, 냉혹한 자|
|$fallenwarrior_title19_m|{name}, 냉혹한 자|
|$fallenwarrior_title2_f|{name}, 불길한 자|
|$fallenwarrior_title2_m|{name}, 불길한 자|
|$fallenwarrior_title20_f|{name}, 정복자|
|$fallenwarrior_title20_m|{name}, 정복자|
|$fallenwarrior_title21_f|{name}, 죽음을 좇는 자|
|$fallenwarrior_title21_m|{name}, 죽음을 좇는 자|
|$fallenwarrior_title22_f|{name}, 저주받은 자|
|$fallenwarrior_title22_m|{name}, 저주받은 자|
|$fallenwarrior_title23_f|{name}, 위험한 자|
|$fallenwarrior_title23_m|{name}, 위험한 자|
|$fallenwarrior_title24_f|{name}, 죽음을 부르는 자|
|$fallenwarrior_title24_m|{name}, 죽음을 부르는 자|
|$fallenwarrior_title25_f|{name}, 기만자|
|$fallenwarrior_title25_m|{name}, 기만자|
|$fallenwarrior_title26_f|{name}, 까다로운 자|
|$fallenwarrior_title26_m|{name}, 까다로운 자|
|$fallenwarrior_title27_f|{name}, 드래곤|
|$fallenwarrior_title27_m|{name}, 드래곤|
|$fallenwarrior_title28_f|{name}, 독수리|
|$fallenwarrior_title28_m|{name}, 독수리|
|$fallenwarrior_title29_f|{name}, 탐험가|
|$fallenwarrior_title29_m|{name}, 탐험가|
|$fallenwarrior_title3_f|{name}, 곰 같은 자|
|$fallenwarrior_title3_m|{name}, 곰 같은 자|
|$fallenwarrior_title30_f|{name}, 두려움의 대상|
|$fallenwarrior_title30_m|{name}, 두려움의 대상|
|$fallenwarrior_title31_f|{name}, 맹렬한 자|
|$fallenwarrior_title31_m|{name}, 맹렬한 자|
|$fallenwarrior_title32_f|{name}, 투사|
|$fallenwarrior_title32_m|{name}, 투사|
|$fallenwarrior_title33_f|{name}, 잊힌 자|
|$fallenwarrior_title33_m|{name}, 잊힌 자|
|$fallenwarrior_title34_f|{name}, 관대한 자|
|$fallenwarrior_title34_m|{name}, 관대한 자|
|$fallenwarrior_title35_f|{name}, 탐욕스러운 자|
|$fallenwarrior_title35_m|{name}, 탐욕스러운 자|
|$fallenwarrior_title36_f|{name}, 음울한 자|
|$fallenwarrior_title36_m|{name}, 음울한 자|
|$fallenwarrior_title37_f|{name}, 파괴자|
|$fallenwarrior_title37_m|{name}, 파괴자|
|$fallenwarrior_title38_f|{name}, 킹메이커|
|$fallenwarrior_title38_m|{name}, 킹메이커|
|$fallenwarrior_title39_f|{name}, 통달한 자|
|$fallenwarrior_title39_m|{name}, 통달한 자|
|$fallenwarrior_title4_f|{name}, 패배한 자|
|$fallenwarrior_title4_m|{name}, 패배한 자|
|$fallenwarrior_title40_f|{name}, 전설의 자|
|$fallenwarrior_title40_m|{name}, 살아있는 전설|
|$fallenwarrior_title41_f|{name}, 혐오스러운 자|
|$fallenwarrior_title41_m|{name}, 혐오스러운 자|
|$fallenwarrior_title42_f|{name}, 고독한 자|
|$fallenwarrior_title42_m|{name}, 고독한 자|
|$fallenwarrior_title43_f|{name}, 길 잃은 자|
|$fallenwarrior_title43_m|{name}, 길 잃은 자|
|$fallenwarrior_title44_f|{name}, 충직한 자|
|$fallenwarrior_title44_m|{name}, 충직한 자|
|$fallenwarrior_title45_f|{name}, 행운아|
|$fallenwarrior_title45_m|{name}, 행운아|
|$fallenwarrior_title46_f|{name}, 표식된 자|
|$fallenwarrior_title46_m|{name}, 표식된 자|
|$fallenwarrior_title47_f|{name}, 강력한 자|
|$fallenwarrior_title47_m|{name}, 강력한 자|
|$fallenwarrior_title48_f|{name}, 산을 걷는 자|
|$fallenwarrior_title48_m|{name}, 산을 걷는 자|
|$fallenwarrior_title49_f|{name}, 신비로운 자|
|$fallenwarrior_title49_m|{name}, 신비로운 자|
|$fallenwarrior_title5_f|{name}, 아름다운 자|
|$fallenwarrior_title5_m|{name}, 아름다운 자|
|$fallenwarrior_title50_f|{name}, 노련한 자|
|$fallenwarrior_title50_m|{name}, 노련한 자|
|$fallenwarrior_title51_f|{name}, 약탈자|
|$fallenwarrior_title51_m|{name} 약탈자|
|$fallenwarrior_title52_f|{name}, 긍지 높은 자|
|$fallenwarrior_title52_m|{name}, 긍지 높은 자|
|$fallenwarrior_title53_f|{name}, 날쌘 자|
|$fallenwarrior_title53_m|{name}, 날쌘 자|
|$fallenwarrior_title54_f|{name}, 습격자|
|$fallenwarrior_title54_m|{name}, 습격자|
|$fallenwarrior_title55_f|{name}, 유린자|
|$fallenwarrior_title55_m|{name}, 유린자|
|$fallenwarrior_title56_f|{name}, 까마귀|
|$fallenwarrior_title56_m|{name}, 까마귀|
|$fallenwarrior_title57_f|{name}, 재건자|
|$fallenwarrior_title57_m|{name}, 재건자|
|$fallenwarrior_title58_f|{name}, 붉은 자|
|$fallenwarrior_title58_m|{name}, 붉은 자|
|$fallenwarrior_title59_f|{name}, 연회꾼|
|$fallenwarrior_title59_m|{name}, 연회꾼|
|$fallenwarrior_title6_f|{name}, 광전사|
|$fallenwarrior_title6_m|{name}, 광전사|
|$fallenwarrior_title60_f|{name}, 부유한 자|
|$fallenwarrior_title60_m|{name}, 부유한 자|
|$fallenwarrior_title61_f|{name}, 통치자|
|$fallenwarrior_title61_m|{name}, 통치자|
|$fallenwarrior_title62_f|{name}, 흉터진 자|
|$fallenwarrior_title62_m|{name}, 흉터진 자|
|$fallenwarrior_title63_f|{name}, 항해자|
|$fallenwarrior_title63_m|{name}, 항해자|
|$fallenwarrior_title64_f|{name}, 영광을 좇는 자|
|$fallenwarrior_title64_m|{name}, 영광을 좇는 자|
|$fallenwarrior_title65_f|{name}, 용병|
|$fallenwarrior_title65_m|{name}, 용병|
|$fallenwarrior_title66_f|{name}, 그림자|
|$fallenwarrior_title66_m|{name}, 그림자|
|$fallenwarrior_title67_f|{name}, 예리한 자|
|$fallenwarrior_title67_m|{name}, 예리한 자|
|$fallenwarrior_title68_f|{name}, 조선공|
|$fallenwarrior_title68_m|{name}, 조선공|
|$fallenwarrior_title69_f|{name}, 난파자|
|$fallenwarrior_title69_m|{name}, 난파자|
|$fallenwarrior_title7_f|{name}, 피에 굶주린 자|
|$fallenwarrior_title7_m|{name}, 피에 굶주린 자|
|$fallenwarrior_title70_f|{name}, 달변가|
|$fallenwarrior_title70_m|{name}, 달변가|
|$fallenwarrior_title71_f|{name}, 음유시인|
|$fallenwarrior_title71_m|{name}, 음유시인|
|$fallenwarrior_title72_f|{name}, 학살자|
|$fallenwarrior_title72_m|{name}, 학살자|
|$fallenwarrior_title73_f|{name}, 처단자|
|$fallenwarrior_title73_m|{name}, 처단자|
|$fallenwarrior_title74_f|{name}, 병사|
|$fallenwarrior_title74_m|{name}, 병사|
|$fallenwarrior_title75_f|{name}, 근엄한 자|
|$fallenwarrior_title75_m|{name}, 근엄한 자|
|$fallenwarrior_title76_f|{name}, 앙심품은 자|
|$fallenwarrior_title76_m|{name}, 앙심품은 자|
|$fallenwarrior_title77_f|{name}, 엄격한 자|
|$fallenwarrior_title77_m|{name}, 엄격한 자|
|$fallenwarrior_title78_f|{name}, 초연한 자|
|$fallenwarrior_title78_m|{name}, 초연한 자|
|$fallenwarrior_title79_f|{name}, 폭풍의 자손|
|$fallenwarrior_title79_m|{name}, 폭풍의 자손|
|$fallenwarrior_title8_f|{name}, 피 묻은 자|
|$fallenwarrior_title8_m|{name}, 피 묻은 자|
|$fallenwarrior_title80_f|{name} 기묘한 자|
|$fallenwarrior_title80_m|{name}, 기묘한 자|
|$fallenwarrior_title81_f|{name}, 강한 자|
|$fallenwarrior_title81_m|{name}, 강한 자|
|$fallenwarrior_title82_f|{name}, 이야기꾼|
|$fallenwarrior_title82_m|{name}, 이야기꾼|
|$fallenwarrior_title83_f|{name}, 여행자|
|$fallenwarrior_title83_m|{name}, 여행자|
|$fallenwarrior_title84_f|{name}, 속임수꾼|
|$fallenwarrior_title84_m|{name}, 속임수꾼|
|$fallenwarrior_title85_f|{name}, 진실한 자|
|$fallenwarrior_title85_m|{name}, 진실한 자|
|$fallenwarrior_title86_f|{name}, 꺾이지 않는 자|
|$fallenwarrior_title86_m|{name}, 꺾이지 않는 자|
|$fallenwarrior_title87_f|{name}, 밑바닥 출신|
|$fallenwarrior_title87_m|{name}, 밑바닥 출신|
|$fallenwarrior_title88_f|{name}, 불멸자|
|$fallenwarrior_title88_m|{name}, 불멸자|
|$fallenwarrior_title89_f|{name}, 통합자|
|$fallenwarrior_title89_m|{name}, 통합자|
|$fallenwarrior_title9_f|{name}, 대담한 자|
|$fallenwarrior_title9_m|{name}, 대담한 자|
|$fallenwarrior_title90_f|{name}, 감흥 없는 자|
|$fallenwarrior_title90_m|{name}, 감흥 없는 자|
|$fallenwarrior_title91_f|{name}, 방랑자|
|$fallenwarrior_title91_m|{name}, 방랑자|
|$fallenwarrior_title92_f|{name}, 정복자|
|$fallenwarrior_title92_m|{name}, 정복자|
|$fallenwarrior_title93_f|{name}, 승리자|
|$fallenwarrior_title93_m|{name}, 승리자|
|$fallenwarrior_title94_f|{name}, 난폭한 자|
|$fallenwarrior_title94_m|{name}, 난폭한 자|
|$fallenwarrior_title95_f|{name}, 독사|
|$fallenwarrior_title95_m|{name}, 독사|
|$fallenwarrior_title96_f|{name}, 떠도는 자|
|$fallenwarrior_title96_m|{name}, 떠도는 자|
|$fallenwarrior_title97_f|{name}, 경계하는 자|
|$fallenwarrior_title97_m|{name}, 경계하는 자|
|$fallenwarrior_title98_f|{name}, 거친 자|
|$fallenwarrior_title98_m|{name}, 거친 자|
|$fallenwarrior_title99_f|{name}, 현명한 자|
|$fallenwarrior_title99_m|{name}, 현명한 자|
|$feedback_bug|버그|
...
|$feedback_topic|피드백|
|$fimbulvinterorb|핌블윈터의 구체|
|$fimbulvinterorb_destroyed|요툰이 퇴각합니다|
|$fimbulvinterorb_start|요툰이 진격합니다|
...
|$hover_memorialstone|선조의 기념비|
|$hud_addfavorite|즐겨찾기 추가|
|$hud_addfavoritecategory|범주 추가...|
|$hud_addfavoritecategory_popupheader|범주 추가|
|$hud_addfavoritecategory_popuptext|범주 이름 입력:|
|$hud_addpin|핀 추가|
|$hud_all|전부 표시|
...
|$hud_buildmenu|건설 메뉴|
|$hud_bymaterial|재료 기준|
|$hud_byusage|사용 기준|
|$hud_categories|범주|
|$hud_category|범주|
|$hud_changeorientation|방향 변경|
|$hud_copypiece|복사|
|$hud_crafting|제작|
|$hud_crossoffpin|크로스오프 핀|
|$hud_cyclesnap|스냅핑 전환|
|$hud_deletecategory|범주 삭제|
|$hud_eitrrequired|에이트르 필요|
|$hud_emotes_blowkiss|키스 날리기|
|$hud_emotes_bow|절하기|
|$hud_emotes_challenge|도전 제스처|
|$hud_emotes_cheer|환호|
|$hud_emotes_comehere|이리 와|
|$hud_emotes_cower|벌벌 떨기|
|$hud_emotes_cry|울기|
|$hud_emotes_dance|춤추기|
|$hud_emotes_despair|절망|
|$hud_emotes_flex|근육 자랑|
|$hud_emotes_headbang|헤드뱅잉|
|$hud_emotes_kneel|무릎 꿇기|
|$hud_emotes_laugh|웃기|
|$hud_emotes_loveyou|사랑해|
|$hud_emotes_nonono|고개 젓기|
|$hud_emotes_point|가리키기|
|$hud_emotes_relax|휴식|
|$hud_emotes_rest|쉬기|
|$hud_emotes_roar|포효|
|$hud_emotes_shrug|어깨 으쓱|
|$hud_emotes_sit|앉기|
|$hud_emotes_thumbsup|엄지 척|
|$hud_emotes_toast|건배|
|$hud_emotes_vibe|그루브 타기|
|$hud_emotes_wave|손 흔들기|
|$hud_equipping|장착 중|
|$hud_extrainvslot1|넓은 주머니|
|$hud_extrainvslot1_tooltip|아이템을 보관할 수 있는 간편한 벨트 주머니입니다.|
|$hud_extrainvslot2|깊은 주머니|
|$hud_extrainvslot2_tooltip|아이템을 보관할 수 있는 실용적인 벨트 주머니입니다.|
|$hud_favorites|즐겨찾기|
|$hud_feasts|잔치|
|$hud_food|식량|
|$hud_furniture|가구|
|$hud_hidden_messagehud_notification|HUD가 비활성화되었습니다. 활성화하려면 Ctrl + F3을 누르세요|
|$hud_hidden_messagehud_notification_gamepad|HUD 비활성화되었습니다. 활성화하려면:|
|$hud_hidemap|지도 숨기기|
|$hud_hidepin|핀 켜기/끄기|
...
|$hud_maxsummonsreached_greenroots|당신의 야생의 스태프는 통제할 수 있는 소환수의 한계에 도달했습니다.|
|$hud_maxsummonsreached_spiritcaller|영혼 소환사가 통제할 수 있는 소환수의 한계에 도달했습니다|
|$hud_maxsummonsreached_trollstav|당신의 트롤스타브는 통제할 수 있는 소환수의 한계에 도달했습니다.|
|$hud_meads|벌꿀주|
|$hud_misc|기타|
|$hud_namepin|핀 이름 지정|
...
|$invalid_keybind_header|잘못된 입력|
|$invalid_keybind_text|이 행동은 선택된 키에 설정 될 수 없습니다.|
|$inventory_achievement_secret|숨겨짐|
|$inventory_achievement_secret_description|오직 오딘만이 무엇이 숨겨져 있는지 알고 있습니다.|
|$inventory_achievements|도전과제|
...
|$inventory_move|이동|
|$inventory_needspace|인벤토리에 빈 공간이 더 필요합니다|
...
|$inventory_skills|기술|
|$inventory_slash|베기|
|$inventory_slightlyresistant|미약한 저항|
|$inventory_slightlyweak|살짝 약함|
|$inventory_spirit|영혼|
|$inventory_split|분리|
...
|$inventory_upgraderbutton|정제 시도|
|$inventory_upgraderwarning|최대한의 안전 품질입니다. 정제 과정에서 아이템이 파괴될 수 있습니다.|
|$inventory_use|사용/장착|
...
|$item_ancientcoin|고대의 동전|
|$item_ancientcoin_description|잃어버린 시대의 유물입니다. 동전의 표면은 여전히 신비로운 상징의 흔적을 담고 있습니다.|
|$item_ancientgemstone_black|드라우믹스|
|$item_ancientgemstone_black_description|어둡고 불투명한 보석으로 표면이 매끄럽고 광택이 납니다.|
|$item_ancientgemstone_green|그림반|
|$item_ancientgemstone_green_description|눈부신 초록색 보석으로 깊은 숲을 연상시킵니다.|
|$item_ancientgemstone_orange|솔리스|
|$item_ancientgemstone_orange_description|여름의 노을처럼 생기 넘치는 주황색 보석입니다.|
|$item_ancientgemstone_purple|베이드리스|
|$item_ancientgemstone_purple_description|왕족에게 어울리는 풍부한 보라색의 보석입니다.|
...
|$item_armor|방어력|
|$item_arrow_bloodgold|혈금 화살|
|$item_arrow_bloodgold_description|아마 이 세상에서 가장 까다로운 소재로 제작된 화살일 겁니다...|
...
|$item_atgeir_gold|노드의 아트가이어|
|$item_atgeir_gold_bloodlightning|천둥피 아트가이어|
|$item_atgeir_gold_bloodlightning_description|적의 피를 흐르게 할 때, 천상에서는 찬사가 울려 퍼질 것입니다.|
|$item_atgeir_gold_bloodlightning_uncooked|주물: 천둥피 아트가이어|
|$item_atgeir_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_atgeir_gold_description|이 무기의 날은 반짝이는 것만큼이나 치명적입니다.|
|$item_atgeir_gold_frostfire|서리불길 아트가이어|
|$item_atgeir_gold_frostfire_description|불길이 모든 것을 집어삼키도록 두세요. 얼음은 남은 것이면 뭐든지 차지할 것입니다.|
|$item_atgeir_gold_frostfire_uncooked|주물: 서리불길 아트가이어|
|$item_atgeir_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_atgeir_gold_uncooked|주물: 노드의 아트가이어|
|$item_atgeir_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
...
|$item_atgeir_wood|나무 아트가이어|
|$item_atgeir_wood_description|큰 피해를 주긴 어렵지만, 사거리는 긴 편입니다!|
...
|$item_axe_early|태고의 도끼|
|$item_axe_early_description|아득한 옛날, 아직 세상이 젊고 미완성이던 시대의 강력한 무기들...|
|$item_axe_flint|부싯돌 도끼|
|$item_axe_flint_description|돌보다 날카롭습니다.|
|$item_axe_gold|노드의 도끼|
|$item_axe_gold_bloodlightning|천둥피 도끼|
|$item_axe_gold_bloodlightning_description|이 도끼가 나무와 피를 같이 베면 온 땅에 천둥 같은 굉음이 울려 퍼질 것입니다.|
|$item_axe_gold_bloodlightning_uncooked|주물: 천둥피 도끼|
|$item_axe_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_axe_gold_description|정교하게 세공된 도끼로 적을 수월하게 쪼갭니다.|
|$item_axe_gold_frostfire|서리불길 도끼|
|$item_axe_gold_frostfire_description|모든 것을 잿더미로 태워버리거나 영원한 파괴의 순간 속에 얼어붙게 하십시오...|
|$item_axe_gold_frostfire_uncooked|주물: 서리불길 도끼|
|$item_axe_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_axe_gold_uncooked|주물: 노드의 도끼|
|$item_axe_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_axe_iron|철 도끼|
...
|$item_axe_wood|나무 도끼|
|$item_axe_wood_description|이 도끼로 장작을 팰 수 있다면 그게 더 이상하지 않을까요?|
|$item_axe2h_gold|노드의 대형도끼|
|$item_axe2h_gold_bloodlightning|천둥피 대형도끼|
|$item_axe2h_gold_bloodlightning_description|적을 두 동강 내면, 그들의 피가 뇌우처럼 노래할 것입니다.|
|$item_axe2h_gold_bloodlightning_uncooked|주물: 천둥피 대형도끼|
|$item_axe2h_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_axe2h_gold_description|강력한 전사에게 어울리는 강력한 도끼입니다.|
|$item_axe2h_gold_frostfire|서리불길 대형도끼|
|$item_axe2h_gold_frostfire_description|얼어붙은 지옥불로 적을 공격하십시오!|
|$item_axe2h_gold_frostfire_uncooked|주물: 서리불길 대형도끼|
|$item_axe2h_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_axe2h_gold_uncooked|주물: 노드의 대형도끼|
|$item_axe2h_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_axehead1|기묘한 도끼날|
|$item_axehead1_description|햇빛을 받으면 묘하게 반짝인다. 왠지 모르게, 이것만으로는 결코 완전해질 수 없다는 것을 알 수 있다...|
|$item_axehead2|신비한 도끼날|
|$item_axehead2_description|이 무기는 어떤 전투들을 지켜봐 왔을까? 그 과거는 볼 수 없지만, 미래는 당신의 손에 달려 있다...|
|$item_backstab|암살|
|$item_bakedpoteitr|구운 포테이트르|
|$item_bakedpoteitr_description|끓이지도 으깨지도 스튜에 넣지도 않았습니다. 그래도 여전히 맛있습니다!|
|$item_bakedpoteitr_uncooked|굽지 않은 포테이트르|
|$item_bakedpoteitr_uncooked_description|오븐에 넣을 준비를 마쳤습니다.|
|$item_barberkit|이발용품|
|$item_barberkit_description|최고의 이발사를 위한 도구입니다.|
|$item_barkabranch|얼어붙은 나뭇가지|
|$item_barkabranch_description|이 나뭇가지는 한때 살아있었습니다. 여전히 기묘한 마법이 깃들어 있습니다.|
|$item_barley|보리|
...
|$item_battleaxe|전투도끼|
|$item_battleaxe_blackmetal|흑철 전투도끼|
|$item_battleaxe_blackmetal_description|반으로 쪼개지기 전, 적들이 마지막으로 보게 될 건 이 도끼의 초록빛 섬광뿐입니다.|
...
|$item_battleaxe_gold_uncooked|주물: 노드의 대형 도끼|
|$item_battleaxe_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_battleaxe_skullsplittur|머리뼈 분리기|
|$item_battleaxe_skullsplittur_description|짙디짙은 안개 속에서도 쪼개버릴 머리뼈를 찾아냅니다.|
|$item_battleaxe_wood|나무 전투도끼|
|$item_battleaxe_wood_description|위협적으로 생기긴 했는데, 진짜에 비하면 아직 멀었습니다.|
...
|$item_bjorn_meat|곰 고기|
|$item_bjorn_meat_cooked|요리한 곰 고기|
|$item_bjorn_meat_cooked_description|승리의 맛이 납니다.|
|$item_bjorn_meat_description|겨울잠을 나기 위해 축적된 기름기 넘치는 고기입니다.|
|$item_bjornhide|곰 가죽|
|$item_bjornhide_description|두꺼운 털가죽입니다. 까슬까슬하지만 놀라울 정도로 폭신폭신합니다.|
|$item_bjornpaw|곰 발|
|$item_bjornpaw_description|열매를 따기에 적합한 날카로운 발톱입니다. 물론, 사지를 찢어발기는 데도 유용합니다.|
|$item_blackcore|검은 핵|
...
|$item_blobvial|코르크 마개 약병|
|$item_blobvial_description|불안정한 물질을 담을 만큼 단단하지만, 한순간에 산산조각 날 수도 있습니다.|
|$item_blockarmor|가드 방어력|
|$item_blockforce|가드 넉백|
...
|$item_bloodgoldkey|복잡한 열쇠|
|$item_bloodgoldkey_description|열쇠가 있다면, 분명 자물쇠도 있을 것입니다.|
|$item_bloodpudding|블랙 푸딩|
|$item_bloodpudding_description|둘이 먹다 하나가 죽어도 모를 맛이군!|
|$item_blubber|물개 지방|
|$item_blubber_cooked|요리한 물개 지방|
|$item_blubber_cooked_description|쫄깃한 고기를 씹으면 후회라는 뒷맛이 남습니다.|
|$item_blubber_description|북해에 적응하기 위한 생명체의 보온용 지방입니다.|
...
|$item_bolt_bloodgold|혈금 볼트|
|$item_bolt_bloodgold_description|아마 이 세상에서 가장 까다로운 소재로 제작된 볼트일 겁니다...|
|$item_bolt_bone|뼈 볼트|
...
|$item_bomb_dynamite|불씨 폭탄|
|$item_bomb_dynamite_description|터질 준비가 된 사로잡힌 불씨입니다. 주의해서 취급해야 합니다.|
|$item_bombblob_frost|블롭 폭탄: 얼음|
|$item_bombblob_frost_description|오랫동안 쥐고 있으면 제자리에 얼어붙을지도 모릅니다.|
|$item_bombblob_lava|블롭 폭탄: 용암|
|$item_bombblob_lava_description|손에 쥐면 파괴의 불길을 예고하듯, 뜨거운 열기가 올라옵니다.|
|$item_bombblob_morkhalla|블롭 폭탄: 펄프|
|$item_bombblob_morkhalla_description|블롭이 있는 곳은 바로 던전입니다.|
|$item_bombblob_poison|블롭 폭탄: 독|
|$item_bombblob_poison_description|혹시 병이 깨진다면... 정말 조심해야 합니다.|
|$item_bombblob_poisonelite|블롭 폭탄: 정예 독|
|$item_bombblob_poisonelite_description|연기를 들이마시는 건 추천하지 않습니다.|
|$item_bombblob_tar|블롭 폭탄: 타르|
|$item_bombblob_tar_description|안에 든 끈적한 물질이 당신을 위협하듯이 꿈틀거리고 있습니다.|
...
|$item_bow_gold|노드의 활|
|$item_bow_gold_bloodlightning|천둥피 활|
|$item_bow_gold_bloodlightning_description|번개가 활줄을 따라 춤을 추며 풀려나길 기다리고 있습니다.|
|$item_bow_gold_bloodlightning_uncooked|주물: 천둥피 활|
|$item_bow_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_bow_gold_description|이 활은 황금 같은 정확성으로 대상을 찾아냅니다.|
|$item_bow_gold_frostfire|서리불길 활|
|$item_bow_gold_frostfire_description|조준하면서 머리를 차갑게 식히고 화살로 분노를 터뜨리십시오.|
|$item_bow_gold_frostfire_uncooked|주물: 서리불길 활|
|$item_bow_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_bow_gold_uncooked|주물: 노드의 활|
|$item_bow_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
...
|$item_cape_deepnorth|무스 가죽 망토|
|$item_cape_deepnorth_description|금실을 엮어 정교함을 더한 따뜻한 망토입니다.|
|$item_cape_deepnorth_mage|소환사의 망토|
|$item_cape_deepnorth_mage_description|이 망토에는 기묘한 마법이 엮여 가벼우면서도 따뜻합니다.|
...
|$item_catapult_bloodgold_ammo|혈금 탄환|
|$item_catapult_bloodgold_ammo_description|강하게 때리고 피투성이로 만듭니다.|
...
|$item_chest_berserker|곰의 무늬|
|$item_chest_berserker_description|이 정교한 무늬가 머나먼 땅에서 온 전사들을 지켜줬다면... 틀림없이 당신도 보호해 줄 겁니다.|
|$item_chest_berserker_undead|바일본의 갈비뼈|
|$item_chest_berserker_undead_description|고통받는 곰의 부서진 뼈로 제작되었습니다.|
...
|$item_chest_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_chest_heavy_deepnorth|수호자의 흉갑|
|$item_chest_heavy_deepnorth_description|모피와 가죽, 금속이 하나로 어우러져 적의 공격을 막아냅니다.|
|$item_chest_heavy_gold_uncooked|주물: 수호자의 흉갑|
|$item_chest_heavy_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_chest_lox|록스 가죽 재킷|
|$item_chest_lox_description|여전히 짙은 야생의 향이 남아 있습니다.|
...
|$item_chest_mage_deepnorth|소환사의 로브|
|$item_chest_mage_deepnorth_description|금실로 수놓은 로브는 가장 강력한 마법사에게 어울립니다.|
|$item_chest_mage_description|옷감을 정교하게 겹쳐 만들었습니다. 주름과 솔기 하나하나 주문과 부적을 엮었습니다.|
|$item_chest_mage_gold_uncooked|주물: 소환사의 로브|
|$item_chest_mage_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_chest_medium_deepnorth|선봉의 흉갑|
|$item_chest_medium_deepnorth_description|전문가의 솜씨로 제작된 가죽 갑옷으로 전사의 움직임을 방해하지 않고 뛰어난 방어를 제공합니다.|
|$item_chest_medium_gold_uncooked|주물: 선봉의 흉갑|
|$item_chest_medium_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_crossbow_bloodlightning_gold|천둥피 석궁|
|$item_crossbow_bloodlightning_gold_description|마치 번개가 치기 전의 공기처럼 활에는 풀려나지 않은 힘이 팽팽히 메여 있습니다.|
|$item_crossbow_bloodlightning_gold_uncooked|주물: 천둥피 석궁|
|$item_crossbow_bloodlightning_gold_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_crossbow_frostfire_gold|서리불길 석궁|
|$item_crossbow_frostfire_gold_description|당신이 조준할 때, 적이 얼어붙지 않는다면 적중당했을 때도 그럴 수 있는지 확인하십시오.|
|$item_crossbow_frostfire_gold_uncooked|주물: 서리불길 석궁|
|$item_crossbow_frostfire_gold_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_crossbow_gold|노드의 석궁|
|$item_crossbow_gold_description|이 무기에는 해방되기를 기다리고 있는 엄청난 힘이 숨겨져 있습니다.|
|$item_crossbow_gold_uncooked|주물: 노드의 석궁|
|$item_crossbow_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
...
|$item_crownjewel|왕관 보석|
|$item_crownjewel_description|이 보석에서 전에 느껴보지 못한 기이한 힘이 솟구칩니다.|
...
|$item_cultivator_remove_description|나중에 심기 위해 토양에서 씨앗을 얻습니다.|
...
|$item_eat|먹기|
|$item_ectoplasm|엑토플라즘|
|$item_ectoplasm_description|한때 살아있던 존재의 정수로, 안식에 들지 못했습니다...|
...
|$item_faderember|불씨|
|$item_faderember_description|떠다니는 불씨 하나하나가 모두 회개하고자 하는 불타는 소망입니다.|
...
|$item_feastdeepnorth|북부식 아침 식사|
|$item_feastdeepnorth_description|따뜻하고 든든하게 먹을 수 있는 이 식사는 가장 추운 날에도 당신을 지켜줍니다. 죽과 팬케이크는 잼과 소시지와 잘 어울려 한 그릇 더 먹지 않고는 배길 수 없습니다!|
|$item_feaster|서빙용 쟁반|
|$item_feaster_description|음식과 음료를 선별해 식탁을 차리고, 풍미 가득한 잔칫상으로 손님에게 깊은 인상을 남기세요.|
|$item_feaster_remove_description|<color=yellow>잔칫상을 섭취한 후에는 해체해도 자원을 돌려받지 못합니다.</color>|
...
|$item_fircone|전나무 방울|
|$item_fircone_big|골조나무 솔방울|
|$item_fircone_big_description|심으면 골조나무가 자랍니다.|
...
|$item_fishsoup|생선 수프|
|$item_fishsoup_description|맛이 헤엄칩니다!|
|$item_fishwraps|피쉬랩|
|$item_fishwraps_description|빵과 생선, 더 바랄게 뭐가 있겠어?|
|$item_fistweapon_bjorn|곰의 발바닥|
|$item_fistweapon_bjorn_description|찢어발기기 위해 존재합니다.|
|$item_fistweapon_bjorn_undead|바일본의 망치발톱|
|$item_fistweapon_bjorn_undead_description|살점이든 뼈든 닥치는 대로 찢어버리는 발톱입니다.|
|$item_fistweapon_fenris|살인광의 클로|
|$item_fistweapon_fenris_description|발톱이 늑대에게 효과가 있다면, 바이킹에게는 왜 안 될까요?|
|$item_fistweapon_frostfire_gold|서리불길 주먹사슬|
|$item_fistweapon_frostfire_gold_description|동상에 걸릴 경미한 위험은 피할 수 없습니다.|
|$item_fistweapon_frostfire_gold_uncooked|주물: 서리불길 주먹사슬|
|$item_fistweapon_frostfire_gold_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_fistweapon_gold|노드의 주먹사슬|
|$item_fistweapon_gold_bloodlightning|천둥피 주먹사슬|
|$item_fistweapon_gold_bloodlightning_description|이 무기와 함께 싸우면 분노가 차오르고 귓가에는 피의 고동이 천둥처럼 울부짖습니다... 참으로 적절한 것 같습니다.|
|$item_fistweapon_gold_bloodlightning_uncooked|주물: 천둥피 주먹사슬|
|$item_fistweapon_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_fistweapon_gold_description|가장 단단한 금속으로 주먹을 감싸 주먹에 담긴 힘을 적이 확실히 느낄 수 있도록 해줍니다.|
|$item_fistweapon_gold_uncooked|주물: 노드의 주먹사슬|
|$item_fistweapon_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_flametal|불금속|
...
|$item_frostcore|서리 핵|
|$item_frostcore_description|얼어붙은 에너지로 가득 채워져 있어 만지면 끔찍하게 차갑습니다.|
|$item_frostorbs_uncooked|주물: 북부의 앙갚음|
|$item_frostorbs_uncooked_description|이 마법 아이템은 서리로 굳혀야 합니다.|
|$item_frostwood|골조나무|
|$item_frostwood_description|단단한 종류의 나무로 웅장한 홀에 적합합니다.|
|$item_frozenfuel|액체 서리|
|$item_frozenfuel_description|마법이 이 얼음에 주입되어 완전히 다른 무언가로 변했습니다.|
|$item_frozenking_drop|희생의 피|
|$item_frozenking_drop_description|한때 예언된 종말의 마지막 정수입니다.|
|$item_fryslingcore|프라이슬링 핵|
|$item_fryslingcore_description|내부는 참을 수 없는 냉기로 일렁입니다.|
|$item_fulladrenaline|아드레날린 효과|
...
|$item_glowworm|야광 애벌레|
|$item_glowworm_description|미끌거리지만 고소합니다.|
|$item_goblintotem|풀링 토템|
|$item_goblintotem_description|야글루스의 고대 힘을 빌립니다.|
|$item_gold|혈금|
|$item_gold_description|살아있는 존재의 정수가 주입된 귀중한 금속입니다.|
|$item_goldore|석화된 조직|
|$item_goldore_description|잠재력이 넘치는 단단하고 견고한 소재입니다. 용광로에서 제련해야 합니다.|
|$item_graplinghook|갈고리 총|
|$item_graplinghook_description|극적인 입장이나 신속한 후퇴에 사용합니다.|
|$item_grausten|묘석|
...
|$item_hardrock|수수께끼의 바위|
|$item_hardrock_description|그냥 바위입니다...|
|$item_hardrock_knowledge1|죽음을 두려워하지 말아라. 누구나 파멸의 시기는 정해져 있으며, 아무도 벗어날 수 없다.|
|$item_hardrock_knowledge10|원하는 대로 조용히 지낼 수 있지만, 언젠가는 누군가 널 찾아낼 것이다.|
|$item_hardrock_knowledge11|수없이 많은 고통을 겪어도 그 기억을 놓아버리고 싶지는 않을 것이다.|
|$item_hardrock_knowledge12|폭풍을 뚫고 나왔다면, 폭풍으로 걸어 들어간 자신과는 다른 사람이 된 것이다. 그것이 바로 폭풍의 존재 이유이다.|
|$item_hardrock_knowledge13|바위는 고통을 느끼지 않으며, 섬은 울지 않는다.|
|$item_hardrock_knowledge2|희망 없이 살아갈 바에야 싸우고 쓰러지는 것이 낫다.|
|$item_hardrock_knowledge3|룬이 너를 찾고 올바르게 읽히며, 놀라운 무게와 강력한 마법을 품을 것이다.|
|$item_hardrock_knowledge4|인간은 시야에서 해안이 사라지는 것을 감수할 용기 없이는 새로운 바다를 발견할 수 없다.|
|$item_hardrock_knowledge5|살아갈 이유가 있는 자는 무엇이든 견딜 수 있다.|
|$item_hardrock_knowledge6|상처란 빛이 너의 안으로 들어오는 통로이다.|
|$item_hardrock_knowledge7|우리는 현실보다 상상에서 더욱 고통받는다.|
|$item_hardrock_knowledge8|고통은 피할 수 없다. 괴로움은 선택 사항이다.|
|$item_hardrock_knowledge9|네가 무엇을 찾든, 그것은 네가 기대한 형태로 나타나지 않을 것이다.|
...
|$item_hatefulblood|악의 서린 피|
|$item_hatefulbood_description|응고되어 얼어붙은 덩어리에서 무언가 불안한 느낌이 듭니다.|
|$item_healthhitreturn|타격 시 체력 회복|
|$item_healthuse|체력 사용|
|$item_heat_modifier|열기 저항|
|$item_helmet_berserker|곰의 머리 장식|
|$item_helmet_berserker_description|강대한 곰의 원초적인 분노에 몸을 맡기세요.|
|$item_helmet_berserker_undead|바일본의 안면|
|$item_helmet_berserker_undead_description|착용 시 적에게를 공포를, 동족에게는 용기를 불어넣습니다.|
...
|$item_helmet_celebration|축하 모자|
|$item_helmet_celebration_description|이 모자를 쓰면 절로 기분이 좋아집니다!|
|$item_helmet_crown_of_valheim|발헤임의 왕관|
|$item_helmet_crown_of_valheim_description|진정한 자격을 갖춘 자에게 주어지는 영광스러운 보상입니다.|
...
|$item_helmet_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_helmet_heavy_deepnorth|수호자의 투구|
|$item_helmet_heavy_deepnorth_description|승리의 날개로 장식되어 있습니다.|
|$item_helmet_heavy_gold_uncooked|주물: 수호자의 투구|
|$item_helmet_heavy_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_helmet_lox|록스 가죽 후드|
|$item_helmet_lox_description|록스의 시선으로 세계를 바라봅니다.|
...
|$item_helmet_mage_deepnorth|소환사의 머리 장식|
|$item_helmet_mage_deepnorth_description|당신이 부르면 대지의 정령들이 찾아옵니다. 당신의 변장에 속은 걸까요?|
|$item_helmet_mage_description|눈을 보면 마법사인지 알 수 있기 때문에, 마법을 연구하는 자는 대부분 눈을 가려 정체를 숨깁니다.|
|$item_helmet_mage_gold_uncooked|주물: 소환사의 머리 장식|
|$item_helmet_mage_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_helmet_medium_deepnorth|선봉의 후드|
|$item_helmet_medium_deepnorth_description|악천후는 물론 적의 날카로운 이빨로부터 목덜미를 보호해 줍니다.|
|$item_helmet_medium_gold_uncooked|주물: 선봉의 후드|
|$item_helmet_medium_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_helmet_rootcrown|뿌리 왕관|
|$item_helmet_rootcrown_description|고통스럽지만 정교하게 만들어진 머리 장식입니다.|
|$item_helmet_strawhat|짚단 모자|
|$item_helmet_strawhat_description|일사병을 예방하는 완벽한 수단입니다.|
|$item_helmet_sweatband|머리띠|
|$item_helmet_sweatband_description|약간... 촉촉합니다.|
...
|$item_hook|갈고리|
|$item_hook_description|정교하게 제작된 이 물건은 사로잡을 수 있는 잠재력을 품고 있습니다.|
|$item_ice|얼음|
|$item_ice_description|아주 차갑습니다...|
|$item_iron|철|
...
|$item_jotunpuffs_description|기운을 회복시키는 버섯으로, 요리에 사용할 수 있습니다.|
|$item_juteblue|푸른 황마|
|$item_juteblue_description|자연의 섬유와 드베르그 머리카락으로 만들었습니다.|
|$item_jutered|붉은 황마|
|$item_jutered_description|견고하고, 거친 천입니다.|
|$item_kale|케일|
|$item_kale_description|다재다능한 잎채소입니다.|
|$item_kalechips|케일 칩|
|$item_kalechips_description|신선한 채소입니다!|
|$item_kalechips_uncooked|생 케일 칩|
|$item_kalechips_uncooked_description|오븐에 넣을 준비가 됐습니다.|
|$item_kaleseeds|케일 씨앗|
|$item_kaleseeds_description|심으면 케일이 자랍니다.|
|$item_keys_gold_uncooked|주물: 복잡한 열쇠|
|$item_keys_gold_uncooked_description|이 열쇠는 서리로 굳혀야 합니다.|
...
|$item_knife_gold|노드의 단검|
|$item_knife_gold_bloodlightning|천둥피 단검|
|$item_knife_gold_bloodlightning_description|칼날은 이미 피에 젖어 있지만, 더욱 원하는 듯이 파지직거립니다.|
|$item_knife_gold_bloodlightning_uncooked|주물: 천둥피 단검|
|$item_knife_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_knife_gold_description|적이 마지막으로 보게 될 건 금빛 섬광일 것입니다.|
|$item_knife_gold_frostfire|서리불길 단검|
|$item_knife_gold_frostfire_description|이 칼날에 베이면 얼음처럼 쓰라리고 불길처럼 타오릅니다.|
|$item_knife_gold_frostfire_uncooked|주물: 서리불길 단검|
|$item_knife_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_knife_gold_uncooked|주물: 노드의 단검|
|$item_knife_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
...
|$item_knife_void|공허소환사|
|$item_knife_void_description|누가 공허의 부름에 답할 것인가?|
|$item_knife_wood|나무 칼|
|$item_knife_wood_description|이런 건 차라리 버터 자르는 데 쓰라고 할 사람도 있을 듯합니다.|
|$item_knockback|밀치기|
|$item_kvastur_description|마녀의 둘도 없는 친구입니다.|
|$item_lantern|드베르그 등불|
|$item_lantern_description|평범한 횃불은 유행 지난 지 오래입니다.|
|$item_lanternDN|회수한 등불|
|$item_lanternDN_description|오래 전에 떠난 누군가가 떨어뜨려 잃어버린 고대의 유물입니다.|
...
|$item_leatherstraps|가죽 끈|
|$item_leatherstraps_description|튼튼하지만 유연한 소재입니다.|
|$item_legs_berserker|곰의 샅바|
|$item_legs_berserker_description|중요한 부위는 다 가려주지만, 그게 전부입니다.|
|$item_legs_berserker_undead|바일본의 휘장|
|$item_legs_berserker_undead_description|두꺼운 가죽과 뼛조각을 엮어 만든 튼튼한 치마입니다.|
...
|$item_legs_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
|$item_legs_heavy_deepnorth|수호자의 바지|
|$item_legs_heavy_deepnorth_description|두꺼운 장화와 바지는 깊은 눈을 헤치고 나아가는 동안에도 온기를 유지합니다.|
|$item_legs_heavy_gold_uncooked|주물: 수호자의 바지|
|$item_legs_heavy_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_legs_lox|록스 가죽 바지|
|$item_legs_lox_description|부드럽고 질기며 유연합니다.|
...
|$item_legs_mage_deepnorth|소환사의 바지|
|$item_legs_mage_deepnorth_description|냉기가 피부에 닿지 않도록 단단하게 조이는 바지입니다.|
|$item_legs_mage_description|마법사가 입는 바지는 항상 꽉 낍니다. 불편해야 주문을 시전할 때 집중할 수 있기 때문입니다.|
|$item_legs_mage_gold_uncooked|주물: 소환사의 바지|
|$item_legs_mage_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_legs_medium_deepnorth|선봉의 바지|
|$item_legs_medium_deepnorth_description|추운 기후에 어울리는 따뜻한 바지입니다. 장화는 얼음 지형에서 뛰어난 접지력을 제공합니다.|
|$item_legs_medium_gold_uncooked|주물: 선봉의 바지|
|$item_legs_medium_gold_uncooked_description|이 갑옷은 서리로 굳혀야 합니다.|
...
|$item_lingonberries|월귤|
|$item_lingonberries_description|이 새콤한 월귤은 추운 기후에서도 자랄 수 있습니다.|
|$item_lingondricka|월귤 주스|
|$item_lingondricka_description|대부분의 음식과 잘 어울립니다.|
|$item_loxmeat|록스 고기|
...
|$item_mace_gold|노드의 철퇴|
|$item_mace_gold_bloodlightning|천둥피 철퇴|
|$item_mace_gold_bloodlightning_description|이 무기와 견줄 수 있는 것은 아마도 천둥의 신 그 자체일지도 모릅니다...|
|$item_mace_gold_bloodlightning_uncooked|주물: 천둥피 철퇴|
|$item_mace_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_mace_gold_description|적이 회복하기도 전에 강력하고 빠르게 공격합니다.|
|$item_mace_gold_frostfire|서리불길 철퇴|
|$item_mace_gold_frostfire_description|무기가 적중할 때 피어나는 것은 불꽃인가? 아니면 얼음 조각인가?|
|$item_mace_gold_frostfire_uncooked|주물: 서리불길 철퇴|
|$item_mace_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_mace_gold_uncooked|주물: 노드의 철퇴|
|$item_mace_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_mace_iron|철 철퇴|
...
|$item_mace_wood|나무 철퇴|
|$item_mace_wood_description|그냥 몽둥이로 삼아도 충분했을 텐데, 왜 굳이 이렇게 만들었을까요?|
|$item_mace2h_gold|노드의 슬레지해머|
|$item_mace2h_gold_bloodlightning|천둥피 슬레지해머|
|$item_mace2h_gold_bloodlightning_description|이 무기를 제대로 내려치는 순간 충격파가 온 세상을 울릴 것입니다...|
|$item_mace2h_gold_bloodlightning_uncooked|주물: 천둥피 슬레지해머|
|$item_mace2h_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_mace2h_gold_description|이 무기라면 트롤에 버금가는 묵직한 공격을 날릴 수 있습니다.|
|$item_mace2h_gold_frostfire|서리불길 슬레지해머|
|$item_mace2h_gold_frostfire_description|너무 차가워서 타오르는 걸까요? 아니면 너무 뜨거워서 얼어붙은 걸까요?|
|$item_mace2h_gold_frostfire_uncooked|주물: 서리불길 슬레지해머|
|$item_mace2h_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_mace2h_gold_uncooked|주물: 노드의 슬레지해머|
|$item_mace2h_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_magecap|마법사갓|
|$item_magecap_description|마법사의 식단에 흔히 사용되는 버섯입니다.|
...
|$item_meatballsmashedpoteitr|미트볼과 포테이트르|
|$item_meatballsmashedpoteitr_description|이보다 더 상징적일 수는 없습니다!|
...
|$item_memorialcoal|기억의 석탄|
|$item_memorialcoal_description|뜨겁게 일렁이는 불길 속 어딘가에서 오래된 기억이 되살아나는 듯한 기분입니다...|
...
|$item_mold_armor_gold_chest|거푸집: 수호자의 흉갑|
|$item_mold_armor_gold_chest_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_gold_helmet|거푸집: 수호자의 투구|
|$item_mold_armor_gold_helmet_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_gold_legs|거푸집: 수호자의 바지|
|$item_mold_armor_gold_legs_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_mage_chest|거푸집: 소환사의 로브|
|$item_mold_armor_mage_chest_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_mage_helmet|거푸집: 소환사의 머리 장식|
|$item_mold_armor_mage_helmet_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_mage_legs|거푸집: 소환사의 바지|
|$item_mold_armor_mage_legs_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_medium_chest|거푸집: 선봉의 흉갑|
|$item_mold_armor_medium_chest_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_medium_helmet|거푸집: 선봉의 후드|
|$item_mold_armor_medium_helmet_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_armor_medium_legs|거푸집: 선봉의 바지|
|$item_mold_armor_medium_legs_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 화려한 갑옷을 만들 것입니다.|
|$item_mold_atgeir|거푸집: 노드의 아트가이어|
|$item_mold_atgeir_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_axe|거푸집: 노드의 도끼|
|$item_mold_axe_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_axe2h|거푸집: 노드의 대형도끼|
|$item_mold_axe2h_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_bow|거푸집: 노드의 활|
|$item_mold_bow_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_crossbow|거푸집: 노드의 석궁|
|$item_mold_crossbow_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_fistweapon|거푸집: 노드의 주먹사슬|
|$item_mold_fistweapon_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_keys|거푸집: 복잡한 열쇠|
|$item_mold_keys_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 강력한 열쇠를 만들 것입니다.|
|$item_mold_knife|거푸집: 노드의 단검|
|$item_mold_knife_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_mace|거푸집: 노드의 철퇴|
|$item_mold_mace_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_mace2h|거푸집: 노드의 슬레지해머|
|$item_mold_mace2h_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_shield_buckler|거푸집: 노드의 버클러|
|$item_mold_shield_buckler_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 단단한 방패를 만들 것입니다.|
|$item_mold_shield_round|거푸집: 노드의 방패|
|$item_mold_shield_round_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 단단한 방패를 만들 것입니다.|
|$item_mold_shield_tower|거푸집: 노드의 대방패|
|$item_mold_shield_tower_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 단단한 방패를 만들 것입니다.|
|$item_mold_spear|거푸집: 노드의 창|
|$item_mold_spear_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_stafffrostorbs|거푸집: 북부의 앙갚음|
|$item_mold_stafffrostorbs_description|제대로 된 소재만 채워진다면, 이 거푸집은 강력한 마법 아이템을 만들 것입니다.|
|$item_mold_stafforbofahri|거푸집: 메아리 가시|
|$item_mold_stafforbofahri_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 강력한 마법 아이템을 만들 것입니다.|
|$item_mold_staffspiritcaller|거푸집: 영혼 소환사|
|$item_mold_staffspiritcaller_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 강력한 마법 아이템을 만들 것입니다.|
|$item_mold_staffthunderblood|거푸집: 번개 일격|
|$item_mold_staffthunderblood_description|제대로 된 소재만 채워진다면, 이 거푸집은 강력한 마법 아이템을 만들 것입니다.|
|$item_mold_sword|거푸집: 노드의 검|
|$item_mold_sword_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_mold_sword2h|거푸집: 노드의 대검|
|$item_mold_sword2h_description|제대로 된 소재로 채우기만 한다면, 이 거푸집은 가장 무시무시한 무기를 만들 것입니다.|
|$item_moleclaws|긴 발톱|
|$item_moleclaws_description|누구든 스스로 베이지 않고 사용할 수만 있다면 치명적인 무기입니다.|
|$item_moltencore|녹아내린 핵|
|$item_moltencore_description|소용돌이치는 강력한 힘이 풀려나기만을 기다립니다.|
|$item_moose_meat|무스 고기|
|$item_moose_meat_cooked|요리한 무스 고기|
|$item_moose_meat_cooked_description|이 고기는 지방이 적지만 풍미가 뛰어납니다.|
|$item_moose_meat_description|이 고기를 요리하면 든든한 한 끼 식사가 됩니다.|
|$item_moosehide|무스 가죽|
|$item_moosehide_description|이 모피는 북부의 기후에 완벽하게 적응했습니다.|
|$item_moosekebab|고기 넣은 빵|
|$item_moosekebab_description|여행하는 상인들이 종종 선호하는 간편식입니다.|
|$item_moosesinew|무스 힘줄|
|$item_moosesinew_description|질기고 튼튼하여 유용하게 사용할 수 있습니다.|
...
|$item_nornthread|노르나실|
|$item_nornthread_description|여린 실가닥에 속지 마십시오. 이 실은 세계수 자체의 힘으로 만들어졌습니다.|
|$item_noteleport|순간이동할 수 없습니다.|
|$item_oakseeds|도토리|
|$item_oakseeds_description|심으면 참나무가 자랍니다.|
|$item_oat|귀리|
|$item_oat_description|맛있는 곡물로 빻아서 가루로 사용할 수 있습니다.|
|$item_oatflour|귀리 가루|
|$item_oatflour_description|곱게 갈은 귀리로 잠재력이 풍부합니다.|
|$item_oatmeallingonberryjam|오트밀|
|$item_oatmeallingonberryjam_description|월귤 잼을 넉넉히 곁들여 제공합니다.|
|$item_oatmilk|귀리 우유|
|$item_oatmilk_description|혁신의 맛이 납니다.|
|$item_oatseeds|귀리 씨앗|
|$item_oatseeds_description|제분기에 갈거나 심어서 더 많은 씨앗을 얻을 수 있습니다.|
|$item_obsidian|흑요석|
...
|$item_ooze_mork|죽은 펄프|
|$item_ooze_mork_description|구성 성분에 대해서는 생각하지 않는 것이 최선입니다.|
|$item_oozebomb|수액 폭탄|
|$item_oozebomb_description|견딜 수 없는 악취를 내뿜습니다...|
|$item_orbfrostfire|서리불길 정수|
|$item_orbfrostfire_description|어째서인지 손을 대면 뜨거움과 동시에 차갑습니다.|
|$item_orbthunderblood|천둥피 정수|
|$item_orbthunderblood_description|불안정하고, 불규칙하며... 살아있나?|
|$item_ovenpancake|오븐 팬케이크|
|$item_ovenpancake_description|따뜻하고 푹신합니다.|
|$item_ovenpancake_uncooked|오븐 팬케이크 반죽|
|$item_ovenpancake_uncooked_description|오븐에 넣을 준비가 됐습니다.|
|$item_pancakes|팬케이크|
|$item_pancakes_description|이보다 더 따뜻해지는 음식이 있었을까요?|
|$item_parryadrenaline|반격 아드레날린|
...
|$item_poteitr|포테이트르|
|$item_poteitr_description|가능성은 말 그대로 무궁무진합니다. 누가 한 번 맛보고 싶지 않을까요?|
|$item_poteitrseeds|포테이트르 씨앗|
|$item_poteitrseeds_description|심으면 포테이트르가 자랍니다.|
...
|$item_pulledbear|풀드 베어|
|$item_pulledbear_description|말 그대로 풀어질 때까지 몇 시간이고 조리한 부드러운 고기입니다.|
...
|$item_saddlemoose|무스 안장|
|$item_saddlemoose_description|무스는 고귀한 생물이지만, 이렇게 훌륭한 안장이 있다면 기수를 태워줄지도 모릅니다.|
|$item_salad|샐러드|
...
|$item_sealhide|물개 가죽|
|$item_sealhide_description|동물이 체온과 건조한 상태를 유지하게 도와주는 두꺼운 모피입니다.|
|$item_sealsoup|물개 고기 수프|
|$item_sealsoup_description|따뜻하고 맛있는 식사로 추운 날에 즐기기 좋습니다.|
...
|$item_shield_buckler_gold_uncooked|주물: 노드의 버클러|
|$item_shield_buckler_gold_uncooked_description|이 방패는 서리로 굳혀야 합니다.|
...
|$item_shield_gold|노드의 방패|
|$item_shield_gold_description|멋을 내면서도 안전하게 보호해줍니다.|
|$item_shield_gold_tower|노드의 대방패|
|$item_shield_goldbuckler|노드의 버클러|
|$item_shield_goldbuckler_description|충분한 기술을 갖추었다면 효과적인 방어 수단입니다.|
...
|$item_shield_roots|뿌리 방패|
|$item_shield_roots_description|유연한 뿌리가 뒤얽혀 놀라울 정도로 견고한 방패가 되었습니다.|
|$item_shield_round_gold_uncooked|주물: 노드의 방패|
|$item_shield_round_gold_uncooked_description|이 방패는 서리로 굳혀야 합니다.|
|$item_shield_serpentscale|바다뱀 비늘 방패|
|$item_shield_serpentscale_description|겹쳐진 비늘들로 만들어진 견고한 방패.|
|$item_shield_silver|은 방패|
|$item_shield_silver_description|빛 나는 은의 방패.|
|$item_shield_tower_gold_description|적들이 당신을 볼 수 없다면, 공격도 할 수 없습니다!|
|$item_shield_tower_gold_uncooked|주물: 노드의 대방패|
|$item_shield_tower_gold_uncooked_description|이 방패는 서리로 굳혀야 합니다.|
...
|$item_sledge_gold|노드의 슬레지해머|
|$item_sledge_gold_description|이 무기라면 트롤의 것과 같은 묵직한 공격을 날릴 수 있습니다.|
|$item_sledge_gold_uncooked|주물: 노드의 슬레지해머|
|$item_sledge_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_sledge_iron|철 슬레지해머|
|$item_sledge_iron_description|챔피언에게 어울리는 강력한 헤머|
|$item_sledge_wood|나무 슬레지해머|
|$item_sledge_wood_description|생긴 것만 놓고 보면... 훨씬 더 강한 위력을 보여야 할 것 같은데 말이죠.|
|$item_smokebomb|연막탄|
|$item_smokebomb_description|연기 속에서 숨을 쉴 수 없는 건 상식입니다.|
|$item_smokedfish|훈연한 생선|
|$item_smokedfish_description|가장 맛있는 방식으로 준비한 생선입니다.|
|$item_smokedmoosemeat|훈제한 무스 고기|
|$item_smokedmoosemeat_description|훈연은 야생의 풍미를 더해줄 뿐입니다.|
|$item_smokepuff|연기 거품|
|$item_smokepuff_description|요리하면 맛이 나아지기를 바라십시오.|
|$item_snowball|눈덩이|
|$item_snowball_description|던지기에 완벽해 보입니다...|
|$item_snowshovel|눈삽|
|$item_snowshovel_description|가장 높게 쌓인 눈을 치울 때 유용합니다.|
...
|$item_spear_gold|노드의 창|
|$item_spear_gold_bloodlightning|천둥피 창|
|$item_spear_gold_bloodlightning_description|번개처럼 빠르고 사납게 공격할 수 있습니다.|
|$item_spear_gold_bloodlightning_uncooked|주물: 천둥피 창|
|$item_spear_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_spear_gold_description|공격을 위한 절호의 기회입니다.|
|$item_spear_gold_frostfire|서리불길 창|
|$item_spear_gold_frostfire_description|얼어붙은 불길에 담근 창으로, 확실한 종말을 선사합니다.|
|$item_spear_gold_frostfire_uncooked|주물: 서리불길 창|
|$item_spear_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_spear_gold_uncooked|주물: 노드의 창|
|$item_spear_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
...
|$item_spear_wood|나무 창|
|$item_spear_wood_description|진짜 창처럼 날카롭습니다. 진짜 창을 나무로 만들었다면 이런 느낌일 듯하네요.|
...
|$item_spicedeepnorth|조롱박 양념|
|$item_spicedeepnorth_description|약초채집사는 계피 껍질과 생강 뿌리를 사용하고 육두구를 살짝 곁들인 이 훌륭한 조합물을 발견하기까지 오랜 시간이 걸렸습니다.|
...
|$item_staff_frostorbs|북부의 앙갚음|
|$item_staff_frostorbs_description|눈송이가 내부에 갇혀 영원한 무늬를 발산합니다...|
|$item_staff_lightning|둔드르|
|$item_staff_lightning_description|짜릿한 일이 일어납니다.|
|$item_staff_orbofahri|메아리 가시|
|$item_staff_orbofahri_description|한기가 뼈를 타고 흐릅니다.|
|$item_staff_orbofahri_uncooked|주물: 메아리 가시|
|$item_staff_orbofahri_uncooked_description|이 마법 아이템은 서리로 굳혀야 합니다.|
|$item_staff_spiritcaller|영혼 소환사|
|$item_staff_spiritcaller_description|이계의 도움을 소환합니다. 필요한 것은 당신의 피 한 방울입니다...|
|$item_staff_spiritcaller_uncooked|주물: 영혼 소환사|
|$item_staff_spiritcaller_uncooked_description|이 마법 아이템은 서리로 굳혀야 합니다.|
|$item_staff_thunderblood|번개 일격|
|$item_staff_thunderblood_description|단순히 가리키기만 하면 하늘의 분노를 소환할 수 있습니다.|
|$item_staff_thunderblood_uncooked|주물: 번개 일격|
|$item_staff_thunderblood_uncooked_description|이 마법 아이템은 서리로 굳혀야 합니다.|
...
|$item_sword_gold|노드의 검|
|$item_sword_gold_bloodlightning|천둥피 검|
|$item_sword_gold_bloodlightning_description|피가 칼날을 타고 흐르면, 내재된 폭풍이 깨어납니다.|
|$item_sword_gold_bloodlightning_uncooked|주물: 천둥피 검|
|$item_sword_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_sword_gold_description|가장 희미한 햇빛 아래에서도 은은하게 빛나는 무기입니다.|
|$item_sword_gold_frostfire|서리불길 검|
|$item_sword_gold_frostfire_description|불길이 칼날을 따라 춤을 춥니다. 이 불은 뜨거울까요? 아니면 차가울까요?|
|$item_sword_gold_frostfire_uncooked|주물: 서리불길 검|
|$item_sword_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_sword_gold_uncooked|주물: 노드의 검|
|$item_sword_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
|$item_sword_iron|철 검|
...
|$item_sword_sword_2h_description|좀 조심해서 다뤄주시겠어요?|
|$item_sword_wood|나무 검|
|$item_sword_wood_2h|나무 대검|
|$item_sword_wood_description|웬만해선 안전합니다. 악착같이 달려들면 얘기가 달라지지만요.|
|$item_sword2h_gold|노드의 대검|
|$item_sword2h_gold_bloodlightning|천둥피 대검|
|$item_sword2h_gold_bloodlightning_description|누구든 이 무기를 휘두른다면 굉장히 무시무시할 것입니다.|
|$item_sword2h_gold_bloodlightning_uncooked|주물: 천둥피 대검|
|$item_sword2h_gold_bloodlightning_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_sword2h_gold_description|시각적으로도, 치명적으로도 뛰어난 무기입니다.|
|$item_sword2h_gold_frostfire|서리불길 대검|
|$item_sword2h_gold_frostfire_description|불타는 죽음과 얼어붙는 죽음 중 하나를 선택해야 한다면 답은 간단합니다. 둘 다 동시에.|
|$item_sword2h_gold_frostfire_uncooked|주물: 서리불길 대검|
|$item_sword2h_gold_frostfire_uncooked_description|같은 거푸집이지만, 더욱 환상적인 결과를 낼 수 있습니다... 때가 되면 서리가 전부 드러낼 것입니다.|
|$item_sword2h_gold_uncooked|주물: 노드의 대검|
|$item_sword2h_gold_uncooked_description|이 무기는 서리로 굳혀야 합니다.|
...
|$item_total|총합|
|$item_trinket|장신구|
|$item_trinketblackdamagedealth|철 가죽|
|$item_trinketblackdamagedealth_description|맹공의 힘이 깃든 경화된 가죽입니다.|
|$item_trinketblackdtamina|그림자 장막|
|$item_trinketblackdtamina_description|죽음과 춤추며 적의 공격을 피하는 이들에게 안성맞춤입니다.|
|$item_trinketbloodgoldhealth|목찌르개|
|$item_trinketbloodgoldhealth_description|발톱과 뼈와 금, 그들에게 피를 바치면 혜택을 내려줄 겁니다.|
|$item_trinketbloodgoldstamina|마녀의 왕관|
|$item_trinketbloodgoldstamina_description|사람들은 마녀의 영혼이 필멸자들에게 기묘한 힘을 부여할 수 있다고 합니다...|
|$item_trinketbronzehealth|숲의 심장|
|$item_trinketbronzehealth_description|고대 생명력의 파편으로 맥동합니다.|
|$item_trinketbronzestamina|청동 펜던트|
|$item_trinketbronzestamina_description|곰의 인내력을 상징하는 아름다운 펜던트입니다.|
|$item_trinketcarapaceeitr|맥동하는 귀걸이|
|$item_trinketcarapaceeitr_description|귀를 기울이면 잊힌 마법 영혼의 메아리가 희미하게 들려옵니다...|
|$item_trinketchitinswim|운명의 지느러미|
|$item_trinketchitinswim_description|마음과 영혼을 비워 형태를 벗어나, 물과 하나가 되세요.|
|$item_trinketflametaleitr|작은 요르문간드|
|$item_trinketflametaleitr_description|빛나는 돌에서 고통에 찬 비명의 메아리가 울려 퍼집니다.|
|$item_trinketflametalstaminahealth|불의 심장|
|$item_trinketflametalstaminahealth_description|심장의 고동 소리를 따라 욕망으로 타오르는 불길의 소리가 들려옵니다.|
|$item_trinketironhealth|철 브로셰|
|$item_trinketironhealth_description|섬세한 호신 장비입니다.|
|$item_trinketironstamina|발찌|
|$item_trinketironstamina_description|가볍고 가속의 기운이 깃들어 있습니다.|
|$item_trinketscalestaminadamage|울려 퍼지는 족쇄|
|$item_trinketscalestaminadamage_description|날카로움이 서려 있는 발목 사슬입니다.|
|$item_trinketsilverdamage|늑대의 시야|
|$item_trinketsilverdamage_description|분노로 타오르는 늑대의 날카로운 지성에서 영감을 얻은 머리띠입니다.|
|$item_trinketsilverresist|수정 심장|
|$item_trinketsilverresist_description|얼어붙은 슬픔과 절망의 파편입니다.|
...
|$item_trophy_barka|바르카의 트로피|
|$item_trophy_barka_description|한때 살아있었던 나무의 얼어붙은 머리입니다.|
|$item_trophy_barka_lore|숲의 생물이 살아있는 서리로 변했습니다.|
|$item_trophy_bjorn|곰의 트로피|
|$item_trophy_bjorn_description|눈빛 하나는 섬뜩하게 살아있습니다...|
|$item_trophy_bjorn_lore|숲의 주인으로 여겨지곤 했습니다. 다 착각이었지만요.|
|$item_trophy_bjorn_undead|바일의 트로피|
|$item_trophy_bjorn_undead_description|눈빛은 사라지고 없습니다...|
|$item_trophy_bjorn_undead_lore|섬뜩하기 이를 데 없는 밤의 그림자입니다.|
|$item_trophy_blob|블롭의 트로피|
|$item_trophy_blob_description|악취를 풍기는 끈적끈적한 물질 덩어리입니다.|
|$item_trophy_blob_frost|얼음 블롭 트로피|
|$item_trophy_blob_frost_description|얼음 파편 같지만... 끈적이기도 하는군요?|
|$item_trophy_blob_frost_lore|시간이 아무리 흘러도 얼어붙은 상태를 유지합니다.|
|$item_trophy_blob_lava|용암 블롭 트로피|
|$item_trophy_blob_lava_description|아마 이제 식어버린 거겠지?|
|$item_trophy_blob_lava_lore|심지어 지금도 손을 대면 뜨겁습니다.|
|$item_trophy_blob_lore|악취를 풍기는 끈적끈적한 물질 덩어리입니다.|
|$item_trophy_blob_morkhalla|펄프의 트로피|
|$item_trophy_blob_morkhalla_description|불행한 모험가들의 유해가 소화되어 오랜 시간 젤리처럼 변했습니다.|
|$item_trophy_blob_morkhalla_lore|여전히 흔들리긴 하지만, 죽었다는 것은 분명합니다.|
...
|$item_trophy_elaking|엘라킹의 트로피|
|$item_trophy_elaking_description|작고 심술궂은 눈이 당신을 응시합니다.|
|$item_trophy_elaking_lore|놈을 움직이게 하는 건 잔혹함일까요? 아니면 장난일까요? 우리는 아마 모를 겁니다.|
...
|$item_trophy_fader_description|손쓸 방법이 없을 정도로 타락한 녹색 용입니다.<br/><br/>희생의 돌에 바치십시오.|
...
|$item_trophy_ghost|유령의 트로피|
|$item_trophy_ghost_description|아직도 풀지 못 한 한을 속삭이진 않나요?|
|$item_trophy_ghost_lore|그래도 왠지 모르게 으스스한 기운이 느껴집니다...|
...
|$item_trophy_jotunwarrior|크리겐의 트로피|
|$item_trophy_jotunwarrior_description|한때 강력한 전사였으나, 이제는 껍데기만 남았습니다.|
|$item_trophy_jotunwarrior_lore|노련한 병사입니다. 어떤 전투를 목격했을까요?|
|$item_trophy_jotunwitch|헥센의 트로피|
|$item_trophy_jotunwitch_description|생전 그녀의 눈은 마법으로 반짝였습니다. 이제는 텅 빈 공허뿐입니다.|
|$item_trophy_jotunwitch_lore|강력한 마녀입니다. 어떤 신기한 비밀을 알고 있었을까요?|
...
|$item_trophy_mole|눈이 없는 자의 트로피|
|$item_trophy_mole_description|이 발톱에 베이면 정말로 불쾌할 것입니다.|
|$item_trophy_mole_lore|이 눈이 없는 자는 더 이상 땅을 파지 못할 것입니다.|
|$item_trophy_moose|무스의 트로피|
|$item_trophy_moose_description|북부 숲의 강력한 통치자입니다.|
|$item_trophy_moose_lore|위엄 넘치는 짐승이자 상징적인 장식품입니다.|
...
|$item_trophy_seal|물개의 트로피|
|$item_trophy_seal_description|이 동물은 아무런 해도 끼치지 않았지만, 불행한 최후를 맞이했습니다.|
|$item_trophy_seal_lore|크고 슬픈 눈이 당신을 응시하고 있습니다. 무슨 짓을 저지른 건가요?|
...
|$item_trophy_writhan|뤼탄의 트로피|
|$item_trophy_writhan_description|쉽게 부서지지 않는 잔해로, 섬세하게 다뤄야 합니다.|
|$item_trophy_writhan_lore|당분간은 휴면 상태입니다...|
|$item_turnip|순무|
...
|$item_turretbolt_bloodgold|혈금 투사체|
|$item_turretbolt_bloodgold_description|이 투사체가 대상을 찾는 순간 적이 생존할 확률은 없습니다.|
...
|$item_UndeadBjornRibcage|바일의 갈비뼈|
|$item_UndeadBjornRibcage_description|야성적인 힘의 유물입니다. 야생의 분노를 품은 방어구를 만들기에 적합합니다.|
|$item_upgrader_armor|보호|
|$item_upgrader_description|이 신비로운 우상에는 신들의 잠재력이 흘러넘치고 있습니다. 강력한 혜택을 내려줄 수도, 크나큰 희생을 요구할 수도 있습니다.|
|$item_upgrader_name|우상|
|$item_upgrader_tier0|나무|
|$item_upgrader_tier1|청동|
|$item_upgrader_tier2|철|
|$item_upgrader_tier3|은|
|$item_upgrader_tier4|흑철|
|$item_upgrader_tier5|검은 대리석|
|$item_upgrader_tier6|화염금속|
|$item_upgrader_tier7|혈금|
|$item_upgrader_weapon|전투|
|$item_utility|다용도 아이템|
|$item_value|값|
|$item_vikingcupcake|아이싱이 올라간 달콤한 빵|
|$item_vikingcupcake_description|위업을 기념하기 위한 달콤하고 맛있는 간식입니다.|
|$item_vikingcupcake_uncooked|굽지 않은 달콤한 빵|
|$item_vikingcupcake_uncooked_description|오븐에 넣을 준비가 됐습니다.|
...
|$item_writhanroots|뤼탄 뿌리|
|$item_writhanroots_description|기괴하고 불쾌한 생물의 뒤틀린 신체 일부입니다.|
...
|$location_bearcave|곰 동굴|
|$location_darkesthole|구멍|
|$location_dnbossroom|최초의 감옥|
|$location_dnbossroomnew|감옥|
...
|$location_morkhalla|모르크할라|
|$location_mountaincave|설산 동굴|
|$location_sunkencrypt|침수된 지하실|
|$location_thehole|구불구불한 터널|
|$lore_ashlands_random01|아직 태어나지 않은 자손들에게 고하노라. 이곳은 본디 온 발헤임에서 가장 강대한 왕국이었다. 에메랄드 화염의 왕이 거느린 자녀들이 이곳에 기거했도다. 그분의 날개 아래 우리는 힘을 얻고 보호받았도다. 그분의 시선을 받으며 우리는 새싹처럼 자랐노라.<br/><br/>그러나 지금 우리는 바스러진 돌 가운데 이 비석을 세우고, 우리가 난 땅을 등지려 한다. 후세는 이를 경고로 삼도록 하라.|
|$lore_ashlands_random02|한번은 먼 북쪽의 숲까지 나섰던 우리의 정찰대가 잠든 아이를 찾게 되었노라. 아이는 벌거벗은 채 나무에 등을 기대고 앉아 있는 형세였도다. 정찰대는 아이를 모피로 감싸 왕 앞에 대령하였고, 아이는 내내 눈꺼풀만 움직이며 잠들어 있었도다.<br/><br/>우리는 아이를 '겨울 아이'라 부르며 좋은 징조로 여겼다. 신께서 어리석은 자를 굽어살피시기를.|
|$lore_ashlands_random03|온 나라가 알았노라, 둘이 마치 대화하듯 자주 함께 앉아있었다는 것을. 왕은 잠든 아이 근처에 똬리를 틀고 얼굴을 가까이해 작은 잠꼬대라도 애써 들었도다.<br/><br/>사이에 어떤 말이 오갔는지는 아도 몰랐으나, 왕의 변화는 자명했도다. 정의감은 불타올라 분노가 되고, 조심성은 깊어져 두려움이 되었다. 어길 수밖에 없는 법이 자꾸 선포되고, 범법자에게 가해지는 형벌은 매번 정도를 더해갔노라.<br/><br/>꼬리를 물며 돌고 돈 악순환은 폭정이라는 거대한 폭풍이 되었도다.|
|$lore_ashlands_random04|에메랄드 화염의 왕이 풀링의 마법사 왕을 만나러 남쪽으로 날아갔을 때, 왕의 봉신 셰인들이 반란을 일으켜 궁궐에 불을 질렀도다. 겨울 아이도 궁궐 안에 있었고, 그 시점을 살아서 직접 경험한 이들은 불이 타오른 아홉 날의 비명을, 이후 몇 주간 도시 거리에 울려 퍼진 그 메아리를 들었노라.<br/><br/>온전했던 시절은 그것이 끝이었고, 결국 왕이 귀환했도다.|
|$lore_ashlands_random05|왕은 까맣게 탄 대궁정의 폐허를 보고, 적이 놓은 작은 불씨로는 헤아리지도 못할 커다란 불을 놓겠다 맹세했도다. 왕은 숨결로 도시를 불태우고 온 땅에 전쟁을 선포했노라. 여전히 왕에게 충성하는 이도 있었으나, 많은 이가 그의 분노를 잠재우고자 했도다.<br/><br/>형제가 형제와 싸우고, 자매가 자매와 싸우고. 에메랄드 화염 왕국은 스스로 갈기갈기 찢기고 말았다. 남은 것은 죽은 자도 안식에 들지 못하는 잿불 폐허뿐이로다.|
...
|$lore_ashlands_random08|위대한 용의 순수한 화염은 생명을 주고 죽은 땅에 기운을 불어넣을 수 있도다. 한때는 정화의 불길이 땅과 바다에 생기를 주고 축복한 적도 있었노라.<br/><br/>하지만 용의 불에 불탄 자에게는 축복이 곧 저주로다. 죽으면서 동시에 생기가 돌아오니, 생과 사 사이에 영원히 갇히는 셈이다. 폐허 속을 돌아다니는 불쌍한 이들이 그런 자로다. 살 대신 불을 뒤집어쓰고, 매 순간 고통에 찬 이들. 그들은 없앨 수 없으며 동정할 수밖에 없도다.|
|$lore_ashlands_random09|이야기에 따르면 신들은 오래전에 이 세계를 버렸도다. 에메랄드 화염의 왕은 우리에게 있어 신에 가장 가까운 존재였으나, 우리의 기도는 입에서 나오지 못하고 재가 되었노라.<br/><br/>이곳은 몇 안 되는 마지막 남은 요새이니, 아침이 되면 이곳을 지키다 죽겠노라. 더 이상 기도는 올리지 않으나, 다만 화염에 닿지 않는 깨끗하고 자유로운 죽음만을 바란다.|
|$lore_ashlands_random10|우리는 신이 필요 없다고 말하는 자유민의 말은 틀렸노라. 신이 필요한 자는 아무도 없다. 신도 사람이 필요하지 않다.<br/><br/>하지만 현명한 이라면 넝쿨이 타고 오를 큰 나무를 찾듯이 강자를 찾는 법. 그래서 우리는 에메랄드 화염의 왕에게 검을 바치노라. 그분 없이는 오직 죽음뿐이로다.|
|$lore_ashlands_random11|전쟁이 불이라면<br/>사람은 땔감이다<br/><br/>가슴이 불 지피면<br/>몸은 장작이 된다|
...
|$lore_blackforest_random08|미드가르드의 트롤들은 다른 모든 인족들이 그러한 것처럼 당신의 기억 속에서 흐려져 가고 있을지도 모릅니다. 수가 적고 고독한 그들은 축축한 동굴에 웅크려 약하고 무모한 자들의 뼈를 갉아먹습니다. 오딘의 의지가 다시 그들을 어두운 곳으로 몰아넣었습니다.<br/><br/>하지만 그들은 발헤임에서 번창하였습니다. 미드가르드가 땅을 납작하게 짓밟고 재미 삼아 나무를 쓸어트리는 거대한 트롤들을 본지도 수 세기가 지났습니다. 낯선 땅의 방랑자여, 이 위대하고 고결한 광경을 목격하십시오! 그리고 뛰어서 달아나십시오...|
...
|$lore_blackforest_random10|너희들 중 누가 살인자였는가, 존속 살인범이었는가, 배교자였는가? 누가 형제의 등에 검을 꽂아 넣었는가? 누가 어미의 품으로부터 아기를 빼앗고, 약탈한 집들을 불태웠는가? 기억할 수 없는 것을 축복으로 여겨라. 너희는 모두 위대한 전사들이고, 전사의 영혼은 깨끗할 수 없으니.<br/><br/>하지만 오딘께서 너희에게 두 번째 기회를 주셨다... 최고신을 찬양하라!|
...
|$lore_blackforest_random13|나는 이 세계에 여러 번 다시 태어났다. 나는 죽고 또 죽었지만, 결국 내 집에서 깨어났다. 내가 몇 번이나 더 이렇게 돌아올지 궁금하다. 프리다는 뱀에게 잡혀갔고 그녀의 침대는 여전히 비어있다. 트롤에게 몸의 절반을 물린 뱌르니의 반쪽은 그 이후로 보이지 않는다... <br/><br/>우리보다 먼저 온 자들의 폐허는 사방에 널려있지만 그 폐허를 지은 자들은 어디에 있는 걸까?<br/><br/>혹시 전사가 이곳에 머무를 의지를 잃게 되면, 돌아오지 못하게 되는 것이 아닐까?|
...
|$lore_deepnorth_hervor01|북부 심층 지역. 나의 자격을 증명하기 전 마지막 장애물이다.<br/><br/><br/><br/>시련은 많았고, 죽음도 많았다. 나의 소중한 친구들을 잃었다.<br/><br/><br/><br/>하지만 마침내 나는 이곳에 도착했다.|
|$lore_deepnorth_hervor02|굉장히 평화로워 보인다. 지금까지는 야생동물들이 나의 존재를 그다지 신경 쓰지 않는 것처럼 보인다.<br/><br/><br/><br/>필요하다면 동물에게서 귀중한 자원을 얻을 수 있을 것이다. 무엇보다 이건 나와 야생동물들의 생존 문제니 말이다.|
|$lore_deepnorth_hervor03|경계를 늦출 수는 없다. 이곳에 처음 도착한 이후 평화로운 지역은 얼마 없었기에 이 땅은 다를 거라 믿는 것은 멍청한 짓이다.<br/><br/><br/><br/>내가 아무리 잘 싸운다고 해도 이곳의 피할 수 없는 추위에 결국 쓰러질지도 모른다.<br/><br/><br/><br/>몸을 피할 곳을 찾아야 한다.|
|$lore_deepnorth_hervor04|지금까지 나는 계속 혼자였다. 그럼에도 누군가가 나를 지켜보고 있다는 느낌을 떨쳐낼 수가 없다.|
|$lore_deepnorth_hervor05|오래된 건물을 찾았지만, 버려진 곳이었다. 얼마나 오래되었는지 확인할 수는 없지만, 이곳에서 내 친구를 찾을 수 있을 것 같지는 않다.|
|$lore_deepnorth_hervor06|내 도끼의 날을 날카롭게 갈지 않았거나, 내 감각이 예리하지 않았다면 어떻게 되었을지 상상하기도 싫다. 무엇보다 나를 도와줄 이들은 아무도 남지 않았으니 말이다.<br/><br/><br/><br/>내가 동료를 잃었을지라도 그들을 위해서 계속해서 나아가야 한다. 이 땅의 통치자는 죽어야만 한다.|
|$lore_deepnorth_hervor07|이상하다. 계속해서 이곳에서 누군가가 나를 기다리며 맞이할 것 같다는 느낌이 든다.<br/><br/><br/><br/>나의 어린 시절 겨울은 이런 모습이었겠지. 그리고 언제라도 아버지께서 나를 집으로 맞이할 것만 같다. 하지만 아버지는 없다. 누구도 없다.|
|$lore_deepnorth_hervor08|최근에 내가 까마귀가 되는 꿈에 시달리고 있다. 거대하고 검은 날개로 내가 잘 알고 있는 이 세상 위로 솟구치지만, 전과 똑같은 꿈은 아니다.<br/><br/><br/><br/>한때 녹색에 비옥했던 풍경은 차갑고 황량하게 변했다. 어쩌면 이 얼어붙은 북부가 나를 잡아먹고 있을지 모른다. 하지만... 만약 그게 아니라면?|
|$lore_deepnorth_hervor09|이제 내가 어디로 가야 하는지 알게 되었다. 선조들께서 이 땅을 지배하는 자의 방향을 알려주셨다. 선조들께서는 놈을 사슬로 묶으려고 하셨지만, 이제 놈은 그 힘으로 세상 자체를 묶고 있다.<br/><br/><br/><br/>내가 이 적, 이 증오스러운 존재를 쓰러뜨릴 수만 있다면, 나의 자격을 영원히 증명할 수 있을 것이다.|
|$lore_deepnorth_memorial_description|선조의 기념비|
|$lore_deepnorth_memorial_label|구전: 선조의 기념비|
|$lore_deepnorth_memorial1|우리보다 앞선 위대한 분들이 이 앞에 잠들어 있다.<br/><br/>그분들의 안식을 방해하지 않도록 조심해서 걸으라.|
|$lore_deepnorth_memorial2|가장 위대한 전사에게도 결국 죽음은 찾아온다.<br/><br/>언젠가는 그대도 그분들과 함께할 것이다.|
|$lore_deepnorth_memorial3|우리가 지금 살아가고 있는 세상을 만든 우리의 선조를 기려야 한다.<br/><br/>그분들이 우리의 가치를 봐주시기를.|
|$lore_deepnorth_random01|처음에는 추위와 눈을 좋아하는 울프에게 좋은 보금자리가 될 것만 같았다. 그러다가 나를 아래로 끌어당기려는 사악하고 작은 생물이 등장하자, 다시 생각할 수밖에 없었다.|
|$lore_deepnorth_random02|만약 까마귀의 말이 사실이라면, 내가 쓰러뜨려야 하는 버려진 자는 이제 단 하나만 남았다. 하지만 그 이후에는? 나의 아들이 진정으로 내게 돌아오게 오는 걸까? 아니면 내가 아들에게 가는 것일까?<br/><br/><br/><br/>아스트리드는 아들을 위해 이 비석을 세운다. 다시 아들을 만나기 전, 아들이 자신의 발걸음을 따라올 수도 있으니.|
|$lore_deepnorth_random03|이 땅은 너무나도 익숙하여 우리들 마음속에 파묻혀 있던 기억을 떠올리게 한다. 우리는 이곳이 보기와는 다르다는 사실을 알고 있어야 했다.|
|$lore_deepnorth_random04|한때 숲의 트롤을 강력한 적수로 여긴 카타의 말에 귀를 기울여라. 이 땅에 있는 트롤이라는 종족은 탑처럼 거대하며 바위처럼 단단하지만, 처치할 수만 있다면 눈부신 보상을 얻을 수 있을 것이다.|
|$lore_deepnorth_random05|우리가 처음 이곳에 도착했을 때, 이곳은 풍부하고 번영하던 곳이었다. 하지만 이제 겨울은 더 춥고 길어졌다. 우리는 겨울이 이곳을 완전히 집어삼킬까 두렵다.<br/><br/><br/><br/>하지만 우리는 이곳에 우리의 보금자리를 만들었고 뿌리를 내렸으니, 이곳에서 살아갈 것이다.|
|$lore_deepnorth_random06|가장 먼 북부<br/><br/>마법이 하늘에서 춤추는 곳<br/><br/>지하에 숨겨진 것을<br/><br/>불러일으키리라<br/><br/><br/><br/>석탄을 밝게 태워라<br/><br/>선조의 지혜가 기다린다<br/><br/>그들의 강력한 검과 활을 들고<br/><br/>싸움에 나설 전사를|
|$lore_deepnorth_random07|가짜 나무를 조심하라! 고드름이 부딪히는 소리와 가지가 삐걱거리는 소리는 그저 바람에 흔들리는 것이 아닐 수도 있다...|
|$lore_deepnorth_random08|시그네는 전투에서 쓰러진 에이길을 추억하기 위해 이 돌을 세웠다. 그는 이곳이 보이는 것과는 달리 전부 얼어붙은 것은 아니라는 사실을 아직 깨닫지 못했다.|
|$lore_deepnorth_random09|북쪽 깊은 곳, 눈 속에 파묻힌,<br/><br/>진실이 녹기 시작하자<br/><br/>유대는 얼어붙은 땅처럼 굳는다.|
...
|$lore_meadows_random01|발밑에 풀이 돋고<br/><br/>하늘이 푸른 곳은<br/><br/>불과 집이 있기 좋은 곳입니다.|
|$lore_meadows_random02|오래전, 최고신 오딘이 세계를 통합했을 때, 그는 거인들과 어떤 것들보다도 오랜 세월을 산 창조물들로 이루어진 바니르를 쓰러뜨렸습니다. 그들 중 가장 위대한 자들은 죽이지 못하였으나 버려져서 이곳 발헤임으로 영원히 추방되었습니다.<br/><br/>그들이 땅을 밟을 때면, 작은 생물들은 북위에 있는 부스러기들 처럼 펄쩍펄쩍 뛰어오릅니다. 그들을 보면 알아볼 수 있을 것입니다.|
|$lore_meadows_random03|지구의 표면에 돋아나는 새싹과 <br/><br/>덩굴에서 자라나는 과일들<br/><br/>햇빛과 비에 대해 프레이 신께 감사드려라<br/><br/>요리를 할때 나오는 연기와, 따뜻한 가죽<br/><br/>그리고 팔의 힘에 대해 오딘께 감사드려라|
...
|$lore_mistlands_random04|드베르그는 위대한 고대 대장장이의 후손, 깊은 땅을 헤집는 자, 숨겨진 보물을 찾는 자로다.<br/><br/>그들은 발헤임에서 요툰의 뼈를 캐고, 마법에 쓰는 에이트르를 정제한다. 내버려 두면 다른 이가 무엇을 하든 제 할 일만 하지만, 다툴 일이 생기면 필시 공격할 것이다.|
...
|$lore_mistlands_random07|그대 안개를 헤매는 자<br/>그대 어디로 가는가?<br/>그대가 무엇이었는지<br/>어느 길로 가는지 모르지 않는가|
...
|$lore_mountains_random10|옛 미드가르드에서 인간의 군대는 바니르족이 그들의 어머니를 발헤임으로 내쫓았듯이 드레이크들을 산으로부터 몰아내었다. 하지만 이곳에서 그들은 그들의 힘과 숫자를 회복했다. 그들의 힘찬 날개의 박자가 산봉우리 사이에서 메아리친다. <br/><br/>그들은 사납고 고귀한 피조물로서, 싸울 가치가 있는 진정한 적이다. 그들이 비웃으며 그대의 칼날에 맞선다면, 화살을 보내어 그들을 맞이하라.|
...
|$lore_plains_random09|외지를 떠도는 것이 얼마나 기쁜 일인가<br/><br/>머리에 안긴 바람과<br/><br/>푸른 하늘이 그대 앞에 있으니.<br/><br/><br/>또 이 얼마나 기쁜 일인가<br/><br/>적 앞에서 당당히 맞서는 것은<br/><br/>그리고 세상에 숨김없이 말하는 것은.<br/><br/><br/>그리고 얼마나 기쁜 일인가<br/><br/>여정에서 집에 돌아오는 것은<br/><br/>그리고 난로에서 여전히 밝게 타오르는 불꽃을 발견하는 것은.|
|$lore_plains_random10|이 초원에서는, 오직 위대한 자들만이 살아남아 나의 말을 읽고 나의 충고에 귀를 기울인다. 그러니 지금 나의 충고를 귀담아 들으라.<br/><br/>위대한 오딘은 친절하거나 상냥하며, 달콤한 말을 내뱉는 자애로운 아버지가 아니다. 하지만 그의 적이 곧 그대의 적이니. 그의 기쁨과 영예 또한 그대의 것이다. 그가 그러했듯이 그대도 싸우고 이길 것이다.<br/><br/>오딘의 아들과 딸이여, 기뻐하라!|
|$lore_plains_random11|이곳 평야에서는 오딘이 그 오만함을 벌하기 전까지 한때 인간의 것에 견주는 탑들과 도시들을 세웠던 고대의 종족 풀링들의 거주지를 발견할 수 있습니다. 그는 풀링의 군대를 짓밟았으며, 그들의 갑옷을 발 아래 깔린 달팽이의 껍질처럼 부수고, 그들의 도시를 무너뜨렸습니다.<br/><br/>오직 위대한 마법사 야글루스만이 그의 분노 앞에서 꺾이거나 부러지지 않을 수 있었습니다. 그에 오딘은 그의 몸을 반으로 찢어 발헤임으로 던졌고, 그는 피를 흘리며 흙으로 무너져 내렸으며, 그의 마지막 백성들은 눈물을 흘렸습니다.<br/><br/>이제 야만적이고 야생적이며 오직 증오와 두려움만을 마음속에 품은 풀링이 발헤임의 평야를 지배합니다. 하지만 야글루스는 아직 그들 곁에 남아 있습니다. 풀링 주술사들이 비뚤어진 마법에 의지하여 펼치는 보이지 않는 힘은 그의 백성들이 세계로 퍼져나감에 따라 다시금 강력해집니다...|
...
|$lore_upgradestation_description|잉그리드와 토르건은 이곳에서 신들을 기리기로 했습니다. 신들은 잉그리드에게 미소를 지으며 큰 축복을 내렸습니다. 반면 토르건은 자신의 검이 제단에서 산산이 부서지는 것을 보며, 자신이 어떤 위험을 감수하고 있는지 확실하게 알게 되었습니다. 그녀는 이 대장간에서 정제를 시도하는 것의 위험을 다른 이들에게 알리기 위해 이 돌을 세웠습니다!|
|$lore_upgradestation_label|구전: 잠재력의 대장간|
|$lore_windingtunnels|빛나는 생물들은 어둠 속에서 훌륭한 광원이 됩니다.<br/><br/>나무 우리가 있다면 가둘 수 있을지도 모릅니다.|
...
|Key M-Z |Korean Text |
|---|---|
|$mac_gamecenter_required_online_header|온라인 기능을 위해 게임 센터에 로그인 해주세요.|
|$mac_gamecenter_required_online_text|발헤임은 계정인증을 위해 게임센터를 사용합니다 - 온라인 기능을 사용하시려면 게임센터에 로그인 하고 발헤임을 재시작해 주세요.|
|$memorialplace|추모의 장소|
...
|$menu_codeofconduct_button|운영 지침|
|$menu_collapse|축소|
|$menu_combat|전투|
...
|$menu_friendinvite_accepted_header|친구 초대 수락됨|
|$menu_friendinvite_accepted_text|친구가 게임을 시작할 때까지 기다리는 중...|
|$menu_friendinvite_selectcharacter_header|친구 초대를 수락 함.|
|$menu_friendinvite_selectcharacter_text|게임에 참여할 캐릭터를 선택해 주세요.|
|$menu_friends|친구|
...
|$menu_hair|머리카락|
|$menu_hairtone|머리색|
|$menu_invite_friends_macos|친구 초대|
...
|$menu_loading|불러오는 중...|
|$menu_locked|잠김|
|$menu_logging_in_played_failed_not_signed_in_to_platform|온라인으로 플레이하기 전에, 사용 중인 플랫폼에 로그인되어 있는지 확인하세요.|
|$menu_logging_in_played_failed_not_signed_in_to_platform_gamecenter|온라인 게임을 플레이하기 전에 Game Center에 로그인되어 있는지 확인하세요. 변경 사항이 적용되려면 게임을 재시작해야 할 수 있습니다.|
|$menu_logging_in_playfab_failed_header|PlayFab에 로그인 할 수 없습니다.|
|$menu_logging_in_playfab_task_header|PlayFab에 로그인 하는 중...|
...
|$menu_loginwithplayfab_header|PlayFab으로 로그인|
|$menu_loginwithplayfab_text|발헤임은 PlayFab을 통해서 다른 플레이어들과 온라인으로 연결합니다. PlayFab에 로그인 하시겠습니까? 플레이하고 계시는 플랫폼에 따라서 자동으로 PlayFab 계정을 생성합니다.|
|$menu_logout|로그아웃|
|$menu_logoutconfirm|로그아웃 하시겠습니까?|
|$menu_logoutprompt|정말 현재 세션에서 로그아웃하시겠습니까?|
|$menu_lowdisk_block_exitanyway_header|디스크 공간 부족 - 그래도 종료합니까?|
|$menu_lowdisk_block_exitanyway_prompt|디스크에 게임을 저장할 공간이 부족합니다. 그래도 종료합니까? (월드와 캐릭터가 저장되지 않습니다!)|
...
|$menu_player_list_block_tooltip|차단|
|$menu_player_list_block_warning_as_client|이 플레이어를 차단하면 함께 플레이할 수 없게 됩니다. 이는 차단한 플레이어의 사용자 생성 콘텐츠(UGC) 열람을 금지하는 플랫폼 정책을 준수하기 위함입니다. 연결이 해제되고 차단한 플레이어가 있는 서버에 참여하지 못하게 됩니다. 정말 차단을 진행하시겠습니까?|
|$menu_player_list_block_warning_as_server|이 플레이어를 차단하면 함께 플레이할 수 없게 됩니다. 또한, 상대방은 즉시 추방됩니다. 사용자 생성 콘텐츠(UGC) 관련 플랫폼 정책에 따라, 귀하는 차단 기간 동안 이 월드에 접속할 수 없으며, 귀하 역시 월드에서 로그아웃됩니다. 정말 차단을 진행하시겠습니까?|
|$menu_player_list_kick_tooltip|서버에서 추방|
|$menu_player_list_mute_tooltip|음소거|
|$menu_player_list_report_tooltip|신고|
...
|$menu_removefavoritecategory|즐겨찾기 카테고리를 제거하시겠습니까?|
...
|$menu_storagefull|저장소가 가득 찼습니다!|
|$menu_storagefulloperationfailed|저장 데이터 공간이 가득 차 이 작업을 완료할 수 없습니다. 사용하지 않는 저장 데이터를 삭제한 후 다시 시도해 주세요.|
|$menu_storageused|사용중인 저장 공간: $1|
...
|$menu_vulkancrashwarning_header|Vulkan을 사용하면 발헤임이 시스템에서 충돌할 수 있습니다|
|$menu_vulkancrashwarning_text|현재 Vulkan을 사용 중입니다. 특정 시스템에서 Vulkan 사용 시 발생하는 알려진 충돌 문제를 조사 중이며, 사용자의 시스템이 영향을 받을 가능성이 있는 것으로 감지되었습니다. 안정성 문제가 발생할 경우, 기본 렌더링 API(DirectX 11)를 사용해 주시기 바랍니다. 불편을 드려 죄송합니다!|
|$menu_worldnametip|최소 5글자|
|$menu_worlds|월드|
|$menu_yes|네|
|$message_dream|오늘 밤 꿈을 꿀 것입니다|
|$morkhalla_drawbridge|도개교|
|$msg_added|추가됨|
...
|$msg_incompleteoffering_memorial|선조들이 여전히 잠들어 있습니다|
...
|$msg_offerdone_memorial|선조들이 당신의 부름에 응답합니다|
...
|$msg_upgrader_broke|$1 정제 실패! 레벨 $2에서 파괴되었습니다|
|$msg_upgrader_fail|$1 정제 실패! 레벨 $2로 하락했습니다|
|$msg_upgrader_success|$1 정제 성공! 레벨이 $2로 상승했습니다|
|$msg_useonwhat|$1을(를) 어디에 사용할까요?|
|$msg_walk|걷기|
|$msg_wontwork|그렇게 쓸 수 없습니다|
|$msg_worldsaveblockedonserver|서버에 게임을 저장할 공간이 없습니다.|
...
|$msg_worldsavewarningonserver|서버의 디스크 공간이 부족합니다, 미래를 위해 공간을 더 확보해 주세요.|
...
|$npc_dvergr_deepnorth_random_goodbye1|내 걱정은 마. 너 없어도 괜찮을 거야.|
|$npc_dvergr_deepnorth_random_goodbye2|알아서 벗어날 방법을 찾아야겠군.|
|$npc_dvergr_deepnorth_random_goodbye3|가능한 모든 거인족을 처치해!|
|$npc_dvergr_deepnorth_random_goodbye4|그럼 다시 만날 때까지.|
|$npc_dvergr_deepnorth_random_goodbye5|뭘 찾고 있어?|
|$npc_dvergr_deepnorth_random_goodbye6|고향에서 너무 멀리까지 왔어...|
|$npc_dvergr_deepnorth_random_goodbye7|떠나는 거야?|
|$npc_dvergr_deepnorth_random_greet1|거기 누구냐?|
|$npc_dvergr_deepnorth_random_greet2|친구인가, 적인가?|
|$npc_dvergr_deepnorth_random_greet3|이봐! 거기 너!|
|$npc_dvergr_deepnorth_random_greet4|여기서 빠져나가게 도와줘!|
|$npc_dvergr_deepnorth_random_greet5|도와줄래?|
|$npc_dvergr_deepnorth_random_greet6|이쪽이야!|
|$npc_dvergr_deepnorth_random_greet7|날 도와주면 나도 도와줄게.|
...
|$npc_dvergrmage_random_talk_in_faction_base1|이번 광산은 지난번 광산처럼 감염되어 있지 않았으면 좋겠군.|
|$npc_dvergrmage_random_talk_in_faction_base10|이곳은 트롤의 겨드랑이만큼 축축하지만, 고통스럽게 더운 남쪽보다는 덥지 않습니다.|
|$npc_dvergrmage_random_talk_in_faction_base2|이번 화물을 빨리 고향에 가져갔으면 좋겠다네.|
|$npc_dvergrmage_random_talk_in_faction_base3|이런 광산들은 우리가 지었다네. 지금의 우리는 형편없지만...|
|$npc_dvergrmage_random_talk_in_faction_base4|할도르는 어떻게 되었을까?|
|$npc_dvergrmage_random_talk_in_faction_base5|에이트르가 과연 이 정도의 가치가 있었을까 생각하곤 해.|
|$npc_dvergrmage_random_talk_in_faction_base6|그 불이 다음엔 무엇을 보여줄지 기대되는걸.|
|$npc_dvergrmage_random_talk_in_faction_base7|그 병을 어디다 뒀더라...?|
|$npc_dvergrmage_random_talk_in_faction_base8|맹세컨대 여기 어딘가에 여분에 채취기가 있었다니까...|
|$npc_dvergrmage_random_talk_in_faction_base9|조금만 더 캐고 뮈르크헤임으로 가져가자.|
...
|$npc_dvergrrogue_random_talk_in_faction_base10|남쪽으로 다시 모험을 떠난다고 들었어. 이번에는 탐험대에 지원해 볼까?|
...
|$npc_munin_deepnorth_general01|이곳은 변신의 장소이지. 어떤 생명체는 이곳에서 새로운 목적을 찾고 과거보다 더욱 대단한 존재가 되기도 해. 너도 그런 존재 중 하나인가?|
|$npc_munin_deepnorth_general02|까악! 이곳을 처음 탐험한 자들은 지하의 도둑에 대해서는 모르고 있었지. 만약 알았다면 보금자리를 건설한 더 나은 장소를 찾았을 테니까.|
|$npc_munin_deepnorth_general03|이 땅에 세워진 기념비를 확인하며 너보다 빨리 이곳에 온 전사들을 기리도록 해. 그들에게 가치가 있는 존재임을 증명한다면 축복을 내려줄 수도 있으니.|
|$npc_munin_deepnorth_general04|최고신께서 너를 소환하기 오래전부터 다른 이들은 이 세상을 지키라는 임무를 받았지. 그들은 오래전에 떠났지만, 여전히 안식을 찾지 못하는 것 같아. 부디 그들을 방해하지 않도록 해.|
|$npc_munin_deepnorth_morkborg|까악! 이곳에는 악 자체에서 탄생한 기묘한 존재들이 거주하고 있어...|
|$npc_munin_deepnorth_ship|오래 전에 다른 이들은 이 땅으로 항해하려 했었지. 여기까지 도착은 한 것으로 보이지만, 다시 돌아갈 길은 없었어...|
...
|$npc_valkyrie_end|발키리|
|$npc_valkyrie_end_interact|발할라로 떠나는 여정|
...
|$online_kickedfromsession_header|세션 연결 끊김|
|$online_kickedfromsession_suspendresume_xbox_text|본체가 네트워크 활동이 정지되는 절전 모드로 전환되어 온라인 세션에서 추방되었습니다.|
|$piece_ancient_pot|고대의 항아리|
|$piece_ancientmetalbarstack|고대 금속 더미|
|$piece_ancientmetalbarstack_description|어디에 사용할 수 있을지 불분명합니다...|
|$piece_archerytarget|활쏘기 목표물|
|$piece_archerytarget_description|중앙을 노리십시오.|
|$piece_archerytarget_hits|명중|
|$piece_archerytarget_lastscores|명중|
|$piece_archerytarget_reset|화살 획득 및 초기화|
|$piece_archerytarget_total|총합|
|$piece_armorstand|갑옷 거치대|
|$piece_armorstand_cantattach|이 아이템은 거기에 맞지 않습니다|
|$piece_armorstand_description|어떤 옷은 접어서 보관하기에 너무 아까워요. 차라리 진열하는 건 어떨까요?|
|$piece_artisan_ext1|장인의 압축기|
|$piece_artisan_ext1_description|이 정교한 도구는 더욱 발전된 설계를 제작하기 위해 필요합니다.|
|$piece_artisanstation|장인의 작업대|
|$piece_artisanstation_description|기계를 만들거나 복잡한 설계를 제작하기 위해서는 장인의 작업대가 필수입니다.|
...
|$piece_ashwood_bed_description|더위와 추위로부터 모두 지켜주는 애스크스빈 가죽으로 정교하게 제작된 침대입니다. 편히 쉴 수 있습니다.|
|$piece_ashwood_decowall|잿가루목 장식 벽|
|$piece_ashwood_decowall_description|이 무늬는 몇 시간이고 지켜볼 수 있습니다...|
|$piece_ashwood_decowall_divider|잿가루목 칸막이|
|$piece_ashwood_decowall_divider_description|어떤 방에나 세련된 분위기를 더해줍니다.|
|$piece_ashwood_decowall_tree|잿가루목 장식 창문|
|$piece_ashwood_decowall_tree_description|창밖을 보는 건가요? 아니면 창인가요? 누구도 알 필요 없습니다.|
|$piece_ashwood_door|잿가루목 문|
|$piece_ashwood_door_description|지나가는 것도 잊고 멈춰 서서 자세히 살펴볼 정도로 섬세한 장식을 가지고 있습니다.|
|$piece_ashwood_floor_1x1|잿가루목 바닥 1x1|
|$piece_ashwood_floor_2x2|잿가루목 바닥 2x2|
|$piece_ashwood_floor_deco|잿가루목 장식 바닥|
|$piece_ashwood_floor_deco_description|바닥에 놓아도 잘 어울리는 무늬입니다.|
|$piece_ashwood_floor_description|사선으로 시공된 잿가루목 바닥재입니다.|
|$piece_ashwood_halfwall|잿가루목 반쪽 벽|
|$piece_ashwood_pole_1m|잿가루목 기둥 1 m|
|$piece_ashwood_pole_2m|잿가루목 기둥 2 m|
|$piece_ashwood_poles_description|이 지지대를 만질 때마다 온기가 느껴집니다.|
...
|$piece_ashwoodbeam67|잿가루목 들보 67°|
|$piece_ashwoodcross26|잿가루목 지붕 교차형, 26°|
|$piece_ashwoodcross45|잿가루목 지붕 교차형, 45°|
|$piece_ashwoodstair|잿가루목 계단|
|$piece_ashwoodstair_description|이 계단은 보이는 것보다 훨씬 견고합니다.|
|$piece_ashwoodwall_description|이 벽의 양쪽 면은 각자의 매력이 있습니다. 선택은 당신의 몫입니다!|
...
|$piece_ashwoodwallroof67|잿가루목 벽 67°|
|$piece_ashwoodwallroof67upsidedown|잿가루목 벽 67° (반전)|
|$piece_ashwoodwallrooftop67|잿가루목 지붕 교차형 67°|
|$piece_asksvinskeleton|애스크스빈 골격|
|$piece_asksvinskeleton_description|섬뜩함이냐, 장식이냐? 선택은 당신의 몫입니다.|
|$piece_banner01|검은 배너|
|$piece_banner01_description|헬의 깊이만큼이나 검은 배너입니다.|
|$piece_banner02|푸른 배너|
|$piece_banner02_description|미드가르드의 바다 같은 파란색 배너입니다.|
|$piece_banner03|홍백색 줄무늬 배너|
|$piece_banner03_description|항해를 떠난 배 같은 빨간색 줄무늬 배너입니다.|
|$piece_banner04|붉은 배너|
|$piece_banner04_description|오딘의 적들이 흘리는 피처럼 붉은 배너입니다.|
|$piece_banner05|녹색 배너|
|$piece_banner05_description|알프헤임의 무성한 숲 같은 초록색 배너입니다.|
|$piece_banner06|파란색, 빨간색, 흰색 배너|
|$piece_banner06_description|가끔 색상을 선택하지 못할 경우를 위한 빨간색과 파란색 줄무늬 배너입니다.|
|$piece_banner07|흰색과 파란색 줄무늬 배너|
|$piece_banner07_description|항해를 떠난 배 같은 파란색 줄무늬 배너입니다.|
|$piece_banner08|노란색 배너|
|$piece_banner08_description|바나헤임의 황금빛 들판 같은 노란색 배너입니다.|
|$piece_banner09|보라색 배너|
|$piece_banner09_description|기묘한 마법 같은 보라색 배너입니다.|
|$piece_banner10|주황색 배너|
|$piece_banner10_description|무스펠헤임의 불길 같은 주황색 배너입니다.|
|$piece_banner11|흰색 배너|
|$piece_banner11_description|니플헤임의 눈처럼 하얀 배너입니다.|
|$piece_barber|이발소|
|$piece_barber_description|최신 바이킹 유행을 따라갈 수 있습니다.|
|$piece_bathtub|온수 욕조|
|$piece_bathtub_description|존경스러운 바이킹이라면 목욕은 일주일에 한 번입니다!|
|$piece_bed|침대|
|$piece_bed_claim|소유하기|
|$piece_bed_currentspawn|현재 스폰 지점|
|$piece_bed_description|밤이 되면 잠잘 곳이 필요할 겁니다.|
|$piece_bed_setspawn|스폰 지점 설정|
|$piece_bed_sleep|잠자기|
|$piece_bed_unclaimed|소유되지 않은 침대|
|$piece_bed02|용상|
|$piece_bed02_description|모피를 덮은 이 침대는 확실한 숙면을 제공합니다.|
|$piece_beehive|벌집|
|$piece_beehive_area|벌들이 이 생물군계를 좋아하지 않습니다|
|$piece_beehive_check|벌 확인|
|$piece_beehive_description|벌은 행복해지면 맛있는 꿀을 생산할 것입니다.|
...
|$piece_bench_runed|조각된 벤치|
|$piece_bench_runed_description|소박하지만 편안하게 앉을 수 있습니다.|
|$piece_bench01|벤치|
|$piece_bench01_description|마음에 여유가 있다면 엉덩이에도 여유를 선물하세요.|
|$piece_benchlog|통나무 벤치|
|$piece_benchlog_description|그다지 멋진 물건은 아니지만, 바닥에 앉는 것보다는 낫습니다.|
|$piece_birdnest|새 둥지|
|$piece_birdnest_area|새들은 이곳을 좋아하지 않습니다|
|$piece_birdnest_check|새 둥지 확인|
|$piece_birdnest_description|건강하고 행복한 새들은 깃털을 몇 개 떨어뜨릴 수 있습니다.|
|$piece_birdnest_extract|깃털 줍기|
|$piece_birdnest_freespace|새들은 더 넓은 공간이 필요합니다|
|$piece_birdnest_happy|새들이 둥지에 머물고 있습니다|
|$piece_birdnest_sleep|새들이 잠들어 있습니다|
|$piece_blackforge|검은 대장간|
|$piece_blackforge_description|특정한 금속, 특히 다른 소재와 결합된 금속은 더욱 고도화된 대장간에서 작업해야 합니다.|
|$piece_blackforge_ext1|검은 대장간 냉각통|
|$piece_blackforge_ext1_description|새로운 작품에 손을 대려면 우선 열이 식을 때까지 기다리십시오.|
|$piece_blackforge_ext2|조임틀|
|$piece_blackforge_ext2_description|작업하는 동안 작품이 제자리에 고정되어 있으면 편리합니다.|
|$piece_blackforge_ext3|금속 절단기|
|$piece_blackforge_ext3_description|정밀하게 금속을 절단합니다. 날카로운 칼날에 주의하십시오!|
|$piece_blackforge_ext4|보석 연마기|
|$piece_blackforge_ext4_description|보석을 작업하기 위해서는 특정한 도구가 필요합니다.|
|$piece_blackforge_ext5|대장장이의 앞치마|
|$piece_blackforge_ext5_description|극한의 온도를 다룰 때, 가장 중요한 것은 작업장의 안전입니다.|
...
|$piece_blackmarble_bench_description|검은 대리석을 정교하게 조각한 벤치로, 위엄 있게 앉을 수 있습니다.|
...
|$piece_blackmarble_floor_description|검은 바닥은 얼룩을 방지합니다.|
...
|$piece_blackmarble_stair_description|위로 갈 수도, 아래로 갈 수도 있습니다. 정말 편리하군요!|
|$piece_blackmarble_table|검은 대리석 탁자|
|$piece_blackmarble_table_description|이 탁자에서 드워프처럼 식사하세요!|
|$piece_blackmarble_throne|검은 대리석 왕좌|
|$piece_blackmarble_throne_description|진정한 드베르그 스타일로 조각된 왕좌이지만, 인간이 편하게 앉을 수 있을 정도로 거대합니다.|
...
|$piece_blackmarbleblock_description|드워프 건축물에서 영감을 받은 검은 대리석 작품입니다. 창의력에는 한계가 없습니다.|
|$piece_blackmetalbarstack|흑철 더미|
|$piece_blackmetalbarstack_description|모든 풀링이 질투할 것입니다!|
|$piece_blackwoodbench01|잿가루목 벤치|
|$piece_blackwoodbench01_description|이 벤치에는 우아한 곡선이 있어 대화를 원활히 나눌 수 있게 도와줍니다.|
|$piece_blackwoodstack|잿가루목 더미|
|$piece_blackwoodstack_description|무슨 일이 있어도, 이 나무 더미에서는 온기가 느껴집니다.|
|$piece_BlackwoodStakewall|잿가루목 말뚝 벽|
|$piece_BlackwoodStakewall_description|확실하게 아픈 뾰족한 말뚝입니다.|
|$piece_blastfurnace|용광로|
|$piece_blastfurnace_description|일부 금속은 녹이기 위해 더 높은 온도가 필요합니다.|
|$piece_bloodgoldbarstack|혈금 더미|
|$piece_bloodgoldbarstack_description|이 금속에서는 다른 것들보다 더 불길한 느낌이 납니다, 안 그런가요?|
|$piece_bone_throne|뼈 왕좌|
|$piece_bone_throne_description|이 왕좌는 친구와 적 모두에게서 경외심을 불러일으킵니다.|
|$piece_bonestack|뼈 더미|
|$piece_bonestack_description|언제 쓸모가 있을지는 모르는 법입니다!|
|$piece_bonfire|화톳불|
|$piece_bonfire_description|평범한 모닥불로는 부족하다고 느껴질 때를 위한 물건입니다!|
|$piece_brazierceiling01|벽걸이형 화로|
|$piece_brazierceiling01_description|불꽃이 천장에 매달려 있다면 실수로 넘어뜨릴 일도 없습니다.|
|$piece_brazierfloor01|자립형 화로|
|$piece_brazierfloor01_description|세련되게 방 안을 밝힐 수 있습니다.|
|$piece_brazierfloor02|파란색 자립형 화로|
|$piece_brazierfloor02_description|이 불길이 놀라울 정도로 뜨겁게 혹은 차갑게 타오르는지 구분하기 어렵습니다.|
|$piece_bronzebarstack|청동 더미|
|$piece_bronzebarstack_description|아름답고, 다용도인데다... 포개놓을 수도 있습니다!|
|$piece_candle|수지 양초|
|$piece_candle_description|작지만 놀라울 정도로 편리한 광원입니다.|
|$piece_cartographytable|지도 제작 테이블|
|$piece_cartographytable_description|지도에 발견한 것들을 기록하고 친구와 공유하세요.|
...
|$piece_cauldron|가마솥|
|$piece_cauldron_description|재료를 조합하고 모든 바이킹에게 중요한 맛있는 식사를 직접 요리하십시오!|
|$piece_cauldron_ext1_spice|향신료 선반|
|$piece_cauldron_ext1_spice_description|다양하고 맛있는 식사를 준비하기 위해서는 다양한 재료가 필요합니다.|
|$piece_cauldron_ext3_butchertable|정육점 테이블|
|$piece_cauldron_ext3_butchertable_description|최고의 요리를 위해서는 최고의 부위가 필요합니다.|
|$piece_cauldron_ext4_pans|냄비와 프라이팬|
|$piece_cauldron_ext4_pans_description|가끔은 가마솥만으로는 부족할 때가 있습니다.|
|$piece_cauldron_ext5_mortarandpestle|절구와 절굿공이|
|$piece_cauldron_ext5_mortarandpestle_description|어떤 재료들은 요리에 사용하기 전에 고운 가루로 분쇄해야 합니다.|
|$piece_cauldron_ext6_rollingpins|밀대와 도마|
|$piece_cauldron_ext6_rollingpins_description|언제나 유용합니다. 특히 제빵에서 말입니다.|
|$piece_cauldron_ext7_smoker|훈연기|
|$piece_cauldron_ext7_smoker_description|훈연한 음식은 더 오래 보관할 수 있고 맛도 뛰어납니다!|
|$piece_celebrationgarland|꽃 장식 가랜드|
|$piece_celebrationgarland_description|하루를 밝게 만들어줄 꽃입니다!|
|$piece_chair|의자|
|$piece_chair_description|등을 대고 편히 휴식하세요.|
|$piece_chair_runed|조각된 의자|
|$piece_chair_runed_description|이 의자의 형태는 단순할 수 있지만, 장식은 그렇지 않습니다.|
|$piece_charcoalkiln|숯가마|
|$piece_charcoalkiln_description|모든 종류의 나무를 석탄으로 만드는 데 유용합니다.|
|$piece_charredballista|스쿠그|
|$piece_charredchest|잿불자 상자|
|$piece_chest|강화된 상자|
|$piece_chest_description|보관할 공간이 더욱 넓고 견고한 상자입니다.|
|$piece_chestbarrel|통|
|$piece_chestbarrel_description|음식과 음료를 포함하여 많은 것을 보관하기에 좋은 통입니다.|
|$piece_chestblackmetal|흑철 상자|
|$piece_chestblackmetal_description|견고한 흑철로 만들어진 상자로 거의 모든 것을 집어넣을 수 있습니다.|
|$piece_chestgrausten|묘석 상자|
|$piece_chestgrausten_description|돌과 금속은 물건을 안전하게 지켜줍니다. 그을린 두개골도 물론 도움이 됩니다.|
|$piece_chestprivate|개인 상자|
|$piece_chestprivate_description|어떤 것들은 자물쇠를 잠그고 혼자만 간직하고 싶은 법입니다.|
|$piece_chesttreasure|보물 상자|
|$piece_chesttreasure_description|금과 보석이 넘치는 보물 상자보다 자신의 부유함을 자랑하기에 더 좋은 방법이 있을까요?|
|$piece_chestwarderobe|옷장|
|$piece_chestwarderobe_description|보관을 위한 우아한 공간입니다.|
|$piece_chestwood|상자|
|$piece_chestwood_description|가지고 다닐 필요가 없는 아이템을 보관하기에 좋은 장소입니다.|
|$piece_clothdoor|붉은 황마 커튼|
|$piece_clothdoor_description|장식용으로 좋은 묵직한 붉은 황마 커튼입니다.|
|$piece_coalpile|석탄 더미|
|$piece_coalpile_description|연료는 아무리 많이 가지고 있어도 부족합니다.|
|$piece_container_empty|비어 있음|
|$piece_container_open|열기|
|$piece_cookingstation|요리 작업대|
|$piece_cookingstation_description|날고기를 굽기에 완벽합니다.|
|$piece_cookingstation_iron|철 요리 작업대|
|$piece_cookingstation_iron_description|튼튼하고 큰 생물의 고기를 조리하기에 넉넉하고 견고합니다.|
|$piece_copperbarstack|구리 더미|
|$piece_copperbarstack_description|최고급 품질의 구리입니다. 불평할 건 아무것도 없습니다!|
|$piece_craftingstation|제작 작업대|
|$piece_crate|궤짝|
|$piece_crate_long|드베르그 부속품 궤짝|
|$piece_crystalwall_description|아름답고 연약합니다.|
|$piece_crystalwall1x1|수정 벽 1x1|
|$piece_cstand_cook|아이템 요리|
|$piece_cultivate|경작|
|$piece_cultivate_description|토양에 작물을 심을 수 있게 준비합니다.|
...
|$piece_darkwoodchair_description|모피로 덧대어진 의자로, 존중받는 손님에게 적합합니다.|
|$piece_darkwooddecowall|조각된 다크우드 칸막이|
|$piece_darkwooddecowall_description|우아한 무늬로 집을 장식하고 호기심 어린 시선도 막아줍니다.|
|$piece_darkwoodgate|다크우드 대문|
|$piece_darkwoodgate_description|세련되고 견고한 문입니다. 단독으로 또는 한 쌍으로 사용할 수 있습니다.|
|$piece_darkwoodpole|다크우드 기둥 2m|
|$piece_darkwoodpole4|다크우드 기둥 4m|
|$piece_darkwoodpoles_description|이 지지대 구조물을 따라 섬세한 문양이 새겨져 있습니다.|
|$piece_darkwoodraven|까마귀 장식|
|$piece_darkwoodraven_description|까마귀는 최고신의 믿음직한 벗으로, 당연히 집에도 하나 두고 싶을 것입니다.|
|$piece_darkwoodroof26|지붕널 26°|
|$piece_darkwoodroof26_description|이 완만한 지붕은 확실하게 비를 막아주며, 보기에도 좋습니다.|
|$piece_darkwoodroof45|지붕널 45°|
|$piece_darkwoodroof45_description|이 가파른 지붕은 확실하게 비를 막아주며, 보기에도 좋습니다.|
|$piece_darkwoodroof67|지붕널 67°|
|$piece_darkwoodroof67_description|이 굉장히 가파른 지붕은 확실하게 비를 막아주며, 보기에도 좋습니다.|
|$piece_darkwoodrooficorner|지붕널 골짜기형 모서리 26°|
|$piece_darkwoodrooficorner45|지붕널 골짜기형 모서리 45°|
|$piece_darkwoodrooficorner67|지붕널 언덕형 내부 모서리 67°|
|$piece_darkwoodroofocorner|지붕널 언덕형 모서리 26°|
|$piece_darkwoodroofocorner45|지붕널 언덕형 모서리 45°|
|$piece_darkwoodroofocorner67|지붕널 언덕형 외부 모서리 67°|
|$piece_darkwoodrooftop|지붕널 용마루 26°|
|$piece_darkwoodrooftop45|지붕널 용마루 45°|
|$piece_darkwoodrooftop67|지붕널 용마루 67°|
|$piece_darkwoodwolf|늑대 장식|
|$piece_darkwoodwolf_description|늑대는 무리 동물이지만, 이 녀석은 혼자서도 행복해 보입니다.|
|$piece_deco_stave_wall|가공 골조목 벽|
|$piece_deco_stave_wall_description|이 벽은 추위를 막는 데는 큰 도움이 안 되겠지만, 보기에는 아름답습니다.|
|$piece_deposit_copper|구리 광맥|
|$piece_deposit_goldvein|석화된 감멜트롤|
...
|$piece_door_close|닫기|
|$piece_door_open|열기|
|$piece_drawbridge|도개교|
|$piece_drawbridge_description|다리이면서 문이라니 참으로 현명하군요!|
|$piece_drawbridge_dn|골조나무 도개교|
|$piece_drawbridge_log|투박한 도개교|
|$piece_drawbridge_log_description|협곡을 건너거나 적을 막아내기 좋습니다.|
|$piece_dv_gate|옛 드베르그 관문|
|$piece_dvergr_door|드베르그 문|
|$piece_dvergr_lantern|드베르그 벽 등불|
|$piece_dvergr_lantern_description|진정한 장인이 정교하게 제작한 등불입니다. 벽에 거는 방법은 어렵지 않아요!|
|$piece_dvergr_lantern_pole|드베르그 등불 기둥|
|$piece_dvergr_lantern_pole_description|기둥은 쉽게 만들 수 있지만, 등불은 진정한 대가만이 만들 수 있습니다.|
|$piece_dvergr_metal_wall|드베르그 금속 벽|
|$piece_dvergr_metal_wall_description|최근에는 드베르그 양식이 유행입니다.|
|$piece_dvergr_pole|드베르그 기둥|
|$piece_dvergr_sharpstakes|드베르그제 날카로운 말뚝|
|$piece_dvergr_sharpstakes_description|드베르그는 원치 않는 방문자를 막아내는 방법을 알고 있습니다.|
|$piece_dvergr_spiralstair|드베르그 나선형 왼쪽 계단|
|$piece_dvergr_spiralstair_description|계속해서 돌며 올라갑니다!|
|$piece_dvergr_spiralstair_right|드베르그 나선형 오른쪽 계단|
|$piece_dvergr_stake_wall|드베르그 말뚝 벽|
|$piece_dvergr_stake_wall_description|금속으로 보강되어 확실한 방어를 제공합니다.|
|$piece_dvergr_woodwall|드베르그 벽|
|$piece_dvergrchest|드베르그 보물 상자|
|$piece_eitrrefinery|에이트르 정제소|
|$piece_eitrrefinery_description|이 기계는 부드러운 조직을 마법 물질인 에이트르로 만듭니다. 하지만 그 과정은 굉장히 위험하니 뒤로 물러나십시오!|
|$piece_faderember|영원한 장작더미|
|$piece_faderember_description|그의 분노와 후회는 서로를 향해 전쟁을 벌이고 있으며, 두 감정의 투쟁은 마지막 순간까지 불타오를 것입니다.|
|$piece_faderember_full|불씨가 밝게 타오르고 있습니다|
|$piece_faderember_light|불씨가 번지고 있습니다|
|$piece_faderember_nospace|불씨가 숨통을 조여옵니다|
|$piece_faderember_ok|불씨가 번지고 있습니다|
|$piece_fairylightgarland|요정빛 조명|
|$piece_fairylightgarland_description|축제에 은은한 조명을 제공합니다.|
|$piece_fermenter|발효통|
|$piece_fermenter_add|아이템 추가|
|$piece_fermenter_description|벌꿀주 특유의 풍미를 구현하려면 시간을 두고 발효시켜야 합니다.|
|$piece_fermenter_exposed|너무 노출되어 있습니다|
|$piece_fermenter_fermenting|발효 중|
|$piece_fermenter_needroof|지붕이 필요합니다|
|$piece_fermenter_ready|완료|
|$piece_fermenter_tap|따르기|
|$piece_fire|불|
|$piece_fire_fuel|연료|
|$piece_firepit|모닥불|
|$piece_firepit_description|요리, 보온 또는 잠시 쉬어갈 때 유용합니다.|
|$piece_firepit_iron|화덕 용구|
|$piece_firepit_iron_description|지면에 곧바로 모닥불을 피우기 싫다면, 이게 바로 세련된 대안입니다.|
|$piece_flametal_beam|불금속 들보|
|$piece_flametal_pillar|불금속 기둥|
|$piece_flametal_pillar_description|순수하게 불타는 금속입니다.|
|$piece_flametalbarstack|불금속 더미|
|$piece_flametalbarstack_description|더미에서 말 그대로 열기가 뿜어져 나오고 있습니다...|
|$piece_flametalgate|불금속 대문|
|$piece_flametalgate_description|놀라운 방법으로 친구를 환대하거나 적을 쫓아낼 수 있습니다.|
|$piece_flintpile|부싯돌 더미|
|$piece_flintpile_description|발밑을 조심하십시오!|
|$piece_forge|대장간|
|$piece_forge_description|금속을 다루고 싶다면, 대장간이 필요합니다.|
|$piece_forge_ext1|단조용 풀무|
|$piece_forge_ext1_description|풀무를 누르면 더욱 많은 열을 생성하여, 대장장이 작업에 큰 도움이 됩니다.|
|$piece_forge_ext2|모루|
|$piece_forge_ext2_description|더 정교한 작업을 위해서는 여러 종류의 모루를 갖춰두는 것이 유용합니다.|
|$piece_forge_ext3|숫돌바퀴|
|$piece_forge_ext3_description|모든 검의 날을 세우기 위해서는 숫돌바퀴가 필요합니다.|
|$piece_forge_ext4|대장장이의 모루|
|$piece_forge_ext4_description|대형 아이템을 작업하기 위한 대형 모루입니다. 발등에 떨어지지 않도록 하십시오.|
|$piece_forge_ext5|단조용 냉각통|
|$piece_forge_ext5_description|제작이 완료되면 이 물통이 금속의 온도를 감당할 수 있는 수준으로 식혀줍니다.|
|$piece_forge_ext6|단조용 공구 선반|
|$piece_forge_ext6_description|작업을 하려면 굉장히 다양한 도구가 필요합니다. 보관을 위해 간편한 선반이 함께 제공됩니다.|
|$piece_frostfoundry|서리 주조소|
|$piece_frostfoundry_additem|주물 놓기|
|$piece_frostfoundry_description|이 주조소를 사용해서 주물을 제대로 된 아이템으로 연마할 수 있습니다.|
|$piece_frostfoundry_takeitem|아이템 가져가기|
|$piece_frostkiln|얼어붙은 가마|
|$piece_frostkiln_description|이 가마 안에서 기묘하고 서늘한 과정을 거쳐 더욱 강력한 연료를 생산합니다...|
...
|$piece_grausten_floor_description|이 얇은 바닥 타일은 보기보다 튼튼합니다.|
...
|$piece_grausten_stair_description|한 걸음씩 나아가기만 하면 됩니다.|
|$piece_grausten_stoneladder|묘석 가파른 계단|
|$piece_grausten_stoneladder_description|높은 층에 올라가기에 좋습니다.|
|$piece_grausten_wall_description|오래전에 사라진 문명에서 영감을 얻은 돌벽입니다.|
...
|$piece_graustenpile_description|묘석이 더미에 조심스럽게 놓여 있습니다.|
|$piece_groundtorch|자립형 철제 횃불|
|$piece_groundtorch_description|주변을 밝히는 견고한 철제 횃불입니다.|
|$piece_groundtorchblue|청염의 자립형 철제 횃불|
|$piece_groundtorchblue_description|으스스한 푸른빛을 내뿜는 견고한 철제 횃불입니다.|
|$piece_groundtorchdemister|위습 횃불|
|$piece_groundtorchdemister_description|위습을 한 곳에 묶어두면 그곳은 언제나 안개가 끼지 않습니다.|
|$piece_groundtorchgreen|녹염의 자립형 철제 횃불|
|$piece_groundtorchgreen_description|초록색 불길로 타오르는 견고한 철제 횃불입니다.|
|$piece_groundtorchwood|목재 횃불|
|$piece_groundtorchwood_description|땅에 꽂을 수 있는 횃불로, 손을 자유롭게 사용해야 할 때 좋습니다.|
...
|$piece_hanging_cloth_blue1_description|푸른 황마는 어떤 건물이든 공식적이고 중요하게 보이도록 만듭니다.|
|$piece_hanging_cloth_blue2|푸른 황마 커튼|
|$piece_harvest|수확|
|$piece_hearth|화로|
|$piece_hearth_description|모든 농가의 중심이 되는 부분입니다.|
|$piece_hexagonalgate|육각 대문|
|$piece_hexagonalgate_description|이 드워프제 문은 원치 않는 손님을 막아내기에 적합합니다.|
|$piece_hoodedlantern|덮개 쌓인 등불|
|$piece_hoodedlantern_description|한 방향만 비추면 빛이 더욱 강해집니다. 은밀한 도둑이나 흔적을 남기려는 이들에게 유용합니다.|
|$piece_horizontal|수평|
|$piece_icecube|얼음 블록|
|$piece_icecube_description|단단한 얼음 덩어리입니다.|
|$piece_incinerator|소각기|
|$piece_incinerator_conversion|토르가 당신에게 선물을 줍니다!|
|$piece_incinerator_description|줄이고, 재사용하고, 소각합니다.|
|$piece_incinerator_empty|토르는 당신에게 눈살을 찌푸립니다|
|$piece_incinerator_fail|이미 소각하고 있습니다|
|$piece_incinerator_success|아이템들을 소각했습니다!|
|$piece_ironbarstack|철 더미|
|$piece_ironbarstack_description|철이 있다면, 전부 다 가진 겁니다.|
|$piece_ironcage_description|정교하게 제작된 철제 창살로 흔들리지 않습니다!|
|$piece_ironfloor|케이지 바닥 2x2|
|$piece_ironfloorSmall|케이지 바닥 1x1|
|$piece_irongate|철제 대문|
|$piece_irongate_description|굉장히 중요한 문입니다.|
|$piece_ironwall|케이지 벽 2x2|
|$piece_ironwallSmall|케이지 벽 1x1|
|$piece_ironwoodbeam67|나무 쇠 들보 67°|
|$piece_itemstand|아이템 진열대|
|$piece_itemstand_attach|아이템 부착|
|$piece_itemstand_cantattach|이 아이템은 부착할 수 없습니다|
|$piece_itemstand_h_description|이 아이템 거치대로 수평 표면에 아이템을 놓을 수 있습니다.|
|$piece_itemstand_missingitem|필요한 아이템이 없습니다|
|$piece_itemstand_take|아이템 가져가기|
|$piece_itemstand_v_description|이 아이템 진열대로 수직 표면에 아이템을 거치할 수 있습니다.|
|$piece_jackoturnip|순무 잭오랜턴|
|$piece_jackoturnip_description|이 채소에 새겨진 얼굴은... 무섭나요? 아니면 친근한가요?|
|$piece_jotunchest|요툰의 상자|
|$piece_jotungate|모르크할라의 문|
|$piece_jute_carpet|붉은 황마 카펫|
|$piece_jute_carpet_description|이 굵은 직물은 냉기를 막기에 적합합니다.|
|$piece_juteblue_carpet|푸른 황마 카펫|
|$piece_juteblue_carpet_description|공기가 아무리 습하더라도 이 카펫은 축축해지지 않습니다.|
|$piece_lavalantern|용암 등불|
|$piece_lavalantern_description|보고 있으면... 최면에 걸릴 것만 같습니다...|
|$piece_levelground|평탄화|
|$piece_levelground_description|지형이 너무 거칠 때 평탄화할 수 있습니다.|
...
|$piece_magetable_description|정체를 알 수 없는 갈드르의 힘이 이 제단에 모입니다. 그 힘을 제어하는 것은 당신의 몫입니다...|
|$piece_magetable_ext|룬 테이블|
|$piece_magetable_ext_description|룬은 읽는 방법만 알고 있다면 마법을 끌어내기 위해 널리 사용되는 도구입니다.|
|$piece_magetable_ext2|꺼지지 않는 양초|
|$piece_magetable_ext2_description|이 양초는 기묘한 빛을 발산하며 더 강력한 마법이 주변에 모여들도록 만듭니다.|
|$piece_magetable_ext3|깃털 화관|
|$piece_magetable_ext3_description|세계 곳곳에 흩어져 있는 신비로운 힘에 바치는 공물입니다. 어쩌면 그들이 당신에게 힘을 빌려줄지도 모릅니다.|
|$piece_magetable_ext4|자립형 베틀|
|$piece_magetable_ext4_description|노른은 마법의 태피스트리 위에 운명의 실을 엮습니다. 당신은 무엇을 엮을 건가요?|
|$piece_maptable_hildir|힐디르의 지도 테이블|
|$piece_maptable_hildir_use|상자 위치 기록|
|$piece_marblepile|검은 대리석 더미|
|$piece_marblepile_description|드베르그 양식 건축에 완벽합니다.|
|$piece_maypole|메이폴|
|$piece_maypole_description|일 년 중 가장 긴 날에, 이 기념비가 태양을 향하길!|
|$piece_meadcauldron|벌꿀주 케틸|
|$piece_meadcauldron_description|이 구리 냄비는 벌꿀주를 섞기에 완벽한 온도를 유지합니다.|
|$piece_mistletoe|겨우살이|
|$piece_mistletoe_description|로맨틱한 기분이 드는 건 어쩔 수 없는 일입니다...|
|$piece_moose_throne|가지뿔 왕좌|
|$piece_moose_throne_description|소박하고 튼튼하지만, 이 왕좌는 가장 고귀한 왕족에게도 손색없이 잘 어울립니다.|
|$piece_morkborg_gate|모르크할라의 문|
|$piece_morkhallachestancient|고대의 상자|
|$piece_mudpile|흙투성이 쓰레기 더미|
|$piece_noaccess|접근 불가|
|$piece_obsidianpile|흑요석 더미|
|$piece_obsidianpile_description|밤처럼 새까만 더미입니다.|
|$piece_offerbowl_bonemass|끓어오르는 죽음|
|$piece_offerbowl_eikthyr|신비로운 제단|
|$piece_offerbowl_fader|에메랄드 화염의 제단|
|$piece_offerbowl_frozenking|이상한 그릇|
|$piece_offerbowl_hive|군락 권좌|
|$piece_offerbowl_makeoffer|제안하기|
|$piece_offerbowl_memorial|고대 제단|
|$piece_offerbowl_offeritem|아이템 제안|
|$piece_offerbowl_offeritem_fader|종을 울립니다|
|$piece_offerbowl_offeritem_memorial|제단 밝히기|
|$piece_offerbowl_yagluth|신비로운 제단|
|$piece_oven|석재 오븐|
|$piece_oven_additem|아이템 굽기|
|$piece_oven_description|제빵에 필요한 모든 것입니다.|
|$piece_path|길 닦기|
|$piece_path_description|앞으로 나갈 최선의 길을 표시합니다.|
|$piece_pavedroad|포장도로|
|$piece_pavedroad_description|확실한 문명의 상징입니다.|
...
|$piece_portal|포탈|
|$piece_portal_censored_warning|검열된 단어가 발견되었습니다. 크로스플레이에 문제가 발생할 수 있습니다.|
...
|$piece_pot_large_green_description|거대한 크기의 항아리입니다! 바이킹 전체를 넣을 수도 있습니다.|
|$piece_pot_large_red|대형 붉은색 항아리|
|$piece_pot_medium_cracked|중형 흙 항아리|
|$piece_pot_medium_green|중형 녹색 항아리|
|$piece_pot_medium_green_description|내부에 물건 한두 개를 넣을 수 있는 도자기입니다.|
|$piece_pot_medium_red|중형 붉은색 항아리|
|$piece_pot_small_cracked|소형 흙 항아리|
|$piece_pot_small_green|소형 녹색 항아리|
|$piece_pot_small_green_description|안에 무언가를 넣을 수 있는 공간이 있는 작은 도기입니다.|
|$piece_pot_small_red|소형 붉은색 항아리|
|$piece_preptable|음식 준비 테이블|
|$piece_preptable_description|모든 재료를 곧바로 가마솥에 넣을 수는 없으니, 작업할 수 있는 훌륭한 공간이 필요합니다!|
|$piece_pulllever|레버 당기기|
|$piece_queendoor|드베르그 금고|
|$piece_raise|지면 높이기|
|$piece_raise_description|구멍을 메우고 높은 발판을 만듭니다.|
|$piece_readmap|지도 읽기|
|$piece_register_location|위치 등록|
|$piece_repair|수리|
|$piece_replant|잔디|
|$piece_replant_description|땅을 기존의 식생으로 되돌립니다.|
|$piece_rock_01|관상용 암석|
|$piece_rock_01_description|어떤 정원에도 소박한 느낌을 더해 줍니다.|
|$piece_rock_02|장식용 암석|
|$piece_rock_02_description|멋진 암석입니다.|
|$piece_rug_asksvin|애스크스빈 가죽 러그|
|$piece_rug_asksvin_description|애스크스빈 가죽은 울퉁불퉁해서 한 조각으로는 유용한 물건을 만들기 어렵습니다. 가죽을 더 모아야 합니다.|
|$piece_rug_bjorn|곰 가죽 러그|
|$piece_rug_bjorn_description|모피는 부드럽지만, 이빨은 여전히 날카롭습니다.|
|$piece_rug_deer|사슴 가죽 러그|
|$piece_rug_deer_description|나무 가시로부터 발을 지키세요.|
|$piece_rug_hare|토끼 가죽 러그|
|$piece_rug_hare_description|질감은 이상하지만, 굉장히 흥미로운 장식품입니다.|
|$piece_rug_lox|록스 가죽 러그|
|$piece_rug_lox_description|놀라울 정도로 푹신합니다!|
|$piece_rug_moose|무스 가죽 카펫|
|$piece_rug_moose_description|이 카펫은 넓고 부드러운 면을 위해 섬세하게 꿰맸습니다.|
|$piece_rug_seal|물개 가죽 러그|
|$piece_rug_seal_description|이 러그는 무해한 만큼 부드럽습니다.|
|$piece_rug_straw|짚단|
|$piece_rug_straw_description|가축의 사랑을 받을 수 있습니다.|
|$piece_rug_wolf|늑대 가죽 러그|
|$piece_rug_wolf_description|따뜻하고 아늑합니다. 특히 산이라면 말입니다.|
|$piece_rune_read|읽기|
...
|$piece_sapling_barley_description|든든한 곡물로, 빻아서 가루로 만들 수 있습니다.|
|$piece_sapling_carrot|당근|
|$piece_sapling_carrot_description|그대로 먹을 수도, 더 고급 요리에 사용할 수도 있습니다.|
|$piece_sapling_flax|아마 섬유|
|$piece_sapling_flax_description|섬유가 들어 있어 실을 뽑을 수 있는 아름다운 꽃입니다.|
|$piece_sapling_jotunpuffs|요툰 거품 원균|
|$piece_sapling_kale|케일|
|$piece_sapling_kale_description|튼튼하고 영양가 높은 식물입니다.|
|$piece_sapling_magecap|마법사갓 원균|
|$piece_sapling_oat|귀리 줄기|
|$piece_sapling_oat_description|심으면 귀리가 자랍니다.|
|$piece_sapling_onion|양파|
|$piece_sapling_onion_description|많은 요리 레시피에 사용됩니다.|
|$piece_sapling_poteitr|포테이트르|
|$piece_sapling_poteitr_description|잠재력 있는 이계의 감자입니다.|
|$piece_sapling_seedcarrot|당근 씨앗|
|$piece_sapling_seedcarrot_description|당근을 심어서 더 많은 씨앗을 얻으세요.|
|$piece_sapling_seedkale|케일 씨앗|
|$piece_sapling_seedkale_description|더 많은 씨앗을 얻으려면 케일 씨앗을 심으세요.|
...
|$piece_sapling_turnip_description|요리할 수 있는 든든한 채소입니다.|
...
|$piece_scale_26|껍질목 왼쪽 지붕벽 26°|
|$piece_scale_26_flipped|껍질목 오른쪽 벽 26°|
|$piece_scale_26_upsidedown|껍질목 오른쪽 벽 26° (반전)|
|$piece_scale_26_upsidedown_flipped|껍질목 왼쪽 벽 26° (반전)|
|$piece_scale_45|껍질목 왼쪽 벽 45°|
|$piece_scale_45_flipped|껍질목 오른쪽 벽 45°|
|$piece_scale_45_upsidedown|껍질목 오른쪽 벽 45° (반전)|
|$piece_scale_45_upsidedown_flipped|껍질목 왼쪽 벽 45° (반전)|
|$piece_scale_67|껍질목 왼쪽 벽 67°|
|$piece_scale_67_flipped|껍질목 오른쪽 벽 67°|
|$piece_scale_67_upsidedown|껍질목 오른쪽 벽 67° (반전)|
|$piece_scale_67_upsidedown_flipped|껍질목 왼쪽 벽 67° (반전)|
|$piece_scale_halfwall|껍질목 반쪽 벽|
|$piece_scale_quarterwall|껍질목 사분면 벽|
|$piece_scale_wall|껍질목 벽|
|$piece_scale_walls_description|겹쳐진 목재 구조의 벽은 비바람으로부터 탁월한 보호를 제공합니다.|
|$piece_sconce|촛대|
|$piece_sconce_description|벽에 걸 수 있는데 횃불을 땅에 꽂을 이유가 있을까요?|
|$piece_secretdoor|숨겨진 문|
|$piece_sharpstakes|날카로운 말뚝|
|$piece_sharpstakes_description|너무 가까이 접근하면 찔릴 겁니다.|
...
|$piece_sign|표지판|
|$piece_sign_description|생존주의자에게 최악의 적은 무질서입니다. 표지판을 붙여 무질서로부터 자신을 보호하세요.|
|$piece_sign_input|내용 입력|
|$piece_silverbarstack|은 더미|
|$piece_silverbarstack_description|부를 과시할 수 있는 깔끔한 방법입니다.|
|$piece_skullpile|해골 더미|
|$piece_skullpile_description|당신의 전투 기량을 확실히 증명하는 물건입니다.|
|$piece_smelter|제련소|
|$piece_smelter_add|추가|
|$piece_smelter_additem|아이템 추가|
|$piece_smelter_description|연료와 광석을 넣으면 아름다운 주괴가 나옵니다.|
|$piece_smelter_empty|비어 있음|
|$piece_smelter_ready|처리됨|
|$piece_smelter_reqroof|지붕이 필요합니다|
|$piece_snowlantern|눈 등불|
|$piece_snowlantern_description|겨울철 풍경에 아늑한 분위기를 더해줍니다.|
|$piece_spinningwheel|물레|
|$piece_spinningwheel_description|이 자동화 기계는 섬유를 실로 만드는 과정을 놀라울 정도로 빠르게 처리합니다.|
|$piece_stakewall|목책 담장|
|$piece_stakewall_description|침입자를 막아내기에 좋습니다.|
|$piece_stave_deco_beam_2m|골조목 장식 들보 2m|
|$piece_stave_deco_beams_description|이 지지대는 우아하고 장식적인 분위기를 더해줍니다.|
|$piece_stave_deco_pole_2m|골조목 장식 기둥 2m|
|$piece_stave_pole_2m|골조목 기둥 2m|
|$piece_stave_pole_4m|골조목 기둥 4m|
|$piece_stave_wall|골조목 벽|
|$piece_stave_walls_description|두꺼운 목재 벽은 추위를 막기에 좋습니다.|
|$piece_stavebeam2|골조목 들보 2m|
|$piece_stavebeam26|골조목 들보 26°|
|$piece_stavebeam4|골조목 들보 4m|
|$piece_stavebeam45|골조목 들보 45°|
|$piece_stavebeam67|골조목 들보 67°|
|$piece_stavebeams_description|두꺼운 목재 토막이 구조물을 확실하게 지지합니다.|
|$piece_stavecross26|골조목 지붕 교차형 26°|
|$piece_stavecross45|골조목 지붕 교차형 45°|
|$piece_stavedecobeam26|골조목 장식 들보 26°|
|$piece_stavedecobeam45|골조목 장식 들보 45°|
|$piece_stavedecobeam67|골조목 장식 들보 67°|
|$piece_stavegate|골조나무 대문|
|$piece_stavegate_description|발할라의 문처럼 장엄하진 않지만, 그에 못지않게 훌륭합니다!|
|$piece_stavewallrooftop67|골조목 지붕 교차형 67°|
|$piece_stonearch|돌 아치|
|$piece_stonearch_description|바위처럼 안정적입니다.|
|$piece_stonecutter|돌 절단기|
|$piece_stonecutter_description|석재로 건설하고 싶다면, 소재를 가공할 수 있는 돌 절단기가 필요합니다.|
|$piece_stonefence|돌 울타리|
|$piece_stonefence_description|돌을 조심스럽게 쌓아 견고한 울타리를 만들었습니다.|
|$piece_stonefloor_description|러그를 까는 것이 좋습니다. 아니면 차가울 테니까요!|
|$piece_stonefloor2x2|돌 바닥 2x2|
|$piece_stonefloor4x4|돌 바닥 4x4|
|$piece_stonepile|돌 무더기|
|$piece_stonepile_description|거대한 돌무더기입니다.|
|$piece_stonepillar|돌 기둥|
|$piece_stonestair|돌 계단|
|$piece_stonestair_description|거대한 요새를 돌아다니는 데 유용합니다.|
|$piece_stonethrone|석재 왕좌|
|$piece_stonethrone_description|훌륭한 지도자는 바위처럼 단단해야 하지만, 언제 모피처럼 너그러워져야 하는지도 알아야 합니다...|
|$piece_stonewall1x1|돌 벽 1x1|
|$piece_stonewall2x1|돌 벽 2x1|
|$piece_stonewall4x2|돌 벽 4x2|
|$piece_stonewalls_description|거칠게 다듬은 돌덩이입니다.|
|$piece_stool|스툴|
|$piece_stool_description|앉을 수 있습니다.|
|$piece_table|탁자|
|$piece_table_description|작지만 견고한 탁자입니다.|
|$piece_table_oak|길고 무거운 테이블|
|$piece_table_oak_description|이 탁자는 다양한 요리를 올릴 공간이 있어 대규모 잔치에 완벽합니다!|
|$piece_table_round|원형 탁자|
|$piece_table_round_description|원형 탁자에서는 모든 자리가 평등합니다.|
|$piece_table_runed|조각된 긴 탁자|
|$piece_table_runed_description|이 탁자에 새겨진 이야기는 긴 잔치에서도 읽기 좋습니다.|
|$piece_table_runed_small|조각된 사각 탁자|
|$piece_table_runed_small_description|더욱 은밀한 모임을 위한 탁자입니다.|
|$piece_tarpile|타르 배럴|
|$piece_throne01|까마귀 왕좌|
|$piece_throne01_description|아마도 발할라에 있는 오딘의 왕좌가 이렇게 생겼을지도 모릅니다... 어느 쪽이든 편안한 의자입니다!|
|$piece_tinbarstack|주석 더미|
|$piece_tinbarstack_description|이게 있다면 많은 청동을 만들 수 있습니다...|
|$piece_tombstone|이곳에 잠들다 :|
|$piece_tombstone_container|무덤|
|$piece_tombstone_recovered|아이템 회수됨|
|$piece_toofar|너무 멉니다|
|$piece_trainingdummy|전투 형제|
|$piece_trainingdummy_description|위험을 감수하고 가까이 접근하십시오!|
|$piece_trap|함정|
|$piece_trap_arm|함정 장전|
|$piece_trap_armed|장전됨|
|$piece_trap_cooldown|트롤 함정 준비되지 않음|
|$piece_trap_description|이 함정은 누구든 발을 디디면 꽉 물어버립니다! 조심하십시오!|
|$piece_treasure_pile|동전 더미|
|$piece_treasure_pile_description|은은하게 반짝이는 작은 보물입니다.|
|$piece_treasure_stack|동전 무더기|
|$piece_treasure_stack_description|동전을 잘 세는 것이 중요합니다.|
|$piece_turret|발리스타|
...
|$piece_upgrade|강화|
|$piece_upgradestation|잠재력의 대장간|
|$piece_use|사용|
|$piece_useitem|아이템 사용|
|$piece_vegvisir|베그비실|
|$piece_vertical|수직|
|$piece_windmill|풍차|
|$piece_windmill_description|곡물을 가루로 만듭니다. 바람 부는 날에 제일 잘 작동합니다!|
|$piece_wisplure|위습 샘|
...
|$piece_woodbeam67|나무 들보 67°|
|$piece_woodcorestack|원목 더미|
|$piece_woodcorestack_description|숲에서 바로 벌목해 가져온 거대한 통나무 더미입니다.|
|$piece_wooddoor|나무 문|
|$piece_wooddoor_description|열고 닫을 수 있는 단순한 문입니다.|
|$piece_wooddragon|목제 용 장식|
|$piece_wooddragon_description|드래곤으로 장식해 집을 전설적인 공간으로 만드십시오.|
|$piece_woodfence|둥근 막대 울타리|
|$piece_woodfence_description|가축과 작물 모두를 위한 훌륭한 울타리입니다!|
|$piece_woodfencegate|둥근 막대 대문|
|$piece_woodfencegate_description|매번 울타리를 뛰어넘는 것보다 대문을 사용하는 것이 더 실용적입니다.|
|$piece_woodfinestack|질 좋은 나무 더미|
|$piece_woodfinestack_description|가구가 되기를 기다리고 있는 나뭇더미입니다.|
|$piece_woodfloor_description|단단한 나무 바닥재입니다.|
|$piece_woodfloor1x1|나무 바닥 1x1|
|$piece_woodfloor2x2|나무 바닥 2x2|
|$piece_woodfroststack|골조나무 더미|
|$piece_woodfroststack_description|마치 방금 눈이 내린 것 같습니다...|
|$piece_woodgate|나무 대문|
|$piece_woodgate_description|단순한 나무 문입니다. 단독으로 또는 한 쌍으로 사용할 수 있습니다.|
|$piece_woodironbeam|나무 쇠 들보|
|$piece_woodironbeam_26|나무 쇠 들보 26°|
|$piece_woodironbeam_45|나무 쇠 들보 45°|
|$piece_woodironpole|나무 쇠 기둥|
|$piece_woodironpoles_description|지금까지 만든 것 중 가장 튼튼한 지지대입니다.|
|$piece_woodledge|나무 선반|
|$piece_woodlog26|통나무 들보 26°|
|$piece_woodlog45|통나무 들보 45°|
|$piece_woodlog67|통나무 들보 67°|
|$piece_woodlogs_description|구조물을 소박한 스타일로 지지하세요.|
|$piece_woodpole|나무 기둥 1m|
|$piece_woodpole2|나무 기둥 2m|
|$piece_woodpoles_description|견고한 나무 지지대입니다.|
|$piece_woodroof26|초가지붕 26°|
|$piece_woodroof26_description|비를 막기 위해 완만한 각도로 제작된 단순한 지붕입니다.|
|$piece_woodroof45|초가지붕 45°|
|$piece_woodroof45_description|비를 막기 위해 가파른 각도로 제작된 단순한 지붕입니다.|
|$piece_woodroof67|초가지붕 67°|
|$piece_woodroof67_description|비를 막기 위해 굉장히 가파른 각도로 제작된 단순한 지붕입니다.|
|$piece_woodrooficorner|초가지붕 골짜기형 모서리 26°|
|$piece_woodrooficorner45|초가지붕 골짜기형 모서리 45°|
|$piece_woodrooficorner67|초가지붕 내부 모서리 67°|
|$piece_woodroofocorner|초가지붕 언덕형 모서리 26°|
|$piece_woodroofocorner45|초가지붕 언덕형 모서리 45°|
|$piece_woodroofocorner67|초가지붕 외부 모서리 67°|
|$piece_woodrooftop|초가지붕 용마루 26°|
|$piece_woodrooftop45|초가지붕 용마루 45°|
|$piece_woodrooftop67|초가지붕 용마루 67°|
|$piece_woodstack|나무 더미|
|$piece_woodstack_description|열심히 노력했음을 모두에게 보여주십시오!|
|$piece_woodstair|나무 계단|
|$piece_woodstair_description|지면에서 올라갈 때 유용합니다.|
|$piece_woodstepladder|나무 사다리|
|$piece_woodstepladder_description|높은 곳에 편리하게 올라갈 수 있습니다.|
|$piece_woodwall|나무 벽|
|$piece_woodwall_description|벽은 모든 집에 있어 중요한 부분입니다!|
...
|$piece_woodwallroof67|나무 벽 67°|
|$piece_woodwallroof67upsidedown|나무 벽 67° (반전)|
|$piece_woodwallrooftop|나무 지붕 교차형 26°|
|$piece_woodwallrooftop45|나무 지붕 교차형 45°|
|$piece_woodwallrooftop67|나무 지붕 교차형 67°|
|$piece_woodwindowshutter|나무 덧문|
|$piece_woodwindowshutter_description|열어두든 닫아두든 원하는 대로 두세요. 언제든지 바꿀 수 있습니다!|
|$piece_workbench|작업대|
|$piece_workbench_description|모든 집에는 작업대가 필수입니다. 나무 구조물을 건설하거나 새로운 도구를 제작하기 위해 필요합니다.|
|$piece_workbench_ext1|절단대|
|$piece_workbench_ext1_description|도끼는 제작에 있어 굉장히 다재다능한 도구입니다.|
|$piece_workbench_ext2|무두질 받침대|
|$piece_workbench_ext2_description|가죽과 생가죽은 사용하기 전에 적절한 처리가 필요합니다.|
|$piece_workbench_ext3|곡자귀|
|$piece_workbench_ext3_description|가끔은 다양한 각도로 문제를 해결할 필요가 있습니다.|
|$piece_workbench_ext4|도구 선반|
|$piece_workbench_ext4_description|섬세한 일에는 그에 어울리는 섬세한 도구가 필요합니다.|
|$piece_writemap|발견 기록|
|$piece_yggdrasilstack|이그드라실 나무 더미|
|$piece_yggdrasilstack_description|수수께끼의 에너지로 진동하는 가느다란 가지입니다.|
|$piece_yulecrown|율 화관|
|$piece_yulecrown_description|화환보다 더 축제에 어울리는 물건을 생각하기는 어렵습니다!|
|$piece_yulegarland|율 화환|
|$piece_yulegarland_description|홀을 꾸밀 수 있습니다!|
|$piece_yuleklapp|율레클랍|
|$piece_yuleklapp_description1|좋아하는 누군가를 위한 작은 선물입니다.|
|$piece_yuleklapp_description2|올해 착한 일을 한 누군가를 위한 선물입니다.|
|$piece_yuleklapp_description3|많이 고마운 누군가를 위한 큰 선물입니다.|
|$piece_yuletree|율 나무|
|$piece_yuletree_description|이 전나무에는 축제용 장식 조명이 붙어 있습니다.|
|$placeofmystery|수수께끼의 지점|
|$playfab_couldnotloadplayfabparty_header|PlayFab 로딩 실패|
|$playfab_couldnotloadplayfabparty_text_linux|이는 크로스 플레이를 사용하는 데 필요합니다. 다음 주소에 명시되어 있는 리눅스에서 PlayFab 파티를 플레이하는 데에 필요한 파일들이 설치되어 있는지 확인해 주세요:https://learn.microsoft.com/en-us/gaming/playfab/features/multiplayer/networking/linux-specific-requirements|
|$playfab_couldnotloadplayfabparty_text_linux_steamdeck|이는 크로스 플레이를 사용하는 데 필요합니다. 버그 픽스가 제공될 때까지 스팀덱의 Proton 호환 레이어를 사용하여 크로스 플레이 기능을 사용할 수 있습니다.|
|$playfab_couldnotloadplayfabparty_text_otherplatforms|이는 크로스 플레이를 사용하는 데 필요합니다. 이 오류가 지속된다면 버그 리포트를 작성해 주세요.|
|$playfab_couldnotloadplayfabparty_text_windows|이는 크로스 플레이를 사용하는 데 필요합니다. 일반적으로 최신 Visual C++ 재배포 가능 패키지가 설치되어 있지 않기 때문일 수 있습니다. 이곳에서 다운로드할 수 있습니다: https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist|
|$playstation_activity_name|열 번째 세계 탐험|
|$playstation_trophy_set_online_only|멀티플레이 전용 트로피|
|$prop_ancienttree|고대의 나무|
|$prop_ancienttreeroot|고대의 뿌리|
|$prop_ashlandstree|그을린 나무|
|$prop_beech|너도밤나무|
|$prop_beech_sapling|너도밤나무 묘목|
|$prop_beech_sapling_description|너도밤나무는 훌륭한 목재가 되어 줍니다.|
|$prop_birch|자작나무|
|$prop_birch_sapling|자작나무 묘목|
|$prop_birch_sapling_description|훌륭한 목재를 제공합니다.|
|$prop_dragonsummoningbowl_name|희생의 제단|
|$prop_eggcup|제물 그릇|
|$prop_eldersummoningbowl_name|고대의 그릇|
|$prop_eldersummoningbowl_use|아이템 태우기|
|$prop_fir|전나무|
|$prop_fir_big_sapling|골조나무 묘목|
|$prop_fir_big_sapling_description|북부 지역에서 자생하지만, 이 나무는 대부분의 기후에서 자랄 수 있습니다.|
|$prop_fir_sapling|전나무 묘목|
|$prop_fir_sapling_description|일 년 내내 아름다운 나무입니다.|
|$prop_oak|참나무|
|$prop_oak_sapling|참나무 묘목|
|$prop_oak_sapling_description|시간이 지나면 거대한 참나무로 성장할 것입니다.|
|$prop_offerbowl_makeoffer|제물 바치기|
|$prop_pine|소나무|
|$prop_pine_sapling|소나무 묘목|
|$prop_pine_sapling_description|이 긴 나무는 베어서 심재로 만들 수 있습니다.|
|$prop_pine_snow|골조나무|
|$prop_timberwoodtree|골조나무|
|$prop_treelog|통나무|
|$prop_treestump|그루터기|
|$prop_yggashoot|이그드라실 묘목|
|$ps_codeofconduct_platform_specific_text|귀하는 PlayStation™Network 운영 지침 또한 준수해야 하며, 이는 당사의 규정 외에 별도로 적용됩니다.|
|$ps_codeofconduct_reporting_violations_body|허용되지 않는 행위를 목격한 경우:<br/>• 게임 내: 자체 "플레이어 신고" 기능을 활용해 주세요. (옵션 -> 플레이어 목록 -> 신고)<br/>• 게임 외부: 온라인 양식(https://valheim.com/report-a-player)을 사용해 주세요<br/>• PlayStation™Network: https://www.playstation.com/en-us/support/account/ps5-report-behaviour/ 웹페이지를 참조하세요|
|$ps_crossplay_user_id_with_name|크로스플레이 유저 ID: $1|
|$ps_error_crossplayprivilege|게임플레이 설정에서 'PlayStation™Network 한정' 설정이 활성화된 상태이므로 다른 플랫폼과의 크로스플레이를 허용하는 서버에서 플레이할 수 없습니다.|
|$ps_eula_important_first_text|(Valheim – PlayStation®5 Edition)<br/>중요: VALHEIM.COM/EULA에서 최종 사용자 라이선스 협정을 주의 깊게 읽어 주시길 바랍니다. 본인이 소유하거나 통제하는 PLAYSTATION®5 콘솔에서 “VALHEIM”(이하 “제품”)을 다운로드, 설치 또는 사용함으로써 귀하는 본 최종 사용자 라이선스 협정(이하 “EULA”)의 모든 약관에 동의하게 됩니다. 이에 동의하지 않으실 경우, 제품을 사용하지 마십시오.|
|$ps_loading_savenotification|이 게임은 자동 저장 기능이 있습니다. 자동 저장 아이콘이 표시될 때 게임을 종료하거나 콘솔의 전원을 끄지 마십시오.|
|$ps_loadscreen_tip24|오른쪽 방향키를 사용해 지도 핀을 유형별로 필터링할 수 있습니다|
|$ps_menu_cloudstoragefull|콘솔 스토리지가 가득 찼습니다!|
|$ps_menu_codeofconduct_button|운영 지침|
|$ps_menu_crossplayserver|크로스플레이|
|$ps_menu_invite_friends|친구 초대|
|$ps_menu_localstoragefullcharacterprompt|저장 공간이 부족하여 캐릭터를 생성하지 못했습니다.|
|$ps_menu_localstoragefullworldprompt|저장 공간이 부족하여 월드를 생성하지 못했습니다.|
|$ps_menu_storagefull|콘솔 스토리지가 가득 찼습니다!|
|$ps_menu_storagefulloperationfailed|저장 데이터 공간이 가득 차 이 작업을 완료할 수 없습니다. 사용하지 않는 저장 데이터를 삭제한 후 다시 시도해 주세요.|
|$ps_menu_storageused|사용 중인 콘솔 스토리지: $1|
|$ps_online_id_with_name|온라인 ID: $1|
|$ps_online_kickedfromsession_suspendresume_text|PlayStation®5 콘솔이 네트워크 활동이 정지되는 대기 모드로 전환되어 온라인 세션에서 추방되었습니다.|
|$ps_online_kickedfromsession_text|온라인 세션에서 추방되었습니다. PlayStation™Network에 로그인 후 PlayStation®Plus 정기 서비스를 구독해 주시길 바랍니다.|
|$ps_report_user_banned_account|귀하의 계정은 EULA 및 운영 지침에 명시된 서비스 약관을 위반하여 온라인에서 차단되었습니다. 본 조처는 Coffee Stain Publishing에 의해 이루어졌습니다. 자세한 정보는 왼쪽 아래의 EULA를 참조하십시오.|
|$ps_settings_3d_audio|3D 오디오|
|$ps_settings_controller|컨트롤러|
|$ps_settings_controller_layout|컨트롤러 레이아웃|
|$ps_settings_controller_motion_sensor|모션 센서|
|$ps_settings_controller_motion_sensor_settings_off|모션 센서가 꺼졌습니다! 설정을 확인하세요.|
|$ps_settings_controller_motion_sensor_toggled_off|모션 센서 끄기|
|$ps_settings_controller_motion_sensor_toggled_on|모션 센서 켜기|
|$ps_settings_controller_motion_sensor_x_axis_sensitivity|모션 센서 X축 감도|
|$ps_settings_controller_motion_sensor_y_axis_sensitivity|모션 센서 Y축 감도|
|$ps_settings_controller_sensitivity|컨트롤러 감도|
|$ps_settings_controller_speaker_volume|컨트롤러 스피커 볼륨|
|$ps_settings_controller_use_adaptive_triggers|적응형 트리거 사용|
|$ps_settings_controller_use_controller_speaker|컨트롤러 스피커 사용|
|$ps_settings_controller_use_vibration|진동 사용|
|$ps_settings_controller_vibration_strength|진동 세기|
|$ps_settings_double_tap_descr|특정 요소 방향으로 스틱을 빠르게 탭하면 상호작용합니다.|
|$ps_settings_flick_interact_descr|특정 요소 방향으로 스틱을 빠르게 움직이면 상호작용합니다.|
|$ps_settings_gamepadenabled|컨트롤러 활성화|
|$ps_settings_persistentbackbtn|뒤로가기 버튼 유지|
|$ps_settings_persistentbackbtn_descr|방사형 메뉴에서 여러 페이지를 열람할 때 화면 상단 요소를 항상 '뒤로' 버튼으로 설정합니다.|
|$ps_settings_same_online_platform_only|PlayStation™Network 한정|
|$ps_settings_same_online_platform_only_desc|PlayStation™Network 플레이어하고만 플레이합니다. 크로스플랫폼 유저와의 모든 상호작용이 제한됩니다. 주 메뉴에서 전환할 수 있습니다.|
|$ps_settings_show_button_hints|힌트 버튼 표시|
|$ps_settings_swap_triggers|R2 버튼과 L2 버튼을 서로 바꾸기|
|$ps_ugc_character_name|UGC 캐릭터 이름|
|$ps_ugc_server_name|UGC 서버 이름|
|$ps_ugc_text|UGC 텍스트|
|$ps_ugc_world_name|UGC 월드 이름|
|$radial_all|전체|
|$radial_armor_utility|방어구 및 다용도 아이템|
|$radial_back|뒤로|
|$radial_close|닫기|
|$radial_consumables|소모품|
|$radial_drop|내려놓기|
|$radial_drop_multiple|여러 개 내려놓기|
|$radial_emotes|감정표현|
|$radial_half|절반|
|$radial_hammer|망치 장비|
|$radial_handitems|손 아이템|
|$radial_hold|(길게 누르기)|
|$radial_hotbar|핫바|
|$radial_interact|사용/열기|
|$radial_speed_fast|빠름|
|$radial_speed_medium|보통|
|$radial_speed_off|끄기|
|$radial_speed_slow|느림|
|$radial_weapons_tools|무기 및 도구|
|$raven_interact|대화하기|
|$report_server_window_explanation_text|만약 이 서버에 운영 지침을 위반하는 사용자 생성 콘텐츠(UGC)가 있다면, 신고될 수 있습니다. 수동으로 UGC를 게임 내에서 제거하는 것을 권장하지만, 그것이 불가능하다면 서버를 신고하는 것도 대안이 될 수 있습니다.|
|$report_server_window_header|서버 신고|
|$report_user_already_reported_header|이미 신고함|
|$report_user_already_reported_text|이미 해당 사용자를 신고했습니다.|
|$report_user_banned_account|귀하의 계정은 EULA 및 운영 지침에 명시된 서비스 약관을 위반하여 온라인에서 차단되었습니다. 본 조처는 Coffee Stain Publishing에 의해 이루어졌습니다. 자세한 정보는 왼쪽 아래의 EULA를 참조하십시오.|
|$report_user_banned_account_steam|귀하의 계정은 EULA 및 운영 지침에 명시된 서비스 약관을 위반하여 크로스플레이 서버에서 차단되었습니다. 본 조처는 Coffee Stain Publishing에 의해 이루어졌습니다. 자세한 정보는 왼쪽 아래의 EULA를 참조하십시오.|
|$report_user_banned_bodytext_permanentBan|본 차단은 영구적인 조처입니다.|
|$report_user_banned_bodytext_unbannedLocalTime|차단 만료 시점|
|$report_user_banned_header|차단됨.|
|$report_user_failed_header|신고 실패!|
|$report_user_failed_text|신고를 전송하지 못했습니다! 나중에 다시 시도해 주세요.|
|$report_user_send_report_cancel|신고 취소|
|$report_user_send_report_cant_send_not_enough_text|텍스트 입력란에 좀 더 많은 세부 사항을 작성한 뒤 신고를 전송해 주십시오!|
|$report_user_send_report_failed|신고 실패|
|$report_user_send_report_send|신고 전송|
|$report_user_successful_header|신고 전송 완료!|
|$report_user_successful_text|신고를 접수했습니다. 이른 시일 내로 대응하겠습니다.|
|$report_user_window_explanation_text|채팅 내역과 이름은 자동으로 첨부됩니다. 위의 텍스트 입력란에 이 사용자를 신고하는 사유를 구체적으로 작성해 주세요. 민감하거나 관련 없는 개인 정보는 포함하지 말아 주시길 바랍니다.|
|$report_user_window_header|사용자 신고|
|$rock_abyssalbarnacle|심연의 따개비|
|$rotate_build_mode|회전(빌드 모드)|
|$se_adrenaline|아드레날린 소모|
|$se_adrenaline_upfront|아드레날린 획득|
|$se_adrenalinerush|아드레날린 촉진|
|$se_adrenalinerush_tooltip|아드레날린이 당신의 몸 안에 감돌고 있습니다|
|$se_ashlandsmediumarmorseteffect_name|애스크의 인내심|
|$se_ashlandsmediumarmorseteffect_tooltip|움직임에 에너지 소모가 덜 한, 비교적 가벼운 갑옷이다.|
|$se_attackstamina|공격 스태미나 소모도|
|$se_beltstrength_start|더 강해진 느낌입니다|
|$se_beltstrength_tooltip|쵀대 운반 중량 향상.|
|$se_berserker_undead_effect_name|바일본의 분노|
|$se_berserker_undead_effect_tooltip|피해량과 회복량이 증가하지만 물리 피해에 취약해집니다.|
|$se_berserkereffect_name|광폭화|
|$se_berserkerteffect_tooltip|피해량과 회복량이 증가하지만 물리 피해에 취약해집니다.|
|$se_blockstamina|막기 스태미나 소모도|
|$se_blockstaminaflat|스티매나 소모|
|$se_blockstaminaflat_minus|막기 스태미나 회복량 감소|
...
|$se_crowned_name|왕족|
|$se_crowned_start|아무런 방해 없이 통과합니다.|
|$se_crowned_tooltip|발헤임의 생물들은 자신을 다스린 자에게 해를 끼치지 않을 것입니다.|
|$se_deepnorthmediumarmorseteffect_name|선봉|
|$se_deepnorthmediumarmorseteffect_tooltip|더욱 강해지고 빨라진 느낌입니다. 적을 공격할 준비는 끝났습니다!|
...
|$se_frostorbs|복수의 구체|
|$se_frostorbs_description|적이 당신을 해친다면, 곧바로 대가를 치르게 될 것입니다.|
...
|$se_loxseteffect_name|록스의 축복|
|$se_loxseteffect_tooltip|털 덕분에 황무지에 녹아들어 눈에 띄지 않게 이동할 수 있습니다.|
...
|$se_trinketblackdamagedealth|철 가죽|
|$se_trinketblackdamagedealth_description|타격 피해가 증가하고 순간적으로 체력 회복량이 대폭 증가합니다.|
|$se_trinketblackdtamina|그림자 장막|
|$se_trinketblackdtamina_description|회피 기술이 증가하고 막기 스태미나 소모량이 감소합니다.|
|$se_trinketbloodgoldhealth|목찌르개|
|$se_trinketbloodgoldhealth_description|체력이 더 빠르게 회복되고 달리기 및 공격이 스태미나를 적게 소모합니다. 또한 체력과 방어가 순간적으로 증가합니다.|
|$se_trinketbloodgoldstamina|마녀의 왕관|
|$se_trinketbloodgoldstamina_description|체력, 스태미나, 에이트르가 더 빠르게 회복되고 스태미나와 에이트르가 순간적으로 증가합니다.|
|$se_trinketbronzehealth|숲의 심장|
|$se_trinketbronzehealth_description|체력 회복량이 증가합니다.|
|$se_trinketbronzestamina|청동 펜던트|
|$se_trinketbronzestamina_description|스태미나 회복량이 증가합니다.|
|$se_trinketcarapaceeitr|맥동하는 귀걸이|
|$se_trinketcarapaceeitr_description|에이트르 회복량이 증가합니다.|
|$se_trinketchitinswim|운명의 지느러미|
|$se_trinketchitinswim_description|수영에 소모되는 스태미나가 감소하고 수영 속도는 증가합니다.|
|$se_trinketflametaleitr|작은 요르문간드|
|$se_trinketflametaleitr_description|원소 마법과 피의 마법 기술이 증가하고, 순간적으로 에이트르 회복량이 대폭 증가합니다.|
|$se_trinketflametalstaminahealth|불의 심장|
|$se_trinketflametalstaminahealth_description|순간적으로 체력과 스태미나 회복이 폭발적으로 증가합니다.|
|$se_trinketironhealth|철 브로셰|
|$se_trinketironhealth_description|방어도가 증가하고 순간적으로 체력 회복량이 대폭 증가합니다.|
|$se_trinketironstamina|발찌|
|$se_trinketironstamina_description|달리기 속도가 증가하고 순간적으로 스태미나 회복량이 대폭 증가합니다.|
|$se_trinketscalestaminadamage|울려 퍼지는 족쇄|
|$se_trinketscalestaminadamage_description|베기 피해가 증가하고 순간적으로 스태미나 회복량이 대폭 증가합니다.|
|$se_trinketsilverdamage|늑대의 시야|
|$se_trinketsilverdamage_description|활 기술, 창 기술, 관통 피해가 증가합니다.|
|$se_trinketsilverresist|수정 심장|
|$se_trinketsilverresist_description|타격, 베기, 관통 피해에 대한 저항이 증가합니다.|
...
|$settings_3dresolution|3D 해상도 제한|
|$settings_accessibility|접근성|
|$settings_account|계정|
|$settings_altkeys|(알트 버튼)|
|$settings_altplace|대체 배치|
|$settings_animateradial|방사형 애니메이션|
|$settings_animateradial_descr|방사형 메뉴를 열고 닫을 때, 그리고 요소를 선택할 때 애니메이션 효과를 추가합니다.|
...
|$settings_bilinear|부드럽게|
|$settings_block|가드|
|$settings_blocked_player_list|차단한 플레이어|
|$settings_bloom|블룸|
...
|$settings_camzoom|뷰 줌 인/줌 아웃|
|$settings_camzoomin|카메라 확대|
|$settings_camzoomout|카메라 축소|
|$settings_chat|채팅|
|$settings_close_radial|방사형 메뉴 / 감정표현 휠 닫기|
|$settings_clothquality|천 품질|
|$settings_cloud_storage_warning|백업 관련 수치를 높게 설정할 경우 디스크 용량이 부족해질 수도 있습니다.|
|$settings_cloudsave|클라우드 저장|
|$settings_console|콘솔 활성화|
|$settings_console_desc|게임 내 콘솔을 열 수 있도록 설정합니다. 콘솔은 특수 디버깅 명령 및 기능에 접근하는 데 사용됩니다. 콘솔 커맨드 라인 옵션이 이 설정보다 우선 적용됩니다.|
|$settings_continousmusic|음악 반복 재생|
|$settings_controller|컨트롤러|
|$settings_controller_classic|클래식|
|$settings_controller_default|레이아웃|
|$settings_controller_layout|컨트롤러 레이아웃|
|$settings_controller_sensitivity|컨트롤러 감도|
|$settings_controller_speaker_volume|컨트롤러 스피커 볼륨|
|$settings_controller_use_adaptive_triggers|적응형 트리거 사용|
|$settings_controller_use_controller_speaker|컨트롤러 스피커 사용|
|$settings_controller_use_vibration|진동 사용|
|$settings_controller_vibration_strength|진동 세기|
|$settings_controls|컨트롤|
|$settings_crouch|앉기|
|$settings_deleteplayfab_task_header|PlayFab 계정을 삭제합니다...|
|$settings_deleteplayfabaccount|PlayFab 계정 삭제|
|$settings_deleteplayfabaccount_failure|PlayFab 계정을 삭제 할 수 없습니다. 사유:|
|$settings_deleteplayfabaccount_ingamewarning|월드에 있는 동안 PlayFab 계정을 삭제 할 수 없습니다. 삭제 하기전에 메인 메뉴로 이동하여 주세요.|
|$settings_deleteplayfabaccount_not_logged_in|PlayFab에 로그인 중이 아닙니다.|
|$settings_deleteplayfabaccount_success|PlayFab 계정이 성공적으로 삭제되었습니다!|
|$settings_deleteplayfabaccount_text|정말로 PlayFab 계정과 계정에 연결된 모든 데이터를 삭제합니까? 월드, 캐릭터, 그리고 건축물과 같은 유저-제작 컨텐츠들은 삭제되지 않습니다. 다음에 온라인 서비스에 접속할 때 쉽게 새로운 계정을 생성 할 수 있습니다.|
|$settings_detailedparticlesystems|세밀한 입자 시스템|
|$settings_distantshadows|먼 그림자|
|$settings_dodge|회피|
|$settings_dof|피사계 심도(DOF)|
|$settings_double_tap|더블 탭|
|$settings_double_tap_descr|특정 요소 방향으로 스틱을 빠르게 탭하면 상호작용합니다.|
|$settings_draw|무기 들기|
|$settings_enable_show_build_piece_author|건설 조각 제작자 표시|
|$settings_enable_show_build_piece_author_desc|건설 모드에서 건설 조각에 커서를 올리면 누가 배치했는지 표시합니다.|
|$settings_extreme|익스트림|
|$settings_fishingcast|낚시대 던지기|
|$settings_fishingpull|낚시대 당기기|
|$settings_flick_interact|플릭 상호작용|
|$settings_flick_interact_descr|특정 요소 방향으로 스틱을 빠르게 움직이면 상호작용합니다.|
|$settings_forward|앞으로|
|$settings_fpslimit|초당 프레임 제한|
|$settings_fullscreen|전체 화면|
|$settings_gamepadenabled|컨트롤러 사용|
...
|$settings_graphics_preset|그래픽 사전 설정|
|$settings_graphics_preset_balanced_description|120Hz가 지원 및 활성화된 경우 높은 그래픽 품질에서 40FPS를 목표로 하며, 그렇지 않은 경우 60FPS 사전 설정을 사용합니다|
|$settings_graphics_preset_high_description|고사양 시스템을 위한 멋진 그래픽입니다|
|$settings_graphics_preset_low_description|좋은 외형을 유지하면서 저사양 시스템에서도 원활하게 실행됩니다|
|$settings_graphics_preset_medium_description|그래픽 품질과 성능의 균형을 맞췄습니다|
|$settings_graphics_preset_performance_description|일반 그래픽 품질에서 60FPS를 목표로 합니다|
|$settings_graphics_preset_quality_description|최고 그래픽 품질에서 30FPS를 목표로 합니다|
|$settings_guicale_note|최소 화면 해상도 2560x1440|
|$settings_guiscale|GUI 배율|
|$settings_hide|무기 숨기기/표시|
|$settings_high|높음|
|$settings_hotbarright|핫바 전환|
|$settings_hotbaruse|핫바 사용|
|$settings_hoverselectspd|호버 선택 속도|
|$settings_hoverselectspd_descr|특정 요소 위에 커서를 올렸을 때 선택될 때까지 얼마나 걸리는지 설정합니다. "끄기"로 설정 시 호버 선택을 비활성화합니다.|
...
|$settings_low|낮음|
|$settings_map|지도|
|$settings_mapzoom|미니맵 줌 인/줌 아웃|
|$settings_mastervol|볼륨|
|$settings_medium|보통|
|$settings_menu|메뉴|
|$settings_minimapzoomin|미니맵 줌인|
|$settings_misc|기타|
...
|$settings_nearestneighbor|픽셀화|
|$settings_nextsnap|다음 스냅 지점|
|$settings_open_emote_wheel|감정표현 휠 열기|
|$settings_open_radial|방사형 메뉴 열기|
|$settings_persistentbackbtn|상시 뒤로 버튼|
|$settings_persistentbackbtn_descr|방사형 메뉴에서 여러 페이지를 열람할 때 화면 상단 요소를 항상 '뒤로' 버튼으로 설정합니다.|
|$settings_place|장소|
|$settings_playfab_timed_out_header|PlayFab 연결 시간 초과! 인터넷에 연결되어 있는지 확인해 주세요.|
...
|$settings_radial|방사형 메뉴|
|$settings_radial_big|크게|
|$settings_radial_small|작게|
|$settings_radial_small_edge|가장자리 작게|
|$settings_radialback|뒤로 (방사형)|
|$settings_radialclose|닫기 (방사형)|
|$settings_radialinteract|상호작용 (방사형)|
|$settings_radialsecondaryinteract|내려놓기 (방사형)|
|$settings_radialsize|방사형 메뉴 크기|
|$settings_radialsize_descr|방사형 메뉴의 크기와 위치를 조절합니다|
...
|$settings_release_to_use_mode|놓아서 사용 모드|
|$settings_release_to_use_mode_descr|번역 예정|
|$settings_remove|해체|
...
|$settings_showgamepadmap|컨트롤러 표시|
|$settings_showkeyhints|조작법 힌트 보이기|
|$settings_simulationdistance|가시거리|
|$settings_simulationdistance_circular|원형 $1 m|
|$settings_simulationdistance_square|사각 $1 m|
|$settings_simulationdistance_warning|가시거리를 늘리면 심각한 성능 저하가 발생할 수 있습니다!|
|$settings_sit|앉기|
|$settings_softpart|부드러운 입자|
|$settings_spiral_normal|보통|
|$settings_spiral_off|끄기|
|$settings_spiral_slight|약함|
|$settings_spiraleffect|나선 효과|
|$settings_spiraleffect_descr|나선 효과의 강도를 결정합니다. 여러 페이지로 구성된 방사형 메뉴를 스크롤할 때, 선택된 요소 주변의 항목들이 확대/이동되어 나선 계단 같은 효과를 만듭니다. 이 옵션을 끄면, 요소들은 단순히 나타났다 사라지는 효과만 적용됩니다. 이 설정을 사용하려면 '방사형 메뉴 애니메이션' 옵션이 활성화되어 있어야 합니다.|
|$settings_ssao|SSAO|
|$settings_sunshafts|선 샤프트|
|$settings_swap_triggers|버튼 바꾸기|
...
|$settings_ultra|울트라|
|$settings_unlimited|무제한|
|$settings_upscalingalgorithm|업스케일링 방식|
|$settings_use|사용|
|$settings_useradial|방사형 메뉴 사용|
|$settings_useradial_descr|활성화 시 인벤토리 탐색에 방사형 메뉴를 사용합니다.|
...
|$shadowperson_randomtalk_01|놈의 칼날에는 독이 묻어 있었고 난 상대가 되지 않았어...|
|$shadowperson_randomtalk_02|고통, 날카로움과 극심한 고통. 그리고 아무것도 남지 않았지.|
|$shadowperson_randomtalk_03|불은 더 이상 나에게 온기를 주지도 않고 진정한 빛을 보여주지도 않아.|
|$shadowperson_randomtalk_04|몸이 마비되고 춥지 않은 상태가 어땠는지 기억도 나지 않아.|
|$shadowperson_randomtalk_05|그녀의 칼이 내 심장을 찾은 순간 나는 그녀의 목을 베었지. 우리는 나란히 죽었어.|
|$shadowperson_randomtalk_06|여긴 발할라도, 헬도 아니야. 아니, 여기는 더 끔찍한 곳이지.|
|$shadowperson_randomtalk_07|죽은 자는 잊히는 법이지...|
|$shadowperson_randomtalk_08|아버지... 저한테 실망하셨죠. 죄송해요...|
|$shadowperson_randomtalk_09|날 용서해, 너의 뒤를 따라가지 못했어.|
|$shadowperson_randomtalk_10|나는 죽을 때까지 그와 함께했지...|
|$shadowperson_randomtalk_11|거기 누구 없어? 나... 분명 누군가를 봤는데.|
|$shadowperson_randomtalk_12|오래전에 잊히고... 외로워...|
|$shadowperson_randomtalk_13|한 걸음만 더. 단 한 걸음만.|
|$shadowperson_randomtalk_14|여긴 우리가 알고 있던 마지막 땅이었지...|
|$shadowperson_randomtalk_15|이런 헛됨과 이런 어두운 밤도 나는 몰랐어...|
|$shadowperson_randomtalk_16|내 옆에서 걷는 누군가가 있는 줄 알았는데, 그냥 그림자였지.|
|$shadowperson_randomtalk_17|이제 얼굴에 비치는 태양도 내 발 아래 땅도 느껴지지 않아.|
|$shadowperson_randomtalk_18|내... 내 몸에 아무런 감각이 없어.|
|$shadowperson_randomtalk_19|내 목적은 달성했지만, 어떤 보상도 얻지 못했어. 이제 여기서 쓸모도 없이 걸을 뿐이지...|
|$shadowperson_randomtalk_20|피가 너무 많아... 사람은 죽기 전에 얼마나 많이 피를 흘릴 수 있는 거지?|
|$shadowperson_randomtalk_21|내 패배의 슬픔은 영원하리라...|
|$shadowperson_randomtalk_22|여전히 내 가슴을 관통한 날카로운 가지뿔이 느껴져. 언제쯤 이 고통에서 벗어날 수 있을까?|
|$shadowperson_randomtalk_23|그 여자가 나에게 손을 내미는 줄 알았는데, 손가락에서 번개가 나올 줄이야.|
|$shadowperson_randomtalk_24|여긴 정말 기이한 생물들이 있지. 우호적인 놈들이면 좋겠다고 생각했었는데.|
|$shadowperson_randomtalk_25|그들의 목소리가 들려? 그들은 아직도 남아 있어...|
|$shadowperson_randomtalk_26|여기까지 왔는데 눈 깜짝할 사이에 전부 끝나버렸어.|
|$shadowperson_randomtalk_27|이렇게 아름답게 변화하며 물결치는 색깔... 왜 난 닿을 수 없는 거지?|
|$shadowperson_randomtalk_28|이게 나의 운명이었나? 목표에 도달하기도 전에 쓰러지는 게?|
|$shadowperson_randomtalk_29|너무 많은 피가 흘렀어. 대체 뭘 위해서?|
|$shadowperson_randomtalk_30|내 이야기는 누가 해줄 수 있을까?|
|$ship_ashlandocean_warning|뜨거운 바닷물에 선체가 망가집니다! 돌아가십시오!|
|$ship_cargo|화물|
|$ship_holdfast|꽉 붙잡기|
|$ship_karve|카르베|
|$ship_karve_description|출항할 준비가 되어있는 작고 날렵한 함선입니다.|
|$ship_longship|롱쉽|
|$ship_longship_ashlands|드라카|
|$ship_longship_ashlands_description|거대한 함선으로, 가장 위험한 바다에서도 항해할 수 있을 만큼 견고합니다.|
|$ship_longship_description|먼 바다까지 항해할 수 있는 강력한 바이킹 함선입니다.|
|$ship_raft|뗏목|
|$ship_raft_description|별거 없어 보이는 뗏목이지만, 수영하는 것보다는 더 멀리 갈 수 있습니다!|
|$skill_axes|도끼|
...
|$skill_dodge|회피|
|$skill_dodge_description|회피 시 스태미나가 소모됩니다.|
...
|$spiritcaller_moose||
|$spiritcaller_wolf||
|$stat_BeesHarvested|수집한 꿀|
|$stat_BuiltPiecesNoDebt|설치한 건설 조각|
|$stat_ConsecutiveDaysSurvivedMax|최대 연속 생존 일수|
|$stat_CraftFood|제작한 요리|
|$stat_DeathByAshlandsOcean|잿가루 지대 바다에 의한 사망|
|$stat_DeathByBoat|배에 의한 사망|
|$stat_DeathByBurning|화상에 의한 사망|
|$stat_DeathByCart|수레에 의한 사망|
|$stat_DeathByCatapult|투석기에 의한 사망|
|$stat_DeathByCinderFire|잿불에 의한 사망|
|$stat_DeathByDrawBridge|도개교에 의한 사망|
|$stat_DeathByDrowning|익사에 의한 사망|
|$stat_DeathByEdgeOfWorld|세계의 끝에서 추락하여 사망|
|$stat_DeathByEnemyHit|적에 의한 사망|
|$stat_DeathByFall|추락에 의한 사망|
|$stat_DeathByFreezing|동결에 의한 사망|
|$stat_DeathByImpact|충격에 의한 사망|
|$stat_DeathByIncinerator|소각기에 의한 사망|
|$stat_DeathByPoisoned|중독에 의한 사망|
|$stat_DeathBySelf|플레이어에 의한 사망|
|$stat_DeathBySmoke|연기에 의한 사망|
|$stat_DeathByStalagtite|종유석에 의한 사망|
|$stat_DeathByStructural|구조물에 의한 사망|
|$stat_DeathByTree|나무에 의한 사망|
|$stat_DeathByTurret|발리스타에 의한 사망|
|$stat_DeathByWater|물에 의한 사망|
|$stat_DistanceSail|항해한 거리|
|$stat_DistanceSailHelm|조타를 맡은 동안 항해한 거리|
|$stat_ExploreEast|동쪽 탐험 거리|
|$stat_ExploreEastNoMap|지도를 사용하지 않고 동쪽을 탐험한 거리|
|$stat_ExploreNorth|북쪽 탐험 거리|
|$stat_ExploreNorthNoMap|지도를 사용하지 않고 북쪽을 탐험한 거리|
|$stat_ExploreSouth|남쪽 탐험 거리|
|$stat_ExploreSouthNoMap|지도를 사용하지 않고 남쪽을 탐험한 거리|
|$stat_ExploreWest|서쪽 탐험 거리|
|$stat_ExploreWestNoMap|지도를 사용하지 않고 서쪽을 탐험한 거리|
|$stat_FoodEaten|먹은 요리|
|$stat_HarvestBerry|수확한 베리|
|$stat_HarvestCrop|수확한 작물|
|$stat_HarvestMushroom|수확한 버섯|
|$stat_MaxBuildingHeight|가장 높은 건물|
|$stat_MaxBuildingHeightWorld|건물의 가장 높은 세계 위치|
|$stat_MaxComfort|최대 편안함 레벨|
|$stat_TreasureBuriedFound|파묻힌 보물 발견|
|$stat_Tree|벤 나무|
|$stat_TreeAshlands|잿가루 지대 나무에 의한 사망|
|$stat_TreeBeech|너도밤나무에 의한 사망|
|$stat_TreeBirch|자작나무에 의한 사망|
|$stat_TreeFir|전나무에 의한 사망|
|$stat_TreeOak|참나무에 의한 사망|
|$stat_TreePine|소나무에 의한 사망|
|$stat_TreeSnowFir|눈 전나무에 의한 사망|
|$stat_TreeSnowPine|눈 소나무에 의한 사망|
|$stat_TreeSwamp|늪지대 나무에 의한 사망|
|$stat_TreeYggdrasilShoot|이그드라실 사격에 의한 사망|
|$stonecircle_hook_name|깎은 발판|
|$stonecircle_itemplaced|자격을 갖추었습니다|
|$store_buy|구매|
|$store_sell|판매|
|$store_topic|상점|
|$switch_codeofconduct_prohibited_behavior_body|다음과 같은 행동은 온라인 플레이에 대한 일시적 또는 영구적인 차단 조치로 이어질 수 있습니다.<br/>• 괴롭힘, 증오 발언, 협박, 차별 행위<br/>• 채팅, 게임 내 건축 혹은 기타 수단을 통한 부적절하거나 불쾌감을 주는 콘텐츠 공유|
|$switch_eula_header|최종 사용자 라이선스 협정|
|$switch_eula_important_first_text|(Valheim – Nintendo Switch 2)<br/>중요: VALHEIM.COM/EULA에서 최종 사용자 라이선스 협정을 주의 깊게 읽어 주시길 바랍니다. 본인이 소유하거나 통제하는 Nintendo Switch 2 시스템에서 “VALHEIM”(이하 “제품”)을 다운로드, 설치 또는 사용함으로써 귀하는 본 Nintendo Switch 2 이용 규약(이하 “EULA”)의 모든 약관에 동의하게 됩니다. 이에 동의하지 않으실 경우, 제품을 사용하지 마십시오.|
|$switch_loading_savenotification|이 소프트웨어는 자동 저장 기능이 있습니다. 자동 저장 아이콘이 표시될 때 게임을 종료하거나 본체의 전원을 끄지 마십시오.|
|$switch_loadscreen_tip24|지도 핀을 오른쪽 버튼으로 클릭하여 유형별로 필터링할 수 있습니다. (Joy-Con 2 마우스 ZR 버튼)|
|$switch_menu_cloudstoragefull|본체 저장 메모리가 가득 찼습니다!|
|$switch_menu_friendinvite_accepted_header|친구 초대 수락|
|$switch_menu_friends|친구|
|$switch_menu_invite_friends|친구 초대|
|$switch_menu_localstoragefullcharacterprompt|본체 저장 메모리가 부족하여 캐릭터를 생성하지 못했습니다.|
|$switch_menu_localstoragefullworldprompt|본체 저장 메모리가 부족하여 월드를 생성하지 못했습니다.|
|$switch_menu_storagefull|본체 저장 메모리가 가득 찼습니다!|
|$switch_menu_storagefulloperationfailed|본체 저장 메모리가 가득 차 이 작업을 완료할 수 없습니다. 사용하지 않는 저장 데이터를 삭제한 후 다시 시도해 주세요.|
|$switch_menu_storageused|사용중인 본체 저장 메모리: $1|
|$switch_online_kickedfromsession_suspendresume_text|본체가 네트워크 활동이 정지되는 슬립 모드로 전환되어 온라인 세션에서 추방되었습니다.|
|$switch_settings_controller|컨트롤러|
|$switch_settings_controller_default|본체|
|$switch_settings_controller_layout|컨트롤러 레이아웃|
|$switch_settings_controller_motion_sensor|6축 센서|
|$switch_settings_controller_motion_sensor_settings_off|모션 컨트롤이 꺼졌습니다! 설정을 확인하세요.|
|$switch_settings_controller_motion_sensor_toggled_off|6축 센서 끄기|
|$switch_settings_controller_motion_sensor_toggled_on|6축 센서 켜기|
|$switch_settings_controller_motion_sensor_x_axis_sensitivity|6축 센서 X축 감도|
|$switch_settings_controller_motion_sensor_y_axis_sensitivity|6축 센서 Y축 감도|
|$switch_settings_controller_sensitivity|컨트롤러 감도|
|$switch_settings_controller_use_vibration|진동 사용|
|$switch_settings_controller_vibration_strength|진동 강도|
|$switch_settings_double_tap_descr|특정 요소 방향으로 스틱을 빠르게 탭하면 상호작용합니다.|
|$switch_settings_flick_interact_descr|특정 요소 방향으로 스틱을 빠르게 움직이면 상호작용합니다.|
|$switch_settings_gamepadenabled|컨트롤러 활성화|
|$switch_settings_mouse_layout|마우스 레이아웃|
|$switch_settings_mouse_layout_controller|본체 마우스|
|$switch_settings_mouse_layout_pc|PC 마우스|
|$switch_settings_mouse_sensitivity|마우스 감도|
|$switch_settings_mouse_tab|Joy-Con 2 마우스|
|$switch_settings_persistentbackbtn|뒤로가기 버튼 유지|
|$switch_settings_persistentbackbtn_descr|방사형 메뉴에서 여러 페이지를 열람할 때 화면 상단 요소를 항상 '뒤로' 버튼으로 설정합니다.|
|$switch_settings_show_button_hints|힌트 버튼 표시|
|$switch_settings_swap_triggers|ZR 버튼과 ZL 버튼을 서로 바꾸기|
|$switch_settings_switch_mouse_enabled|마우스 활성화|
|$switch_ugc_character_name|UGC 캐릭터 이름|
|$switch_ugc_server_name|UGC 서버 이름|
|$switch_ugc_text|UGC 텍스트|
|$switch_ugc_world_name|UGC 월드 이름|
|$tag_architecture|건축물|
|$tag_building|건설|
|$tag_crafting|제작|
|$tag_decor|장식|
|$tag_defense|방어|
...
|$tag_wall|벽|
|$tamed_name_01|절친|
|$text_hidden_notification_muted|숨겨진 텍스트, 제작자 음소거|
|$text_hidden_notification_ugc_settings|숨겨진 텍스트, UGC 설정 확인|
|$text_mistlands_bosshint|관문은 봉인되었다. 열쇠를 조각내 광산 깊은 곳에 숨겼다. 다시는 봉인이 풀리지 않도록. 관문은 봉인되었다.|
|$text_player_arrived|내가 왔다!|
|$tinyrom_download_patch_to_play|플레이하려면 패치를 다운로드하세요|
|$tool_batteringram|공성추|
|$tool_batteringram_description|만만히 볼 수 없는 전력입니다. 연료를 가득 채우고 적의 요새로 진격하면 성공 확률이 훨씬 증가할 것입니다.|
|$tool_cart|수레|
|$tool_cart_description|많은 양의 자원을 옮겨야 할 때 편리합니다.|
|$tool_catapult|투석기|
|$tool_catapult_description|뚫고 지나갈 수 없다면, 위로 지나갈 수 있을 것입니다...|
...
|$tutorial_artisan_extension_text|이제 고온을 견디는 데 탁월한 세라믹 타일을 제작할 수 있다네.<br/>남쪽으로 더 가려면 필요할 게야!|
|$tutorial_artisan_extension_topic|새로운 도구|
|$tutorial_ashlandocean_label|후긴: 끓는 바다|
|$tutorial_ashlandocean_text|끓어오르는 남쪽 바다까지 들어왔군. 이미 경험했겠지만, 이 해역은 대단히 위험하다네.<br/>물고기 밥이 되지 않고 항해하려면 더욱 튼튼한 배가 필요할 걸세.|
|$tutorial_ashlandocean_topic|이보게!|
|$tutorial_ashlands_label|후긴: 잿가루 지대|
|$tutorial_ashlands_text|그대는 잿가루 지대에 당도했네. 열 번째 세계에서도 가장 뜨거운 지역이지.<br/>이곳은 가마솥 없이도 물이 끓는다네. 불에 타는 물건은 약간만 틈을 줘도 타오르곤 하지. 조심하게!|
...
|$tutorial_eitr|이그드라실 가지의 수액을 마셨나 보군. 아마 즐거울 거야.<br/>주변을 맴도는 특이한 색의 빛은 사실 머릿속에만 있는 게 아닐 걸세.<br/>그래도 너무 자주 마시지는 말게. 장기적인 영향은 지금처럼 마법 보듯 즐겁지 않을 테니.|
|$tutorial_eitr_label|후긴: 에이트르|
|$tutorial_eitr_text|이 땅에 나고 자라는 모든 것에는 안개가 스며 있지. 이젠 그대의 몸에도 스며들었을 것이네.<br/><br/>에이트르를 사용하면 온갖 강력한 마법을 사용할 수 있다네. 에이트르가 충만한 재료를 찾아 힘을 늘리게.|
|$tutorial_end_hugin_label|후긴: 발할라로|
|$tutorial_end_hugin_text|잘했다, 전사여!<br/><br/>드디어 그대가 모든 버려진 자를 물리치고 자신의 자격을 증명했다. 이제 그대를 위해 발할라의 문이 열렸으며, 남은 것은 발키리가 그대를 발할라로 데려가는 것이다.<br/><br/>하지만 걱정하지 말지어다. 돌아오고 싶다면 언제든 이곳 열 번째 세계에서 그대를 환영할 것이다.|
|$tutorial_end_hugin_topic|발할라로 떠나는 여정|
|$tutorial_end_munin_label|무닌: 버려진 자를 무찌르다|
|$tutorial_end_munin_text|그대는 잘 싸웠다, 전사여.<br/><br/>덕분에 버려진 자는 사라졌고 이 세계는 다시 이그드라실의 다른 세계들과 합쳐질 수 있게 되었다. 하지만 그 이야기는 다음에 하도록 하지! 일단 지금은 발할라에서의 보상을 이야기하는 게 어떻겠나?|
|$tutorial_end_munin_topic|그렇게 이야기는 막을 내리게 되었습니다...|
|$tutorial_faderember_label|후긴: 영원한 장작더미|
|$tutorial_faderember_text|밝게 타오르는 것은 드래곤의 숨결만이 아니라 정수 그 자체이기도 합니다. 충분한 실력과 인내심이 있다면, 다룰 수 있습니다...|
...
|$tutorial_food2_text|간식을 찾았습니다. 섭취해서 배고픔을 달래세요. 일부 식품 유형은 체력에 좋으며 비틀거리기 전에 차단할 수 있는 피해량을 간접적으로 늘려줍니다. 다른 유형은 스태미나를 강화합니다. 만능인 것들도 있습니다!<br/><br/>얼마 지나지 않아 다시 배가 고플 테니 여러 종류의 음식을 조금씩 가지고 다닐 수 있도록 준비하세요.|
...
|$tutorial_haldor|열 번째 세계에 웬 상인들이 흘러들어왔다는 소문이 돌고 있어. 특별한 물품을 찾는다면 그 상인들을 만나보게.<br/><br/>아, 마침 그중 한 명이 같은 숲에 머무르고 있다고 하더군. 미안하네만 내가 도와줄 수 있는 건 여기까지네... 직접 찾아보도록 해.|
...
|$tutorial_hildir|이런 지역에 어떤 상인이 머무른다는 얘기를 들었네. 독특한 여자지만, 아주 특별한 물건을 판다더군.<br/><br/>그런데 듣자 하니 상품을 약탈당했다고 하더라고. 도움이 필요할 텐데, 지금 자네 정도면 얼추 믿을 만하다고 볼 게야.|
|$tutorial_hildir_label|후긴: 상인 힐디르|
|$tutorial_hildir_topic|여보게, 안녕하신가.|
|$tutorial_hildirdungeon|이곳은 보기보다 탐사하기 어려운 곳이다.<br/><br/>더 나아가기 전에 잘 생각해 보고, 철저히 준비하길 바란다.|
...
|$tutorial_jotuninvasion_hugin_label|후긴: 요툰 침공|
|$tutorial_jotuninvasion_hugin_text|"요툰 군대의 접근을 경계하라. 열 번째 세계를 바로잡고자 한다면, 그들의 침공 지점에서 맞서 진격을 막아내야 한다..."|
|$tutorial_jotuninvasion_hugin_topic|정체불명의 세력이 침공하고 있습니다!|
|$tutorial_magetable_label|후긴: 갈드르 테이블|
|$tutorial_magetable_text|이제 룬도 만져보는 건가? 대단한걸, 마술사여!<br/><br/>마법 도구나 주문은 쓸수록 힘이 빠질 걸세. 그러니 마술을 연마하고 싶다면 필요한 영양소를 섭취해야겠지? 마침 이 근처는 맛있는 새 음식 재료가 잔뜩 있다네. 그대는 운이 정말 좋군!|
...
|$tutorial_mould_hugin_label|후긴: 거푸집|
|$tutorial_mould_hugin_text|거푸집은 환상적인 결과를 만들 수 있지! 하지만 단순히 소재를 채우는 것만으로는 부족해. 극한의 온도를 이용해서 굳혀야 해...|
|$tutorial_mould_hugin_topic|거푸집을 찾았군!|
...
|$tutorial_prison_label|후긴: 감옥|
|$tutorial_prison_text|조심하라! 이 관문 너머에 갇힌 존재는 발헤임 전역에서 만날 수 있는 어느 존재보다도 강력하니. 최후의 적과 마주하기 전에 충분한 준비를 마쳐야 할 것이다.|
|$tutorial_prison_topic|마지막 시련...|
|$tutorial_random1|까악!|
...
|$tutorial_sacrificialblood_label|후긴: 칼 핌불브링거 처치|
|$tutorial_sacrificialblood_text|훌륭하다, 전사여! 이 세계를 되살리는 마지막 열쇠, 희생의 피를 찾아냈구나. 이제 최고신께서 그대에게 마지막 과업을 내리셨으니, 모든 것이 시작된 장소로 돌아가 자신의 자격을 증명하라!|
|$tutorial_sacrificialblood_topic|때가 되었다...|
...
|$tutorial_tissueref_text|전사여, 이건 도대체 무슨 장치인가?! 위험해 보이는군…<br/><br/>위에 분쇄기 투입구가 있는데, 뭘 넣을 생각인가?|
|$tutorial_trinket_label|후긴: 장신구|
|$tutorial_trinket_text|까악까악! 전사여, 그대의 손에서 번쩍이는 장신구가 보이는군! 당당하게 착용하게나! 그 힘을 온몸에 흐르게 하고, 그 이름 아래 적을 쓰러뜨리게. 그렇게 하면 순수한 아드레날린으로 타오르는 분노가 그대를 가득 채울 걸세!|
|$tutorial_trinket_topic|아드레날린이 당신의 몸 안에 감돌고 있습니다!|
|$tutorial_upgrader_hugin_label|후긴: 잠재력의 대장간|
|$tutorial_upgrader_hugin_text|이 고대의 힘이 서린 장소를 찾는 것은 쉬운 일이 아니지만, 그곳에 도달한 자는 큰 혜택을 얻게 될 것이다! 하지만 경고하자면, 대장간은 그대에게 큰 도움이 될 수도 있지만, 정제하려는 물건을 쉽게 산산조각낼 수도 있다...|
|$tutorial_upgrader_hugin_topic|들어라, 방랑자여!|
...
|$tutorial_wispattractor_text|참으로 이상한 장치로다. 뭘 끌어들일지 궁금하니, 잠시 앉아 기다려볼까…<br/><br/><br/>음, 지루하구나. 난 그대 같은 자를 밤새 돌볼 의무도 없지. 그럼 잘 있게나, 전사여. 주의를 기울이면 보상이 있을 게야.|
...
|$tutorial_yggroot_text|까악! 오랜 물푸레나무의 뿌리로군. 줄기와 떨어졌는데도 마력을 품고 있다네.<br/><br/>짐작했겠지만, 그대가 만든 무기로는 이 껍질을 뚫을 수 없네. 그대보다 손재주 나은 자가 만든 더 좋은 도구가 필요할 걸세.|
|$ui_hold|길게 누르기|
|$wolf_statue|펜리스의 신전|
|$xbox_codeofconduct_platform_specific_text|귀하는 Xbox 커뮤니티 기준 또한 준수해야 하며, 이는 당사의 규정 외에 별도로 적용됩니다.|
|$xbox_codeofconduct_reporting_violations_body|허용되지 않는 행위를 목격한 경우:<br/>• 게임 내: 자체 "플레이어 신고" 기능을 활용해 주세요. (옵션 -> 플레이어 목록 -> 신고)<br/>• 게임 외부: 온라인 양식(https://valheim.com/report-a-player)을 사용해 주세요<br/>• Xbox: https://support.xbox.com/en-US/help/family-online-safety/enforcement/file-a-complaint-on-xbox-app 웹페이지를 참조하세요|
|$xbox_error_crossplayprivilege|플랫폼 권한 설정으로 인해 다른 플랫폼과의 크로스플레이를 허용하는 서버에서 플레이할 수 없습니다.|
|$xbox_eula_important_first_text|(Valheim – Xbox® Edition)<br/>중요: VALHEIM.COM/EULA에서 최종 사용자 라이선스 협정을 주의 깊게 읽어 주시길 바랍니다. 본인이 소유하거나 통제하는 Xbox 본체에서 “VALHEIM”(이하 “제품”)을 다운로드, 설치 또는 사용함으로써 귀하는 본 최종 사용자 라이선스 협정(이하 “EULA”)의 모든 약관에 동의하게 됩니다. 이에 동의하지 않으실 경우, 제품을 사용하지 마십시오.|
|$xbox_loading_savenotification|이 게임은 자동 저장 기능이 있습니다. 자동 저장 아이콘이 표시될 때 게임을 종료하거나 본체의 전원을 끄지 마십시오.|
|$xbox_menu_resolve_privilege|권한 문제를 해결하시겠습니까?|
|$xbox_menu_storagefull|저장소가 가득 찼습니다!|
|$xbox_menu_storagefulloperationfailed|저장 데이터 공간이 가득 차 이 작업을 완료할 수 없습니다. 사용하지 않는 저장 데이터를 삭제한 후 다시 시도해 주세요.|
|$xbox_menu_storageused|사용중인 저장 공간: $1|
|$xbox_online_kickedfromsession_suspendresume_text|본체가 네트워크 활동이 정지되는 절전 모드로 전환되어 온라인 세션에서 추방되었습니다.|
|$xbox_settings_controller|컨트롤러|
|$xbox_settings_controller_default|본체|
|$xbox_settings_controller_layout|컨트롤러 레이아웃|
|$xbox_settings_controller_sensitivity|컨트롤러 감도|
|$xbox_settings_controller_use_vibration|진동 사용|
|$xbox_settings_controller_vibration_strength|진동 강도|
|$xbox_settings_double_tap_descr|특정 요소 방향으로 스틱을 빠르게 탭하면 상호작용합니다.|
|$xbox_settings_flick_interact_descr|특정 요소 방향으로 스틱을 빠르게 움직이면 상호작용합니다.|
|$xbox_settings_gamepadenabled|컨트롤러 사용|
|$xbox_settings_persistentbackbtn|뒤로가기 버튼 유지|
|$xbox_settings_persistentbackbtn_descr|방사형 메뉴에서 여러 페이지를 열람할 때 화면 상단 요소를 항상 '뒤로' 버튼으로 설정합니다.|
|$xbox_settings_show_button_hints|힌트 버튼 표시|
|$xbox_ugc_character_name|UGC 캐릭터 이름|
|$xbox_ugc_server_name|UGC 서버 이름|
|$xbox_ugc_text|UGC 텍스트|
|$xbox_ugc_world_name|UGC 월드 이름|
