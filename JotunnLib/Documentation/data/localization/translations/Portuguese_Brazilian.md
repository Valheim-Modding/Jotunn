...
|$ach_allbosses_desc|Derrote todos os chefes em qualquer dificuldade.|
|$ach_allbosseshard|Viking implacável|
|$ach_allbosseshard_desc|Derrote todos os chefes no modo difícil.|
|$ach_allbossesnormal|Viking inflexível|
|$ach_allbossesnormal_desc|Derrote todos os chefes na dificuldade normal ou superior.|
|$ach_allbossesunarmed|Pugilista|
|$ach_allbossesunarmed_desc|Derrote todos os chefes usando só os punhos.|
|$ach_allbuildpieces|Carpinteiro|
|$ach_allbuildpieces_desc|Construa tudo.|
|$ach_allfoodcooked|Mestre da cozinha|
|$ach_allfoodcooked_desc|Prepare todos os tipos de prato.|
|$ach_allfoodeaten|Amante da gastronomia|
|$ach_allfoodeaten_desc|Coma todos os tipos de itens comestíveis.|
|$ach_allitemcraft|Artífice|
|$ach_allitemcraft_desc|Produza todos os tipos de item.|
|$ach_allminibosses|Odin está satisfeito|
|$ach_allminibosses_desc|Derrote todos os minichefes.|
|$ach_allweaponcraft|Ferreiro|
|$ach_allweaponcraft_desc|Produza todos os tipos de arma.|
|$ach_arrived|Cheguei!|
|$ach_arrived_desc|Entre no décimo mundo.|
|$ach_bigfish|Uma pesca digna de Njord|
|$ach_bigfish_desc|Pesque um peixe de quatro estrelas.|
|$ach_boss1eikthyr|Eikthyr|
|$ach_boss1eikthyr_desc|Derrote o Cervo Elétrico.|
|$ach_boss2elder|O Ancião|
|$ach_boss2elder_desc|Derrote a Floresta Viva.|
|$ach_boss3bonemass|Massa Óssea|
|$ach_boss3bonemass_desc|Derrote os Mortos Contorcidos.|
|$ach_boss4moder|Moder|
|$ach_boss4moder_desc|Derrote a Mãe dos Dragões.|
|$ach_boss5yagluth|Yagluth|
|$ach_boss5yagluth_desc|Derrote a Alma Corrompida.|
|$ach_boss6queen|A Rainha Errante|
|$ach_boss6queen_desc|Derrote a Matriarca Rastejante.|
|$ach_boss7fader|Fader|
|$ach_boss7fader_desc|Derrote a Chama Esmeralda.|
|$ach_boss8frozenking|Kall Fimbulbringer|
|$ach_boss8frozenking_desc|Derrote o Acorrentado.|
|$ach_builddyrnwyn|Escolhido|
|$ach_builddyrnwyn_desc|Monte Dyrnwyn.|
|$ach_buildhigh|Salões grandiosos|
|$ach_buildhigh_desc|Erga uma estrutura muito alta.|
|$ach_buildhighworld|Topo do mundo|
|$ach_buildhighworld_desc|Construa algo em altitude muito elevada.|
|$ach_buildhouse|Residente|
|$ach_buildhouse_desc|Construa uma casa.|
|$ach_buildvillage|Arquiteto|
|$ach_buildvillage_desc|Construa um vilarejo.|
|$ach_childofodin|Filho de Odin|
|$ach_childofodin_desc|Encarne os espíritos de Viking Implacável, Mestre da Caça, Sobrevivente e Desbravador.|
|$ach_deathbyalltypes|Você está bem?|
|$ach_deathbyalltypes_desc|Morra de todas as formas possíveis.|
|$ach_deathbyobliterator|Obliteração|
|$ach_deathbyobliterator_desc|Você ficou um pouco perto demais.|
|$ach_deathbytree|Acidentes acontecem|
|$ach_deathbytree_desc|Morra por causa de uma árvore.|
|$ach_deathbytreeall|Isso não pode ser um acidente|
|$ach_deathbytreeall_desc|Morra por causa de todos os tipos de árvore.|
|$ach_everyachievement|O mais digno|
|$ach_everyachievement_desc|Desbloqueie todas as outras conquistas.|
|$ach_explorensew|Explorador|
|$ach_explorensew_desc|Viaje longas distâncias em todas as quatro direções.|
|$ach_explorensewnomap|Desbravador|
|$ach_explorensewnomap_desc|Viaje longas distâncias em todas as quatro direções, sem usar um mapa.|
|$ach_findalltrophies|O Colecionador de troféus|
|$ach_findalltrophies_desc|Colete todos os troféus.|
|$ach_firstdeath|A primeira de muitas|
|$ach_firstdeath_desc|Encontre seu fim, e então prepare-se para fazer tudo de novo...|
|$ach_grindbuild|Construtor|
|$ach_grindbuild_desc|Construa 500 peças.|
|$ach_grindcomfort|Conforto é tudo|
|$ach_grindcomfort_desc|Atinja um nível de conforto de 20.|
|$ach_grindcook|Cozinheiro|
|$ach_grindcook_desc|Prepare 100 pratos.|
|$ach_grinddays|Sobrevivente|
|$ach_grinddays_desc|Sobreviva por 30 dias consecutivos.|
|$ach_grindeat|Saco vazio não para em pé|
|$ach_grindeat_desc|Consuma 500 comidas.|
|$ach_grindfish|Pescador|
|$ach_grindfish_desc|Pesque todos os tipos de peixe.|
|$ach_grindforager|Coletor|
|$ach_grindforager_desc|Colete 250 frutinhas e 250 cogumelos.|
|$ach_grindharvest|Fazendeiro|
|$ach_grindharvest_desc|Faça 500 colheitas.|
|$ach_grindhoney|Apicultor|
|$ach_grindhoney_desc|Colete 500 de mel.|
|$ach_grindleviathan|Sem tempo para cochilos|
|$ach_grindleviathan_desc|Desperte uma criatura marinha.|
|$ach_grindsail|Marujo|
|$ach_grindsail_desc|Navegue por distância suficiente para circundar o mundo duas vezes.|
|$ach_grindsailhelm|Capitão|
|$ach_grindsailhelm_desc|Navegue por distância suficiente para circundar o mundo, no comando do leme.|
|$ach_grindtreasure|Caça-tesouros|
|$ach_grindtreasure_desc|Descubra 10 baús do tesouro enterrados.|
|$ach_grindtrees|Lenhador|
|$ach_grindtrees_desc|Corte 500 árvores.|
|$ach_killallcreatures|Caçador|
|$ach_killallcreatures_desc|Mate todos os tipos de criatura.|
|$ach_killallcreatureshard|Mestre da caça|
|$ach_killallcreatureshard_desc|Mate todos os tipos de criatura no modo difícil.|
|$ach_kingsqueens|Reis e rainhas de Valheim|
|$ach_kingsqueens_desc|Encarne os espíritos de Viking, Caçador, Artífice, Mestre da Cozinha, Carpinteiro e Explorador.|
|$ach_multiplayerboss|Mais Fortes Juntos|
|$ach_multiplayerboss_desc|Mate um chefe junto com um amigo.|
|$ach_sailedge|As lendas são verdadeiras|
|$ach_sailedge_desc|Navegue além da borda do mundo.|
|$ach_soloboss|Lobo solitário|
|$ach_soloboss_desc|Mate um chefe por conta própria.|
|$achievement_details|Detalhes de conquistas|
|$achievements_cheated_item_inventory|Este item foi invocado por trapaça.|
|$achievements_confirm_cheat|Esse comando é uma trapaça. Insira "confirmcheats" no console para usar trapaças. <color=red>Usar trapaças desativará permanentemente a capacidade de desbloquear conquistas para este personagem e este mundo.</color>|
|$achievements_permanently_cheated_character|O progresso de conquistas está permanentemente desativado para este personagem devido ao uso de trapaças.|
|$achievements_permanently_cheated_world|O progresso de conquistas está permanentemente desativado para este mundo devido ao uso de modificadores de mundo por trapaças.|
|$achievements_picked_up_cheated_item|Item trapaceado adquirido. O progresso de conquistas está temporariamente desativado.|
|$achievements_temporarily_cheated|O progresso de conquistas está temporariamente desativado para este personagem devido à posse de itens obtidos por trapaças.|
...
|$biome_swamp|Pântano|
|$black_ice_combo|Gelo maldoso|
|$blackice_core|Gelo maldoso|
|$blackice_triggeritem|Gelo maldoso|
|$blocking_joined_world_with_blocked_player|Este mundo contém Conteúdo Gerado por Usuários (UGC) de um jogador que você bloqueou. Para jogar neste mundo, é necessário desbloquear o usuário. Deseja desbloquear o seguinte usuário:|
|$boss_hive_end|Nós fomos dispersados.|
|$boss_hive_start|Nós nos reunimos.|
|$build_piece_author_built_by|Autoria de construção:|
|$build_piece_author_unknown|Desconhecida|
|$button_a|A|
|$button_b|B|
|$button_back|Voltar|
...
|$cinematics_end_credits|Créditos|
|$cinematics_intro|Introdução|
|$cinematics_outro|Tela Final|
|$codeofconduct_ban_appeals_body|Caso acredite que seu banimento foi equivocado, é possível contatar nosso suporte para rever a decisão. Porém, decisões finais serão tomadas de acordo com nossas políticas e os requerimentos das plataformas.|
|$codeofconduct_ban_appeals_header|Revisão de banimentos|
|$codeofconduct_bodytext_first|Ao jogar usando os serviços de crossplay, é necessário seguir todas as regras e diretrizes de comunidade definidas por nós. Exerça bom comportamento.|
|$codeofconduct_enforcement_and_bans_body|Reservamo-nos o direito de intervir contra usuários que violem estas regras, incluindo:<br/><br/>• Banimentos temporários ou permanentes dos serviços online.<br/><br/>• Restrições na funcionalidade de crossplay.|
|$codeofconduct_enforcement_and_bans_header|Imposições e Banimentos|
|$codeofconduct_header|Conduta de usuário e Banimentos — Jogue com responsabilidade|
|$codeofconduct_prohibited_behavior_body|As ações a seguir podem resultar em banimentos temporários ou permanentes dos serviços online:<br/><br/>• Assédio, discurso de ódio, ameaças ou discriminação.<br/><br/>• Compartilhar conteúdo ofensivo ou impróprio por meio do chat, construções no jogo ou outros meios.|
|$codeofconduct_prohibited_behavior_header|Comportamentos proibidos|
|$codeofconduct_reporting_violations_body|Caso você testemunhe comportamento inaceitável:<br/><br/>• Dentro do jogo: use a função de "Denunciar jogador" (Opções->Lista de jogadores->Denunciar)<br/><br/>• Fora do jogo: use este formulário online: https://valheim.com/report-a-player|
|$codeofconduct_reporting_violations_header|Denunciando violações|
...
|$customization_beard22|Bigode|
|$customization_beard23|Bigodinho|
|$customization_beard24|Aparado|
|$customization_beard25|Aparada|
|$customization_beard26|Bigode em guidão|
...
|$customization_hair33|Barba Vinland|
|$customization_hair34|Castelão|
|$customization_hair35|Campeão|
|$customization_hair36|Cronista|
|$customization_hair37|Arauto da alvorada|
...
|$deadspeak_fish1|Sou uma perca, não um robalo!|
...
|$dream_deepnorth01|Em seu sonho, você está como veio ao mundo em meio a um corpo de água tão cristalina que não pode ser vista, apenas sentida como um cinto oscilante ao redor do quadril. Três figuras na borda observam você em silêncio. Quando a figura líder toca a superfície da água com o pé, a ondulação dissolve o sonho e você acorda.|
|$dream_deepnorth02|Você desce o túnel de um sonho inquieto para um vazio tão completo que nenhuma palavra se prende a ele…|
|$dream_deepnorth03|Você sonha com um salão no inverno, resplandecente com luz e risadas no meio de uma noite nevada. Ao se aproximar, as luzes se transformam em grandes chamas e as risadas viram gritos. Você corre em direção ao salão, mas ele afunda com um chiado entre a neve.|
|$dream_deepnorth04|Você corre por uma colina infinita, com o coração batendo de alegria no peito. Duas formas sombrias voam ao seu lado, e a batida das asas delas permanece com você após acordar.|
|$dream_deepnorth05|Você vê o rosto de uma criança, rindo e chorando ao mesmo tempo. Os olhos são cristalinos e azuis por trás das lágrimas, e a boca é uma profusão de dentinhos. No sonho, ele diz algo a você, mas as palavras desaparecem quando você acorda.|
|$dream_deepnorth06|Em seu sonho, há uma porta sem fechadura nem cadeado. Você sente que ela abriria com um empurrão, mas seu corpo está congelado em um redemoinho de vento gelado. Atrás da porta estão as vozes de pessoas que você ama, mas não consegue nomear. Você se esforça para chegar a um despertar vazio.|
|$dream_deepnorth07|Os fantasmas de todos aqueles que morreram por suas mãos aparecem para você em seu sono e permanecem nas bordas de seus sonhos. Eles não desejam nada, não precisam de nada, não dizem nada.|
|$dream_deepnorth08|Você afunda por camadas de sono para uma vasta câmara em que uma forma sombria se curva sob um emaranhado de pesadas correntes. Quando ela se move para encarar você, os orbes azuis de seus olhos perfuram o sonho e você acorda, o corpo coberto de suor.|
|$dream_deepnorth09|Você não se lembra de nada do sonho desta noite, mas um humor espirituoso alegra você para o dia com um sorriso nos lábios.|
|$dream_deepnorth10|Odin visita você em seu sonho e oferece um chifre cheio até a borda de uma bebida espumosa. Você bebe um grande gole e recebe o novo dia, seu corpo renovado e vivo.|
...
|$elaking_trashpile|Pilha de escombros|
|$enemy_abomination|Abominação|
|$enemy_asksvin|Asksvin|
|$enemy_asksvin_hatchling|Filhote de asksvin|
|$enemy_aspect_bonemass|Aspecto dos Mortos Contorcidos|
|$enemy_aspect_dragon|Aspecto da Mãe dos Dragões|
|$enemy_aspect_eikthyr|Aspecto do Cervo Elétrico|
|$enemy_aspect_fader|Aspecto da Chama Esmeralda|
|$enemy_aspect_gdking|Aspecto da Floresta Viva|
|$enemy_aspect_goblinking|Aspecto da Alma Corrompida|
|$enemy_aspect_seekerqueen|Aspecto da Matriarca Rastejante|
|$enemy_babyseeker|Buscador filhote|
|$enemy_barka|Barka|
|$enemy_bat|Morcego|
|$enemy_bigblob|Massa hexaédrica|
|$enemy_bjorn|Urso|
|$enemy_blob|Bolha|
|$enemy_blobelite|Bolha Elite|
|$enemy_blobfrost|Bolha de gelo|
|$enemy_bloblava|Bolha de lava|
|$enemy_blobmork|Massa amorfa|
|$enemy_blobmorkmini|Massa minúscula|
...
|$enemy_boss_dragon_spawnmessage|Moder infurecida|
|$enemy_boss_fader_alertmessage|A Chama Esmeralda se acende|
|$enemy_boss_fader_deathmessage|A Chama Esmeralda se apaga|
|$enemy_boss_frozenking_alertmessage|O ódio dele corrompe tudo!|
|$enemy_boss_frozenking_deathmessage|A paz toma conta do mundo|
...
|$enemy_dvergr_deepnorth|Dvergr aprisionado|
|$enemy_dvergr_mage|Anão dvergr mago|
|$enemy_dvergrs|Dvergrs|
|$enemy_eikthyr|Eikthyr|
|$enemy_eikthyr_alertmessage|Eikthyr invoca a tempestade|
|$enemy_eikthyr_deathmessage|Eikthyr foi morto|
|$enemy_elaking|Elaking|
|$enemy_elakingmole|Sem-olhos|
|$enemy_fader|Fader|
|$enemy_fader_codename|A Chama Esmeralda|
|$enemy_fallenvalkyrie|Valquíria caída|
|$enemy_fallenwarrior|Guerreiro caído|
...
|$enemy_gdking|Ancião|
|$enemy_gdking_alertmessage|O Ancião surge da floresta|
|$enemy_gdking_deathmessage|O Ancião foi derrotado|
|$enemy_gemgoblin|Fuling Precioso|
|$enemy_ghost|Fantasma|
|$enemy_ghost_void|O Vazio|
|$enemy_gjall|Gjall|
|$enemy_goblin|Fuling|
|$enemy_goblin_deepnorth|Fuling cativo|
|$enemy_goblin_hildir|<color=orange>Zil</color>|
|$enemy_goblinbrute|Fuling furioso|
...
|$enemy_hare|Lebre|
|$enemy_hen|Galinha|
|$enemy_holespawner|Túnel de guarda-roupa|
...
|$enemy_moose|Alce|
|$enemy_moosecalf|Filhote de alce|
|$enemy_morgen|Morgen|
|$enemy_neck|Lagarto|
|$enemy_seal|Foca|
|$enemy_seal_baby|Bebê foca|
...
|$enemy_summonedroot|Raiz invocada|
...
|$error_needslocalupdatetojoin|Você está em uma versão mais antiga de Valheim que é incompatível com este servidor. Por favor atualize seu jogo para entrar neste servidor.|
...
|$eula_acceptance|AO ESCOLHER “ACEITO”, OU UTILIZAR O PRODUTO, VOCÊ RECONHECE QUE LEU, COMPREENDEU E CONCORDOU EM SEGUIR OS TERMOS DESTE ACORDO (“EULA”).|
|$eula_header|ACORDO DE LICENÇA DE USUÁRIO FINAL|
|$eula_important_first_text|IMPORTANTE: LEIA CUIDADOSAMENTE O ACORDO EM VALHEIM.COM/EULA. AO BAIXAR, INSTALAR OU UTILIZAR “VALHEIM” (O “PRODUTO”) EM UM SISTEMA QUE VOCÊ POSSUI OU CONTROLA, VOCÊ CONCORDA EM SEGUIR OS TERMOS DESTE ACORDO DE LICENÇA DE USUÁRIO FINAL (“EULA”). CASO NÃO CONCORDE, NÃO UTILIZE O PRODUTO.|
|$event_bats_end|O caldeirão se acalma|
|$event_bats_start|Você agitou o caldeirão|
|$event_bonemassarmy_end|O cheiro passou|
...
|$event_elakingarmy_end|Eles retornam às suas tocas...|
|$event_elakingarmy_start|Eles surgem das profundezas...|
...
|$event_jotunarmy_end|Os Jotun se retiram|
|$event_jotunarmy_start|Os Jotun encontraram você|
...
|$fallen_viking_randomend_1|Você está à altura.|
|$fallen_viking_randomend_10|Parece que você está à altura.|
|$fallen_viking_randomend_11|Posso ver suas habilidades.|
|$fallen_viking_randomend_12|Os ancestrais sorriem para você.|
|$fallen_viking_randomend_13|As valquírias fizeram uma boa escolha.|
|$fallen_viking_randomend_14|Finalmente.|
|$fallen_viking_randomend_15|Agora posso descansar.|
|$fallen_viking_randomend_16|Foi uma boa batalha.|
|$fallen_viking_randomend_17|Agora vá, com nossa bênção.|
|$fallen_viking_randomend_18|Agora você luta por todos nós.|
|$fallen_viking_randomend_19|Vigiaremos seu progresso com interesse.|
|$fallen_viking_randomend_2|Você provou seu valor.|
|$fallen_viking_randomend_20|Você é realmente capaz.|
|$fallen_viking_randomend_3|Foi um bom combate.|
|$fallen_viking_randomend_4|Mereceu o triunfo.|
|$fallen_viking_randomend_5|Seu destino é a vitória.|
|$fallen_viking_randomend_6|Uma batalha realmente louvável.|
|$fallen_viking_randomend_7|Foi uma honra.|
|$fallen_viking_randomend_8|Você luta bem.|
|$fallen_viking_randomend_9|Você tem muita força.|
|$fallen_viking_randomstart_1|Vamos ver do que você é capaz!|
|$fallen_viking_randomstart_10|Quer me desafiar?|
|$fallen_viking_randomstart_11|Estive esperando por isto!|
|$fallen_viking_randomstart_12|Lute comigo!|
|$fallen_viking_randomstart_13|Mostre sua força!|
|$fallen_viking_randomstart_14|É sangue que você quer?|
|$fallen_viking_randomstart_15|Pela vitória!|
|$fallen_viking_randomstart_16|Então venha!|
|$fallen_viking_randomstart_17|Você quer lutar?|
|$fallen_viking_randomstart_18|Finalmente!|
|$fallen_viking_randomstart_19|Vamos duelar?|
|$fallen_viking_randomstart_2|Me mostre o que você sabe fazer!|
|$fallen_viking_randomstart_20|Não tenha vergonha. Lute comigo!|
|$fallen_viking_randomstart_3|Prove seu valor!|
|$fallen_viking_randomstart_4|Você está à altura?|
|$fallen_viking_randomstart_5|Vamos ver se está à altura!|
|$fallen_viking_randomstart_6|Acha que pode me derrotar?|
|$fallen_viking_randomstart_7|Que vença quem lutar melhor!|
|$fallen_viking_randomstart_8|Vamos ver quem é mais forte?|
|$fallen_viking_randomstart_9|Um desafio, finalmente!|
|$fallen_viking_randomtaunt_1|Isso é o melhor que você pode fazer?|
|$fallen_viking_randomtaunt_10|Isto é uma piada?|
|$fallen_viking_randomtaunt_11|Isto é tudo que pode fazer?|
|$fallen_viking_randomtaunt_12|O que mais você pode fazer?|
|$fallen_viking_randomtaunt_13|Isso sim que é uma luta!|
|$fallen_viking_randomtaunt_14|Que o sangue manche o solo!|
|$fallen_viking_randomtaunt_15|Mostre seu valor, então! Vamos!|
|$fallen_viking_randomtaunt_16|Ataque com toda a sua força!|
|$fallen_viking_randomtaunt_17|Já encontrei ratos mais ferozes que você!|
|$fallen_viking_randomtaunt_18|Uma colher velha bateria mais forte que você!|
|$fallen_viking_randomtaunt_19|Que vergonhoso!|
|$fallen_viking_randomtaunt_2|Venha! Lute comigo!|
|$fallen_viking_randomtaunt_20|Você é o melhor que conseguiram trazer até aqui?|
|$fallen_viking_randomtaunt_21|Realmente deixam qualquer pessoa pegar uma arma hoje em dia!|
|$fallen_viking_randomtaunt_22|Não humilhe nossos ancestrais!|
|$fallen_viking_randomtaunt_23|Uma criança poderia lutar melhor!|
|$fallen_viking_randomtaunt_24|Tem certeza que você é mesmo viking?|
|$fallen_viking_randomtaunt_25|Vamos lá, isso não pode ser tudo!|
|$fallen_viking_randomtaunt_26|Que esforço patético! De novo!|
|$fallen_viking_randomtaunt_27|Chama isso de lutar?|
|$fallen_viking_randomtaunt_28|E você se considera forte?|
|$fallen_viking_randomtaunt_29|Alguém já te ensinou qualquer técnica de posicionamento?|
|$fallen_viking_randomtaunt_3|Você pode fazer melhor que isso!|
|$fallen_viking_randomtaunt_30|Essa é mesmo a arma que você vai usar nesta luta?|
|$fallen_viking_randomtaunt_31|Um cinzento tem mais elegância que você!|
|$fallen_viking_randomtaunt_32|Será que as valquírias cometeram um erro com você?|
|$fallen_viking_randomtaunt_33|Não se contenha!|
|$fallen_viking_randomtaunt_34|Seus golpes precisam ser certeiros!|
|$fallen_viking_randomtaunt_35|Não há lugar para fraqueza!|
|$fallen_viking_randomtaunt_36|Esperei por isto por muito tempo!|
|$fallen_viking_randomtaunt_37|Deseja que eu acabe com você?|
|$fallen_viking_randomtaunt_38|Não é possível que isso seja o seu melhor!|
|$fallen_viking_randomtaunt_39|Você não veio tão longe por nada!|
|$fallen_viking_randomtaunt_4|Certamente esta não é toda a sua força?|
|$fallen_viking_randomtaunt_40|Você precisa estar em harmonia com sua arma!|
|$fallen_viking_randomtaunt_5|Isto é tudo?|
|$fallen_viking_randomtaunt_6|Você tem que ser mais forte que isto!|
|$fallen_viking_randomtaunt_7|Você é quem deveria estar à altura?|
|$fallen_viking_randomtaunt_8|Não nos envergonhe!|
|$fallen_viking_randomtaunt_9|Você está se esquecendo do seu lugar!|
|$fallenwarrior_title1_f|{name}, a Aventureira|
|$fallenwarrior_title1_m|{name}, o Aventureiro|
|$fallenwarrior_title10_f|{name}, a Corajosa|
|$fallenwarrior_title10_m|{name}, o Corajoso|
|$fallenwarrior_title100_f|{name}, a Loba|
|$fallenwarrior_title100_m|{name}, o Lobo|
|$fallenwarrior_title101_f|{name}, a Jovem|
|$fallenwarrior_title101_m|{name}, o Jovem|
|$fallenwarrior_title11_f|{name}, a Radiante|
|$fallenwarrior_title11_m|{name}, o Radiante|
|$fallenwarrior_title12_f|{name}, a Quebrada|
|$fallenwarrior_title12_m|{name}, o Quebrado|
|$fallenwarrior_title13_f|{name}, a Construtora de Cidades|
|$fallenwarrior_title13_m|{name}, o Construtor de Cidades|
|$fallenwarrior_title14_f|{name}, a Calma|
|$fallenwarrior_title14_m|{name}, o Calmo|
|$fallenwarrior_title15_f|{name}, a Campeã|
|$fallenwarrior_title15_m|{name}, o Campeão|
|$fallenwarrior_title16_f|{name}, a Alegre|
|$fallenwarrior_title16_m|{name}, o Alegre|
|$fallenwarrior_title17_f|{name}, a Escolhida|
|$fallenwarrior_title17_m|{name}, o Escolhido|
|$fallenwarrior_title18_f|{name}, a Esperta|
|$fallenwarrior_title18_m|{name}, o Esperto|
|$fallenwarrior_title19_f|{name}, a Fria|
|$fallenwarrior_title19_m|{name}, o Frio|
|$fallenwarrior_title2_f|{name}, a Nefasta|
|$fallenwarrior_title2_m|{name}, o Nefasto|
|$fallenwarrior_title20_f|{name}, a Conquistadora|
|$fallenwarrior_title20_m|{name}, o Conquistador|
|$fallenwarrior_title21_f|{name}, a Cortejadora da Morte|
|$fallenwarrior_title21_m|{name}, o Cortejador da Morte|
|$fallenwarrior_title22_f|{name}, a Maldita|
|$fallenwarrior_title22_m|{name}, o Maldito|
|$fallenwarrior_title23_f|{name}, a Perigosa|
|$fallenwarrior_title23_m|{name}, o Perigoso|
|$fallenwarrior_title24_f|{name}, a Portadora da Morte|
|$fallenwarrior_title24_m|{name}, o Portador da Morte|
|$fallenwarrior_title25_f|{name}, a Enganadora|
|$fallenwarrior_title25_m|{name}, o Enganador|
|$fallenwarrior_title26_f|{name}, a Exigente|
|$fallenwarrior_title26_m|{name}, o Exigente|
|$fallenwarrior_title27_f|{name}, a Dragoa|
|$fallenwarrior_title27_m|{name}, o Dragão|
|$fallenwarrior_title28_f|{name}, a Águia|
|$fallenwarrior_title28_m|{name}, a Águia|
|$fallenwarrior_title29_f|{name}, a Exploradora|
|$fallenwarrior_title29_m|{name}, o Explorador|
|$fallenwarrior_title3_f|{name}, a Ursa|
|$fallenwarrior_title3_m|{name}, o Urso|
|$fallenwarrior_title30_f|{name}, a Temida|
|$fallenwarrior_title30_m|{name}, o Temido|
|$fallenwarrior_title31_f|{name}, a Feroz|
|$fallenwarrior_title31_m|{name}, o Feroz|
|$fallenwarrior_title32_f|{name}, a Lutadora|
|$fallenwarrior_title32_m|{name}, o Lutador|
|$fallenwarrior_title33_f|{name}, a Esquecida|
|$fallenwarrior_title33_m|{name}, o Esquecido|
|$fallenwarrior_title34_f|{name}, a Generosa|
|$fallenwarrior_title34_m|{name}, o Generoso|
|$fallenwarrior_title35_f|{name}, a Gananciosa|
|$fallenwarrior_title35_m|{name}, o Ganancioso|
|$fallenwarrior_title36_f|{name}, a Sinistra|
|$fallenwarrior_title36_m|{name}, o Sinistro|
|$fallenwarrior_title37_f|{name}, a Horripilante|
|$fallenwarrior_title37_m|{name}, o Horripilante|
|$fallenwarrior_title38_f|{name}, a Criadora de Reis|
|$fallenwarrior_title38_m|{name}, o Criador de Reis|
|$fallenwarrior_title39_f|{name}, a Sábia|
|$fallenwarrior_title39_m|{name}, o Sábio|
|$fallenwarrior_title4_f|{name}, a Derrotada|
|$fallenwarrior_title4_m|{name}, o Derrotado|
|$fallenwarrior_title40_f|{name}, a Lendária|
|$fallenwarrior_title40_m|{name}, o Lendário|
|$fallenwarrior_title41_f|{name}, a Repugnante|
|$fallenwarrior_title41_m|{name}, o Repugnante|
|$fallenwarrior_title42_f|{name}, a Solitária|
|$fallenwarrior_title42_m|{name}, o Solitário|
|$fallenwarrior_title43_f|{name}, a Perdida|
|$fallenwarrior_title43_m|{name}, o Perdido|
|$fallenwarrior_title44_f|{name}, a Leal|
|$fallenwarrior_title44_m|{name}, o Leal|
|$fallenwarrior_title45_f|{name}, a Sortuda|
|$fallenwarrior_title45_m|{name}, o Sortudo|
|$fallenwarrior_title46_f|{name}, a Marcada|
|$fallenwarrior_title46_m|{name}, o Marcado|
|$fallenwarrior_title47_f|{name}, a Poderosa|
|$fallenwarrior_title47_m|{name}, o Poderoso|
|$fallenwarrior_title48_f|{name}, a Caminhante de Montanhas|
|$fallenwarrior_title48_m|{name}, o Caminhante de Montanhas|
|$fallenwarrior_title49_f|{name}, a Misteriosa|
|$fallenwarrior_title49_m|{name}, o Misterioso|
|$fallenwarrior_title5_f|{name}, a Bela|
|$fallenwarrior_title5_m|{name}, o Belo|
|$fallenwarrior_title50_f|{name}, a Velha|
|$fallenwarrior_title50_m|{name}, o Velho|
|$fallenwarrior_title51_f|{name}, a Saqueadora|
|$fallenwarrior_title51_m|{name}, o Saqueador|
|$fallenwarrior_title52_f|{name}, a Orgulhosa|
|$fallenwarrior_title52_m|{name}, o Orgulhoso|
|$fallenwarrior_title53_f|{name}, a Rápida|
|$fallenwarrior_title53_m|{name}, o Rápido|
|$fallenwarrior_title54_f|{name}, a Invasora|
|$fallenwarrior_title54_m|{name}, o Invasor|
|$fallenwarrior_title55_f|{name}, a Devastadora|
|$fallenwarrior_title55_m|{name}, o Devastador|
|$fallenwarrior_title56_f|{name}, o Corvo|
|$fallenwarrior_title56_m|{name}, o Corvo|
|$fallenwarrior_title57_f|{name}, a Restauradora|
|$fallenwarrior_title57_m|{name}, o Restaurador|
|$fallenwarrior_title58_f|{name}, a Rubra|
|$fallenwarrior_title58_m|{name}, o Rubro|
|$fallenwarrior_title59_f|{name}, a Foliã|
|$fallenwarrior_title59_m|{name}, o Folião|
|$fallenwarrior_title6_f|{name}, a Berserker|
|$fallenwarrior_title6_m|{name}, o Berserker|
|$fallenwarrior_title60_f|{name}, a Rica|
|$fallenwarrior_title60_m|{name}, o Rico|
|$fallenwarrior_title61_f|{name}, a Soberana|
|$fallenwarrior_title61_m|{name}, o Soberano|
|$fallenwarrior_title62_f|{name}, a Desfigurada|
|$fallenwarrior_title62_m|{name}, o Desfigurado|
|$fallenwarrior_title63_f|{name}, a Marinheira|
|$fallenwarrior_title63_m|{name}, o Marinheiro|
|$fallenwarrior_title64_f|{name}, a Caçadora da Glória|
|$fallenwarrior_title64_m|{name}, o Caçador da Glória|
|$fallenwarrior_title65_f|{name}, a Mercenária|
|$fallenwarrior_title65_m|{name}, o Mercenário|
|$fallenwarrior_title66_f|{name}, a Assombrada|
|$fallenwarrior_title66_m|{name}, o Assombrado|
|$fallenwarrior_title67_f|{name}, a Incisiva|
|$fallenwarrior_title67_m|{name}, o Incisivo|
|$fallenwarrior_title68_f|{name}, a Construtora de Embarcações|
|$fallenwarrior_title68_m|{name}, o Construtor de Embarcações|
|$fallenwarrior_title69_f|{name}, a Sabotadora de Embarcações|
|$fallenwarrior_title69_m|{name}, o Sabotador de Embarcações|
|$fallenwarrior_title7_f|{name}, a Sanguinária|
|$fallenwarrior_title7_m|{name}, o Sanguinário|
|$fallenwarrior_title70_f|{name}, a Linguaruda|
|$fallenwarrior_title70_m|{name}, o Linguarudo|
|$fallenwarrior_title71_f|{name}, a Escalda|
|$fallenwarrior_title71_m|{name}, o Escaldo|
|$fallenwarrior_title72_f|{name}, a Abatedora|
|$fallenwarrior_title72_m|{name}, o Abatedor|
|$fallenwarrior_title73_f|{name}, a Assassina|
|$fallenwarrior_title73_m|{name}, o Assassino|
|$fallenwarrior_title74_f|{name}, a Soldada|
|$fallenwarrior_title74_m|{name}, o Soldado|
|$fallenwarrior_title75_f|{name}, a Imponente|
|$fallenwarrior_title75_m|{name}, o Imponente|
|$fallenwarrior_title76_f|{name}, a Vingativa|
|$fallenwarrior_title76_m|{name}, o Vingativo|
|$fallenwarrior_title77_f|{name}, a Sisuda|
|$fallenwarrior_title77_m|{name}, o Sisudo|
|$fallenwarrior_title78_f|{name}, a Estoica|
|$fallenwarrior_title78_m|{name}, o Estoico|
|$fallenwarrior_title79_f|{name}, a Filha da Tempestade|
|$fallenwarrior_title79_m|{name}, o Filho da Tempestade|
|$fallenwarrior_title8_f|{name}, a Cruel|
|$fallenwarrior_title8_m|{name}, o Cruel|
|$fallenwarrior_title80_f|{name}, a Estranha|
|$fallenwarrior_title80_m|{name}, o Estranho|
|$fallenwarrior_title81_f|{name}, a Forte|
|$fallenwarrior_title81_m|{name}, o Forte|
|$fallenwarrior_title82_f|{name}, a Contadora de Histórias|
|$fallenwarrior_title82_m|{name}, o Contador de Histórias|
|$fallenwarrior_title83_f|{name}, a Viajante|
|$fallenwarrior_title83_m|{name}, o Viajante|
|$fallenwarrior_title84_f|{name}, a Malandra|
|$fallenwarrior_title84_m|{name}, o Malandro|
|$fallenwarrior_title85_f|{name}, a Autêntica|
|$fallenwarrior_title85_m|{name}, o Autêntico|
|$fallenwarrior_title86_f|{name}, a Invicta|
|$fallenwarrior_title86_m|{name}, o Invicto|
|$fallenwarrior_title87_f|{name}, a Azarona|
|$fallenwarrior_title87_m|{name}, o Azarão|
|$fallenwarrior_title88_f|{name}, a Imortal|
|$fallenwarrior_title88_m|{name}, o Imortal|
|$fallenwarrior_title89_f|{name}, a Unificadora|
|$fallenwarrior_title89_m|{name}, o Unificador|
|$fallenwarrior_title9_f|{name}, a Ousada|
|$fallenwarrior_title9_m|{name}, o Ousado|
|$fallenwarrior_title90_f|{name}, a Indiferente|
|$fallenwarrior_title90_m|{name}, o Indiferente|
|$fallenwarrior_title91_f|{name}, a Desocupada|
|$fallenwarrior_title91_m|{name}, o Desocupado|
|$fallenwarrior_title92_f|{name}, a Vencedora|
|$fallenwarrior_title92_m|{name}, o Vencedor|
|$fallenwarrior_title93_f|{name}, a Vitoriosa|
|$fallenwarrior_title93_m|{name}, o Vitorioso|
|$fallenwarrior_title94_f|{name}, a Violenta|
|$fallenwarrior_title94_m|{name}, o Violento|
|$fallenwarrior_title95_f|{name}, a Víbora|
|$fallenwarrior_title95_m|{name}, a Víbora|
|$fallenwarrior_title96_f|{name}, a Andarilha|
|$fallenwarrior_title96_m|{name}, o Andarilho|
|$fallenwarrior_title97_f|{name}, a Vigilante|
|$fallenwarrior_title97_m|{name}, o Vigilante|
|$fallenwarrior_title98_f|{name}, a Selvagem|
|$fallenwarrior_title98_m|{name}, o Selvagem|
|$fallenwarrior_title99_f|{name}, a Sensata|
|$fallenwarrior_title99_m|{name}, o Sensato|
|$feedback_bug|Erro|
...
|$fimbulvinterorb|Orbe do Fimbulvinter|
|$fimbulvinterorb_destroyed|A Retirada dos Jotun|
|$fimbulvinterorb_start|O Avanço dos Jotun|
...
|$hud_addfavorite|Adicionar favorito|
|$hud_addfavoritecategory|Adicionar categoria...|
|$hud_addfavoritecategory_popupheader|Adicionar categoria|
|$hud_addfavoritecategory_popuptext|Digite o nome da categoria:|
...
|$hud_byusage|Por uso|
|$hud_categories|Categorias|
|$hud_category|Categoria|
|$hud_changeorientation|Mudar orientação|
|$hud_copypiece|Copiar|
|$hud_crafting|Produção|
|$hud_crossoffpin|Adicionar um X no marcador|
|$hud_cyclesnap|Alternar encaixes|
|$hud_deletecategory|Excluir categoria|
|$hud_eitrrequired|Requer éter|
|$hud_emotes_blowkiss|Mandar beijo|
|$hud_emotes_bow|Reverência|
|$hud_emotes_challenge|Desafiar|
|$hud_emotes_cheer|Torcer|
|$hud_emotes_comehere|Vem cá|
|$hud_emotes_cower|Encolher-se|
|$hud_emotes_cry|Choro|
|$hud_emotes_dance|Dançar|
|$hud_emotes_despair|Desespero|
|$hud_emotes_flex|Exibir músculos|
|$hud_emotes_headbang|Bate cabeça|
|$hud_emotes_kneel|Ajoelhar-se|
|$hud_emotes_laugh|Risada|
|$hud_emotes_loveyou|Te amo|
|$hud_emotes_nonono|Não, não e não|
|$hud_emotes_point|Apontar|
|$hud_emotes_relax|Relaxar|
|$hud_emotes_rest|Descansar|
|$hud_emotes_roar|Rugido|
|$hud_emotes_shrug|Dar de ombros|
|$hud_emotes_sit|Sentar-se|
|$hud_emotes_thumbsup|Positivo|
|$hud_emotes_toast|Brindar|
|$hud_emotes_vibe|Curtir|
|$hud_emotes_wave|Acenar|
|$hud_equipping|Equipando|
|$hud_extrainvslot1|Bolsos maiores|
|$hud_extrainvslot1_tooltip|Uma algibeira prática para armazenar seus itens.|
|$hud_extrainvslot2|Bolsos mais fundos|
|$hud_extrainvslot2_tooltip|Uma bolsa prática para armazenar seus itens.|
|$hud_favorites|Favoritos|
|$hud_feasts|Banquetes|
|$hud_food|Comida|
|$hud_furniture|Mobília|
|$hud_hidden_messagehud_notification|Interface desativada. Para ativar, pressione Ctrl + F3|
|$hud_hidden_messagehud_notification_gamepad|Interface desativada. Para ativar, pressione|
...
|$hud_maxsummonsreached_spiritcaller|Seu Invocador de espíritos não é forte o suficiente para controlar mais invocações|
...
|$hud_on|Lig.|
|$hud_pet|Acariciar|
|$hud_pin_dnboss|Passagem dos Aesir|
...
|$inventory_achievement_secret_description|Só Odin sabe o que está escondido aqui.|
|$inventory_achievements|Conquistas|
...
|$inventory_needspace|Você precisa de mais espaço livre no inventário|
...
|$inventory_slightlyresistant|Ligeiramente resistente|
|$inventory_slightlyweak|Ligeiramente fraco|
...
|$inventory_stats|Estatísticas de jogador|
...
|$inventory_upgraderbutton|Tentar Refinar|
|$inventory_upgraderwarning|Máxima qualidade segura. O refinamento pode danificar seu item.|
...
|$item_ancientcoin|Moeda antiga|
|$item_ancientcoin_description|Uma relíquia de uma era perdida. Sua superfície ainda carrega traços de símbolos misteriosos.|
|$item_ancientgemstone_black|Draumyx|
|$item_ancientgemstone_black_description|Uma gema escura e opaca com uma superfície lisa e polida.|
|$item_ancientgemstone_green|Grimvarn|
|$item_ancientgemstone_green_description|Uma gema verde impressionante, cuja cor lembra florestas densas.|
|$item_ancientgemstone_orange|Solryth|
|$item_ancientgemstone_orange_description|Uma pedra laranja vibrante como um pôr do sol de verão.|
|$item_ancientgemstone_purple|Veydris|
|$item_ancientgemstone_purple_description|Uma suntuosa pedra roxa, adequada para a realeza.|
...
|$item_armor|Armadura|
|$item_arrow_bloodgold|Flecha de ourossangue|
|$item_arrow_bloodgold_description|Uma flecha forjada com o que podem ser os materiais mais rígidos deste mundo...|
...
|$item_atgeir_gold_bloodlightning|Atgeir de trovossangue|
|$item_atgeir_gold_bloodlightning_description|Os céus reverberam elogios enquanto você faz seus inimigos sangrarem.|
|$item_atgeir_gold_bloodlightning_uncooked|Peça fundida: Atgeir de trovossangue|
|$item_atgeir_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_atgeir_gold_description|A lâmina desta arma é tão mortal quanto é brilhante.|
|$item_atgeir_gold_frostfire|Atgeir de fogogelo|
|$item_atgeir_gold_frostfire_description|Deixe que as chamas comecem a devorar, e o gelo se apossará do que sobrar.|
|$item_atgeir_gold_frostfire_uncooked|Peça fundida: Atgeir de fogogelo|
|$item_atgeir_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_atgeir_gold_uncooked|Peça fundida: Atgeir Nord|
|$item_atgeir_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_atgeir_wood|Atgeir de madeira|
|$item_atgeir_wood_description|Pode não ferir muito, mas tem alcance!|
...
|$item_axe_early|Machados primitivos|
|$item_axe_early_description|Armas poderosas de um passado distante, de uma época em que o mundo ainda era jovem e incompleto...|
|$item_axe_flint|Machado de sílex|
|$item_axe_flint_description|Mais afiado do que pedra.|
|$item_axe_gold|Machado Nord|
|$item_axe_gold_bloodlightning|Machado de trovossangue|
|$item_axe_gold_bloodlightning_description|Conforme este machado cortar madeira e carne da mesma forma, um retumbante trovão será ouvido em toda a terra.|
|$item_axe_gold_bloodlightning_uncooked|Peça fundida: Machado de trovossangue|
|$item_axe_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_axe_gold_description|Um machado detalhado com refino para derrubar seus inimigos com refino.|
|$item_axe_gold_frostfire|Machado de fogogelo|
|$item_axe_gold_frostfire_description|Queime tudo pela frente, ou congele em um momento eterno de destruição no tempo...|
|$item_axe_gold_frostfire_uncooked|Peça fundida: Machado de fogogelo|
|$item_axe_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_axe_gold_uncooked|Peça fundida: Machado Nord|
|$item_axe_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_axe_wood|Machado de madeira|
|$item_axe_wood_description|Se este machado pudesse cortar madeira, isso não seria estranho?|
|$item_axe2h_gold|Grão-machado Nord|
|$item_axe2h_gold_bloodlightning|Grão-machado de trovossangue|
|$item_axe2h_gold_bloodlightning_description|Enquanto você parte os inimigos ao meio, o sangue deles ressoará como uma tempestade.|
|$item_axe2h_gold_bloodlightning_uncooked|Peça fundida: Grão-machado de trovossangue|
|$item_axe2h_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_axe2h_gold_description|Um machado poderoso para guerreiros poderosos.|
|$item_axe2h_gold_frostfire|Grão-machado de fogogelo|
|$item_axe2h_gold_frostfire_description|Ataque seus inimigos com um inferno congelado!|
|$item_axe2h_gold_frostfire_uncooked|Peça fundida: Grão-machado de fogogelo|
|$item_axe2h_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_axe2h_gold_uncooked|Peça fundida: Grão-machado Nord|
|$item_axe2h_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
|$item_axehead1|Cabeça de machado curiosa|
|$item_axehead1_description|O metal reluz de maneira curiosa com a luz do sol. De alguma forma, você sabe que ele nunca estará completo sozinho...|
|$item_axehead2|Cabeça de machado misteriosa|
|$item_axehead2_description|Que batalhas esta arma testemunhou? Não é possível ver seu passado, resta apenas moldar o futuro...|
|$item_backstab|Facada nas costas|
|$item_bakedpoteitr|Batáter assada|
|$item_bakedpoteitr_description|Nem cozido, nem amassado, nem ensopado. Mesmo assim, delicioso!|
|$item_bakedpoteitr_uncooked|Batáter crua|
|$item_bakedpoteitr_uncooked_description|Pronta para assar.|
|$item_barberkit|Kit de barbearia|
|$item_barberkit_description|Um kit ideal para os melhores barbeiros.|
|$item_barkabranch|Galho congelado|
|$item_barkabranch_description|Este pedaço de madeira já teve vida e energia. Um estranho ar mágico ainda o envolve.|
|$item_barley|Cevada|
...
|$item_battleaxe_blackmetal|Machado de guerra de metal negro|
|$item_battleaxe_blackmetal_description|Verde será a última coisa que seus inimigos verão antes de você os partir ao meio.|
...
|$item_battleaxe_gold_uncooked|Peça fundida: Grão-machado Nord|
|$item_battleaxe_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
|$item_battleaxe_skullsplittur|Quebra-crânios|
|$item_battleaxe_skullsplittur_description|Encontrará crânios para quebrar mesmo nas névoas mais densas.|
|$item_battleaxe_wood|Machado de guerra de madeira|
|$item_battleaxe_wood_description|Intimidante, mas não tanto quanto o verdadeiro.|
...
|$item_bjorn_meat|Carne de urso|
|$item_bjorn_meat_cooked|Carne de urso cozida|
|$item_bjorn_meat_cooked_description|Tem gosto de vitória.|
|$item_bjorn_meat_description|Essa carne gordurosa já foi destinada a sustentar um corpo durante a hibernação.|
|$item_bjornhide|Pele de urso|
|$item_bjornhide_description|Uma pele espessa e peluda, áspera, mas incrivelmente macia.|
|$item_bjornpaw|Pata de urso|
|$item_bjornpaw_description|Garras afiadas, adequadas para colher frutas – ou para esquartejar.|
...
|$item_blobvial|Frasco tampado|
|$item_blobvial_description|Espesso o suficiente para conter algo volátil, mas frágil o bastante para ser estilhaçado.|
...
|$item_bloodgoldkey|Chave intrincada|
|$item_bloodgoldkey_description|Se há uma chave, então certamente deve haver uma fechadura.|
|$item_bloodpudding|Pudim de sangue|
|$item_bloodpudding_description|Delícia de lamber os beiços.|
|$item_blubber|Gordura de foca|
|$item_blubber_cooked|Gordura de foca cozida|
|$item_blubber_cooked_description|Difícil de mastigar, com sabor de remorso.|
|$item_blubber_description|A gordura isolante de uma criatura adaptada às águas do norte.|
...
|$item_bolt_bloodgold|Virote de ourossangue|
|$item_bolt_bloodgold_description|Um virote forjado com o que podem ser os materiais mais rígidos deste mundo...|
...
|$item_bomb_dynamite_description|Brasas aprisionadas, prontas para explodir. Tome cuidado.|
|$item_bombblob_frost|Bomba de bolha: Gelo|
|$item_bombblob_frost_description|Se você segurá-la por muito tempo, sua mão pode simplesmente congelar no lugar.|
|$item_bombblob_lava|Bomba de bolha: Lava|
|$item_bombblob_lava_description|O frasco está quente em sua mão, prometendo destruição ígnea.|
|$item_bombblob_morkhalla|Bomba-bolha: Massa|
|$item_bombblob_morkhalla_description|Uma masmorra é o lugar das bolhas.|
|$item_bombblob_poison|Bomba de bolha: veneno|
|$item_bombblob_poison_description|Caso este frasco se quebre, a cautela é fortemente recomendada.|
|$item_bombblob_poisonelite|Bomba de bolha: Veneno elite|
|$item_bombblob_poisonelite_description|Não é recomendado respirar os vapores.|
|$item_bombblob_tar|Bomba de bolha: Betume|
|$item_bombblob_tar_description|A substância pegajosa dentro pulsa, como se estivesse te ameaçando.|
...
|$item_bow_gold_bloodlightning|Arco de trovossangue|
|$item_bow_gold_bloodlightning_description|A eletricidade dança pela corda, aguardando ser libertada.|
|$item_bow_gold_bloodlightning_uncooked|Peça fundida: Arco de trovossangue|
|$item_bow_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_bow_gold_description|Este arco encontra o alvo com precisão áurea.|
|$item_bow_gold_frostfire|Arco de fogogelo|
|$item_bow_gold_frostfire_description|Mantenha a calma ao preparar o arco e então solte sua fúria com as flechas.|
|$item_bow_gold_frostfire_uncooked|Peça fundida: Arco de fogogelo|
|$item_bow_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_bow_gold_uncooked|Peça fundida: Arco Nord|
|$item_bow_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_cape_deepnorth|Capa de pele de alce|
|$item_cape_deepnorth_description|Uma capa quente com detalhes delicados em fios de ouro.|
|$item_cape_deepnorth_mage|Capa do Invocador|
|$item_cape_deepnorth_mage_description|Uma estranha magia está tecida nesta capa, tornando-a leve e quente.|
...
|$item_catapult_bloodgold_ammo|Carga de ourossangue|
|$item_catapult_bloodgold_ammo_description|Acerte em cheio e faça sangrar.|
...
|$item_chest_berserker|Padrões de urso|
|$item_chest_berserker_description|Se esses desenhos complexos podem proteger guerreiros de terras distantes, certamente podem proteger você também.|
|$item_chest_berserker_undead|Gaiola de ossos malditos|
|$item_chest_berserker_undead_description|Feita a partir dos ossos despedaçados de um urso atormentado.|
...
|$item_chest_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_chest_heavy_deepnorth|Peitoral do Protetor|
|$item_chest_heavy_deepnorth_description|Pele, couro e metal trabalham em conjunto para evitar os golpes inimigos.|
|$item_chest_heavy_gold_uncooked|Peça fundida: Peitoral do Protetor|
|$item_chest_heavy_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_chest_lox|Jaqueta de Pele de Lox|
|$item_chest_lox_description|Um cheiro forte ainda permanece nele.|
...
|$item_chest_mage_deepnorth|Manto do Invocador|
|$item_chest_mage_deepnorth_description|Um manto com detalhes em ouro, adequado somente para os magos mais poderosos.|
...
|$item_chest_mage_gold_uncooked|Peça fundida: Manto do Invocador|
|$item_chest_mage_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_chest_medium_deepnorth|Peitoral da Vanguarda|
|$item_chest_medium_deepnorth_description|Uma armadura de couro produzida com maestria, oferecendo excelente proteção sem limitar os movimentos de um guerreiro.|
|$item_chest_medium_gold_uncooked|Peça fundida: Peitoral da Vanguarda|
|$item_chest_medium_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_cloudberries|Amora do Ártico|
...
|$item_crossbow_bloodlightning_gold|Besta de trovossangue|
|$item_crossbow_bloodlightning_gold_description|A arma pulsa com poder acumulado, como o ar antes de um raio.|
|$item_crossbow_bloodlightning_gold_uncooked|Peça fundida: Besta de trovossangue|
|$item_crossbow_bloodlightning_gold_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_crossbow_frostfire_gold|Besta de fogogelo|
|$item_crossbow_frostfire_gold_description|Se os inimigos não congelarem ao cair sob sua mira, certamente farão isso ao serem atingidos.|
|$item_crossbow_frostfire_gold_uncooked|Peça fundida: Besta de fogogelo|
|$item_crossbow_frostfire_gold_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_crossbow_gold|Besta Nord|
|$item_crossbow_gold_description|Uma força incrível está vinculada a esta arma, aguardando sua liberdade.|
|$item_crossbow_gold_uncooked|Peça fundida: Besta Nord|
|$item_crossbow_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_crownjewel|Joia da Coroa|
|$item_crownjewel_description|Um poder estranho surge dentro dessa gema, diferente de tudo que você já sentiu antes.|
...
|$item_cultivator_remove_description|Retire as sementes do solo para plantá-las em outro momento.|
...
|$item_ectoplasm_description|Uma essência inquieta de algo que já foi vivo...|
...
|$item_eitrhitreturn|Retorno de éter|
|$item_eitrregen_modifier|Regeneração de éter|
|$item_eitruse|Usar éter|
|$item_elakinghairbundle|Feixe de pelos de elaking|
|$item_elakinghairbundle_description|O pelo é denso, áspero e surpreendentemente limpo.|
...
|$item_faderember_description|Cada brasa no ar é um desejo ardente por penitência.|
...
|$item_feastdeepnorth|Café da manhã do norte|
|$item_feastdeepnorth_description|Quente e substancial, esta refeição sustentará você mesmo no dia mais frio. Mingau e panquecas combinam bem com geleias e salsichas, então é difícil não repetir o prato!|
...
|$item_fircone_big|Cone de árvore de madeira de construção|
|$item_fircone_big_description|Plante-o para cultivar uma árvore de madeira de construção.|
...
|$item_fishsoup|Sopa de peixe|
|$item_fishsoup_description|Um mar de sabores!|
|$item_fishwraps|Embrulhos de peixe|
|$item_fishwraps_description|Pão e peixe, o que mais se pode querer?|
|$item_fistweapon_bjorn|Patas de urso|
|$item_fistweapon_bjorn_description|Feitas para rasgar e dilacerar.|
|$item_fistweapon_bjorn_undead|Garras de ossos malditos|
|$item_fistweapon_bjorn_undead_description|Estas garras rasgarão carne e ossos igualmente.|
...
|$item_fistweapon_frostfire_gold|Soqueiras de fogogelo|
|$item_fistweapon_frostfire_gold_description|Um leve risco de geladura é inevitável.|
|$item_fistweapon_frostfire_gold_uncooked|Peça fundida: Soqueiras de fogogelo|
|$item_fistweapon_frostfire_gold_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_fistweapon_gold|Soqueiras Nord|
|$item_fistweapon_gold_bloodlightning|Soqueiras de trovossangue|
|$item_fistweapon_gold_bloodlightning_description|Uma fúria se apossa de você ao lutar com estas armas, e seu sangue ruge como trovão nos seus ouvidos... Parece apropriado.|
|$item_fistweapon_gold_bloodlightning_uncooked|Peça fundida: Soqueiras de trovossangue|
|$item_fistweapon_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_fistweapon_gold_description|Envolva os punhos com o metal mais resistente e garanta que os inimigos sintam a força dos seus golpes.|
|$item_fistweapon_gold_uncooked|Peça fundida: Soqueiras Nord|
|$item_fistweapon_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_frostcore|Núcleo de geada|
|$item_frostcore_description|Terrivelmente frio ao toque, cheio de energia congelada.|
|$item_frostorbs_uncooked|Peça fundida: Vingança do norte|
|$item_frostorbs_uncooked_description|Este item mágico precisa ser endurecido pela geada.|
|$item_frostwood|Madeira de construção|
|$item_frostwood_description|Um tipo de madeira resistente, excelente para salões grandiosos.|
|$item_frozenfuel|Geada líquida|
|$item_frozenfuel_description|A magia impregnou este gelo, transformando-o em algo completamente diferente.|
|$item_frozenking_drop|Sangue sacrificial|
|$item_frozenking_drop_description|A última essência de um fim prenunciado.|
|$item_fryslingcore|Núcleo de frysling|
|$item_fryslingcore_description|Contém um frio insuportável.|
|$item_fulladrenaline|Efeito de adrenalina|
...
|$item_glowworm_description|Pegajosa, mas satisfatória.|
|$item_goblintotem|Totem Fuling|
|$item_goblintotem_description|Canaliza o poder antigo de Yagluth.|
|$item_gold|Ourossangue|
|$item_gold_description|Metal precioso, infundido com a essência de um ser vivo.|
|$item_goldore|Tecido petrificado|
|$item_goldore_description|Um material duro e resistente com muito potencial. Precisa ser refinado em um Alto-forno.|
|$item_graplinghook|Gancho|
|$item_graplinghook_description|Para uma entrada dramática, ou uma retirada rápida.|
...
|$item_hardrock|Rocha misteriosa|
|$item_hardrock_description|É só uma pedra...|
|$item_hardrock_knowledge1|Não tema a morte, pois a hora do seu fim já foi dada, e ninguém pode escapar dela.|
|$item_hardrock_knowledge10|Você pode se resguardar o quanto quiser, mas um dia alguém encontrará você.|
|$item_hardrock_knowledge11|Não importa por quanto sofrimento você passou, você nunca desejará abandonar essas memórias.|
|$item_hardrock_knowledge12|Ao sair da tempestade, você não será a mesma pessoa que entrou. Esse é o sentido da tempestade.|
|$item_hardrock_knowledge13|Uma rocha não sente dor, e uma ilha nunca chora.|
|$item_hardrock_knowledge2|É melhor lutar e perder do que viver sem esperança.|
|$item_hardrock_knowledge3|Runas você encontrará, e seus conhecimentos aprenderá, com suas magias poderosas e imponência maravilhosa.|
|$item_hardrock_knowledge4|Novos oceanos não podem ser descobertos a menos que se tenha a coragem de perder a costa de vista.|
|$item_hardrock_knowledge5|Quem tem um motivo para viver pode suportar quase qualquer coisa.|
|$item_hardrock_knowledge6|É pelo ferimento que a luz entra em você.|
|$item_hardrock_knowledge7|Sofremos mais na imaginação do que na realidade.|
|$item_hardrock_knowledge8|A dor é inevitável. O sofrimento é opcional.|
|$item_hardrock_knowledge9|O que quer que você estiver buscando não virá na forma que você espera.|
...
|$item_hatefulblood|Sangue maldoso|
|$item_hatefulbood_description|Tem algo perturbador nesta massa congelada coagulada.|
|$item_healthhitreturn|Vida recuperada após um golpe|
|$item_healthuse|Usar cura|
|$item_heat_modifier|Resistência a calor|
|$item_helmet_berserker|Cabeça de urso|
|$item_helmet_berserker_description|Deixe a fúria primordial de um urso poderoso te consumir.|
|$item_helmet_berserker_undead|Visagem de ossos malditos|
|$item_helmet_berserker_undead_description|Inspirando medo em inimigos e coragem em aliados quando usada.|
...
|$item_helmet_celebration|Chapéu comemorativo|
|$item_helmet_celebration_description|Não tem como não se sentir feliz usando esse chapéu!|
|$item_helmet_crown_of_valheim|Coroa de Valheim|
|$item_helmet_crown_of_valheim_description|Uma recompensa gloriosa para aqueles que merecem de verdade.|
...
|$item_helmet_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_helmet_heavy_deepnorth|Elmo do Protetor|
|$item_helmet_heavy_deepnorth_description|Adornado com as asas da vitória.|
|$item_helmet_heavy_gold_uncooked|Peça fundida: Elmo do Protetor|
|$item_helmet_heavy_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_helmet_lox|Capuz de Pele de Lox|
|$item_helmet_lox_description|Veja o mundo como ele é visto por um Lox.|
...
|$item_helmet_mage_deepnorth|Carapuça do Invocador|
|$item_helmet_mage_deepnorth_description|Os espíritos da terra atendem ao seu chamado. Terão sido enganados pelo seu disfarce?|
...
|$item_helmet_mage_gold_uncooked|Peça fundida: Carapuça do Invocador|
|$item_helmet_mage_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_helmet_medium_deepnorth|Capuz da Vanguarda|
|$item_helmet_medium_deepnorth_description|Algo para proteger o pescoço dos elementos e dos dentes afiados dos inimigos.|
|$item_helmet_medium_gold_uncooked|Peça fundida: Capuz da Vanguarda|
|$item_helmet_medium_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_helmet_rootcrown|Coroa de Raízes|
|$item_helmet_rootcrown_description|Um adereço de cabeça doloroso, mas ao mesmo tempo complexo.|
|$item_helmet_strawhat|Chapéu de palha|
|$item_helmet_strawhat_description|A forma ideal de se evitar insolação.|
|$item_helmet_sweatband|Faixa de cabeça|
|$item_helmet_sweatband_description|Está um pouco...úmida.|
...
|$item_hook|Gancho|
|$item_hook_description|Um item trabalhado com maestria, com muito potencial.|
|$item_ice|Gelo|
|$item_ice_description|Tão frio...|
|$item_iron|Ferro|
...
|$item_jotunpuffs_description|Um cogumelo revigorante que pode ser usado para cozinhar.|
...
|$item_kale|Couve|
|$item_kale_description|Uma verdura versátil.|
|$item_kalechips|Chips de couve|
|$item_kalechips_description|Verduras crocantes!|
|$item_kalechips_uncooked|Chips de couve crus|
|$item_kalechips_uncooked_description|Prontos para assar.|
|$item_kaleseeds|Sementes de couve|
|$item_kaleseeds_description|Plante para cultivar couve.|
|$item_keys_gold_uncooked|Peça fundida: Chave intrincada|
|$item_keys_gold_uncooked_description|As chaves precisam ser endurecidas pela geada.|
...
|$item_knife_gold|Adaga Nord|
|$item_knife_gold_bloodlightning|Adaga de trovossangue|
|$item_knife_gold_bloodlightning_description|A lâmina já está ensanguentada, mas brilha querendo mais.|
|$item_knife_gold_bloodlightning_uncooked|Peça fundida: Adaga de trovossangue|
|$item_knife_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_knife_gold_description|Um brilho dourado será a última coisa que seus inimigos verão na vida.|
|$item_knife_gold_frostfire|Adaga de fogogelo|
|$item_knife_gold_frostfire_description|Um corte desta lâmina arde como gelo e então queima como o fogo.|
|$item_knife_gold_frostfire_uncooked|Peça fundida: Adaga de fogogelo|
|$item_knife_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_knife_gold_uncooked|Peça fundida: Adaga Nord|
|$item_knife_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_knife_void|Invocadora do Vazio|
|$item_knife_void_description|Que responderá ao chamado do Vazio?|
|$item_knife_wood|Faca de madeira|
|$item_knife_wood_description|Algumas pessoas diriam que esta faca é melhor para a manteiga.|
...
|$item_lanternDN|Lanterna recuperada|
|$item_lanternDN_description|Uma antiga relíquia, largada e esquecida por alguém há muito tempo.|
...
|$item_leatherstraps|Tiras de couro|
|$item_leatherstraps_description|Um material resistente, mas flexível.|
|$item_legs_berserker|Tanga de urso|
|$item_legs_berserker_description|Cobre todas as partes importantes, mas não muito mais.|
|$item_legs_berserker_undead|Vestes de ossos malditos|
|$item_legs_berserker_undead_description|Peles grossas e fragmentos de ossos entrelaçados em uma saia áspera.|
...
|$item_legs_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
|$item_legs_heavy_deepnorth|Calças do Protetor|
|$item_legs_heavy_deepnorth_description|Calças e botas pesadas para manter você aquecido enquanto passa por neve profunda.|
|$item_legs_heavy_gold_uncooked|Peça fundida: Calças do Protetor|
|$item_legs_heavy_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_legs_lox|Calças de Pele de Lox|
|$item_legs_lox_description|Macias, silenciosas e flexíveis.|
...
|$item_legs_mage_deepnorth|Calças do Invocador|
|$item_legs_mage_deepnorth_description|Perneiras justas para evitar que o frio chegue à sua pele.|
...
|$item_legs_mage_gold_uncooked|Peça fundida: Calças do Invocador|
|$item_legs_mage_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_legs_medium_deepnorth|Calças da Vanguarda|
|$item_legs_medium_deepnorth_description|Calças quentes adequadas para um clima frio. As botas oferecem excelente tração em terreno congelado.|
|$item_legs_medium_gold_uncooked|Peça fundida: Calças da Vanguarda|
|$item_legs_medium_gold_uncooked_description|Esta armadura precisa ser endurecida pela geada.|
...
|$item_lingonberries|Arandos|
|$item_lingonberries_description|Estas frutinhas ácidas podem crescer mesmo em climas frios.|
|$item_lingondricka|Suco de arando|
|$item_lingondricka_description|Combina bem com a maioria das comidas.|
|$item_loxmeat|Filé de Lox|
|$item_loxmeat_cooked|Filé de Lox grelhado|
...
|$item_mace_gold|Maça Nord|
|$item_mace_gold_bloodlightning|Maça de trovossangue|
|$item_mace_gold_bloodlightning_description|Uma arma que talvez faça páreo até mesmo à do deus do trovão...|
|$item_mace_gold_bloodlightning_uncooked|Peça fundida: Maça de trovossangue|
|$item_mace_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_mace_gold_description|Golpeie forte e rápido e não dê tempo para que seu inimigo se recupere.|
|$item_mace_gold_frostfire|Maça de fogogelo|
|$item_mace_gold_frostfire_description|Esta arma solta faíscas no impacto ou são lascas de gelo?|
|$item_mace_gold_frostfire_uncooked|Peça fundida: Maça de fogogelo|
|$item_mace_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_mace_gold_uncooked|Peça fundida: Maça Nord|
|$item_mace_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_mace_wood|Maça de madeira|
|$item_mace_wood_description|Fica a dúvida de por que alguém fez isso em vez de um simples porrete.|
|$item_mace2h_gold|Marreta Nord|
|$item_mace2h_gold_bloodlightning|Marreta de trovossangue|
|$item_mace2h_gold_bloodlightning_description|Os golpes certeiros desta arma ecoam pelo mundo todo...|
|$item_mace2h_gold_bloodlightning_uncooked|Peça fundida: Marreta de trovossangue|
|$item_mace2h_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_mace2h_gold_description|Com esta arma, seus golpes serão tão fortes quanto os de um troll.|
|$item_mace2h_gold_frostfire|Marreta de fogogelo|
|$item_mace2h_gold_frostfire_description|É tão fria que arde ou tão quente que congela?|
|$item_mace2h_gold_frostfire_uncooked|Peça fundida: Marreta de fogogelo|
|$item_mace2h_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_mace2h_gold_uncooked|Peça fundida: Marreta Nord|
|$item_mace2h_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
|$item_magecap|Chapéu de magos|
|$item_magecap_description|Um cogumelo comumente usado na dieta de feiticeiros.|
...
|$item_meatballsmashedpoteitr|Almôndegas e batáters|
|$item_meatballsmashedpoteitr_description|Nada mais icônico que isto!|
...
|$item_memorialcoal|Carvão memorial|
|$item_memorialcoal_description|Em algum lugar nas profundezas do nebuloso brilho ardente, você quase pode ver o desenrolar de uma antiga memória...|
...
|$item_mold_armor_gold_chest|Molde: Peitoral do Protetor|
|$item_mold_armor_gold_chest_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_gold_helmet|Molde: Elmo do Protetor|
|$item_mold_armor_gold_helmet_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_gold_legs|Molde: Pernas do Protetor|
|$item_mold_armor_gold_legs_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_mage_chest|Molde: Manto do Invocador|
|$item_mold_armor_mage_chest_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_mage_helmet|Molde: Carapuça do Invocador|
|$item_mold_armor_mage_helmet_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_mage_legs|Molde: Calças do Invocador|
|$item_mold_armor_mage_legs_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_medium_chest|Molde: Peitoral da Vanguarda|
|$item_mold_armor_medium_chest_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_medium_helmet|Molde: Capuz da Vanguarda|
|$item_mold_armor_medium_helmet_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_armor_medium_legs|Molde: Calças da Vanguarda|
|$item_mold_armor_medium_legs_description|Preenchido com o material certo, este molde criará uma armadura espetacular.|
|$item_mold_atgeir|Molde: Atgeir Nord|
|$item_mold_atgeir_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_axe|Molde: Machado Nord|
|$item_mold_axe_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_axe2h|Molde: Grão-machado Nord|
|$item_mold_axe2h_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_bow|Molde: Arco Nord|
|$item_mold_bow_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_crossbow|Molde: Besta Nord|
|$item_mold_crossbow_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_fistweapon|Molde: Soqueiras Nord|
|$item_mold_fistweapon_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_keys|Molde: Chave intrincada|
|$item_mold_keys_description|Preenchido com o material certo, este molde criará uma chave poderosa.|
|$item_mold_knife|Molde: Adaga Nord|
|$item_mold_knife_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_mace|Molde: Maça Nord|
|$item_mold_mace_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_mace2h|Molde: Marreta Nord|
|$item_mold_mace2h_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_shield_buckler|Molde: Broquel Nord|
|$item_mold_shield_buckler_description|Preenchido com o material certo, este molde criará um escudo resistente.|
|$item_mold_shield_round|Molde: Escudo Nord|
|$item_mold_shield_round_description|Preenchido com o material certo, este molde criará um escudo resistente.|
|$item_mold_shield_tower|Molde: Grão-escudo Nord|
|$item_mold_shield_tower_description|Preenchido com o material certo, este molde criará um escudo resistente.|
|$item_mold_spear|Molde: Lança Nord|
|$item_mold_spear_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_stafffrostorbs|Molde: Vingança do norte|
|$item_mold_stafffrostorbs_description|Preenchido com o material certo, este molde criará um item mágico poderoso.|
|$item_mold_stafforbofahri|Molde: Estaca do eco|
|$item_mold_stafforbofahri_description|Preenchido com o material certo, este molde criará um item mágico poderoso.|
|$item_mold_staffspiritcaller|Molde: Invocador de espíritos|
|$item_mold_staffspiritcaller_description|Preenchido com o material certo, este molde criará um item mágico poderoso.|
|$item_mold_staffthunderblood|Molde: Raio|
|$item_mold_staffthunderblood_description|Preenchido com o material certo, este molde criará um item mágico poderoso.|
|$item_mold_sword|Molde: Espada Nord|
|$item_mold_sword_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_mold_sword2h|Molde: Grã-espada Nord|
|$item_mold_sword2h_description|Preenchido com o material certo, este molde criará uma arma formidável.|
|$item_moleclaws|Garras longas|
|$item_moleclaws_description|Uma arma letal, se você conseguir segurá-la sem se cortar.|
...
|$item_moose_meat_cooked|Carne de alce assada|
|$item_moose_meat_cooked_description|Uma carne magra, mas cheia de sabor.|
|$item_moose_meat_description|Esta carne certamente renderá uma refeição nutritiva.|
|$item_moosehide|Pele de alce|
|$item_moosehide_description|Esta pele está perfeitamente adaptada ao clima do norte.|
|$item_moosekebab|Carne no pão|
|$item_moosekebab_description|Uma refeição conveniente, muito apreciada por caixeiros-viajantes.|
|$item_moosesinew|Tendão de alce|
|$item_moosesinew_description|Duro e firme. Certamente será útil.|
...
|$item_nornthread|Nornafio|
|$item_nornthread_description|Não se engane com os fios delicados. Eles são tecidos com o poder da própria árvore do mundo.|
...
|$item_oat|Aveia|
|$item_oat_description|Grãos saborosos para uso imediato ou para moer como farinha.|
|$item_oatflour|Farinha de aveia|
|$item_oatflour_description|Aveia moída fina, com muito potencial.|
|$item_oatmeallingonberryjam|Mingau de aveia|
|$item_oatmeallingonberryjam_description|Servido com uma porção generosa de geleia de arando.|
|$item_oatmilk|Leite de aveia|
|$item_oatmilk_description|Tem o sabor da inovação.|
|$item_oatseeds|Sementes de aveia|
|$item_oatseeds_description|Transforme em farinha de aveia no moinho ou plante para obter mais sementes.|
...
|$item_ooze_mork|Massa morta|
|$item_ooze_mork_description|É melhor não pensar na composição disto.|
|$item_oozebomb|Bomba de gosma|
|$item_oozebomb_description|O fedor é insuportável...|
|$item_orbfrostfire|Essência de fogogelo|
|$item_orbfrostfire_description|De alguma forma, é simultaneamente quente e frio ao toque.|
|$item_orbthunderblood|Essência de trovossangue|
|$item_orbthunderblood_description|Instável, errática e... viva?|
|$item_ovenpancake|Panqueca de forno|
|$item_ovenpancake_description|Quente e fofinha.|
|$item_ovenpancake_uncooked|Massa de panqueca de forno|
|$item_ovenpancake_uncooked_description|Pronta para assar.|
|$item_pancakes|Panquecas|
|$item_pancakes_description|Já existiu outra comida mais reconfortante?|
|$item_parryadrenaline|Adrenalina de aparo|
...
|$item_poteitr|Batáter|
|$item_poteitr_description|As possibilidades são praticamente infinitas. Quem não ia querer um pouco?|
|$item_poteitrseeds|Semente de batáter|
|$item_poteitrseeds_description|Plante para cultivar batáters.|
...
|$item_pulledbear|Urso Desfiado|
|$item_pulledbear_description|Carne macia cozida por horas e horas, até praticamente se desfazer.|
...
|$item_saddlemoose|Sela de alce|
|$item_saddlemoose_description|O alce é uma criatura nobre, mas com uma sela tão magnífica, talvez permita ser montado.|
|$item_salad|Salada|
...
|$item_sealhide|Couro de foca|
|$item_sealhide_description|O couro espesso ajuda o animal a ficar quente e seco.|
|$item_sealsoup|Sopa de carne de foca|
|$item_sealsoup_description|Uma refeição quente e saborosa, perfeita para um dia frio.|
...
|$item_shield_buckler_gold_uncooked|Peça fundida: Broquel Nord|
|$item_shield_buckler_gold_uncooked_description|Este escudo precisa ser endurecido pela geada.|
...
|$item_shield_gold_description|Proteja-se com estilo.|
|$item_shield_gold_tower|Grão-escudo Nord|
|$item_shield_goldbuckler|Broquel Nord|
|$item_shield_goldbuckler_description|Um método de proteção eficaz nas mãos dos suficientemente habilidosos.|
...
|$item_shield_roots|Escudo de Raízes|
|$item_shield_roots_description|Raízes maleáveis foram entrelaçadas para formar um escudo surpreendentemente resistente.|
|$item_shield_round_gold_uncooked|Peça fundida: Escudo Nord|
|$item_shield_round_gold_uncooked_description|Este escudo precisa ser endurecido pela geada.|
...
|$item_shield_tower_gold_description|Seus inimigos não podem atingir o que não conseguem ver!|
|$item_shield_tower_gold_uncooked|Peça fundida: Grão-escudo Nord|
|$item_shield_tower_gold_uncooked_description|Este escudo precisa ser endurecido pela geada.|
...
|$item_sledge_gold|Marreta Nord|
|$item_sledge_gold_description|Com esta arma, seus golpes serão tão fortes quanto os de um troll.|
|$item_sledge_gold_uncooked|Peça fundida: Marreta Nord|
|$item_sledge_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
|$item_sledge_iron|Marreta de ferro|
|$item_sledge_iron_description|Um poderoso martelo, digno de um campeão.|
|$item_sledge_wood|Marreta de madeira|
|$item_sledge_wood_description|Isto provavelmente deveria machucar mais do que machuca.|
|$item_smokebomb|Bomba de fumaça|
|$item_smokebomb_description|Todo mundo sabe que não dá para respirar na fumaça.|
|$item_smokedfish|Peixe defumado|
|$item_smokedfish_description|Peixe preparado da forma mais deliciosa.|
|$item_smokedmoosemeat|Carne de alce defumada|
|$item_smokedmoosemeat_description|A fumaça só realça o sabor selvagem.|
|$item_smokepuff|Sopra-fumaça|
|$item_smokepuff_description|Tomara que tenha um gosto melhor após cozinhar.|
|$item_snowball|Bola de neve|
|$item_snowball_description|Parece algo perfeito para arremessar...|
|$item_snowshovel|Pá de neve|
|$item_snowshovel_description|Útil para remover a neve mais profunda.|
...
|$item_spear_gold|Lança Nord|
|$item_spear_gold_bloodlightning|Lança de trovossangue|
|$item_spear_gold_bloodlightning_description|Que seus golpes sejam como raios, rápidos e violentos.|
|$item_spear_gold_bloodlightning_uncooked|Peça fundida: Lança de trovossangue|
|$item_spear_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_spear_gold_description|Uma oportunidade de ouro para atacar.|
|$item_spear_gold_frostfire|Lança de fogogelo|
|$item_spear_gold_frostfire_description|Embebida em chamas congeladas, esta lança garante a ruína de seus alvos.|
|$item_spear_gold_frostfire_uncooked|Peça fundida: Lança de fogogelo|
|$item_spear_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_spear_gold_uncooked|Peça fundida: Lança Nord|
|$item_spear_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_spear_wood|Lança de madeira|
|$item_spear_wood_description|Esta é tão afiada quanto uma lança de verdade, se uma lança de verdade fosse feita de madeira.|
...
|$item_spicedeepnorth|Tempero aboboral|
|$item_spicedeepnorth_description|Usando casca de canela e raiz de gengibre, com um toque de noz-moscada, o herborista viajou longe para criar esta mescla deliciosa de temperos quentes.|
...
|$item_staff_frostorbs|Vingança do norte|
|$item_staff_frostorbs_description|Um floco de neve aprisionado, com infinitos padrões emergindo do interior...|
|$item_staff_lightning|Dundr|
|$item_staff_lightning_description|O que acontece a seguir pode chocar você.|
|$item_staff_orbofahri|Estaca do eco|
|$item_staff_orbofahri_description|Um arrepio que chega até os ossos.|
|$item_staff_orbofahri_uncooked|Peça fundida: Estaca do eco|
|$item_staff_orbofahri_uncooked_description|Este item mágico precisa ser endurecido pela geada.|
|$item_staff_spiritcaller|Invocador de espíritos|
|$item_staff_spiritcaller_description|Invoque auxílio sobrenatural. Custa apenas uma gota do seu sangue...|
|$item_staff_spiritcaller_uncooked|Peça fundida: Invocador de espíritos|
|$item_staff_spiritcaller_uncooked_description|Este item mágico precisa ser endurecido pela geada.|
|$item_staff_thunderblood|Raio|
|$item_staff_thunderblood_description|Basta apontar para invocar a fúria do céu.|
|$item_staff_thunderblood_uncooked|Peça fundida: Raio|
|$item_staff_thunderblood_uncooked_description|Este item mágico precisa ser endurecido pela geada.|
...
|$item_stonerock|Rocha|
|$item_stonerock_description|É uma rocha.|
...
|$item_swimspeed_modifier|Velocidade de nado|
...
|$item_sword_gold_bloodlightning|Espada de trovossangue|
|$item_sword_gold_bloodlightning_description|Conforme o sangue escorre pela lâmina, ele desperta a tempestade em seu interior.|
|$item_sword_gold_bloodlightning_uncooked|Peça fundida: Espada de trovossangue|
|$item_sword_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_sword_gold_description|Mesmo sob o mais fraco raio de sol, esta arma brilha.|
|$item_sword_gold_frostfire|Espada de fogogelo|
|$item_sword_gold_frostfire_description|Chamas dançam ao redor desta lâmina, mas são quentes ou frias?|
|$item_sword_gold_frostfire_uncooked|Peça fundida: Espada de fogogelo|
|$item_sword_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_sword_gold_uncooked|Peça fundida: Espada Nord|
|$item_sword_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_sword_sword_2h_description|Você poderia ter cuidado com isso, por favor?|
|$item_sword_wood|Espada de madeira|
|$item_sword_wood_2h|Espada longa de madeira|
|$item_sword_wood_description|Na maioria das vezes inofensiva, a não ser que você seja muito persistente.|
|$item_sword2h_gold|Grã-espada Nord|
|$item_sword2h_gold_bloodlightning|Grã-espada de trovossangue|
|$item_sword2h_gold_bloodlightning_description|Quem portar esta arma com certeza terá uma presença muito aterrorizante.|
|$item_sword2h_gold_bloodlightning_uncooked|Peça fundida: Grã-espada de trovossangue|
|$item_sword2h_gold_bloodlightning_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_sword2h_gold_description|Uma arma impactante, tanto na aparência quanto na letalidade.|
|$item_sword2h_gold_frostfire|Grã-espada de fogogelo|
|$item_sword2h_gold_frostfire_description|A escolha entre um gume flamejante e um congelado é simples: ambos ao mesmo tempo.|
|$item_sword2h_gold_frostfire_uncooked|Peça fundida: Grã-espada de fogogelo|
|$item_sword2h_gold_frostfire_uncooked_description|O mesmo molde, mas propenso a produzir um resultado mais espetacular... O gelo revelará tudo, no devido tempo.|
|$item_sword2h_gold_uncooked|Peça fundida: Grã-espada Nord|
|$item_sword2h_gold_uncooked_description|Esta arma precisa ser endurecida pela geada.|
...
|$item_total|Total|
|$item_trinket|Amuleto|
|$item_trinketblackdamagedealth|Braceletes dos corajosos|
|$item_trinketblackdamagedealth_description|Sua mente se endurece, assim como seus golpes.|
|$item_trinketblackdtamina|Manto da evasão|
|$item_trinketblackdtamina_description|Dance com a morte enquanto você desvia dos golpes de seus inimigos.|
|$item_trinketbloodgoldhealth|Fura-pescoço|
|$item_trinketbloodgoldhealth_description|Garra, osso e ouro. Forneça o sangue e receberá uma bênção.|
|$item_trinketbloodgoldstamina|Coroa de bruxa|
|$item_trinketbloodgoldstamina_description|Dizem que a alma de uma bruxa pode conceder estranhos poderes aos mortais...|
|$item_trinketbronzehealth|Coração da floresta|
|$item_trinketbronzehealth_description|Pulsa com fragmentos de vida antiga.|
|$item_trinketbronzestamina|Pingente de bronze|
|$item_trinketbronzestamina_description|Um belo pingente, abrigando a resistência de um urso.|
|$item_trinketcarapaceeitr|Brincos pulsantes|
|$item_trinketcarapaceeitr_description|Se você escutar atentamente, pode ouvir os ecos fracos de almas perdidas...|
|$item_trinketchitinswim|Barbatanas do destino|
|$item_trinketchitinswim_description|Esvazie a mente e torne-se sem forma, um só com a água.|
|$item_trinketflametaleitr|Jörmundling|
|$item_trinketflametaleitr_description|Gritos atormentados ressoam de dentro.|
|$item_trinketflametalstaminahealth|Enxofre|
|$item_trinketflametalstaminahealth_description|É quente, como se estivesse preenchido com um sangue vital próprio.|
|$item_trinketironhealth|Broche de ferro|
|$item_trinketironhealth_description|Um acessório delicado, mas defensivo.|
|$item_trinketironstamina|Pulseira veloz|
|$item_trinketironstamina_description|Dê um pulo na sua caminhada!|
|$item_trinketscalestaminadamage|Tornozeleira retumbante|
|$item_trinketscalestaminadamage_description|Uma corrente afiada no tornozelo. Será que realmente é confortável?|
|$item_trinketsilverdamage|Visão do lobo|
|$item_trinketsilverdamage_description|Assuma a mente afiada e feroz de um lobo.|
|$item_trinketsilverresist|Coração de cristal|
|$item_trinketsilverresist_description|Um fragmento de tristeza congelada. Tocá-lo faz você se sentir quase entorpecido.|
...
|$item_trophy_barka|Troféu de barka|
|$item_trophy_barka_description|A cabeça congelada de uma árvore outrora viva.|
|$item_trophy_barka_lore|Uma criatura da floresta, metamorfoseada em geada viva.|
|$item_trophy_bjorn|Troféu de Urso|
|$item_trophy_bjorn_description|Esse olhar ainda é assustador...|
|$item_trophy_bjorn_lore|Por engano, acreditava ser o mestre da floresta.|
|$item_trophy_bjorn_undead|Troféu de Zomburso|
|$item_trophy_bjorn_undead_description|Esses olhos estão finalmente vazios para sempre.|
|$item_trophy_bjorn_undead_lore|A sombra mais temida da noite.|
|$item_trophy_blob|Troféu Bolha|
|$item_trophy_blob_description|Uma massa fedida de material pegajoso.|
|$item_trophy_blob_frost|Troféu de bolha gélida|
|$item_trophy_blob_frost_description|É como uma lasca de gelo, mas... pegajosa?|
|$item_trophy_blob_frost_lore|Apesar da passagem do tempo, permanece congelada.|
|$item_trophy_blob_lava|Troféu de bolha de lava|
|$item_trophy_blob_lava_description|Provavelmente está morta, não é?|
|$item_trophy_blob_lava_lore|Mesmo agora, continua muito quente ao toque.|
|$item_trophy_blob_lore|Uma massa fedida de material pegajoso.|
|$item_trophy_blob_morkhalla|Troféu de massa|
|$item_trophy_blob_morkhalla_description|Restos de aventureiros desafortunados, digeridos e gelificados com o tempo.|
|$item_trophy_blob_morkhalla_lore|Ainda se mexe, mas você tem quase certeza de que está morta.|
...
|$item_trophy_elaking|Troféu de elaking|
|$item_trophy_elaking_description|Olhinhos maldosos encaram você.|
|$item_trophy_elaking_lore|O que o movia era a crueldade ou a malícia? Talvez nunca saibamos.|
...
|$item_trophy_ghost|Troféu Fantasma|
|$item_trophy_ghost_description|Ainda sussurra sobre assuntos inacabados?|
|$item_trophy_ghost_lore|Ainda há algo assombrando em sua presença...|
...
|$item_trophy_goblinbrute|Troféu de Fuling furioso|
...
|$item_trophy_jotunwarrior|Troféu de krigen|
|$item_trophy_jotunwarrior_description|Outrora um poderoso guerreiro, agora não resta nada além de uma casca.|
|$item_trophy_jotunwarrior_lore|Um soldado calejado. Que batalhas ele testemunhou?|
|$item_trophy_jotunwitch|Troféu de hexen|
|$item_trophy_jotunwitch_description|Antes da morte, os olhos dela brilhavam com magia. Agora, não há mais brilho algum.|
|$item_trophy_jotunwitch_lore|Uma bruxa poderosa. Que estranhos mistérios ela conhecia?|
...
|$item_trophy_mole|Troféus de sem-olhos|
|$item_trophy_mole_description|Ser cortado por estas garras seria bastante desagradável.|
|$item_trophy_mole_lore|Este sem-olhos já não cavará mais.|
|$item_trophy_moose|Troféu de alce|
|$item_trophy_moose_description|O poderoso governante das florestas do norte.|
|$item_trophy_moose_lore|Uma fera majestosa, e um item de decoração icônico.|
...
|$item_trophy_seal|Troféu de foca|
|$item_trophy_seal_description|Este animal nunca machucou ninguém, mas teve um fim precoce.|
|$item_trophy_seal_lore|Os grandes olhos tristes encaram você. O que você fez?|
...
|$item_trophy_volture|Troféu de uruvul|
...
|$item_trophy_writhan|Troféu de Writhan|
|$item_trophy_writhan_description|Por mais que esteja morto, é melhor tratar com cuidado.|
|$item_trophy_writhan_lore|Permanece inativo, pelo menos por enquanto...|
|$item_turnip|Nabo|
...
|$item_turretbolt_bloodgold|Projétil de ourossangue|
|$item_turretbolt_bloodgold_description|Seu inimigo não terá chance quando este projétil acertar o alvo.|
...
|$item_UndeadBjornRibcage|Costela de zomburso|
|$item_UndeadBjornRibcage_description|Uma relíquia de força selvagem, perfeita para forjar armaduras que carregam a fúria da vida selvagem.|
|$item_upgrader_armor|Proteção|
|$item_upgrader_description|Este ídolo misterioso está repleto do poder dos deuses. Ele pode conceder uma bênção poderosa ou exigir um grande sacrifício.|
|$item_upgrader_name|Ídolo|
|$item_upgrader_tier0|Madeira|
|$item_upgrader_tier1|Bronze|
|$item_upgrader_tier2|Ferro|
|$item_upgrader_tier3|Prata|
|$item_upgrader_tier4|Metal Negro|
|$item_upgrader_tier5|Mármore Preto|
|$item_upgrader_tier6|Lumetal|
|$item_upgrader_tier7|Ourossangue|
|$item_upgrader_weapon|Batalha|
|$item_utility|Item utilitário|
|$item_value|Valor|
|$item_vikingcupcake|Pão doce glaceado|
|$item_vikingcupcake_description|Uma guloseima saborosa para comemorar sua vitória!|
|$item_vikingcupcake_uncooked|Pão doce cru|
|$item_vikingcupcake_uncooked_description|Pronto para assar.|
...
|$item_writhanroots|Raízes de Writhan|
|$item_writhanroots_description|As partes retorcidas do corpo de uma criatura estranha e repulsiva.|
...
|$jotuninvasion|Invasão dos Jotun|
...
|$loadscreen_tip11|Diferentes inimigos possuem faquezas a diferentes tipos de dano. Os anões cinzentos, por exemplo, não gostam de fogo.|
...
|$loadscreen_tip17|Descanse para aumentar a taxa de regeneração de vida e de vigor.|
...
|$loadscreen_tip23|Procure frutas silvestres e cogumelos para manter seu estômago cheio.|
|$loadscreen_tip24|Clique com o direcional direito sobre as marcações no mapa para filtrá-las por tipo.|
...
|$location_bearcave|Caverna do Urso|
|$location_darkesthole|O Buraco|
|$location_dnbossroom|A Primeira Prisão|
|$location_dnbossroomnew|A Prisão|
...
|$location_thehole|Túneis Sinuosos|
...
|$lore_deepnorth_hervor01|O Norte Profundo. O último obstáculo antes de poder provar que sou digna.<br/><br/><br/><br/>As provações foram muitas, assim como as mortes. Perdi amigos que me eram queridos.<br/><br/><br/><br/>Mas enfim estou aqui.|
|$lore_deepnorth_hervor02|Parece tranquilo o bastante. Por enquanto, a vida selvagem não parece se importar muito com minha presença aqui.<br/><br/><br/><br/>Eu devo conseguir reunir alguns recursos valiosos dos animais se precisar. É a minha sobrevivência ou a deles, afinal de contas.|
|$lore_deepnorth_hervor03|Preciso ficar em alerta. Poucos lugares foram tranquilos desde que cheguei aqui, e seria tolice acreditar que estas terras seriam diferentes.<br/><br/><br/><br/>Não importa o quanto eu lute bem, ainda posso ser superada pelo inevitável frio dos arredores.<br/><br/><br/><br/>É melhor encontrar abrigo.|
|$lore_deepnorth_hervor04|Até agora fui deixada em paz. Apesar disso, não consigo deixar de sentir que algo está me observando.|
|$lore_deepnorth_hervor05|Encontrei uma velha construção, mas estava deserta. É difícil dizer por quanto tempo, mas não acredito que vá encontrar amigos por aqui.|
|$lore_deepnorth_hervor06|Não gosto de pensar sobre o que poderia ter acontecido se meu machado não fosse tão afiado nem meus sentidos tão aguçados. Afinal de contas, não há ninguém mais para vir em meu auxílio.<br/><br/><br/><br/>Posso ter perdido meus companheiros. Mas é por causa deles que preciso continuar. O líder destas terras precisa morrer.|
|$lore_deepnorth_hervor07|É estranho. Não consigo ignorar a sensação de que deveria ter pessoas aqui, só esperando para me receber.<br/><br/><br/><br/>Acho que os invernos pareciam assim quando eu era criança, e a qualquer momento meu pai me receberia em casa. Mas ele não está aqui. Ninguém está.|
|$lore_deepnorth_hervor08|Ultimamente, tenho sido assombrada por sonhos em que sou um corvo. Em enormes asas pretas, voo por este mundo que conheci, mas não é igual.<br/><br/><br/><br/>A paisagem passou de verde e fértil para fria e vazia. Talvez seja só este norte congelado me afetando. Mas... e se não for?|
|$lore_deepnorth_hervor09|Eu sei para onde preciso ir. Os Ancestrais me colocaram na direção do líder destas terras, daquele que eles tentaram manter aprisionado, mas cujo poder agora aprisiona o próprio mundo.<br/><br/><br/><br/>Se eu puder matar esse oponente, esse ser terrível, terei provado meu valor de uma vez por todas.|
|$lore_deepnorth_memorial_description|Memorial Ancestral|
|$lore_deepnorth_memorial_label|Conhecimento: Memorial Ancestral|
|$lore_deepnorth_memorial1|Os poderosos que vieram antes de nós descansam aqui.<br/><br/>Ande com cautela, pois o sono deles ainda pode ser perturbado.|
|$lore_deepnorth_memorial2|A morte termina chegando para todos, mesmo para os maiores guerreiros.<br/><br/>Um dia você poderá estar entre eles.|
|$lore_deepnorth_memorial3|Honremos nossos ancestrais, que esculpiram este mundo em que agora vivemos.<br/><br/>E que eles nos considerem dignos.|
|$lore_deepnorth_random01|No início, este pareceu um bom lar para Ulf, que gostava do frio e da neve. Então vieram as criaturinhas malvadas, determinadas a me arrastar para as profundezas, e eu fui forçado a reconsiderar.|
|$lore_deepnorth_random02|Se o que o corvo diz é verdade, só há mais um guardião que eu preciso matar. Mas o que vem depois? Meu filho será realmente devolvido a mim, ou eu a ele?<br/><br/><br/><br/>Astrid ergueu esta pedra para seu filho, caso ele seguisse os passos dela antes de que ela o visse novamente.|
|$lore_deepnorth_random03|Estas terras pareciam tão familiares, despertando memórias enterradas nas profundezas de nossas mentes. Deveríamos ter imaginado que elas não eram o que pareciam.|
|$lore_deepnorth_random04|Escute as palavras de Kata, que outrora pensou que os trolls da floresta eram adversários poderosos. Os parentes deles nestas terras são tão altos quanto a mais alta das torres e mais sólidos que a mais sólida das pedras, mas quem conseguir derrotá-los obterá uma recompensa resplandecente.|
|$lore_deepnorth_random05|Quando chegamos aqui, este lugar era rico e próspero. Mas os invernos agora estão mais frios e longos, e tememos que logo tomem conta por completo.<br/><br/><br/><br/>Contudo, foi aqui que construímos nossas casas e criamos nossas raízes, então é aqui que permaneceremos.|
|$lore_deepnorth_random06|No norte mais distante<br/><br/>Onde a magia tem nos céus seu lar<br/><br/>Ofereça para chamar num instante<br/><br/>O que logo sob o solo se pode encontrar<br/><br/><br/><br/>Que os fogos ardam intensos<br/><br/>Saber ancestral aguarda os poderosos<br/><br/>Que se ergam para lutar indomados<br/><br/>As antigas lâminas e arcos poderosos|
|$lore_deepnorth_random07|Cuidado com as árvores falsas! Estalactites de gelo estalando e galhos rangendo podem não estar se movendo só com o vento...|
|$lore_deepnorth_random08|Signe ergueu esta pedra em memória de Eigil, que caiu em batalha. Ele ainda não havia aprendido que nem tudo aqui está tão congelado quanto parece à primeira vista.|
|$lore_deepnorth_random09|Enterrados sob a neve, nas profundezas do norte,<br/><br/>os vínculos endurecem como a terra congelada<br/><br/>conforme a verdade começa a degelar.|
...
|$lore_frozenking|DETENHA A INVASÃO|
...
|$lore_upgradestation_description|Ingrid e Torgunn decidiram honrar os deuses neste lugar. Eles sorriram para Ingrid, concedendo-lhe uma grande bênção. Torgunn, por outro lado, percebeu claramente o risco que estava correndo, quando sua lâmina se estilhaçou em pedaços sobre o altar. Ela ergueu esta pedra para alertar os outros sobre o perigo de ousar refinar nesta forja!|
|$lore_upgradestation_label|Conhecimento: Forja de Potencial|
|$lore_windingtunnels|As criaturas brilhantes são uma excelente fonte de luz no escuro.<br/><br/>Talvez uma gaiola de madeira possa mantê-las no lugar.|
...
|$menu_codeofconduct_button|Código de conduta|
...
|$menu_done|Pronto|
|$menu_dontshowagain|Não exibir novamente|
...
|$menu_logging_in_played_failed_not_signed_in_to_platform|Conecte-se à plataforma em que está jogando antes de tentar jogar online.|
|$menu_logging_in_played_failed_not_signed_in_to_platform_gamecenter|Conecte-se ao Game Center antes de tentar jogar online. Pode ser necessário reiniciar o jogo para aplicar as alterações.|
...
|$menu_player_list_block_warning_as_client|Bloquear este usuário impossibilitará vocês de jogarem juntos, conforme diretrizes de plataforma que não permitem visualizar Conteúdo Gerado por Usuários (UGC) de jogadores bloqueados. Sua conta será desconectada do servidor e não poderá participar de qualquer servidor em que o outro usuário esteja jogando. Deseja prosseguir com o bloqueio?|
|$menu_player_list_block_warning_as_server|Bloquear este usuário impossibilitará vocês de jogarem juntos. Esta ação, portanto, expulsará o outro jogador. Conforme diretrizes de plataforma em relação a Conteúdo Gerado por Usuários (UGC), você também perderá acesso a este mundo durante a vigência do bloqueio, o que significa que sua conexão também será interrompida. Deseja prosseguir com o bloqueio?|
|$menu_player_list_kick_tooltip|Expulsar do servidor|
...
|$menu_removefavoritecategory|Remover categoria de favoritos?|
...
|$menu_storagefull|Seu armazenamento está cheio!|
|$menu_storagefulloperationfailed|A operação falhou porque o armazenamento de dados salvos está cheio. Exclua dados salvos não utilizados e tente novamente.|
|$menu_storageused|Armazenamento usado: $1|
...
|$menu_vulkancrashwarning_header|Valheim pode travar no seu sistema ao usar Vulkan|
|$menu_vulkancrashwarning_text|Você está usando o Vulkan. Estamos investigando um erro conhecido de travamento ao se usar Vulkan em certos sistemas, e seu sistema foi detectado como sendo potencialmente afetado. Caso enfrente problemas de estabilidade, use a API de renderização padrão (DirectX 11). Desculpe pelo transtorno!|
|$menu_worldnametip|Mínimo de 5 caracteres|
|$menu_worlds|Mundos|
|$menu_yes|Sim|
|$message_dream|Você sonhará hoje à noite|
|$morkhalla_drawbridge|Ponte levadiça|
...
|$msg_incompleteoffering_memorial|Os Ancestrais seguem adormecidos|
...
|$msg_nosnow|Sem neve para remover|
...
|$msg_offerdone_memorial|Os Ancestrais ouviram seu chamado|
...
|$msg_snowtoodeep|A neve é profunda demais|
...
|$msg_upgrader_broke|$1 falhou no refinamento e se quebrou no nível $2|
|$msg_upgrader_fail|$1 falhou no refinamento e voltou para o nível $2|
|$msg_upgrader_success|$1 foi refinado com sucesso para o nível $2|
...
|$npc_dvergr_deepnorth_random_goodbye1|Não se preocupe comigo. Ficarei bem sem você.|
|$npc_dvergr_deepnorth_random_goodbye2|Vou encontrar a saída por minha conta, pelo jeito.|
|$npc_dvergr_deepnorth_random_goodbye3|Mate todos os gigantes que puder!|
|$npc_dvergr_deepnorth_random_goodbye4|Até a próxima, então.|
|$npc_dvergr_deepnorth_random_goodbye5|O que você está olhando?|
|$npc_dvergr_deepnorth_random_goodbye6|Estou tão longe de casa...|
|$npc_dvergr_deepnorth_random_goodbye7|Você está indo embora?|
|$npc_dvergr_deepnorth_random_greet1|Quem vai lá?|
|$npc_dvergr_deepnorth_random_greet2|Você é amigo ou inimigo?|
|$npc_dvergr_deepnorth_random_greet3|Ei! Você aí!|
|$npc_dvergr_deepnorth_random_greet4|Ajude-me a sair daqui!|
|$npc_dvergr_deepnorth_random_greet5|Uma ajuda, por favor?|
|$npc_dvergr_deepnorth_random_greet6|Por aqui!|
|$npc_dvergr_deepnorth_random_greet7|Vou ajudar você se você me ajudar.|
...
|$npc_munin_deepnorth_general01|Este é um lugar de transformação. Certas criaturas encontram um novo propósito aqui, tornando-se algo mais do que eram antes. Será que você é uma dessas criaturas?|
|$npc_munin_deepnorth_general02|Crá! Aqueles que primeiro vieram aqui não sabiam sobre os ladrões subterrâneos. Se soubessem, eles certamente teriam escolhido melhores lugares para construir suas casas.|
|$npc_munin_deepnorth_general03|Procure nestas terras por memoriais em homenagem aos guerreiros que vieram antes de você. Eles podem conceder uma bênção se você mostrar a eles que merece.|
|$npc_munin_deepnorth_general04|Muito antes de o Pai de Todos ter chamado você, outros foram encarregados de vigiar este mundo. Embora muitos anos tenham se passado desde a morte deles, parece que ainda não conseguem encontrar paz. Seja gentil e não os perturbe.|
|$npc_munin_deepnorth_morkborg|Crá! Pessoas estranhas moram aqui, originadas do próprio mal...|
|$npc_munin_deepnorth_ship|Há muito tempo, outros tentaram navegar para estas terras. Parece que chegaram aqui, mas jamais teriam como fazer a jornada de volta...|
...
|$npc_valkyrie_end|Valquíria|
|$npc_valkyrie_end_interact|Jornada para Valhalla|
...
|$online_kickedfromsession_header|Conta desconectada da sessão|
|$online_kickedfromsession_suspendresume_xbox_text|Sua conta foi expulsa da sessão online; o console entrou em modo de suspensão, interrompendo a atividade de rede.|
|$piece_ancient_pot|Panela antiga|
|$piece_ancientmetalbarstack|Pilha de metal antigo|
|$piece_ancientmetalbarstack_description|Não está claro para que isso poderia ser usado...|
|$piece_archerytarget|Alvo de arco-e-flecha|
|$piece_archerytarget_description|Mire no centro.|
|$piece_archerytarget_hits|acertos|
|$piece_archerytarget_lastscores|Acertos|
|$piece_archerytarget_reset|Coletar flechas e redefinir|
|$piece_archerytarget_total|Total|
|$piece_armorstand|Suporte de armaduras|
|$piece_armorstand_cantattach|Esse item não cabe aí|
|$piece_armorstand_description|Algumas roupas são muito boas para guardar. Por que não colocá-las em exibição?|
|$piece_artisan_ext1|Prensa artesanal|
|$piece_artisan_ext1_description|Esta ferramenta complexa é necessária para produzir designs mais avançados.|
|$piece_artisanstation|Mesa de artesão|
|$piece_artisanstation_description|Para construir máquinas e produzir designs complexos, é necessário ter uma mesa de artesão.|
...
|$piece_ashwood_bed_description|Descanse nesta cama feita com maestria, com peles de asksvin para proteger você do calor e do frio.|
|$piece_ashwood_decowall|Parede decorativa de madeira chamuscada|
|$piece_ashwood_decowall_description|Você poderia observar este padrão por horas...|
|$piece_ashwood_decowall_divider|Divisória de madeira chamuscada|
|$piece_ashwood_decowall_divider_description|Acrescenta um belo detalhe a qualquer ambiente.|
|$piece_ashwood_decowall_tree|Janela decorativa de madeira chamuscada|
|$piece_ashwood_decowall_tree_description|Você está olhando pela janela ou para a janela? Ninguém precisa saber.|
|$piece_ashwood_door|Porta de madeira chamuscada|
|$piece_ashwood_door_description|As decorações detalhadas podem fazer você parar para olhar em vez de passar.|
...
|$piece_ashwood_floor_deco_description|Padrões também funcionam muito bem no piso.|
|$piece_ashwood_floor_description|Tábuas de madeira chamuscada, colocadas diagonalmente.|
...
|$piece_ashwood_poles_description|Estes suportes sempre estão quentes ao toque.|
...
|$piece_ashwoodbeam67|Viga de madeira chamuscada 67º|
...
|$piece_ashwoodstair_description|Esta escada é mais robusta do que pode parecer.|
|$piece_ashwoodwall_description|Os dois lados desta parede têm seu charme. A escolha é sua!|
...
|$piece_ashwoodwallroof67|Parede de madeira chamuscada 67º|
|$piece_ashwoodwallroof67upsidedown|Parede de madeira chamuscada 67º (invertida)|
|$piece_ashwoodwallrooftop67|Teto cruzado de madeira chamuscada 67°|
|$piece_asksvinskeleton|Esqueleto de asksvin|
|$piece_asksvinskeleton_description|Macabro ou decorativo? Você é quem sabe.|
|$piece_banner01|Estandarte preto|
|$piece_banner01_description|Um estandarte preto como as profundezas de Hel.|
|$piece_banner02|Estandarte azul|
|$piece_banner02_description|Um estandarte azul como os oceanos que cercam Midgard.|
|$piece_banner03|Estandarte listrado vermelho e branco|
|$piece_banner03_description|Um estandarte listrado vermelho, como uma vela de navio.|
|$piece_banner04|Estandarte vermelho|
|$piece_banner04_description|Um estandarte vermelho como o sangue dos inimigos de Odin.|
|$piece_banner05|Estandarte verde|
|$piece_banner05_description|Um estandarte verde como as florestas exuberantes de Alfheim.|
|$piece_banner06|Estandarte listrado azul, vermelho e branco|
|$piece_banner06_description|Um estandarte listrado vermelho e azul, porque às vezes você não consegue escolher uma cor só.|
|$piece_banner07|Estandarte listrado azul e branco|
|$piece_banner07_description|Um estandarte listrado azul, como uma vela de navio.|
|$piece_banner08|Estandarte amarelo|
|$piece_banner08_description|Um estandarte amarelo como os campos dourados de Vanaheim.|
|$piece_banner09|Estandarte roxo|
|$piece_banner09_description|Um estandarte roxo como estranhas magias.|
|$piece_banner10|Estandarte laranja|
|$piece_banner10_description|Um estandarte laranja como as chamas de Muspelheim.|
|$piece_banner11|Estandarte branco|
|$piece_banner11_description|Um estandarte branco como a neve em Niflheim.|
...
|$piece_bathtub_description|Vikings respeitáveis chegam a tomar banho até uma vez por semana!|
|$piece_bed|Cama|
|$piece_bed_claim|Reivindicar|
|$piece_bed_currentspawn|Ponto de surgimento atual|
|$piece_bed_description|Quando a noite chegar, você vai querer ter algum lugar para dormir.|
...
|$piece_bed02_description|Envolta em peles, esta cama certamente oferecerá uma boa noite de descanso.|
|$piece_beehive|Colmeia|
|$piece_beehive_area|As abelhas não gostam deste bioma|
|$piece_beehive_check|Conferir as abelhas|
|$piece_beehive_description|Quando estão felizes, as abelhas produzem um mel delicioso.|
...
|$piece_bench_runed|Banco entalhado|
|$piece_bench_runed_description|Um lugar rústico mas confortável para se sentar.|
|$piece_bench01|Banco|
|$piece_bench01_description|Se há espaço no seu coração, há espaço para se sentar.|
|$piece_benchlog|Banco de tronco|
|$piece_benchlog_description|Não é nada chique, mas é melhor que se sentar no chão.|
|$piece_birdnest|Ninho dos Pássaros|
|$piece_birdnest_area|Os pássaros não gostam daqui|
|$piece_birdnest_check|Conferir o Ninho dos Pássaros|
|$piece_birdnest_description|Pássaros saudáveis e felizes podem perder uma pena ou outra.|
|$piece_birdnest_extract|Coletar penas|
|$piece_birdnest_freespace|Os pássaros precisam de mais espaço aberto|
|$piece_birdnest_happy|Os pássaros estão se abrigando|
|$piece_birdnest_sleep|Os pássaros estão dormindo|
|$piece_blackforge|Forja preta|
|$piece_blackforge_description|Alguns metais, especialmente quando combinados com outros materiais, precisam de uma forja mais avançada.|
|$piece_blackforge_ext1|Resfriador de forja preta|
|$piece_blackforge_ext1_description|Deixe suas novas criações esfriarem antes de tocá-las.|
|$piece_blackforge_ext2|Torno|
|$piece_blackforge_ext2_description|É conveniente fixar seu projeto no lugar durante o trabalho.|
|$piece_blackforge_ext3|Cortador de metal|
|$piece_blackforge_ext3_description|Para dividir metal com precisão. Cuidado com as bordas afiadas!|
|$piece_blackforge_ext4|Cortador de gema|
|$piece_blackforge_ext4_description|Para trabalhar com gemas, é necessário ter ferramentas específicas.|
|$piece_blackforge_ext5|Avental de ferreiro|
|$piece_blackforge_ext5_description|Ao lidar com temperaturas extremas, a segurança no local de trabalho é fundamental.|
...
|$piece_blackmarble_bench_description|Sente-se com dignidade neste banco, esculpido com maestria de mármore negro.|
...
|$piece_blackmarble_floor_description|Pisos escuros evitam manchas.|
...
|$piece_blackmarble_stair_description|Pode ser usada para subir e para descer. Que conveniente!|
|$piece_blackmarble_table|Mesa de mármore preto|
|$piece_blackmarble_table_description|Jante como um anão com esta mesa!|
|$piece_blackmarble_throne|Trono de mármore preto|
|$piece_blackmarble_throne_description|Um trono esculpido em autêntico estilo dvergr, mas grande o suficiente para que um humano se sente com conforto.|
...
|$piece_blackmarbleblock_description|Uma peça de mármore preto inspirada pela arquitetura dos anões. O único limite é sua própria criatividade.|
|$piece_blackmetalbarstack|Pilha de metal negro|
|$piece_blackmetalbarstack_description|Certamente causará inveja entre todos os fulings!|
|$piece_blackwoodbench01|Banco de madeira chamuscada|
|$piece_blackwoodbench01_description|Este banco tem uma curva elegante para facilitar as conversas.|
|$piece_blackwoodstack|Pilha de madeira chamuscada|
|$piece_blackwoodstack_description|Aconteça o que acontecer, esta pilha de madeira está sempre quente.|
|$piece_BlackwoodStakewall|Paliçada de freixinzas|
|$piece_BlackwoodStakewall_description|Estacas afiadas com dor garantida.|
|$piece_blastfurnace|Alto-forno|
|$piece_blastfurnace_description|Alguns metais precisam de temperaturas mais altas para derreter.|
|$piece_bloodgoldbarstack|Pilha de ourossangue|
|$piece_bloodgoldbarstack_description|Este metal tem mesmo um ar mais sinistro que os outros, não tem?|
|$piece_bone_throne|Trono de ossos|
|$piece_bone_throne_description|Este trono certamente inspirará respeito em aliados e inimigos.|
|$piece_bonestack|Pilha de ossos|
|$piece_bonestack_description|Nunca se sabe quando eles podem ser úteis!|
|$piece_bonfire|Pira|
|$piece_bonfire_description|Para quando uma fogueira comum não é impressionante o suficiente!|
|$piece_brazierceiling01|Braseiro pendurado|
|$piece_brazierceiling01_description|Se o fogo está pendurado no teto, não tem como tropeçar nele por acidente.|
|$piece_brazierfloor01|Braseiro pendurado|
|$piece_brazierfloor01_description|Uma forma sofisticada de iluminar o ambiente.|
|$piece_brazierfloor02|Braseiro azul pendurado|
|$piece_brazierfloor02_description|É difícil dizer se esta chama é incrivelmente quente ou incrivelmente fria.|
|$piece_bronzebarstack|Pilha de bronze|
|$piece_bronzebarstack_description|Belo, versátil... E agora empilhável!|
|$piece_candle|Vela de resina|
|$piece_candle_description|Uma fonte de luz pequena, mas incrivelmente aconchegante.|
|$piece_cartographytable|Mesa de cartografia|
|$piece_cartographytable_description|Marque suas descobertas neste mapa e compartilhe-as com os amigos.|
...
|$piece_cauldron_description|Misture ingredientes e prepare uma refeição saborosa, o que é importante para todos os vikings!|
|$piece_cauldron_ext1_spice|Suporte de temperos|
|$piece_cauldron_ext1_spice_description|Uma dieta variada e deliciosa exige muitos ingredientes.|
|$piece_cauldron_ext3_butchertable|Mesa de açougue|
|$piece_cauldron_ext3_butchertable_description|Os melhores pratos exigem os melhores cortes.|
|$piece_cauldron_ext4_pans|Formas e panelas|
|$piece_cauldron_ext4_pans_description|Às vezes um caldeirão não basta.|
|$piece_cauldron_ext5_mortarandpestle|Almofariz e pilão|
|$piece_cauldron_ext5_mortarandpestle_description|Alguns ingredientes precisam ser moídos em um pó fino antes de poderem ser usados na cozinha.|
|$piece_cauldron_ext6_rollingpins|Rolos de massa e tábuas de corte|
|$piece_cauldron_ext6_rollingpins_description|Sempre úteis, especialmente na confeitaria.|
|$piece_cauldron_ext7_smoker|Defumador|
|$piece_cauldron_ext7_smoker_description|Comida defumada dura mais tempo e é mais saborosa!|
|$piece_celebrationgarland|Guirlanda de flores|
|$piece_celebrationgarland_description|Algumas flores para alegrar seu dia!|
|$piece_chair|Cadeira|
|$piece_chair_description|Acomode-se e relaxe.|
|$piece_chair_runed|Cadeira entalhada|
|$piece_chair_runed_description|O formato desta cadeira pode ser simples, mas as decorações não são.|
|$piece_charcoalkiln|Forno de carvão|
|$piece_charcoalkiln_description|Útil para transformar qualquer tipo de madeira em carvão.|
|$piece_charredballista|Skugg|
|$piece_charredchest|Baú carbonizado|
|$piece_chest|Baú reforçado|
|$piece_chest_description|Um baú mais resistente, com mais espaço de armazenamento.|
|$piece_chestbarrel|Barril|
|$piece_chestbarrel_description|Um barril é bom para guardar muitas coisas, incluindo comida e bebida.|
|$piece_chestblackmetal|Baú de metal negro|
|$piece_chestblackmetal_description|O metal negro resistente deste baú permite colocar quase qualquer coisa dentro dele.|
|$piece_chestgrausten|Baú de rocha cinzenta|
|$piece_chestgrausten_description|Pedra e metal certamente protegerão seus pertences. Os crânios carbonizados também ajudam.|
|$piece_chestprivate|Baú pessoal|
|$piece_chestprivate_description|Algumas coisas são melhores guardadas e mantidas para si.|
|$piece_chesttreasure|Baú do tesouro|
|$piece_chesttreasure_description|Que melhor forma de mostrar sua riqueza do que um baú do tesouro transbordando de ouro e joias?|
|$piece_chestwarderobe|Guarda-roupa|
|$piece_chestwarderobe_description|Um espaço de armazenamento elegante.|
|$piece_chestwood|Baú|
|$piece_chestwood_description|Um bom lugar para guardar itens que você não precisa carregar.|
|$piece_clothdoor|Cortina de juta vermelha|
|$piece_clothdoor_description|Cortinas pesadas de juta vermelha, excelentes para pendurar.|
|$piece_coalpile|Pilha de carvão|
|$piece_coalpile_description|Nunca é má ideia ter bastante combustível disponível.|
|$piece_container_empty|VAZIO|
|$piece_container_open|Abrir|
|$piece_cookingstation|Bancada de cozinha|
|$piece_cookingstation_description|Perfeita para grelhar carne crua.|
|$piece_cookingstation_iron|Bancada de cozinha de ferro|
|$piece_cookingstation_iron_description|Robusta, com espaço para cozinhar carne de criaturas maiores.|
|$piece_copperbarstack|Pilha de cobre|
|$piece_copperbarstack_description|Cobre de alta qualidade. Nada a reclamar!|
|$piece_craftingstation|Bancada de produção|
|$piece_crate|Caixa|
|$piece_crate_long|Caixa de componentes dvergr|
|$piece_crystalwall_description|Bela e frágil.|
|$piece_crystalwall1x1|Parede de cristal 1x1|
|$piece_cstand_cook|Cozinhar item|
|$piece_cultivate|Cultivar|
|$piece_cultivate_description|Deixe o solo pronto para o plantio.|
...
|$piece_darkwoodchair_description|Esta cadeira é revestida com peles, adequada para convidados importantes.|
|$piece_darkwooddecowall|Divisória de madeira escura entalhada|
|$piece_darkwooddecowall_description|Um design elegante para decorar sua casa e para manter afastados olhares curiosos.|
|$piece_darkwoodgate|Portão de madeira escura|
|$piece_darkwoodgate_description|Um portão chique e robusto. Pode ser usado sozinho ou em um par.|
|$piece_darkwoodpole|Coluna de madeira escura 2 m|
|$piece_darkwoodpole4|Coluna de madeira escura 4 m|
|$piece_darkwoodpoles_description|Designs intrincados permeiam esta estrutura de sustentação.|
|$piece_darkwoodraven|Adorno de corvo|
|$piece_darkwoodraven_description|Os corvos são companheiros fiéis do Pai de Todos, então é claro que você também ia querer um na sua casa.|
|$piece_darkwoodroof26|Telhado de telhas 26°|
|$piece_darkwoodroof26_description|Este teto pouco inclinado certamente protegerá da chuva com estilo.|
|$piece_darkwoodroof45|Telhado de telhas 45°|
|$piece_darkwoodroof45_description|Este teto mais inclinado certamente protegerá da chuva com estilo.|
|$piece_darkwoodroof67|Teto de telhas 67°|
|$piece_darkwoodroof67_description|Este teto muito inclinado certamente protegerá da chuva com estilo.|
|$piece_darkwoodrooficorner|Telhado de telhas (canto-i) 26°|
|$piece_darkwoodrooficorner45|Telhado de telhas (canto-i) 45°|
|$piece_darkwoodrooficorner67|Teto de telhas (canto interno) 67°|
|$piece_darkwoodroofocorner|Telhado de telhas (canto-o) 26°|
|$piece_darkwoodroofocorner45|Telhado de telhas (canto-o) 45°|
|$piece_darkwoodroofocorner67|Teto de telhas (canto externo) 67°|
|$piece_darkwoodrooftop|Cumeeira de telhas 26°|
|$piece_darkwoodrooftop45|Cumeeira de telhas 45°|
|$piece_darkwoodrooftop67|Cumeeira de telhas 67°|
|$piece_darkwoodwolf|Adorno de lobo|
|$piece_darkwoodwolf_description|Os lobos vivem em matilhas, mas este parece contente sozinho.|
|$piece_deco_stave_wall|Parede de madeira torneada|
|$piece_deco_stave_wall_description|Esta parede não vai ajudar muito a evitar a entrada do frio, mas é bonita.|
|$piece_deposit_copper|Depósito de cobre|
|$piece_deposit_goldvein|Gammeltroll petrificado|
...
|$piece_drawbridge|Ponte levadiça|
|$piece_drawbridge_description|Uma ponte e um portão ao mesmo tempo. Muito engenhoso!|
|$piece_drawbridge_dn|Ponte Levadiça de Madeira de Construção|
|$piece_drawbridge_log|Ponte Levadiça Rústica|
|$piece_drawbridge_log_description|Útil para atravessar abismos ou para impedir a entrada de inimigos.|
|$piece_dv_gate|Portão antigo dvergr|
|$piece_dvergr_door|Porta dvergr|
|$piece_dvergr_lantern|Lanterna dvergr de parede|
|$piece_dvergr_lantern_description|Uma lanterna bem trabalhada, produzida por um verdadeiro artesão. A montagem na parede é fácil de entender!|
|$piece_dvergr_lantern_pole|Poste de lanterna dvergr|
|$piece_dvergr_lantern_pole_description|Construir um poste é relativamente fácil, mas a lanterna só pode ter sido feita por um verdadeiro mestre.|
|$piece_dvergr_metal_wall|Parede de metal dvergr|
|$piece_dvergr_metal_wall_description|O design dvergr faz muito sucesso atualmente.|
|$piece_dvergr_pole|Coluna dvergr|
|$piece_dvergr_sharpstakes|Estacas afiadas dvergr|
|$piece_dvergr_sharpstakes_description|Os anões dvergr sabem como manter visitas indesejadas afastadas.|
|$piece_dvergr_spiralstair|Escadaria dvergr em espiral esquerda|
|$piece_dvergr_spiralstair_description|Ela sobe em espiral.|
|$piece_dvergr_spiralstair_right|Escadaria dvergr em espiral direita|
|$piece_dvergr_stake_wall|Paliçada dvergr|
|$piece_dvergr_stake_wall_description|Reforçada com metal. Certamente será uma defesa robusta.|
|$piece_dvergr_woodwall|Parede dvergr|
|$piece_dvergrchest|Baú do tesouro dvergr|
|$piece_eitrrefinery|Refinaria de éter|
|$piece_eitrrefinery_description|Esta máquina transforma tecido mole na substância mágica éter. O processo é bem volátil, então tenha cuidado!|
|$piece_faderember|Pira eterna|
|$piece_faderember_description|A raiva e o remorso dele guerreiam entre si, e essa luta alimentará este fogo até o fim.|
|$piece_faderember_full|As brasas estão ardendo intensamente|
|$piece_faderember_light|As brasas estão pegando fogo|
|$piece_faderember_nospace|As brasas estão sendo sufocadas|
|$piece_faderember_ok|As brasas estão pegando fogo|
|$piece_fairylightgarland|Luzes de fada|
|$piece_fairylightgarland_description|Confere uma luz suave às suas festividades.|
|$piece_fermenter|Fermentador|
|$piece_fermenter_add|Adicionar item|
|$piece_fermenter_description|O hidromel precisa descansar e fermentar por um tempo para que todas as propriedades desejadas emerjam.|
...
|$piece_firepit_description|Útil para cozinhar, se aquecer ou só descansar um pouco.|
|$piece_firepit_iron|Atiçador de fogueira|
|$piece_firepit_iron_description|Se você não quer fazer uma fogueira diretamente no chão, esta é uma alternativa elegante.|
|$piece_flametal_beam|Viga de flametal|
|$piece_flametal_pillar|Pilar de flametal|
|$piece_flametal_pillar_description|Puro metal ardente.|
|$piece_flametalbarstack|Pilha de Flametal|
|$piece_flametalbarstack_description|O calor está praticamente irradiando desta pilha...|
|$piece_flametalgate|Portão de flametal|
|$piece_flametalgate_description|Uma forma impressionante de receber seus amigos ou de afastar seus inimigos.|
|$piece_flintpile|Pilha de sílex|
|$piece_flintpile_description|Cuidado por onde anda!|
|$piece_forge|Forja|
|$piece_forge_description|Para trabalhar com metal, é necessário ter uma forja.|
|$piece_forge_ext1|Fole|
|$piece_forge_ext1_description|Apertar este fole gera mais calor, o que é muito útil ao trabalhar com metal.|
|$piece_forge_ext2|Bigornas|
|$piece_forge_ext2_description|Para trabalhos mais detalhados, pode ser útil ter vários tipos de bigornas.|
|$piece_forge_ext3|Moedor|
|$piece_forge_ext3_description|Um rebolo é necessário para afiar qualquer tipo de espada.|
|$piece_forge_ext4|Bigorna do ferreiro|
|$piece_forge_ext4_description|Uma bigorna grande para trabalhar com itens grandes. Cuidado para não deixar cair nos seus pés.|
|$piece_forge_ext5|Resfriador de forja|
|$piece_forge_ext5_description|Quando uma criação está pronta, este barril de água esfria o metal para uma temperatura mais adequada.|
|$piece_forge_ext6|Suporte de ferramentas da forja|
|$piece_forge_ext6_description|O trabalho exige muitas ferramentas diferentes. Estas acompanham um suporte conveniente para armazenamento.|
|$piece_frostfoundry|Fundição gélida|
|$piece_frostfoundry_additem|Colocar peça fundida|
|$piece_frostfoundry_description|Esta fundição pode ser usada para endurecer peças fundidas para que virem itens práticos.|
|$piece_frostfoundry_takeitem|Pegar item|
|$piece_frostkiln|Forno gélido|
|$piece_frostkiln_description|Um estranho processo gelado acontece neste forno para produzir um combustível muito potente...|
...
|$piece_grausten_floor_description|Estes ladrilhos de piso finos são mais resistentes do que parecem.|
...
|$piece_grausten_pillars_description|Fortes o bastante para resistir a uma terra de fogo.|
...
|$piece_grausten_roof_description|Um design de teto feito para os salões mais magníficos.|
...
|$piece_grausten_stair_description|Basta dar um passo depois do outro.|
|$piece_grausten_stoneladder|Escada íngreme de rocha cinzenta|
|$piece_grausten_stoneladder_description|Útil para subir a níveis mais altos.|
|$piece_grausten_wall_description|Paredes de pedra inspiradas por uma civilização que desapareceu há muito tempo.|
...
|$piece_graustenpile_description|Rocha cinzenta, cuidadosamente empilhada.|
|$piece_groundtorch|Tocha de ferro em pé|
|$piece_groundtorch_description|Uma tocha de ferro robusta para iluminar o ambiente.|
|$piece_groundtorchblue|Tocha de ferro azul em pé|
|$piece_groundtorchblue_description|Uma tocha de ferro robusta que emite uma estranha luz azul.|
|$piece_groundtorchdemister|Tocha de Wisp|
|$piece_groundtorchdemister_description|Prenda a wisp em um lugar fixo para garantir que o espaço fique sempre livre de névoa.|
|$piece_groundtorchgreen|Tocha de ferro verde em pé|
|$piece_groundtorchgreen_description|Uma tocha de ferro robusta com uma chama verde.|
|$piece_groundtorchwood|Tocha de madeira em pé|
|$piece_groundtorchwood_description|Uma tocha para colocar no chão, para quando você precisa das mãos livres.|
...
|$piece_hanging_cloth_blue1_description|A juta azul faz qualquer construção parecer oficial e importante.|
|$piece_hanging_cloth_blue2|Cortina de juta azul|
|$piece_harvest|Coletar|
|$piece_hearth|Lareira|
|$piece_hearth_description|Parte central de qualquer casa.|
|$piece_hexagonalgate|Portão hexagonal|
|$piece_hexagonalgate_description|Este projeto dos anões é excelente para manter convidados indesejados longe.|
|$piece_hoodedlantern|Lanterna coberta|
|$piece_hoodedlantern_description|Voltada para uma só direção, a luz fica mais potente. Conveniente para ladrões furtivos ou para quem quer deixar um rastro.|
|$piece_horizontal|Horizontal|
|$piece_icecube|Bloco de gelo|
|$piece_icecube_description|Um sólido pedaço de gelo.|
|$piece_incinerator|Obliterador|
|$piece_incinerator_conversion|Thor lhe concede uma dádiva!|
|$piece_incinerator_description|Reduzir, reutilizar, obliterar.|
...
|$piece_ironbarstack|Pilha de ferro|
|$piece_ironbarstack_description|Se você tem ferro, tem tudo.|
|$piece_ironcage_description|Barras de ferro produzidas com maestria, certamente à prova de vibrações!|
|$piece_ironfloor|Piso de grade 2x2|
|$piece_ironfloorSmall|Piso de grade1x1|
|$piece_irongate|Portão de ferro|
|$piece_irongate_description|Um portão muito importante.|
|$piece_ironwall|Parede de grade 2x2|
|$piece_ironwallSmall|Parede de grade 1x1|
|$piece_ironwoodbeam67|Viga de Madeira e Ferro 67°|
...
|$piece_itemstand_h_description|Coloque itens em superfícies horizontais com este suporte de itens.|
|$piece_itemstand_missingitem|Está faltando um item|
|$piece_itemstand_take|Pegar item|
|$piece_itemstand_v_description|Coloque itens em superfícies verticais com este suporte de itens.|
|$piece_jackoturnip|Nabo de Halloween|
|$piece_jackoturnip_description|O rosto esculpido neste vegetal... é assustador ou simpático?|
|$piece_jotunchest|Baú dos Jotun|
|$piece_jotungate|Portões de Mörkhalla|
|$piece_jute_carpet|Tapete de juta vermelha|
|$piece_jute_carpet_description|Este tecido grosso é excelente para afastar o frio.|
|$piece_juteblue_carpet|Tapete de juta azul|
|$piece_juteblue_carpet_description|Não importa o quanto o ar esteja úmido, este tapete nunca parece molhar.|
|$piece_lavalantern|Lanterna de lava|
|$piece_lavalantern_description|É... hipnotizante de olhar...|
|$piece_levelground|Terreno plano|
|$piece_levelground_description|Se o terreno for muito acidentado, basta aplainá-lo.|
...
|$piece_magetable_description|Misteriosas forças galdr concentram-se neste altar. Cabe a você manejá-las...|
|$piece_magetable_ext|Mesa de runas|
|$piece_magetable_ext_description|As runas são uma ferramenta conhecida para a canalização de magia, se você sabe como lê-las.|
|$piece_magetable_ext2|Velas perpétuas|
|$piece_magetable_ext2_description|Estas velas emitem uma luz estranha, exortando magia mais potente a se juntar ao redor delas.|
|$piece_magetable_ext3|Grinalda emplumada|
|$piece_magetable_ext3_description|Uma oferenda aos poderes misteriosos espalhados pelos reinos. Talvez eles permitam que você os utilize.|
|$piece_magetable_ext4|Tear de chão|
|$piece_magetable_ext4_description|As Nornas tecem os fios do destino para criar uma tapeçaria mágica. O que você tecerá?|
...
|$piece_marblepile_description|Perfeito para construção com inspiração dvergr.|
|$piece_maypole|Maypole|
|$piece_maypole_description|No mais longo dia do ano, que este monumento se estenda em direção ao sol!|
|$piece_meadcauldron|Caldeirão de hidromel|
|$piece_meadcauldron_description|Esta panela de cobre mantém a temperatura perfeita para misturar hidromel.|
|$piece_mistletoe|Ramo de visco|
|$piece_mistletoe_description|É inevitável pensar que tem um quê de romântico...|
|$piece_moose_throne|Trono de galhada|
|$piece_moose_throne_description|Embora rústico e resistente, este trono é adequado até para os maiores entre os nobres.|
|$piece_morkborg_gate|Portões de Mörkhalla|
|$piece_morkhallachestancient|Baú antigo|
|$piece_mudpile|Pilha de sucata enlameada|
|$piece_noaccess|Sem acesso|
|$piece_obsidianpile|Pilha de obsidiana|
|$piece_obsidianpile_description|Uma pilha tão escura quanto a própria noite.|
...
|$piece_offerbowl_frozenking|Tigela estranha|
|$piece_offerbowl_hive|Base do ninho|
|$piece_offerbowl_makeoffer|Fazer oferta|
|$piece_offerbowl_memorial|Altar antigo|
|$piece_offerbowl_offeritem|Oferecer item|
|$piece_offerbowl_offeritem_fader|Tocar os sinos|
|$piece_offerbowl_offeritem_memorial|Ilumine o altar|
|$piece_offerbowl_yagluth|Altar místico|
|$piece_oven|Forno de pedra|
|$piece_oven_additem|Assar|
|$piece_oven_description|Para todas suas necessidades de confeitaria.|
|$piece_path|Capinar|
|$piece_path_description|Marque o melhor caminho a seguir.|
|$piece_pavedroad|Rua pavimentada|
|$piece_pavedroad_description|Um indício certeiro de civilização.|
...
|$piece_portal|Portal|
|$piece_portal_censored_warning|Palavras censuradas identificadas, possível problema de crossplay.|
...
|$piece_pot_large_green_description|Uma peça de cerâmica grande e marcante! Quase cabe um viking inteiro nela.|
...
|$piece_pot_medium_green_description|Uma peça de cerâmica funda o suficiente para colocar algumas coisas dentro.|
...
|$piece_pot_small_green_description|Uma pequena peça de cerâmica, com espaço para colocar algo dentro.|
|$piece_pot_small_red|Panela vermelha pequena|
|$piece_preptable|Mesa de preparação de alimentos|
|$piece_preptable_description|Nem tudo pode ser despejado diretamente no caldeirão, então você precisa de uma boa superfície de trabalho!|
|$piece_pulllever|Puxar alavanca|
|$piece_queendoor|Cofre dvergr|
|$piece_raise|Elevar terreno|
|$piece_raise_description|Preencha buracos e crie plataformas elevadas.|
|$piece_readmap|Ler mapa|
|$piece_register_location|Registrar local|
|$piece_repair|Consertar|
|$piece_replant|Grama|
|$piece_replant_description|Recupere o solo para a vegetação original.|
|$piece_rock_01|Rocha Ornamental|
|$piece_rock_01_description|Dá um toque rústico a qualquer jardim.|
|$piece_rock_02|Rocha Decorativa|
|$piece_rock_02_description|Isso, sim, é uma rocha legal.|
|$piece_rug_asksvin|Tapete de asksvin|
|$piece_rug_asksvin_description|Como a pele de asksvin é muito rugosa, é difícil fazer algo útil com uma única peça. Exige alguma montagem.|
|$piece_rug_bjorn|Tapete de pele de urso|
|$piece_rug_bjorn_description|A pele é macia, mas os dentes seguem afiados.|
|$piece_rug_deer|Tapete de cervo|
|$piece_rug_deer_description|Protege seus pés de farpas de madeira.|
|$piece_rug_hare|Tapete de lebre|
|$piece_rug_hare_description|A textura é estranha, mas é uma decoração muito interessante.|
|$piece_rug_lox|Tapete de Lox|
|$piece_rug_lox_description|É incrivelmente macio!|
|$piece_rug_moose|Carpete de pele de alce|
|$piece_rug_moose_description|Este carpete está habilmente costurado para garantir uma grande superfície macia.|
|$piece_rug_seal|Tapete de pele de foca|
|$piece_rug_seal_description|Este tapete é tão suave como a inocência.|
|$piece_rug_straw|Palha|
|$piece_rug_straw_description|Seus animais vão adorar.|
|$piece_rug_wolf|Tapete de lobo|
|$piece_rug_wolf_description|Quente e aconchegante, especialmente nas montanhas.|
|$piece_rune_read|Ler|
...
|$piece_sapling_barley_description|Um grão robusto que pode ser moído como farinha.|
|$piece_sapling_carrot|Cenoura|
|$piece_sapling_carrot_description|Pode ser consumida crua ou usada para receitas mais avançadas.|
|$piece_sapling_flax|Linho|
|$piece_sapling_flax_description|Belas flores com fibras que podem ser transformadas em fios.|
|$piece_sapling_jotunpuffs|Broto de sopro de Jotun|
|$piece_sapling_kale|Couve|
|$piece_sapling_kale_description|Uma planta resistente e nutritiva.|
|$piece_sapling_magecap|Broto de chapéu de magos|
|$piece_sapling_oat|Palha de aveia|
|$piece_sapling_oat_description|Plante para cultivar aveia.|
|$piece_sapling_onion|Cebola|
|$piece_sapling_onion_description|Usada para muitas receitas culinárias.|
|$piece_sapling_poteitr|Batáter|
|$piece_sapling_poteitr_description|Um tubérculo potente e sobrenatural.|
...
|$piece_sapling_seedkale|Semente de couve|
|$piece_sapling_seedkale_description|Plante sementes de couve para obter ainda mais sementes.|
...
|$piece_sapling_turnip_description|Um vegetal nutritivo usado para cozinhar.|
...
|$piece_scale_26|Parede de madeira escamada 26° esquerda|
|$piece_scale_26_flipped|Parede de madeira escamada 26° direita|
|$piece_scale_26_upsidedown|Parede de madeira escamada 26° direita (invertida)|
|$piece_scale_26_upsidedown_flipped|Parede de madeira escamada 26° esquerda (invertida)|
|$piece_scale_45|Parede de madeira escamada 45° esquerda|
|$piece_scale_45_flipped|Parede de madeira escamada 45° direita|
|$piece_scale_45_upsidedown|Parede de madeira escamada 45° direita (invertida)|
|$piece_scale_45_upsidedown_flipped|Parede de madeira escamada 45° esquerda (invertida)|
|$piece_scale_67|Parede de madeira escamada 67° esquerda|
|$piece_scale_67_flipped|Parede de madeira escamada 67° direita|
|$piece_scale_67_upsidedown|Parede de madeira escamada 67° direita (invertida)|
|$piece_scale_67_upsidedown_flipped|Parede de madeira escamada 67° esquerda (invertida)|
|$piece_scale_halfwall|Parede de madeira escamada (metade)|
|$piece_scale_quarterwall|Parede de madeira escamada (um quarto)|
|$piece_scale_wall|Parede de madeira escamada|
|$piece_scale_walls_description|A madeira sobreposta destas paredes oferece excelente proteção contra os elementos.|
|$piece_sconce|Arandela|
|$piece_sconce_description|Por que colocar uma tocha no chão quando você pode pendurá-la na parede?|
|$piece_secretdoor|Passagem secreta|
|$piece_sharpstakes|Estacas afiadas|
|$piece_sharpstakes_description|Quem chega muito perto acabará furado.|
...
|$piece_sign|Placa|
|$piece_sign_description|A desordem é o pior inimigo de um sobrevivente. Defenda-se dela instalando placas.|
|$piece_sign_input|Digite o texto|
|$piece_silverbarstack|Pilha de prata|
|$piece_silverbarstack_description|Uma forma organizada de mostrar sua riqueza.|
|$piece_skullpile|Pilha de crânios|
|$piece_skullpile_description|Uma prova da sua maestria em combate.|
|$piece_smelter|Fundição|
|$piece_smelter_add|Adicionar|
|$piece_smelter_additem|Adicionar item|
|$piece_smelter_description|O combustível e o minério entram, e belos lingotes de metal saem.|
|$piece_smelter_empty|Vazio|
|$piece_smelter_ready|Processado|
|$piece_smelter_reqroof|Precisa de um telhado|
|$piece_snowlantern|Lanterna de neve|
|$piece_snowlantern_description|Acrescenta um toque aconchegante a uma paisagem invernal.|
|$piece_spinningwheel|Roda de fiar|
|$piece_spinningwheel_description|Esta máquina automatizada torna fiar fibras em fios um processo incrivelmente rápido.|
|$piece_stakewall|Paliçada|
|$piece_stakewall_description|Boa para evitar intrusos.|
|$piece_stave_deco_beam_2m|Viga de madeira ornamental 2 m|
|$piece_stave_deco_beams_description|Estes suportes acrescentam um toque decorativo elegante.|
|$piece_stave_deco_pole_2m|Coluna de madeira ornamental 2 m|
|$piece_stave_pole_2m|Coluna de madeira 2 m|
|$piece_stave_pole_4m|Coluna de madeira 4 m|
|$piece_stave_wall|Parede de madeira|
|$piece_stave_walls_description|Paredes de madeira pesadas são boas para afastar o frio.|
|$piece_stavebeam2|Viga de madeira 2 m|
|$piece_stavebeam26|Viga de madeira 26°|
|$piece_stavebeam4|Viga de madeira 4 m|
|$piece_stavebeam45|Viga de madeira 45°|
|$piece_stavebeam67|Viga de madeira 67°|
|$piece_stavebeams_description|Estes pedaços espessos de madeira certamente sustentarão suas construções.|
|$piece_stavecross26|Teto cruzado de madeira 26°|
|$piece_stavecross45|Teto cruzado de madeira 45°|
|$piece_stavedecobeam26|Viga de madeira ornamental 26°|
|$piece_stavedecobeam45|Viga de madeira ornamental 45°|
|$piece_stavedecobeam67|Viga de madeira ornamental 67°|
|$piece_stavegate|Portão de Madeira de Construção|
|$piece_stavegate_description|Não é tão glorioso quanto os portões do Valhalla, mas chega bem perto!|
|$piece_stavewallrooftop67|Teto cruzado de madeira 67°|
|$piece_stonearch|Arco de pedra|
|$piece_stonearch_description|Estável como uma rocha.|
|$piece_stonecutter|Talhador de pedras|
|$piece_stonecutter_description|Para construir com pedra, é necessário um talhador de pedras para lidar com o material.|
|$piece_stonefence|Cerca de Pedras|
|$piece_stonefence_description|Pedras cuidadosamente encaixadas umas nas outras, formando uma cerca resistente.|
|$piece_stonefloor_description|Melhor colocar um tapete nele para não sentir frio!|
|$piece_stonefloor2x2|Piso de pedra 2x2|
|$piece_stonefloor4x4|Piso de pedra 4x4|
|$piece_stonepile|Pilha de pedra|
|$piece_stonepile_description|É uma grande pilha de pedra.|
|$piece_stonepillar|Pilar de pedra|
|$piece_stonestair|Escada de pedra|
|$piece_stonestair_description|Útil para se mover por uma grande fortaleza.|
|$piece_stonethrone|Trono de pedra|
|$piece_stonethrone_description|Um bom líder deve ser firme como rocha, mas também precisa saber quando ser suave como pele...|
|$piece_stonewall1x1|Parede de pedra 1x1|
|$piece_stonewall2x1|Parede de pedra 2x1|
|$piece_stonewall4x2|Parede de pedra 4x2|
|$piece_stonewalls_description|Um bloco de pedra talhado de forma grosseira.|
|$piece_stool|Banqueta|
|$piece_stool_description|Um lugar para se sentar.|
|$piece_table|Mesa|
|$piece_table_description|Uma mesa pequena, mas resistente.|
|$piece_table_oak|Mesa longa pesada|
|$piece_table_oak_description|Esta mesa é perfeita para um grande banquete, com espaço para muitos pratos diferentes!|
|$piece_table_round|Mesa redonda|
|$piece_table_round_description|Em uma mesa redonda, nenhum lugar é mais importante que outro.|
|$piece_table_runed|Mesa entalhada longa|
|$piece_table_runed_description|A história entalhada nesta mesa é excelente para ler durante longos banquetes.|
|$piece_table_runed_small|Mesa entalhada quadrada|
|$piece_table_runed_small_description|Uma mesa para reuniões mais íntimas.|
|$piece_tarpile|Barril de betume|
|$piece_throne01|Trono de corvo|
|$piece_throne01_description|Talvez o trono de Odin em Valhalla seja assim... De qualquer forma, é confortável!|
|$piece_tinbarstack|Pilha de estanho|
|$piece_tinbarstack_description|Dá para fazer muito bronze com isto...|
|$piece_tombstone|Aqui jaz|
|$piece_tombstone_container|Túmulo|
|$piece_tombstone_recovered|Objetos recuperados|
|$piece_toofar|Muito longe|
|$piece_trainingdummy|Boneco de treinamento|
|$piece_trainingdummy_description|Aproxime-se por sua conta e risco!|
...
|$piece_trap_description|Esta armadilha prende quem pisa nela. Cuidado!|
|$piece_treasure_pile|Monte de moedas|
|$piece_treasure_pile_description|Uma pequena fortuna, brilhante e reluzente.|
|$piece_treasure_stack|Pilha de moedas|
|$piece_treasure_stack_description|É importante manter uma boa contagem das moedas.|
...
|$piece_upgradestation|Forja de Potencial|
|$piece_use|Usar|
|$piece_useitem|Usar item|
|$piece_vegvisir|Vegvísir|
|$piece_vertical|Vertical|
|$piece_windmill|Moinho|
|$piece_windmill_description|Transforma grãos em farinha. Funciona melhor em dias ventosos!|
...
|$piece_woodbeam67|Viga de madeira 67°|
|$piece_woodcorestack|Pilha de madeira de lei|
|$piece_woodcorestack_description|Uma grande pilha de troncos, recém-saída da floresta.|
|$piece_wooddoor|Porta de madeira|
|$piece_wooddoor_description|Uma porta simples para abrir e fechar.|
|$piece_wooddragon|Adorno de dragão de madeira|
|$piece_wooddragon_description|Deixe seu lar lendário decorando-o com um dragão.|
|$piece_woodfence|Cerca arredondada|
|$piece_woodfence_description|Uma boa cerca, tanto para rebanhos quanto para plantações!|
|$piece_woodfencegate|Portão de Colunas Redondas|
|$piece_woodfencegate_description|Um portão é muito mais prático do que ter que pular a cerca toda vez.|
|$piece_woodfinestack|Pilha de madeira de qualidade|
|$piece_woodfinestack_description|Esta pilha de madeira está aguardando ser transformada em mobília.|
|$piece_woodfloor_description|Um pedaço sólido de piso de madeira.|
|$piece_woodfloor1x1|Piso de madeira 1x1|
|$piece_woodfloor2x2|Piso de madeira 2x2|
|$piece_woodfroststack|Pilha de madeira de construção|
|$piece_woodfroststack_description|É como se neve fresca tivesse acabado de cair sobre ela...|
|$piece_woodgate|Portão de madeira|
|$piece_woodgate_description|Um portão de madeira simples. Pode ser usado sozinho ou em um par.|
...
|$piece_woodironpoles_description|A sustentação mais resistente que você já construiu.|
...
|$piece_woodlogs_description|Sustente suas construções neste estilo rústico.|
|$piece_woodpole|Coluna de madeira 1 m|
|$piece_woodpole2|Coluna de madeira 2 m|
|$piece_woodpoles_description|Um suporte de madeira resistente.|
|$piece_woodroof26|Telhado de palha 26°|
|$piece_woodroof26_description|Um teto simples para se proteger da chuva, construído em um ângulo raso.|
|$piece_woodroof45|Telhado de palha 45°|
|$piece_woodroof45_description|Um teto simples para se proteger da chuva, com um ângulo mais acentuado.|
|$piece_woodroof67|Teto de palha 67°|
|$piece_woodroof67_description|Um teto simples para se proteger da chuva, construído em um ângulo muito acentuado.|
|$piece_woodrooficorner|Telhado de palha (canto-i) 26°|
|$piece_woodrooficorner45|Telhado de palha (canto-i) 45°|
|$piece_woodrooficorner67|Teto de palha (canto interno) 67°|
|$piece_woodroofocorner|Telhado de palha (canto-e) 26°|
|$piece_woodroofocorner45|Telhado de palha (canto-e) 45°|
|$piece_woodroofocorner67|Teto de palha (canto externo) 67°|
|$piece_woodrooftop|Cumeeira de palha 26°|
|$piece_woodrooftop45|Cumeeira de palha 45°|
|$piece_woodrooftop67|Cumeeira de palha 67°|
|$piece_woodstack|Pilha de madeira|
|$piece_woodstack_description|Mostre todo seu trabalho duro!|
|$piece_woodstair|Escada de madeira|
|$piece_woodstair_description|Útil para sair do chão.|
|$piece_woodstepladder|Degraus de madeira|
|$piece_woodstepladder_description|Conveniente para subir mais alto.|
|$piece_woodwall|Parede de madeira|
|$piece_woodwall_description|As paredes são partes importantes de qualquer casa!|
...
|$piece_woodwallroof67|Parede de madeira 67°|
|$piece_woodwallroof67upsidedown|Parede de madeira 67° (invertida)|
|$piece_woodwallrooftop|Telhado cruzado de madeira 26°|
|$piece_woodwallrooftop45|Telhado cruzado de madeira 45°|
|$piece_woodwallrooftop67|Teto cruzado de madeira 67°|
|$piece_woodwindowshutter|Persiana de madeira|
|$piece_woodwindowshutter_description|Aberta ou fechada, mantenha como preferir ou mude sempre que quiser!|
|$piece_workbench|Bancada|
|$piece_workbench_description|Todo lar precisa de uma bancada. É necessária para construir estruturas de madeira e produzir novas ferramentas.|
|$piece_workbench_ext1|Cepo|
|$piece_workbench_ext1_description|Um machado é uma ferramenta muito versátil para produção.|
|$piece_workbench_ext2|Suporte de curtume|
|$piece_workbench_ext2_description|Couros e peles precisam de tratamento adequado antes de poderem ser usados.|
|$piece_workbench_ext3|Enxó|
|$piece_workbench_ext3_description|Às vezes você precisa trabalhar no problema de outro ângulo.|
|$piece_workbench_ext4|Estante de ferramentas|
|$piece_workbench_ext4_description|Trabalho com detalhes delicados exige ferramentas igualmente delicadas.|
|$piece_writemap|Registrar descobertas|
|$piece_yggdrasilstack|Pilha de madeira Yggdrasil|
|$piece_yggdrasilstack_description|Galhos finos, pulsando com energia misteriosa.|
|$piece_yulecrown|Grinalda Yule|
|$piece_yulecrown_description|É difícil pensar em algo mais festivo do que uma grinalda!|
|$piece_yulegarland|Guirlanda Yule|
|$piece_yulegarland_description|Enfeite os salões!|
|$piece_yuleklapp|Presente Yule|
|$piece_yuleklapp_description1|Um presentinho para alguém de que você goste.|
|$piece_yuleklapp_description2|Um presente para alguém que se comportou bem este ano.|
|$piece_yuleklapp_description3|Um grande presente para alguém de que você gosta muito.|
|$piece_yuletree|Árvore Yule|
|$piece_yuletree_description|Este abeto recebeu luzes decorativas festivas.|
...
|$playstation_activity_name|Explorando o 10º mundo|
|$playstation_trophy_set_online_only|Troféus apenas de multijogador|
...
|$prop_beech_sapling_description|Uma faia rende boa madeira de uso tradicional.|
|$prop_birch|Bétula|
|$prop_birch_sapling|Arvoreta de bétula|
|$prop_birch_sapling_description|Uma ótima fonte de madeira boa.|
...
|$prop_fir|Abeto|
|$prop_fir_big_sapling|Muda de árvore de madeira de construção|
|$prop_fir_big_sapling_description|Embora nativa das regiões do norte, esta árvore pode crescer na maioria dos climas.|
|$prop_fir_sapling|Arvoreta de abeto|
|$prop_fir_sapling_description|Uma árvore que se mantém bela o ano todo.|
|$prop_oak|Carvalho|
|$prop_oak_sapling|Semente de carvalho|
|$prop_oak_sapling_description|Com o tempo, será um grande carvalho.|
|$prop_offerbowl_makeoffer|Oferecer sacrifício|
|$prop_pine|Pinheiro|
|$prop_pine_sapling|Arvoreta de pinheiro|
|$prop_pine_sapling_description|Estas árvores altas podem ser cortadas para obter madeira de lei.|
|$prop_pine_snow|Árvore de madeira de construção|
|$prop_timberwoodtree|Árvore de madeira de construção|
|$prop_treelog|Tronco|
|$prop_treestump|Cepo|
|$prop_yggashoot|Broto de Yggdrasil|
|$ps_codeofconduct_platform_specific_text|Também é necessário seguir o Código de Conduta da Comunidade PlayStation™Network, aplicado em adição às nossas regras.|
|$ps_codeofconduct_reporting_violations_body|Caso você testemunhe comportamento inaceitável:<br/>• Dentro do jogo: use a função de "Denunciar jogador" (Opções->Lista de jogadores->Denunciar)<br/>• Fora do jogo: use este formulário online: https://valheim.com/report-a-player<br/>• Pela PlayStation™Network: consulte https://www.playstation.com/pt-br/support/account/ps5-report-behaviour/|
|$ps_crossplay_user_id_with_name|ID de usuário ao jogar entre plataformas: $1|
|$ps_error_crossplayprivilege|Você habilitou a configuração "Apenas PlayStation™Network" nas configurações de Jogabilidade, impossibilitando jogar em servidores com funcionalidade de jogar entre plataformas.|
|$ps_eula_important_first_text|(Valheim – Edição PlayStation®5)<br/>IMPORTANTE: LEIA CUIDADOSAMENTE O ACORDO EM VALHEIM.COM/EULA. AO BAIXAR, INSTALAR OU UTILIZAR “VALHEIM” (O “PRODUTO”) EM UM CONSOLE PLAYSTATION®5 QUE VOCÊ POSSUI OU CONTROLA, VOCÊ CONCORDA EM SEGUIR OS TERMOS DESTE ACORDO DE LICENÇA DE USUÁRIO FINAL (“EULA”). CASO NÃO CONCORDE, NÃO UTILIZE O PRODUTO.|
|$ps_loading_savenotification|O jogo tem um recurso de salvamento automático. Quando vir o ícone de salvamento automático, não desligue o jogo nem o console.|
|$ps_loadscreen_tip24|Filtre marcações do mapa por tipo clicando com o botão de direção para a direita|
|$ps_menu_cloudstoragefull|O armazenamento do console está cheio!|
|$ps_menu_codeofconduct_button|Código de conduta|
|$ps_menu_crossplayserver|Crossplay|
|$ps_menu_invite_friends|Convidar amigos|
|$ps_menu_localstoragefullcharacterprompt|Espaço de armazenamento insuficiente. Não foi possível criar o personagem.|
|$ps_menu_localstoragefullworldprompt|Espaço de armazenamento insuficiente. Não foi possível criar o mundo.|
|$ps_menu_storagefull|O armazenamento do console está cheio!|
|$ps_menu_storagefulloperationfailed|A operação falhou porque o armazenamento de dados salvos está cheio. Exclua dados salvos não utilizados e tente novamente.|
|$ps_menu_storageused|Armazenamento do console usado: $1|
|$ps_online_id_with_name|ID online: $1|
|$ps_online_kickedfromsession_suspendresume_text|Sua conta foi expulsa da sessão online; o console PlayStation®5 entrou em modo de repouso, interrompendo a atividade de rede.|
|$ps_online_kickedfromsession_text|Sua conta foi expulsa da sessão online; confira sua conexão com a PlayStation™Network e a validade de sua assinatura PlayStation®Plus.|
|$ps_report_user_banned_account|Sua conta foi banida dos serviços online por violar os termos de serviço listados no EULA e no Código de Conduta. Esta ação foi tomada pela Coffee Stain Publishing. Confira o EULA no canto inferior esquerdo para mais informações.|
|$ps_settings_3d_audio|Áudio 3D|
|$ps_settings_controller|Controle|
|$ps_settings_controller_layout|Configuração de controle|
|$ps_settings_controller_motion_sensor|Sensor de movimento|
|$ps_settings_controller_motion_sensor_settings_off|O sensor de movimento está desligado! Verifique as configurações.|
|$ps_settings_controller_motion_sensor_toggled_off|Sensor de movimento desligado|
|$ps_settings_controller_motion_sensor_toggled_on|Sensor de movimento ligado|
|$ps_settings_controller_motion_sensor_x_axis_sensitivity|Sensibilidade do eixo X do sensor de movimento|
|$ps_settings_controller_motion_sensor_y_axis_sensitivity|Sensibilidade do eixo Y do sensor de movimento|
|$ps_settings_controller_sensitivity|Sensibilidade do controle|
|$ps_settings_controller_speaker_volume|Volume do alto-falante do controle|
|$ps_settings_controller_use_adaptive_triggers|Usar gatilhos adaptáveis|
|$ps_settings_controller_use_controller_speaker|Usar alto-falante do controle|
|$ps_settings_controller_use_vibration|Usar vibração|
|$ps_settings_controller_vibration_strength|Intensidade da vibração|
|$ps_settings_double_tap_descr|Dê dois toques rápidos no controle analógico na direção de um elemento para interagir com ele.|
|$ps_settings_flick_interact_descr|Mova o controle analógico rapidamente na direção de um elemento para interagir com ele.|
|$ps_settings_gamepadenabled|Controle ativado|
|$ps_settings_persistentbackbtn|Botão de voltar persistente|
|$ps_settings_persistentbackbtn_descr|Ao percorrer um menu radial com várias páginas, o elemento do topo será sempre o botão de voltar.|
|$ps_settings_same_online_platform_only|Apenas PlayStation™Network|
|$ps_settings_same_online_platform_only_desc|Permite jogar apenas com jogadores na PlayStation™Network. Desabilita todas as interações com usuários de outras plataformas. Pode ser alternada no menu principal.|
|$ps_settings_show_button_hints|Exibir dicas de botões|
|$ps_settings_swap_triggers|Trocar botões R2 e L2|
|$ps_ugc_character_name|Nome de personagem UGC|
|$ps_ugc_server_name|Nome de servidor UGC|
|$ps_ugc_text|Texto UGC|
|$ps_ugc_world_name|Nome de mundo UGC|
|$radial_all|Tudo|
|$radial_armor_utility|Armaduras e utilitários|
|$radial_back|Voltar|
|$radial_close|Fechar|
|$radial_consumables|Consumíveis|
|$radial_drop|Soltar|
|$radial_drop_multiple|Soltar vários|
|$radial_emotes|Emotes|
|$radial_half|Metade|
|$radial_hammer|Equipar martelo|
|$radial_handitems|Objetos de mão|
|$radial_hold|(Segurar)|
|$radial_hotbar|Barra rápida|
|$radial_interact|Usar/abrir|
|$radial_speed_fast|Rápida|
|$radial_speed_medium|Média|
|$radial_speed_off|Desligado|
|$radial_speed_slow|Devagar|
|$radial_weapons_tools|Armas e ferramentas|
|$raven_interact|Conversar|
|$report_server_window_explanation_text|Se este servidor contém Conteúdo Gerado por Usuários (UGC) que viola o Código de Conduta, ele pode ser denunciado. É recomendado remover UGC manualmente dentro do jogo, mas denunciar o servidor é uma alternativa se isso não for possível.|
|$report_server_window_header|Denunciar servidor|
|$report_user_already_reported_header|Denúncia já feita|
|$report_user_already_reported_text|Você já denunciou este usuário.|
|$report_user_banned_account|Sua conta foi banida dos serviços online por violar os termos de serviço listados no EULA e no Código de Conduta. Esta ação foi tomada pela Coffee Stain Publishing. Confira o EULA no canto inferior esquerdo para mais informações.|
|$report_user_banned_account_steam|Sua conta foi banida dos servidores de crossplay por violar os termos de serviço listados no EULA e no Código de Conduta. Esta ação foi tomada pela Coffee Stain Publishing. Confira o EULA no canto inferior esquerdo para mais informações.|
|$report_user_banned_bodytext_permanentBan|Este banimento é permanente.|
|$report_user_banned_bodytext_unbannedLocalTime|Seu banimento é válido até|
|$report_user_banned_header|Conta banida.|
|$report_user_failed_header|Erro ao denunciar!|
|$report_user_failed_text|Não foi possível enviar a denúncia! Tente novamente mais tarde.|
|$report_user_send_report_cancel|Cancelar denúncia|
|$report_user_send_report_cant_send_not_enough_text|Insira mais detalhes no campo de texto antes de enviar a denúncia!|
|$report_user_send_report_failed|Erro ao denunciar|
|$report_user_send_report_send|Enviar denúncia|
|$report_user_successful_header|Denúncia enviada!|
|$report_user_successful_text|Sua denúncia foi registrada e será analisada em breve.|
|$report_user_window_explanation_text|O histórico do chat e nome são incluídos automaticamente. Explique detalhadamente o motivo da denúncia sobre esse usuário na janela de texto acima. Não inclua informações pessoais sensíveis ou irrelevantes.|
|$report_user_window_header|Denunciar usuário|
|$rock_abyssalbarnacle|Barnaculo abissal|
|$rotate_build_mode|Girar (Construção)|
|$se_adrenaline|Uso de adrenalina|
|$se_adrenaline_upfront|Ganho de adrenalina|
|$se_adrenalinerush|Explosão de adrenalina|
|$se_adrenalinerush_tooltip|A adrenalina corre por suas veias|
...
|$se_berserker_undead_effect_name|Fúria de ossos malditos|
|$se_berserker_undead_effect_tooltip|Aumenta o dano e a regeneração, mas enfraquece você contra dano físico.|
|$se_berserkereffect_name|Fúria|
|$se_berserkerteffect_tooltip|Aumenta o dano e a regeneração, mas enfraquece você contra dano físico.|
|$se_blockstamina|Uso de vigor: bloqueio|
|$se_blockstaminaflat|Uso de vigor ao bloquear|
|$se_blockstaminaflat_minus|Recuperação de vigor ao bloquear|
...
|$se_cold_tooltip|Reduz a vida e diminui a regeneração de vigor.|
...
|$se_crowned_start|Você passa sem nenhuma contestação.|
|$se_crowned_tooltip|As criaturas de Valheim não farão mal a quem as dominou.|
|$se_deepnorthmediumarmorseteffect_name|Vanguarda|
|$se_deepnorthmediumarmorseteffect_tooltip|Você se sente mais forte e ágil, pronto para atacar seus inimigos!|
...
|$se_frostorbs|Esfera da vingança|
|$se_frostorbs_description|Se seu inimigo ferir você, a dor será refletida nele imediatamente.|
...
|$se_health|Vida|
|$se_health_upfront|Ganho de saúde|
...
|$se_loxseteffect_name|Bênção do Lox|
|$se_loxseteffect_tooltip|A pele permite que você se camufle na natureza selvagem e circule sem chamar a atenção de ninguém.|
...
|$se_stagger|Resistência a atordoamento|
|$se_stamina|Vigor|
|$se_stamina_upfront|Ganho de vigor|
...
|$se_trinketblackdamagedealth|Braceletes dos corajosos|
|$se_trinketblackdamagedealth_description|Aumento no dano da maça e uma rápida regeneração de vida.|
|$se_trinketblackdtamina|Manto da evasão|
|$se_trinketblackdtamina_description|Aumento na habilidade de esquiva e redução no custo de vigor ao bloquear.|
|$se_trinketbloodgoldhealth|Fura-pescoço|
|$se_trinketbloodgoldhealth_description|A vida regenera mais rápido, e correr e atacar custam menos vigor. Você também pode obter um reforço instantâneo de vida e armadura.|
|$se_trinketbloodgoldstamina|Coroa de bruxa|
|$se_trinketbloodgoldstamina_description|Vida, vigor e éter regeneram mais rápido, e você pode obter um reforço instantâneo de vigor e éter.|
|$se_trinketbronzehealth|Coração da floresta|
|$se_trinketbronzehealth_description|Aumento na regeneração de vida.|
|$se_trinketbronzestamina|Pingente de bronze|
|$se_trinketbronzestamina_description|Aumento na regeneração de vigor.|
|$se_trinketcarapaceeitr|Brincos pulsantes|
|$se_trinketcarapaceeitr_description|Aumento na regeneração de éter.|
|$se_trinketchitinswim|Barbatanas do destino|
|$se_trinketchitinswim_description|Redução do custo de vigor ao nadar e aumento da velocidade de nado.|
|$se_trinketflametaleitr|Jörmundling|
|$se_trinketflametaleitr_description|Aumento nas habilidades de magia elemental e de sangue, e um rápido impulso de regeneração de éter.|
|$se_trinketflametalstaminahealth|Enxofre|
|$se_trinketflametalstaminahealth_description|Um rápido impulso na regeneração de saúde e vigor.|
|$se_trinketironhealth|Broche de ferro|
|$se_trinketironhealth_description|Aumento de armadura e um rápido impulso na regeneração de saúde.|
|$se_trinketironstamina|Pulseira veloz|
|$se_trinketironstamina_description|Aumento na velocidade de corrida e um rápido impulso na regeneração de vigor.|
|$se_trinketscalestaminadamage|Tornozeleira retumbante|
|$se_trinketscalestaminadamage_description|Aumento no dano de corte e um rápido impulso na regeneração de vigor.|
|$se_trinketsilverdamage|Visão do lobo|
|$se_trinketsilverdamage_description|Aumento na habilidade com arco, habilidade com lança e aumento no dano de perfuração.|
|$se_trinketsilverresist|Coração de cristal|
|$se_trinketsilverresist_description|Aumento de resistência contra danos de impacto, corte e perfuração.|
|$se_trollseteffect_name|Furtividade|
|$se_trollseteffect_tooltip|Torna você mais furtivo(a).|
|$se_ttl|Duração do efeito|
|$se_warm_name|Quente|
...
|$se_windrun_tooltip|Aumenta a velocidade de corrida e reduz significativamente o uso de vigor ao correr com o vento. Deixe o vento te guiar até a vitória!|
...
|$settings_3dresolution|Limite de resolução 3D|
...
|$settings_animateradial|Animação do radial|
|$settings_animateradial_descr|Adiciona animações ao abrir e fechar o menu radial, e ao selecionar elementos nele.|
...
|$settings_bilinear|Suave|
|$settings_block|Bloquear|
|$settings_blocked_player_list|Jogadores bloqueados|
...
|$settings_chat|Chat|
|$settings_close_radial|Fechar menu radial / arco de emotes|
|$settings_clothquality|Qualidade dos tecidos|
...
|$settings_console|Habilitar console|
|$settings_console_desc|Habilita o acesso ao console interno do jogo, no qual é possível utilizar comandos e recursos especiais de debug. O argumento de linha de comando -console sobrescreve esta configuração.|
...
|$settings_controller_layout|Layout de controle|
|$settings_controller_sensitivity|Sensibilidade do controle|
|$settings_controller_speaker_volume|Volume do alto-falante do controle|
|$settings_controller_use_adaptive_triggers|Usar gatilhos adaptáveis|
|$settings_controller_use_controller_speaker|Usar alto-falante do controle|
|$settings_controller_use_vibration|Usar vibração|
|$settings_controller_vibration_strength|Intensidade da vibração|
...
|$settings_double_tap|Toque duplo|
|$settings_double_tap_descr|Dois toques rápidos no analógico em direção a um elemento permite interagir com ele.|
|$settings_draw|Sacar|
|$settings_enable_show_build_piece_author|Exibir autoria de peça de construção|
|$settings_enable_show_build_piece_author_desc|Ao passar o mouse por uma peça de construção no modo de construção, mostra quem a colocou.|
|$settings_extreme|Extrema|
|$settings_fishingcast|Lançar|
|$settings_fishingpull|Puxar|
|$settings_flick_interact|Interação rápida|
|$settings_flick_interact_descr|Mover o analógico rapidamente na direção de um elemento permite interagir com ele.|
...
|$settings_graphics_preset|Predefinição gráfica|
|$settings_graphics_preset_balanced_description|Tenta manter 40 fps com qualidade gráfica superior, caso a frequência de 120 Hz seja compatível e esteja ativada. Caso contrário, utiliza a predefinição de 60 fps.|
|$settings_graphics_preset_high_description|Gráficos incríveis para sistemas potentes|
|$settings_graphics_preset_low_description|Proporciona boa aparência e funciona bem mesmo em sistemas com pouca potência.|
|$settings_graphics_preset_medium_description|Oferece um bom equilíbrio entre qualidade gráfica e desempenho|
|$settings_graphics_preset_performance_description|Meta de 60 fps com qualidade gráfica padrão.|
|$settings_graphics_preset_quality_description|Tenta manter 30 fps com a mais alta qualidade gráfica.|
...
|$settings_high|Alta|
|$settings_hotbarright|Mudar hotbar|
|$settings_hotbaruse|Usar item (hotbar)|
|$settings_hoverselectspd|Velocidade de seleção do menu radial|
|$settings_hoverselectspd_descr|A velocidade com que um elemento é selecionado ao passar o mouse sobre ele. Defina como "Desligado" para desativar.|
...
|$settings_lod2|Nível de detalhamento|
|$settings_look|Olhar|
|$settings_low|Baixa|
|$settings_map|Mapa|
...
|$settings_nearestneighbor|Pixelizado|
|$settings_nextsnap|Próximo ponto de encaixe|
|$settings_open_emote_wheel|Abrir arco de emotes|
|$settings_open_radial|Abrir menu radial|
|$settings_persistentbackbtn|Botão de voltar persistente|
|$settings_persistentbackbtn_descr|Ao percorrer um menu radial com várias páginas, o elemento do topo será sempre o botão de voltar.|
...
|$settings_radial|Menu radial|
|$settings_radial_big|Grande|
|$settings_radial_small|Pequeno|
|$settings_radial_small_edge|Borda pequena|
|$settings_radialback|Voltar (radial)|
|$settings_radialclose|Fechar (radial)|
|$settings_radialinteract|Interagir (radial)|
|$settings_radialsecondaryinteract|Soltar (radial)|
|$settings_radialsize|Tamanho do radial|
|$settings_radialsize_descr|Controla o tamanho e posição do menu radial.|
...
|$settings_release_to_use_mode|Modo de soltar para usar|
|$settings_release_to_use_mode_descr|Soltar para usar|
...
|$settings_simulationdistance|Distância de renderização|
|$settings_simulationdistance_circular|circular $1 m|
|$settings_simulationdistance_square|quadrado $1 m|
|$settings_simulationdistance_warning|Aumentar a distância de renderização pode prejudicar significativamente o desempenho!|
|$settings_sit|Sentar|
|$settings_softpart|Partículas suaves|
|$settings_spiral_normal|Normal|
|$settings_spiral_off|Desligado|
|$settings_spiral_slight|Sutil|
|$settings_spiraleffect|Efeito espiral|
|$settings_spiraleffect_descr|Define a intensidade do efeito espiral. Ao navegar por um menu radial com diversas páginas, elementos próximos ao selecionado serão escalonados e organizados em um efeito espiral. Se desligado, os elementos só ficaram em destaque ou opacos. Esta configuração requer que "Animação de radial" esteja habilitada.|
...
|$settings_upscalingalgorithm|Método de ampliação|
|$settings_use|Usar|
|$settings_useradial|Usar radial|
|$settings_useradial_descr|Habilita o uso do menu radial para navegar no inventário.|
...
|$shadowperson_randomtalk_01|A lâmina dele estava coberta de veneno, eu não tive chance...|
|$shadowperson_randomtalk_02|Dor, aguda e excruciante. E então o nada.|
|$shadowperson_randomtalk_03|O fogo já não me aquece, nem oferece nenhuma luz de verdade.|
|$shadowperson_randomtalk_04|Não me lembro de como era não estar dormente e com frio.|
|$shadowperson_randomtalk_05|A faca dela encontrou meu coração exatamente enquanto eu cortava sua garganta. Morremos lado a lado.|
|$shadowperson_randomtalk_06|Isto não é Valhalla e não é Hel. Não, é algo muito pior.|
|$shadowperson_randomtalk_07|Um homem morto esquecido...|
|$shadowperson_randomtalk_08|Pai... Eu falhei com você. Sinto muito...|
|$shadowperson_randomtalk_09|Perdoe-me, irmã, por não poder seguir seus passos.|
|$shadowperson_randomtalk_10|Eu fui com ele até o fim...|
|$shadowperson_randomtalk_11|Tem alguém aqui? Eu... Eu poderia jurar que vi alguém.|
|$shadowperson_randomtalk_12|Esquecido há tanto tempo... Solitário...|
|$shadowperson_randomtalk_13|Só mais um passo. Só mais um.|
|$shadowperson_randomtalk_14|Estas são as últimas das terras que conhecíamos...|
|$shadowperson_randomtalk_15|Nada sei deste ermo, nem desta noite escura...|
|$shadowperson_randomtalk_16|Achei que vi alguém caminhando ao meu lado, mas era só uma sombra.|
|$shadowperson_randomtalk_17|Já não sinto o sol no meu rosto nem o chão sob os meus pés.|
|$shadowperson_randomtalk_18|Eu... Eu já não sinto mais nada.|
|$shadowperson_randomtalk_19|Meu propósito aqui foi cumprido, mas nenhuma recompensa foi concedida. Agora eu caminho por aqui, sem qualquer utilidade...|
|$shadowperson_randomtalk_20|Tem tanto sangue... Quanto uma pessoa pode sangrar antes de morrer?|
|$shadowperson_randomtalk_21|A tristeza da minha derrota, interminável...|
|$shadowperson_randomtalk_22|Ainda sinto a galhada afiada perfurando meu peito. Quando me libertarei desta dor?|
|$shadowperson_randomtalk_23|Pensei que ela estava me estendendo a mão, mas então eletricidade saiu de seus dedos.|
|$shadowperson_randomtalk_24|Que estranhas criaturas podem ser encontradas aqui. Tive esperança de que fossem amigáveis.|
|$shadowperson_randomtalk_25|Consegue ouvir as vozes? Seus ecos permanecem...|
|$shadowperson_randomtalk_26|Eu cheguei tão longe, só para tudo terminar em um piscar de olhos.|
|$shadowperson_randomtalk_27|Que cores ondulantes tão belas... Por que não consigo alcançá-las?|
|$shadowperson_randomtalk_28|Este era o meu destino? Morrer antes de atingir meu objetivo?|
|$shadowperson_randomtalk_29|Tanto sangue derramado, e para quê?|
|$shadowperson_randomtalk_30|Quem contará minha história?|
|$ship_ashlandocean_warning|As águas escaldantes estão corroendo o seu casco, volte!|
|$ship_cargo|Carga|
|$ship_holdfast|Fique firme|
|$ship_karve|Karve|
|$ship_karve_description|Um navio pequeno e leve, pronto para zarpar.|
|$ship_longship|Drácar|
|$ship_longship_ashlands|Dracar|
|$ship_longship_ashlands_description|Um navio enorme, robusto o suficiente para navegar até mesmo nos mares mais perigosos.|
|$ship_longship_description|Um poderoso navio viking para navegar para costas distantes.|
|$ship_raft|Jangada|
|$ship_raft_description|Pode não parecer grande coisa, mas uma jangada leva mais longe que o nado!|
|$skill_axes|Machados|
...
|$skill_dodge|Esquiva|
|$skill_dodge_description|Consome vigor ao esquivar.|
...
|$spiritcaller_moose||
|$spiritcaller_wolf||
|$stat_BeesHarvested|Mel coletado|
|$stat_BuiltPiecesNoDebt|Peças de construção colocadas|
|$stat_ConsecutiveDaysSurvivedMax|Máximo de dias consecutivos de sobrevivência|
|$stat_CraftFood|Comida produzida|
|$stat_DeathByAshlandsOcean|Morte por oceano das Terras de Cinzas|
|$stat_DeathByBoat|Morte por barco|
|$stat_DeathByBurning|Morte por fogo|
|$stat_DeathByCart|Morte por carroça|
|$stat_DeathByCatapult|Morte por catapulta|
|$stat_DeathByCinderFire|Morte por cinzafogo|
|$stat_DeathByDrawBridge|Morte por ponte levadiça|
|$stat_DeathByDrowning|Morte por afogamento|
|$stat_DeathByEdgeOfWorld|Morte por cair da borda do mundo|
|$stat_DeathByEnemyHit|Morte por inimigo|
|$stat_DeathByFall|Morte por queda|
|$stat_DeathByFreezing|Morte por congelamento|
|$stat_DeathByImpact|Morte por impacto|
|$stat_DeathByIncinerator|Morte pelo Obliterador|
|$stat_DeathByPoisoned|Morte por envenenamento|
|$stat_DeathBySelf|Morte por jogador|
|$stat_DeathBySmoke|Morte por fumaça|
|$stat_DeathByStalagtite|Morte por estalactite|
|$stat_DeathByStructural|Morte por estrutura|
|$stat_DeathByTree|Morte por árvore|
|$stat_DeathByTurret|Morte por balista|
|$stat_DeathByWater|Morte por água|
|$stat_DistanceSail|Distância navegada|
|$stat_DistanceSailHelm|Distância navegada, no comando do leme|
|$stat_ExploreEast|Explore o leste distante|
|$stat_ExploreEastNoMap|Explore o leste distante, sem usar um mapa|
|$stat_ExploreNorth|Explore o norte distante|
|$stat_ExploreNorthNoMap|Explore o norte distante, sem usar um mapa|
|$stat_ExploreSouth|Explore o sul distante|
|$stat_ExploreSouthNoMap|Explore o sul distante, sem usar um mapa|
|$stat_ExploreWest|Explore o oeste distante|
|$stat_ExploreWestNoMap|Explore o oeste distante, sem usar um mapa|
|$stat_FoodEaten|Comida consumida|
|$stat_HarvestBerry|Frutinhas coletadas|
|$stat_HarvestCrop|Colheitas feitas|
|$stat_HarvestMushroom|Cogumelos coletados|
|$stat_MaxBuildingHeight|Construção mais alta|
|$stat_MaxBuildingHeightWorld|Posição de construção mais alta no mundo|
|$stat_MaxComfort|Nível máximo de conforto|
|$stat_TreasureBuriedFound|Tesouros enterrados encontrados|
|$stat_Tree|Árvores cortadas|
|$stat_TreeAshlands|Morte por árvore das Terras de Cinzas|
|$stat_TreeBeech|Morte por faia|
|$stat_TreeBirch|Morte por bétula|
|$stat_TreeFir|Morte por abeto|
|$stat_TreeOak|Morte por carvalho|
|$stat_TreePine|Morte por pinheiro|
|$stat_TreeSnowFir|Morte por abeto nevado|
|$stat_TreeSnowPine|Morte por pinheiro nevado|
|$stat_TreeSwamp|Morte por árvore do pântano|
|$stat_TreeYggdrasilShoot|Morte por broto de Yggdrasil|
|$stonecircle_hook_name|Plataforma cinzelada|
|$stonecircle_itemplaced|Você está à altura|
|$store_buy|Comprar|
|$store_sell|Vender|
|$store_topic|Loja|
|$switch_codeofconduct_prohibited_behavior_body|As ações a seguir podem resultar em banimentos temporários ou permanentes dos serviços online:<br/>• Assédio, discurso de ódio, ameaças ou discriminação.<br/>• Compartilhar conteúdo ofensivo ou impróprio por meio do chat, construções no jogo ou outros meios.|
|$switch_eula_header|ACORDO DE LICENÇA DE USUÁRIO FINAL|
|$switch_eula_important_first_text|(Valheim – Nintendo Switch 2)<br/>IMPORTANTE: LEIA CUIDADOSAMENTE O ACORDO EM VALHEIM.COM/EULA. AO BAIXAR, INSTALAR OU UTILIZAR “VALHEIM” (O “PRODUTO”) EM UM CONSOLE NINTENDO SWITCH 2 QUE VOCÊ POSSUI OU CONTROLA, VOCÊ CONCORDA EM SEGUIR OS TERMOS DESTE ACORDO DE LICENÇA DE USUÁRIO FINAL (“EULA”). CASO NÃO CONCORDE, NÃO UTILIZE O PRODUTO.|
|$switch_loading_savenotification|O jogo tem um recurso de salvamento automático. Quando vir o ícone de salvamento automático, não desligue o jogo nem o console.|
|$switch_loadscreen_tip24|Filtre marcações do mapa por tipo clicando com o botão para a direita (botão ZR com o mouse Joy-Con 2)|
|$switch_menu_cloudstoragefull|A memória do sistema está cheia!|
|$switch_menu_friendinvite_accepted_header|Solicitação de amizade aceita|
|$switch_menu_friends|Amigos|
|$switch_menu_invite_friends|Convidar amigos|
|$switch_menu_localstoragefullcharacterprompt|Memória do console insuficiente. Não foi possível criar o personagem.|
|$switch_menu_localstoragefullworldprompt|Memória do console insuficiente. Não foi possível criar o mundo.|
|$switch_menu_storagefull|A memória do sistema está cheia!|
|$switch_menu_storagefulloperationfailed|A operação falhou porque a memória do sistema está cheia. Exclua dados salvos não utilizados e tente novamente.|
|$switch_menu_storageused|Memória do sistema usada: $1|
|$switch_online_kickedfromsession_suspendresume_text|Sua conta foi expulsa da sessão online; o console entrou em modo de descanso, interrompendo a atividade de rede.|
|$switch_settings_controller|Controle|
|$switch_settings_controller_default|Console|
|$switch_settings_controller_layout|Configuração de controle|
|$switch_settings_controller_motion_sensor|Sensores de movimento|
|$switch_settings_controller_motion_sensor_settings_off|Os sensores de movimento estão desligados! Verifique as configurações.|
|$switch_settings_controller_motion_sensor_toggled_off|Sensores de movimento desligados|
|$switch_settings_controller_motion_sensor_toggled_on|Sensores de movimento ligados|
|$switch_settings_controller_motion_sensor_x_axis_sensitivity|Sensibilidade do eixo X dos sensores de movimento|
|$switch_settings_controller_motion_sensor_y_axis_sensitivity|Sensibilidade do eixo Y dos sensores de movimento|
|$switch_settings_controller_sensitivity|Sensibilidade do controle|
|$switch_settings_controller_use_vibration|Usar vibração|
|$switch_settings_controller_vibration_strength|Intensidade da vibração|
|$switch_settings_double_tap_descr|Dê dois toques rápidos no analógico na direção de um elemento para interagir com ele.|
|$switch_settings_flick_interact_descr|Mova o analógico rapidamente na direção de um elemento para interagir com ele.|
|$switch_settings_gamepadenabled|Controle ativado|
|$switch_settings_mouse_layout|Layout de mouse|
|$switch_settings_mouse_layout_controller|Mouse do console|
|$switch_settings_mouse_layout_pc|Mouse do PC|
|$switch_settings_mouse_sensitivity|Sensibilidade do mouse|
|$switch_settings_mouse_tab|Mouse Joy-Con 2|
|$switch_settings_persistentbackbtn|Botão de voltar persistente|
|$switch_settings_persistentbackbtn_descr|Ao percorrer um menu radial com várias páginas, o elemento do topo será sempre o botão de voltar.|
|$switch_settings_show_button_hints|Exibir dicas de botões|
|$switch_settings_swap_triggers|Trocar botões ZR e ZL|
|$switch_settings_switch_mouse_enabled|Mouse ativado|
|$switch_ugc_character_name|Nome de personagem UGC|
|$switch_ugc_server_name|Nome de servidor UGC|
|$switch_ugc_text|Texto UGC|
|$switch_ugc_world_name|Nome de mundo UGC|
|$tag_architecture|Arquitetura|
|$tag_building|Construção|
|$tag_crafting|Produção|
|$tag_decor|Decoração|
|$tag_defense|Defesa|
|$tag_doors|Portas e janelas|
|$tag_feasts|Banquetes|
|$tag_floor|Pisos|
|$tag_food|Comida|
|$tag_furniture|Mobília|
|$tag_lighting|Iluminação|
|$tag_mead|Hidromel|
|$tag_misc|Outros|
|$tag_roof|Tetos|
|$tag_seasonal|Itens sazonais|
|$tag_stacks|Pilhas|
|$tag_stairs|Escadas|
|$tag_storage|Armazenamento|
|$tag_transport|Transporte|
|$tag_wall|Paredes|
|$tamed_name_01|Seu melhor parceiro|
|$text_hidden_notification_muted|TEXTO ESCONDIDO, CRIADOR(A) FOI SILENCIADO(A)|
|$text_hidden_notification_ugc_settings|TEXTO ESCONDIDO, VERIFIQUE CONFIGURAÇÕES DE UGC|
...
|$tinyrom_download_patch_to_play|Baixe o patch para jogar|
|$tool_batteringram|Aríete|
|$tool_batteringram_description|Uma máquina temível. Coloque combustível e leve-o até fortalezas inimigas para uma maior chance de sucesso.|
|$tool_cart|Carrinho|
|$tool_cart_description|Conveniente quando você precisa mover muitos recursos.|
|$tool_catapult|Catapulta|
|$tool_catapult_description|Se você não consegue atravessar, talvez possa passar por cima...|
...
|$tutorial_end_hugin_label|Hugin: Rumo a Valhalla|
|$tutorial_end_hugin_text|Parabéns, fiel de Odin!<br/><br/>Finalmente você derrotou todos os Guardiões e conquistou sua honra. Os portões de Valhalla agora estão abertos para você. Tudo que você precisa fazer é deixar que a valquíria te leve até lá.<br/><br/>Mas não se preocupe. Você sempre terá um lugar aqui no décimo mundo, se quiser retornar.|
|$tutorial_end_hugin_topic|Jornada para Valhalla|
|$tutorial_end_munin_label|Munin: Guardiões derrotados|
|$tutorial_end_munin_text|Você guerreou bem, fiel de Odin.<br/><br/>Graças a você, os Guardiões já não existem, e este mundo pode novamente ser reunido com o resto de Yggdrasil. Mas essa é uma história para outro momento! Agora, você precisa resgatar sua recompensa em Valhalla, não acha?|
|$tutorial_end_munin_topic|E então a saga chega ao fim...|
|$tutorial_faderember_label|Hugin: Pira eterna|
|$tutorial_faderember_text|Não é só o sopro de um dragão que arde intensamente, mas também a própria essência dele. É possível utilizá-la, com habilidade e paciência suficientes...|
...
|$tutorial_jotuninvasion_hugin_label|Hugin: Invasões dos Jotun|
|$tutorial_jotuninvasion_hugin_text|"Fique alerta com a aproximação do exército Jotun. Vá até o ponto de origem da invasão e detenha os invasores. Só assim você poderá retificar o décimo mundo..."|
|$tutorial_jotuninvasion_hugin_topic|Exércitos estranhos estão invadindo!|
...
|$tutorial_mould_hugin_text|Os moldes podem produzir resultados fascinantes! Mas não basta preenchê-los com materiais. Eles também precisam ser endurecidos com a ajuda de temperaturas extremas...|
|$tutorial_mould_hugin_topic|Você encontrou um molde!|
...
|$tutorial_prison_label|Hugin: A Prisão|
|$tutorial_prison_text|Tenha cuidado! O ser aprisionado atrás deste portão é poderoso, mais do que qualquer outro em toda Valheim. É aconselhável que você tenha o devido preparo antes de se aventurar a enfrentar esse inimigo final.|
|$tutorial_prison_topic|Uma última tentativa...|
...
|$tutorial_sacrificialblood_text|Muito bem, combatente! Você encontrou o sangue do sacrifício, a chave final para restaurar este reino. Agora, o Pai de Todos tem uma última tarefa para você: prove que merece voltando ao lugar onde tudo começou!|
|$tutorial_sacrificialblood_topic|Chegou a hora...|
...
|$tutorial_trinket_label|Hugin: Amuletos|
|$tutorial_trinket_text|Crá-crááá! Guerreiro, é esse um amuleto reluzente que vejo em sua mão? Coloque-o com orgulho e deixe seu poder fluir através de você enquanto derruba seus inimigos. Quando sua adrenalina atingir seu auge, com certeza será recompensado!|
|$tutorial_trinket_topic|A adrenalina invade seu corpo!|
|$tutorial_upgrader_hugin_label|Hugin: Forja de Potencial|
|$tutorial_upgrader_hugin_text|Encontrar esse lugar de poder ancestral não é tarefa fácil, e aqueles que o fizeram têm muito a ganhar! Mas um aviso: embora a Forja possa ser ótima a seu favor, ela pode destruir aquilo que você busca refinar com a mesma facilidade...|
|$tutorial_upgrader_hugin_topic|Ouça bem, viajante!|
...
|$xbox_codeofconduct_platform_specific_text|Também é necessário seguir os Padrões da Comunidade Xbox, aplicados em adição às nossas regras.|
|$xbox_codeofconduct_reporting_violations_body|Caso você testemunhe comportamento inaceitável:<br/>• Dentro do jogo: use a função de "Denunciar jogador" (Opções->Lista de jogadores->Denunciar)<br/>• Fora do jogo: use este formulário online: https://valheim.com/report-a-player<br/>• Pela rede Xbox: consulte https://support.xbox.com/pt-BR/help/family-online-safety/enforcement/file-a-complaint-on-xbox-app|
|$xbox_error_crossplayprivilege|Suas configurações de privilégio de plataforma impedem que você jogue em servidores com funcionalidade de crossplay.|
|$xbox_eula_important_first_text|(Valheim – Edição Xbox®)<br/>IMPORTANTE: LEIA CUIDADOSAMENTE O ACORDO EM VALHEIM.COM/EULA. AO BAIXAR, INSTALAR OU UTILIZAR “VALHEIM” (O “PRODUTO”) EM UM CONSOLE XBOX QUE VOCÊ POSSUI OU CONTROLA, VOCÊ CONCORDA EM SEGUIR OS TERMOS DESTE ACORDO DE LICENÇA DE USUÁRIO FINAL (“EULA”). CASO NÃO CONCORDE, NÃO UTILIZE O PRODUTO.|
|$xbox_loading_savenotification|O jogo tem um recurso de salvamento automático. Quando vir o ícone de salvamento automático, não desligue o jogo nem o console.|
|$xbox_menu_resolve_privilege|Resolver problema de privilégio?|
|$xbox_menu_storagefull|Seu armazenamento está cheio!|
|$xbox_menu_storagefulloperationfailed|A operação falhou porque o armazenamento de dados salvos está cheio. Exclua dados salvos não utilizados e tente novamente.|
|$xbox_menu_storageused|Armazenamento usado: $1|
|$xbox_online_kickedfromsession_suspendresume_text|Sua conta foi expulsa da sessão online; o console entrou em modo de suspensão, interrompendo a atividade de rede.|
|$xbox_settings_controller|Controle|
|$xbox_settings_controller_default|Console|
|$xbox_settings_controller_layout|Configuração de controle|
|$xbox_settings_controller_sensitivity|Sensibilidade do controle|
|$xbox_settings_controller_use_vibration|Usar vibração|
|$xbox_settings_controller_vibration_strength|Intensidade da vibração|
|$xbox_settings_double_tap_descr|Dê dois toques rápidos no direcional analógico na direção de um elemento para interagir com ele.|
|$xbox_settings_flick_interact_descr|Mova o direcional analógico rapidamente na direção de um elemento para interagir com ele.|
|$xbox_settings_gamepadenabled|Controle ativado|
|$xbox_settings_persistentbackbtn|Botão de voltar persistente|
|$xbox_settings_persistentbackbtn_descr|Ao percorrer um menu radial com várias páginas, o elemento do topo será sempre o botão de voltar.|
|$xbox_settings_show_button_hints|Exibir dicas de botões|
|$xbox_ugc_character_name|Nome de personagem UGC|
|$xbox_ugc_server_name|Nome de servidor UGC|
|$xbox_ugc_text|Texto UGC|
|$xbox_ugc_world_name|Nome de mundo UGC|
