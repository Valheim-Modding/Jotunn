...
|$menu_vulkancrashwarning_text|Você está usando Vulkan no momento. Estamos investigando uma falha conhecida ao usar Vulkan em certos sistemas, e seu sistema foi detectado como potencialmente afetado. Se você tiver problemas de estabilidade, use a API de renderização padrão (DirectX 11). Desculpe pelo transtorno!|
