...
|$error_worldfileload|Erro ao carregar o arquivo do mundo. Confira os backups!|
...
|$menu_acceptedinvite|Você aceitou o convite!|
|$menu_addserver|Adicionar servidor|
|$menu_addserverfailed|Falha ao adicionar servidor!|
|$menu_addserverfailedincorrectformatting|Você inseriu um IP, URL ou código de convite inválido!|
|$menu_addserverfailedresolvejoincode|Não foi possível resolver o código de entrada|
|$menu_back|Voltar|
|$menu_backupcount|$1 backups|
|$menu_backuprestorefailedheader|Falha ao restaurar backup!|
|$menu_backuprestorepromptheader|Restaurar backup?|
|$menu_backuprestorepromptrecover|O arquivo apagado $1 será restaurado de $2.|
|$menu_backuprestorepromptreplace|A versão atual de $1 será salva e substituída por $2.|
|$menu_beard|Barba|
...
|$menu_cloudstoragefull|Seu armazenamento na nuvem está cheio!|
|$menu_cloudstoragefullcharacterprompt|Em vez disso, você gostaria de salvar este personagem no armazenamento local?|
|$menu_cloudstoragefullmovingsave|Para evitar perda de dados, os dados salvos da sessão atual podem ser movidos para o armazenamento local.|
|$menu_cloudstoragefulloperationfailed|Esta operação falhou pois o seu armazenamento na nuvem está cheio. Mova alguns mundos para o armazenamento local e tente novamente.|
|$menu_cloudstoragefullworldprompt|Em vez disso, você gostaria de salvar este mundo no armazenamento local?|
|$menu_cloudstorageused|Armazenamento na nuvem utilizado: $1/$2|
|$menu_collapse|Reduzir|
...
|$menu_deleted|Apagado|
|$menu_disallowedcharactername|Can't create a character with this name|
|$menu_done|Pronto|
|$menu_duplicatefilepromptheader|Impossível mover o jogo salvo|
|$menu_duplicatefileprompttext|Já existe um jogo salvo chamado $1 no local de destino.|
|$menu_enteripinvite|Digite o IP ou código de convite|
...
|$menu_gamepreviewpopuptext|Alguns recursos da plataforma ou jogo podem não funcionar corretamente, e o jogo pode parar de funcionar.|
|$menu_hair|Cabelo|
|$menu_hairtone|Cor do Cabelo|
|$menu_ipportorinvitecode|[IP/URL]:[port] ou [código de convite de 6 dígitos]|
|$menu_joincode|Código de entrada $1|
...
|$menu_logoutprompt|Você tem certeza que deseja desconectar-se da sessão atual?|
|$menu_male|Masculino|
|$menu_managesaves|Administrar jogos salvos|
...
|$menu_newworldalreadyexists|O mundo já existe!|
|$menu_newworldalreadyexistsmessage|Já existe um mundo chamado $1|
|$menu_no|Não|
|$menu_ok|OK|
|$menu_password|Senha|
...
|$menu_tryagainorrestart|Tente novamente ou reinicie o jogo se o problema persistir|
...
|$msg_worldsavedcloudstoragefull|O armazenamento na nuvem está cheio! O mundo foi movido e salvo no armazenamento local|
...
|$settings_autobackup|Histórico de backup automático|
...
|$settings_chat|Chat|
|$settings_cloudsave|Salvar na Nuvem|
