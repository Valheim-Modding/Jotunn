...
|$error_platformexcluded|O proprietário do servidor não permite que usuários de outras plataformas que não a sua joguem em seu servidor.|
...
|$item_helmet_fishinghat_description|Este chapéu estiloso só pode ser usado pelos aventureiros mais experientes.|
...
|$menu_addserverfaileddnslookup|Falha ao consultar o DNS!|
...
|$menu_loginfailedtext|Falha ao logar. Por favor, certifique-se que você está conectado a internet.|
|$menu_loginheader|Conectando ao serviço do servidor...|
|$menu_loginretrycountdowntext|Tentando novamente em $1 segundo(s)...|
|$menu_logintext|Logando...|
...
|$piece_turret_target_set|Definir alvo com troféu|
...
|$se_fishinghat_description|Vikings querem você, mas os peixes temem você.|
...
|$settings_reduceflashinglights|Reduzir luzes piscando|
