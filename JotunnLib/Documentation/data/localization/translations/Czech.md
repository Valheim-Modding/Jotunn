...
|$item_askbladder_description|Kyselý zápach stále přetrvává. Výrazně přetrvává...|
...
|$item_seekerqueen_drop_description|Vůle Jejího Veličenstvo byla přímo nezlomná, ovšem tento krunýř ji možná překonává.|
...
|$item_trophy_asksvin_description|Nenechte se zmást jejich úsměvem, klidně vám můžou uhryznout ruku.|
...
|$item_trophy_bonemaw_description|Lebka z pevné a hutné kosti, poskytuje stejně tolik ochrany jako představuje nebezpečí.|
...
|$item_trophy_fallenvalkyrie_description|I po smrti stále touží po krvi.|
...
|$menu_cloudsavesdisabled|Máte vypnutý Steam Cloud ukládání ve vašem nastavení Steamu. Všechny světy a charaktery uložené na Cloudu zde nebudou vidět. Aktivujte Steam Cloud ukládání, abyste k ním opět získali přístup.|
...
|$piece_artisan_ext1|Umělecký lis|
...
|$piece_catapult_wontfit|Tohle se do katapultu nevejde|
