...
|$event_bats_end|Letka se uklidňuje|
|$event_bats_start|Narušili jste letku|
...
|$item_chest_fenris|Fenridův Kabátec|
|$item_chest_fenris_description|Bestie se dokázala hluboce nadechnout, aby její vití bylo slyšet celou zemí.|
...
|$item_helmet_fenris|Fenridova hůčka|
|$item_helmet_fenris_description|Oči bestie byly moudré a vědoucí, tak, aby mohla změřit sílu válečníka pouhým pohledem.|
...
|$item_legs_fenris_description|Nohy bestie byly štíhlé a silné, aby mohla skákat smrtící výpady.|
...
|$item_pickable_hairstrands|Fenridův vlas|
...
|$item_trophy_cultist|Trofej skřetího kutlisty|
...
|$item_trophy_ulv|Ulv v trofeji|
|$item_trophy_ulv_description|Bitelný ocas od zlobivého pejska.|
|$item_trophy_ulv_lore|Bitelný ocas od zlobivého pejska.|
...
|$item_wolfhairbundle|Svazek Fenridových vlasů|
|$item_wolfhairbundle_description|Svazek silných, hrubých vlasů. Silně zapáchají.|
...
|$lore_caveman01|Hlubiny jeskyně mi slibovaly bohatství.<br/>Jít dolů, zdá se, je snažší, jak jít nahoru.<br/>Jezero pomohlo, jak jen mohlo, ale nestačilo to.<br/>Stálo mě to sílu, abych ho celé nevyprázdnil, abych Tobě, znavený poutníku, dal stejnou šanci, jako jsem měl já.<br/>Doufám, že jsi přišel více připravený, než já.<br/>Pokud ne, zde, vedle mne je pokoj. Zalehni a... odpočívej.|
|$lore_caveman02|Tuto skálu jsem vyšplhal doufajíc, že dosáhnu vrcholu.<br/>Bohužel, jeskyně byla příliš hluboká<br/>...<br/>Jsem zpět zde a zvažuji skočit.<br/>Žel, zbabělcem jsem a šplhám zpátky dolů.|
...
|$piece_jackoturnip|Vyřezávaný Tuřín|
...
|$se_fenringseteffect_tooltip|Fenridova zbroj vás urychlí, abyste prošli ohněm a vaše pěsti pociťují moc bestie.|
|$se_fire_name|Oheň|
...
|$settings_bigpicturetext|* Textová pole a chat na ovládadači jsou k dispozici pouze při hraní v režimu Steam Big Picture.|
...
|$settings_glyphs_ps|Alternativní Glyfy|
