...
|$item_axehead1|Zajímavá hlavice sekery|
|$item_axehead1_description|Světlo se na jejím povrchu zajímavě odráží. A někde uvnitř citíš že nemá býti samotná...|
...
|$item_cape_lox_description|Kožešina jednoho z velkých zvířat, tlustá a teplá.|
...
|$item_chest_pcuirass_description|Jemná, ale dostatečně silná, aby dokázala odvrátit i ty nejostřejší čepele.|
...
|$item_jotunpuffs_description|Nafouknuté magií, tyto zlaté kuličky vykukují ze země tam kde padl Jotun.|
...
|$item_magecap_description|Delikátní modré Mágovky praskají čarovnou vitalitou jako nervová zakončení.|
...
|$item_necktail_description|Syrový se nedá jíst, ale po upečení je to překvapivě chutná pochoutka.|
|$item_necktailgrilled|Grilovaný ocas Necka|
|$item_necktailgrilled_description|Toto chutné, na dřevěném uhlí grilované maso, je protknuté jemnou vůní mořských řas a trávy.|
|$item_needle|Jehla|
...
|$item_trophy_gjall_lore|Snad nikam neuletí.|
...
|$item_trophy_growth_description|Černé a lepivé svinstvo.|
|$item_trophy_growth_lore|Černé a lepivé svinstvo.|
|$item_trophy_hare|Trofej Zajíce|
|$item_trophy_hare_description|Prý nosí štěstí. No, rozhodně ne původnímu majiteli.|
|$item_trophy_hare_lore|Prý nosí štěstí. No, rozhodně ne původnímu majiteli.|
...
|$item_trophy_seeker_lore|Jsou odolnější, než vypadají. Kůže těchto křídel zachycuje světlo ohně, jako by si pamatovala let.|
...
|$item_trophy_serpent_lore|Šupiny jsou sice již matné, ale oči má stále jasné.|
...
|$item_trophy_ulv_lore|Střapatý ocas ne až tak hodného pejska.|
...
|$lore_greydwarfs|Nechť se všichni, kdož mne čtou, obávají Šedých trpaslíků, bezduchých ďáblů číhajících v temnotě. Rodí se z hniloby a deště, rostou jako houby z doutnající země. Nemají slova ni myšlěnky a i ti, kteří se nebojí ničeho, by se stále měli obávat.<br/><br/>Když duše vraha nebo kacíře hnije pod zemí, vytvoří prázdnou cystu, která vtáhne kameny, dřevo a mech. Tento proces zformuje rašelinu v tělo, splete stonky v kosti a cáry hadrů přemění v kůži.<br/><br/>Nemělo by to býti schopné chodit, ale jakmile přijde noc, stejně se rozejde. Nechť proto ty, který čteš tyto řádky s mečem v ruce, když tuto zrůdu potkáš, staň se jejím koncem. Nabylo by to však v tvých silách, můžeš tuto zrůdu zahnat pochodní, protože oheň je to jediné z čeho má skutečný strach.|
...
|$lore_mistlands_random04|Dvergrové, potomci velkých kovářů věků minulých, noří se do hlubin země hledajíc skryté poklady.<br/><br/>Zde ve Valheimu těží kosti Jotunů a destilují Éitr, magickou to věc. Jsou-li ponecháni své práci, budou spokojeni se svými plány a pramálo zajímati se budou o životy ostatních, ale vyrušeni, brániti se budou.|
...
|$lore_plains_random12|Loxové jsou mocná stvoření, velcí zemětřasové kteří se procházeli pláněmi Valheimu dlouho před vykázáním Zatracených do tohoto světa.<br/>Snadno se rozčílí a rozdrtí kohokoli, kde je dosti hloupý, aby je neozbrojený obtěžoval. Ale ruku lidskou znali a mohou být naučeni ji znovu milovat.|
...
|$menu_logging_in_played_failed_not_signed_in_to_platform|Ujistěte se, že jste přihlášeni do platformy, na které hrajete předtím, než zkusíte hrát online.|
...
|$online_kickedfromsession_header|Byli jste vykopnuti|
...
|$piece_archerytarget|Terč|
|$piece_archerytarget_hits|zásahů|
|$piece_archerytarget_lastscores|Zásahy|
|$piece_archerytarget_reset|Sebrat šípy a vynulovat|
|$piece_archerytarget_total|Skóre|
...
|$se_yagluth_start|Kosmické Yagluthovi síly|
