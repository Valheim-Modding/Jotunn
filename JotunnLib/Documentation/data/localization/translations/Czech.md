...
|$animal_fish9|Ďas|
|$base_item_modifier|Základní hodnota únavy při užití předmětu|
...
|$enemy_fenringcultist_hildir|Geirrhafa|
|$enemy_gdking|Prastarý|
|$enemy_ghost|Duch|
|$enemy_gjall|Gjall|
|$enemy_goblin|Fuling|
|$enemy_goblin_hildir|Zil |
|$enemy_goblinbrute|Fuling Berserk|
|$enemy_goblinbrute_hildir|Thungr |
|$enemy_goblinbrute_hildircombined|Zil & Thungr|
...
|$error_cantrestorebackup|Nepodařilo se obnovit zálohu!|
|$error_cantrestoremeta|Nepodařilo se obnovit meta soubor!|
...
|$piece_brazierfloor02|Modré stojanové ohniště|
...
|$settings_camerashake_descr|Přidá třes kamery, když vaše postava schytá zranění.|
...
|$settings_quality_mode_balanced_description|Vyvážený režim, který drží kompromis mezi výkonem a kvalitou.|
...
|$settings_quality_mode_quality_description|Režim kvality, který preferuje dobře vypadat, než běžet plynule.|
|$settings_quality_mode_very_low|Velmi nízké|
|$settings_quality_mode_very_low_description|Velmi ošklivá kvalita, ale můžete hrát na slabém systému.|
...
|$settings_reducebg_descr|Když bude hra minimalizovaná, bude méně zatěžovat váš stroj.|
|$settings_reduceflashinglights|Ztlumit blikající světla|
|$settings_reduceflashinglights_descr|Snižuje výraznost blikajících světel.|
...
|$settings_show_button_hints_descr|Aktivuje více vyskakujících oken s informacemi ohledně ovládání v menu.|
...
|$settings_swap_triggers|Prohodit Triggery na ovladači|
...
|$settings_tutorialsenabled_descr|Ódin vyšle své havrany, aby vám pomáhali ve vašem dobrodružství.|
|$settings_use|Použít|
