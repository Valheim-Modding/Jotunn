...
|$error_worldfileload|Chargement du fichier de monde impossible. Consultez les copies de sauvegarde !|
...
|$menu_addserver|Ajout serveur|
|$menu_addserverfailed|Échec de l'ajout du serveur !|
|$menu_addserverfailedincorrectformatting|Saisie invalide. Changez d'adresse IP/URL ou de code d'invitation !|
|$menu_addserverfailedresolvejoincode|Utilisation du code d'accès impossible|
|$menu_back|Retour|
|$menu_backupcount|$1 copies de sauvegarde|
|$menu_backuprestorefailedheader|Restauration de la copie de sauvegarde échouée !|
|$menu_backuprestorepromptheader|Restaurer la copie de sauvegarde ?|
|$menu_backuprestorepromptrecover|Le fichier supprimé $1 sera restauré à partir de $2.|
|$menu_backuprestorepromptreplace|La version actuelle de $1 sera remplacée par la copie de sauvegarde $2.|
|$menu_beard|Barbe|
...
|$menu_cloudstoragefull|Espace de stockage cloud saturé !|
|$menu_cloudstoragefullcharacterprompt|Voulez-vous plutôt sauvegarder ce personnage dans un espace de stockage local ?|
|$menu_cloudstoragefullmovingsave|Afin d'éviter toutes pertes de données, transférez et sauvegardez celles de votre session actuelle dans l'espace de stockage local.|
|$menu_cloudstoragefulloperationfailed|Votre espace de stockage cloud est saturé. Veuillez transférer plusieurs de vos mondes dans votre espace de stockage local avant de réessayer.|
|$menu_cloudstoragefullworldprompt|Voulez-vous plutôt sauvegarder ce monde dans un espace de stockage local ?|
...
|$menu_crossplayserver|Multiplateforme|
|$menu_deleted|Supprimé|
|$menu_disallowedcharactername|Can't create a character with this name|
|$menu_done|Terminé|
|$menu_duplicatefilepromptheader|Transfert de sauvegarde impossible|
|$menu_duplicatefileprompttext|Une sauvegarde du nom de $1 existe déjà dans l'emplacement de destination.|
|$menu_enteripinvite|Entrer l'adresse IP ou le code d'invitation|
...
|$menu_filter|Filtre|
|$menu_friends|Amis|
|$menu_gamepreviewpopupheader|Valheim est disponible en accès anticipé.|
|$menu_gamepreviewpopuptext|Certaines plateformes et fonctionnalités inachevées peuvent bloquer le jeu.|
|$menu_hair|Cheveux|
|$menu_hairtone|Couleur de cheveux|
|$menu_ipportorinvitecode|[Adresse IP/URL] : [port] ou [code d'invitation à 6 chiffres]|
|$menu_joincode|Code d'accès $1|
|$menu_joindifferentserver|Vous allez rejoindre un autre serveur !|
...
|$menu_logoutprompt|Confirmez-vous vouloir quitter votre session actuelle ?|
|$menu_male|Homme|
|$menu_managesaves|Gestion des sauvegardes|
...
|$menu_movefailedheader|Transfert du fichier échoué !|
...
|$menu_newworldalreadyexistsmessage|Un monde porte déjà le nom : $1|
|$menu_no|Non|
|$menu_ok|Ok|
...
|$menu_removebackup|Supprimer la copie de sauvegarde ?|
...
|$menu_restorebackup|Restaurer la copie de sauvegarde|
|$menu_seed|Seed|
...
|$menu_tryagainorrestart|Veuillez réessayer ou redémarrer le jeu si le problème persiste.|
...
|$msg_worldsavedcloudstoragefull|Espace de stockage cloud saturé ! Le monde a été déplacé dans un espace de stockage local avant d'être sauvegardé.|
...
|$settings_autobackup|Historique des copies de sauvegarde automatiques|
