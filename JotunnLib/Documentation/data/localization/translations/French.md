...
|$error_platformexcluded|Le propriétaire du serveur n'admet que les utilisateurs de la même plateforme à jouer sur son serveur.|
...
|$item_helmet_fishinghat_description|Ce couvre-chef à la mode ne peut être obtenu que par les aventuriers les plus chevronnés.|
...
|$menu_loginfailedtext|Échec de la connexion. Vérifiez votre connexion à Internet.|
|$menu_loginheader|Connexion au service backend...|
...
|$xbox_error_crossplayprivilege|Les paramètres de votre plateforme vous empêchent de jouer sur des serveurs autorisant le multiplateformes.|
