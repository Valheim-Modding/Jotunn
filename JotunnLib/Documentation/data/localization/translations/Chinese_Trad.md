...
|$menu_upgrade_tab|升級|
|$menu_vulkancrashwarning_header|在使用Vulkan時，Valheim可能會在您的系統上當機|
|$menu_vulkancrashwarning_text|您目前正在使用Vulkan。我們正在調查在某些系統上使用Vulkan時發生的已知當機問題，您的系統已被檢測為可能受到影響。如果您遇到穩定性問題，請改用預設的渲染API（DirectX 11）。對造成的不便深感抱歉！|
