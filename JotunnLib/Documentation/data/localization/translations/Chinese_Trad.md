...
|$menu_vulkancrashwarning_text|您目前正在使用 Vulkan。我們正在調查在某些系統上使用 Vulkan 時發生的已知當機問題，您的系統已被偵測出可能會受到影響。如果您遇到穩定性問題，請改用預設的渲染API（DirectX 11）。為您帶來不便，深感抱歉！|
...
|$online_kickedfromsession_header|從連線遭到踢出|
...
|$piece_archerytarget_lastscores|命中數|
|$piece_archerytarget_reset|取下箭矢並重設|
|$piece_archerytarget_total|總分|
...
|$text_hidden_notification_ugc_settings|文字已隱藏，請確認使用者產生內容 (UGC) 設定|
