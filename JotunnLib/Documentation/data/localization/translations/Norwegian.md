...
|$deadspeak_fader|Jeg fulgte en falsk skjebne, og den førte meg til undergang. Tilgi meg, kjære...|
...
|$dream_bonemass01|Du drømmer om hundre spøkelser som trenger seg sammen rundt sengen din, på jakt etter liv og varme. Noe dundrer dypt under jorden og de forsvinner like raskt som de kom.|
...
|$enemy_morgen|Morken|
|$enemy_neck|Nøkk|
|$enemy_seeker|Speider|
|$enemy_seekerbrute|Speidersoldat|
...
|$guardianstone_fader_desc|En far, nobel og stolt<br/>Flyr gjennom en himmel av ild<br/>Vi ønsket at sinnet hans holdt<br/>Men man får ikke alt man vil|
...
|$item_axe_berzerkr_lightning_description|Et blodbad uten like sprer seg omkring bæreren av disse øksene, slik at selv Thor ville vært stolt.|
...
|$item_bonemawmeat|Beinhogg|
|$item_bonemawmeat_cooked|Beinhoggkjøtt|
...
|$item_bonemawtooth|Beinhogg Tann|
...
|$item_catapult_ammo_description|Best utnyttet i en katapult. Bruk med omhu.|
|$item_catapult_training_ammo|Gråstein Ammunisjon|
|$item_catapult_training_ammo_description|Best utnyttet i en katapult. Pass på det ikke står noe skjørt i veien.|
...
|$item_feastblackforest|Svartskogens Buffettallerken|
|$item_feastblackforest_description|Du kommer ikke til å klare å motstå denne utsøkte buffeten fra Svartskogen! Indrefilet av hjort servert med krydrede tistler og gulerøtter, og som prikken over i'en får man deilig syltetøy på siden. Man bare må ha en bit til!|
...
|$item_lavabomb_description|Men nok varme vil den stivne når den eksploderer.|
...
|$item_seekerqueen_drop_description|Dronningas herredømme var hardt og urettelig, men dette skallet er kanskje enda hardere.|
...
|$item_spiceoceans_description|Den skarpe lukten av syre, blandet med noe som urtekjenneren helst ikke vil avsløre, passer utmerket til fisk. Enhver fisker har godt av å ha med seg litt av denne blandingen, i tilfelle godt hall!|
...
|$item_trophy_abomination|Uhyretrofé|
...
|$lore_ashlands_random08|Den rene flammen til en mektig drage bærer kraften til å gi liv, og kvikne til den døde jorden. Det var en gang da de velsignet både land og hav med den hellige flammen, og skapte nytt litt hvor enn de dro.<br/><br/>Men for dem som brenner seg på dragens flammer, er velsignelsen en forbannelse. De både dør og gjenoppstår, og en fanget mellom liv og død til evig tid. Slik er det for de fortapte sjelene som vandrer i dette landet lagt øde, med flammer til kropp og en evig lidelse. De kan ikke ødelegges, bare ynkes.|
...
|$lore_blackforest_random13|Jeg har blitt gjenfødt mange ganger i denne verden. Jeg har dødd gang på gang, men våkner bestandig opp i mitt eget hus. Likevel har jeg undret på hvor mange ganger jeg kan komme tilbake hit. Frida ble tatt av en orm og hennes seng er står fortsatt tom. Bjarni ble bitt i to av et troll og ingen av halvdelene har vært sett siden...<br/><br/>Vi ser ruinene etter de som har vært her før oss, men hvor er hendene som bygde dem?<br/><br/>Når en kriger mister viljen til å være her, kanskje de ikke kan komme tilbake...|
...
|$lore_meadows_random01|Der gresset vokser underfots<br/><br/>Og himmelen er blå over hodet<br/><br/>Vil det alltid være en varme og et hjem|
...
|$lore_mountains_random09|På dette sted, kjempet Otho og Bjørn en mektig duell for å avgjøre hvem som hadde det fineste skjegget. Nå må jeg, Bjørn, skjære ut i denne steinen at skjegget til Otho er så lyst og vakkert som en maisåker om sommeren. Måtte allmektige Thor rive av mitt eget skjegg om jeg lyver.|
|$lore_mountains_random10|I gamle Midgard presset menneskenes hær dragene tilbake til fjellene, slik som Vanene kastet deres mor ned til Valheim. Men her har de funnet tilbake sin styrke og vokst i antall. Deres mektige vingeslag kan høres over fjelltoppene.<br/><br/>De er blodtørstige og edle vesener, virkelig verdige motstandere i kamp. Hvis de møter ditt sverd med hån, møt deres hån med piler.|
...
|$lore_swamp_random08|I mang en tidsalder, var Odins øye vent bort fra Valheim. Men mens gudene ignorerte det, smøg eller forvillet andre vesener seg inn i denne glemte verden. Troll, gnomer og mennesker fant hemmelige veier som ledet dem hit. Kongeriker blomstret og falt, og er begravd dypt under jorden.<br/><br/>Vandrende blant de døde, går du på en grav med hvert et steg.|
...
|$npc_dvergr_ashlands_random_aggravated1|Det skulle du ikke gjort!|
...
|$npc_dvergr_ashlands_random_greet2|En levende person? Forandring fryder.|
...
|$npc_dvergr_ashlands_random_private_area_alarm3|Hold fingra av fatet.|
...
|$npc_dvergr_ashlands_random_talk_in_faction_base1|Jeg skulle ikke ha veddet på de terningene...|
|$npc_dvergr_ashlands_random_talk_in_faction_base10|Jeg har vurdert å få meg et kjæledyr. Hadde ikke det vært fint?|
|$npc_dvergr_ashlands_random_talk_in_faction_base11|Du har godt av å svette litt, sa alltid moren min!|
...
|$npc_dvergr_ashlands_random_talk_in_faction_base14|Når vi kommer oss hjem igjen skal få meg en ny hobby.|
|$npc_dvergr_ashlands_random_talk_in_faction_base15|Jeg tror skoen min trenger litt lapping.|
|$npc_dvergr_ashlands_random_talk_in_faction_base16|Ah, følelsen av kjølig tåke på kinnene... Hvorfor dro jeg derfra?...|
|$npc_dvergr_ashlands_random_talk_in_faction_base17|I lurer på hva slags oppdagelser som venter på oss. De Hvitskjeggene vet ikke hva de går glipp av!|
...
|$npc_dvergr_ashlands_random_talk_in_faction_base20|Jeg syns ikke noe særlig om den røyksoppen jeg. Foretrekker egentlig asksvinkjøtt!|
...
|$npc_dvergr_ashlands_random_talk_in_faction_base5|Jeg lurer på hva vi finner der ut. Håper det er verdt det.|
...
|$npc_dvergr_ashlands_random_talk_in_faction_base9|De tilba Smaragdflammen her i landet. Lurer veldig på hva slags bånd det var...|
|$npc_dvergr_ashlands_random_talk1|Jeg kommer til å svette av meg skjegget.|
...
|$npc_dvergr_ashlands_random_talk12|Ikke glem å tørke bort den svetten! Ellers kan det hende en morken lukter deg og velger deg til middag.|
|$npc_dvergr_ashlands_random_talk13|Blodstein, blodstein, blodstein, blodstein...|
|$npc_dvergr_ashlands_random_talk14|Vær forsiktig hvis du ser en stor haug med bein. Det betyr vanligvis at en sånn morken er i nærheten.|
...
|$npc_dvergr_ashlands_random_talk18|Ha! En Hvitskjegg ville aldri våget å komme hit.|
...
|$npc_dvergr_ashlands_random_talk20|Jeg støtte på en flokk med asksvin blandt noen ruiner i går! Jeg tror de lette etter mat.|
|$npc_dvergr_ashlands_random_talk3|Forsiktig, til og med vannet her er kokende varmt.|
|$npc_dvergr_ashlands_random_talk4|Fettern min er stasjonert i Tåkemarka. Heldige Hvitskjegg...|
|$npc_dvergr_ashlands_random_talk5|Lurer på om det fins noe skygge her. Ikke at det ville hjulpet...|
|$npc_dvergr_ashlands_random_talk6|Hm. Lukter råtne egg.|
|$npc_dvergr_ashlands_random_talk7|Følg med hvor du trår. Broren min mistet en tå til lavaen en stund tilbake.|
|$npc_dvergr_ashlands_random_talk8|Søstra mi prøvde å temme et asksvin. Den bet av hånda hånnes, og de spiser ikke engang kjøtt!|
...
|$piece_ashwood_decowall_divider|Asketre romdeler|
|$piece_ashwood_decowall_tree|Asketrevindu dekorativ|
|$piece_ashwood_door|Asketredør|
|$piece_ashwood_floor_1x1|Asketregulv 1x1|
|$piece_ashwood_floor_2x2|Asketregulv 2x2|
|$piece_ashwood_floor_deco|Asketregulv dekorativ|
...
|$piece_ashwoodwallroof_26_upsidedown|Asketrevegg 26° (invertert)|
|$piece_ashwoodwallroof_45|Asketrevegg 45°|
|$piece_ashwoodwallroof_45_upsidedown|Asketrevegg 45° (invertert)|
...
|$piece_blackforge_ext4|Edelstenskjærer|
...
|$piece_blackwoodstack|Asketrestabel|
|$piece_BlackwoodStakewall|Asketre stakevegg|
...
|$piece_catapult_wontfit|Passer ikke i katapulten|
...
|$piece_grausten_archmedium|Gråsteinbue Medium|
|$piece_grausten_archsmall|Gråsteinbue Liten|
|$piece_grausten_beammedium|Gråsteinbjelke Medium|
...
|$piece_grausten_pillarmedium|Gråsteinsøyle Medium|
|$piece_grausten_pillarsmall|Gråsteinsøyle Liten|
|$piece_grausten_pillartapered|Gråsteinsøyle Konisk|
|$piece_grausten_pillartaperedinverted|Gråsteinsøyle Konisk (Invertert)|
...
|$piece_grausten_wallarchinv|Gråsteinvegg Buet (Invertert)|
...
|$piece_hanging_cloth_blue1|Blå Jutegardiner|
...
|$piece_juteblue_carpet|Blå Juteteppe|
...
|$piece_portal_stone_description|Denne kraftige energikilden lar deg ta med deg selv de mest verdifulle gjenstander.|
...
|$piece_shieldgenerator_add|Legg til bein|
...
|$se_ashlandsmediumarmorseteffect_name|Asks Heltemot|
...
|$se_fenringseteffect_tooltip|Fenrisrustningen gjør deg lett på labben så du kan gå urørt gjennom ild, og knyttnevene dine fylles med beistets kraft.|
|$se_fire_name|Brann|
...
|$se_mageseteffect_tooltip|Du er ett med eiteret (Øker regenerering + elementmagiferdigheter)|
...
|$se_potion_bzerker_tooltip|Slåss med raseriet til et vilt og illsint beist, i en liten stund.|
...
|$se_potion_hasty_tooltip|Du fylles med magi som lar deg løpe raskere enn noensinne.|
...
|$se_potion_lightfoot_tooltip|Du føler deg lettere, som om du kunne ha hoppet helt opp til selveste yggdrasils grener.|
...
|$se_potion_strength_tooltip|Du blir fylt med en utrolig styrke, men bare en liten stund...|
|$se_potion_swimmer_tooltip|Ha med deg havgudens makt når du våger bølgene.|
...
|$se_queen_tooltip|Raskere hakking og økt eitergenerering.|
...
|$tutorial_artisan_extension_text|Nå vil du kunne lage keramikkplater, som isolerer godt mot varme.<br/>Du kommer til å trenge dem på ferden sørover!|
|$tutorial_artisan_extension_topic|Et nytt verktøy|
|$tutorial_ashlandocean_label|Hugin: Kokende vann|
|$tutorial_ashlandocean_text|Ser ut som du har seilt til det kokende hav i sør. Som du sikkert la merke til er det en farlig affære.<br/>For å krysse dette havet, må du nok bygge deg noe kraftigere hvis du vil unngå å sove blant fiskene.|
|$tutorial_ashlandocean_topic|Ahoy!|
|$tutorial_ashlands_label|Hugin: Askeland|
|$tutorial_ashlands_text|Du har oppdaget Askelandet, det aller varmeste her i den tiende verden. Her koker vannet uten en kjele og alt som kan, brenner ved den minste gnist. Vær forsiktig!|
...
|$tutorial_batteringram_text|Fiendens festninger er bygd med skikkelig saker. Du kommer til å trenge maskiner som denne til å bryte gjennom murene.|
|$tutorial_batteringram_topic|Et kraftig beleiringsmaskin|
|$tutorial_bed_label|Hugin: Å slå seg ned|
|$tutorial_bed_text|Sov bort natten i sengen din og start morgendagen med ny energi.<br/><br/>En annen forbedring til hjemmet ditt vil være noen kister så du kan oppbevare saker og ting. <color=yellow>Det er en god idé å alltid ha noe reserveutstyr</color>, dersom noe uheldig skulle skje med deg mens du er ute å utforsker...|
...
|$tutorial_eitr|Ser ut som du har tatt en slurk fra en av Yggdrasils grener, og jeg regner med du likte det.<br/>De pene lysene som snurrer rundt deg er kanskje ikke lengre bare i hodet ditt.<br/>Bare ikke gjør dette til en vane. Det kan være noen langsiktige effekter som er alt annet enn magisk.|
|$tutorial_eitr_label|Hugin: Eiter|
|$tutorial_eitr_text|Tåkene gjennomsyrer alt som lever og spirer i dette landet, og nå er den en del av deg også.<br/><br/>Med eiter kan du bruke mange slags mektige trylleformler. Prøv å finn flere eitertilførte ingredienser for å forbedre dine evner.|
...
|$tutorial_food2_text|Du har funnet en matbit, spis den for å ikke sulte. Noen matsorter er bedre for helse og vil indirekte bestemme hvor mye skade du kan blokkere før du blir lamslått, og andre vil øke utholdenheten din. Det finnes også noen som er jevnt over nyttig!<br/><br/>Vær varsom på at du om ikke lenge, vil bli sulten igjen, så prøv å alltid ha med deg et par forskjellige måltider.|
...
|$tutorial_haldor|Det ryktes at noen handelsreisende har funnet veien til den tiende verden. Hvis du trenger spesielle varer, bør du kanskje oppsøke dem.<br/><br/>En av de burde befinne seg i en skog sånn som denne. Beklager så meget at jeg ikke kan være mer til hjelp... du får holde øynene åpne.|
|$tutorial_haldor_label|Hugin: Handelsmann Haldor|
|$tutorial_haldor_topic|Vær hilset, vandrer…|
|$tutorial_hammer_label|Hugin: Hammer|
|$tutorial_hammer_text|Med dette verktøyet kommer du til bygge mektige haller og tårnhøye forsvarsmurer.<br/><br/>Begynn med å lage en <color=yellow>arbeidsbenk</color>, den vil gi deg mulighet til å bygge flere ting.|
|$tutorial_hammer_topic|Du har laget en Hammer|
|$tutorial_hildir|Jeg har hørt at det er handelskvinne som har blitt sett i dette område likt dette. Hun er en underlig skrue, men har veldig unike gjenstander til salgs.<br/><br/>Derimot, vil ryktene ha det til at hun har blitt ranet. Hun trenger kanskje en hjelpende hånd, og du virker å være nok så kapabel til nå.|
|$tutorial_hildir_label|Hugin: Handelskvinne Hildir|
|$tutorial_hildir_topic|Nei men, hallo der.|
|$tutorial_hildirdungeon|Jeg har en anelse om at dette stedet kan være mer utfordrende enn det kanskje ser ut til.|
...
|$tutorial_inventory_text|De fleste gjenstander må lages med håndverk. På grunn av din nylige avskjed fra Midgard, er du nødt til å lære deg og huske ting som du en gang var godt kjent med. Bare plukk opp tingene du ser, og så faller det nok på plass igjen. Det er jeg sikker på.<br/><br/>Min mindreverdige bror, Munin, forteller meg at du kan lage en steinøks av <color=yellow>treverk og stein</color>.|
...
|$tutorial_ore_text|Råmalm må raffineres i en <color=yellow>smelteovn</color> før det kan brukes i en <color=yellow>smie</color>.<br/><br/>For å bygge en smelteovn vil du trenge <color=yellow>surtlingkjerner</color>. Du kan finne dem i mørke steder under jorden.|
...
|$tutorial_randomevent_text|Monstre kommer til å beleire bostedet ditt fra tid til annen. Din egen styrke vil ikke alltid sikre deg seier i en slik situasjon. Bygg et sterkt forsvar slik at du kan ri stormen av!|
...
|$tutorial_shieldgenerator_text|Kraa! Denne burde holde vekk alt himmelen kaster på deg.|
|$tutorial_shieldgenerator_topic|En måte å beskytte seg på|
|$tutorial_smelter_label|Hugin: Smelteovn|
|$tutorial_smelter_text|Legg råmalm i denne ovnen og den vil smelte vekk alt unødvendig materiale og etterlate deg med en barre av raffinert metall du kan bruke i en smie.<br/><br/>Du vil trenge <color=yellow>kull</color> som brensel i smelteverket, dette kan du skaffe ved å bygge en <color=yellow>kullovn</color> og laste inn treverk.|
...
|$tutorial_stemple2_label|Hugin: Vegvisirer|
...
|$tutorial_wishbone_text|Det viser seg at et av de mange beinene dette levende knokkelhuset hadde inni seg var et ønskebein.<br/><br/>Dette beinet inneholder kraftig magi som viser deg veien til ting gjemt under jorden. Det kan finne <color=yellow>sølvårer</color> i fjellene og andre skjulte skatter...|
