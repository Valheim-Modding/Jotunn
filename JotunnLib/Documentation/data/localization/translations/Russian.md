...
|$button_x|X|
|$button_y|Y|
|$charredfortress|Обгорелая крепость|
...
|$enemy_asksvin|Пеплосвин|
|$enemy_asksvin_hatchling|Детеныш пеплосвина|
...
|$enemy_charred_melee_Dyrnwyn|Владыка Рето|
...
|$enemy_charredtwitcherspawner|Памятник мучений|
...
|$hud_building2|Тяжелые постройки|
...
|$item_arrow_charred|Обгорелая стрела|
...
|$item_askbladder|Мочевой пузырь пеплосвина|
|$item_askbladder_description|Сильный кислый запах. Никуда от него не деться.|
|$item_askhide|Шкура пеплосвина|
|$item_askhide_description|Добротная толстая кожа. Теплая на ощупь.|
|$item_asksvin_egg|Яйцо пеплосвина|
...
|$item_asksvin_meat|Хвост пеплосвина|
|$item_asksvin_meat_cooked|Жареный хвост пеплосвина|
...
|$item_blackwood|Пепельное дерево|
|$item_blackwood_description|Закаленное огнем и пеплом дерево.|
...
|$item_bolt_charred|Обгорелый болт|
...
|$item_bow_ashlands_description|Воссозданный из пепла лук содержит в себе непреклонную силу.|
...
|$item_cape_asksvin|Плащ из шкуры пеплосвина|
...
|$item_catapult_ammo_description|Для катапульты. Обращайтесь осторожно.|
|$item_catapult_training_ammo|Снаряд из граустена|
|$item_catapult_training_ammo_description|Для катапульты. На пути полёта не должно быть ничего хрупкого.|
...
|$item_charredskull|Обгорелый череп|
...
|$item_chest_flametal_description|Огнеметалл и обгорелые кости соединяются в прочнейший защитный покров, равный которому не сыскать во всем Мидгарде.|
...
|$item_Dyrnwyn_blade_description|Часть старого клинка. Если собрать все части воедино, клинок можно соединить.|
...
|$item_fierysvinstew|Острая тушеная свинина|
|$item_fierysvinstew_description|Без дымящейся тушеной свинины не обходится рацион ни одного искателя приключений.|
...
|$item_mead_eitr_lingering|Долгоиграющая медовуха из эйтра|
...
|$item_mead_hp_lingering|Долгоиграющий лечащий мед|
...
|$item_meadbaseeitr_lingering|Основа медовухи: долгоиграющий эйтр|
|$item_meadbasefrostresist|Основа медовухи: сопротивление морозу|
|$item_meadbasehealth|Основа медовухи: малое лечение|
|$item_meadbasehealth_lingering|Основа медовухи: долгоиграющее лечение|
...
|$item_pot_shard_description|Кусочек чего-то хрупкого.|
...
|$item_saddleasksvin|Седло для пеплосвина|
|$item_saddleasksvin_description|Спины у пеплосвинов узловатые. Чтобы ездить на них верхом, обязательно нужно седло.|
...
|$item_sword_slayer_blood_description|Если у врага есть кровь, его можно убить.|
|$item_sword_slayer_description|Могучий клинок просит вражеской крови.|
...
|$item_trophy_asksvin|Трофей: пеплосвин|
|$item_trophy_asksvin_description|Не смотри, что оно дружелюбно улыбается: запросто руку откусит.|
...
|$item_trophy_fader_description|Оскверненного зеленого дракона уже не спасти.<br/><br/>Принеси его в жертву на камнях.|
...
|$item_vineberryseeds_description|Они как будто вот-вот рассыплются в руках.|
...
|$lore_ashlands_random11|Война — пламя,<br/>Люди — розжиг.<br/><br/>Разжигая сердца,<br/>Тела обращаются сухостоем.|
...
|$menu_female|Женский|
|$menu_filter|Фильтр|
|$menu_firehazards|Воспламеняемое|
...
|$menu_lowdisk_message_warn|У вас заканчивается место на диске. Ваша игра будет сохранена, но, пожалуйста, освободите место на диске.|
|$menu_male|Мужской|
...
|$menu_movetocloud|Переместить в Steam Cloud|
...
|$menu_no|Нет|
|$menu_nobossportals|Нет порталов с боссами|
...
|$npc_dvergr_ashlands_random_aggravated4|Я тебя пущу на корм пеплосвинам!|
...
|$npc_dvergr_ashlands_random_goodbye5|Тетто.|
...
|$npc_dvergr_ashlands_random_talk_in_faction_base20|Не люблю я эти грибы, что дымок выпускают. Как по мне, так они только на корм пеплосвинам годятся!|
...
|$npc_dvergr_ashlands_random_talk20|Я вчера нашел руины, где паслось целое стадо пеплосвинов! Они туда, должно быть, за едой пришли.|
|$npc_dvergr_ashlands_random_talk3|Осторожней, тут даже вода — кипяток.|
|$npc_dvergr_ashlands_random_talk4|Двоюродный брат мой стоит в туманных землях. Везучий Белобород...|
...
|$npc_dvergr_ashlands_random_talk8|Представь себе, сестра моя пыталась как-то пеплосвина приручить. Он ей руку откусил! А ведь они даже мясо не едят.|
...
|$npc_dvergrmage_random_talk_in_faction_base10|Здесь сыро, как подмышки у тролля, но, по крайней мере, не так жарко, как на юге.|
...
|$npc_munin_ashlands_general05|Хмм... Как же ты ещё не погиб, воин? Быть может, в этом горниле тебе открылось что-то, к чему лежит твоя душа? Любопытно...|
...
|$piece_ashwood_decowall_divider|Перегородка из пепельного дерева|
...
|$piece_ashwoodstair|Ступень из пепельного дерева|
|$piece_ashwoodwallroof_26|Стена из пепельного дерева (26°)|
|$piece_ashwoodwallroof_26_upsidedown|Стена обратная из пепельного дерева (26°)|
|$piece_ashwoodwallroof_45|Стена из пепельного дерева (45°)|
|$piece_ashwoodwallroof_45_upsidedown|Стена обратная из пепельного дерева (45°)|
|$piece_asksvinskeleton|Скелет пеплосвина|
...
|$piece_blackwoodbench01|Скамья из пепельного дерева|
|$piece_blackwoodstack|Стопка пепельной древесины|
|$piece_BlackwoodStakewall|Частокол из пепельного дерева|
...
|$piece_graustenpile|Куча граустена|
...
|$piece_plant_nowall|Нужна стена поблизости|
...
|$piece_repair|Ремонт|
|$piece_replant|Трава|
|$piece_rug_asksvin|Ковер из шкуры пеплосвина|
...
|$piece_sapling_vineash_description|Льнёт к опоре.|
...
|$piece_shieldgenerator_description|Создаёт щит, защищающий от погоды и летящих снарядов. Подпитывается любыми костями.|
...
|$se_attackstamina|Использование выносливости при атаке|
|$se_beltstrength_start|Вы чувствуете прилив сил|
|$se_beltstrength_tooltip|Увеличивает макс. переносимый вес.|
|$se_blockstamina|Использование выносливости при блокировании|
...
|$se_dodgestamina|Использование выносливости при уклонении|
...
|$se_sneakstamina|Использование выносливости при скрытном передвижении|
...
|$se_swimstamina|Использование выносливости при плавании|
...
|$se_windrun_name|Бег с ветром|
|$se_windrun_tooltip|Вы бежите быстрее, когда в спину дует попутный ветер. Пусть он несет вас к победе!|
...
|$settings_toggle_attack_towards_look_direction_tooltip|В положении ВЫКЛ атаки будут производиться в направлении, куда смотрит камера.|
...
|$tutorial_ashlandocean_text|Похоже, вы заплыли в кипящие воды на юге. Как вы, должно быть, поняли, это смертельно опасно.<br/>Если не хотите пойти на корм рыбам, нужно построить что-то достаточно прочное.<br/>|
