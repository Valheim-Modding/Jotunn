...
|$item_trophy_leech_lore|Несмотря на склизкость, кожа красиво украшена черно-красными узорами.|
...
|$online_kickedfromsession_header|Завершение сетевой сессии|
...
|$piece_archerytarget_lastscores|Кольцо|
...
|$text_hidden_notification_muted|ТЕКСТ СКРЫТ, АВТОР ЗАГЛУШЕН|
|$text_hidden_notification_ugc_settings|ТЕКСТ СКРЫТ, ПРОВЕРЬТЕ НАСТРОЙКИ UGC|
...
|$tutorial_death_text|Каждый раз, когда вы умираете, <color=yellow>Вы теряете небольшую часть ваших способностей и все Ваши предметы будут потеряны</color> на месте смерти.<br/><br/>Построив <color=yellow>кровать</color> и заняв ее на месте, которым будет Вашим домом, Вы будете возрождаться на ней после своей смерти.|
