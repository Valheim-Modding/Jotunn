...
|$error_platformexcluded|Владелец сервера не позволяет игрокам других платформ, кроме его собственной, играть на своем сервере.|
...
|$item_helmet_fishinghat_description|Эту броскую шляпу могут носить только самые опытные искатели приключений.|
...
|$menu_addserverfaileddnslookup|Не удалось выполнить поиск DNS!|
...
|$menu_loginfailedtext|Не удалось войти. Убедитесь, что вы подключены к Интернету.|
|$menu_loginheader|Вход в серверную службу...|
|$menu_loginretrycountdowntext|Повторная попытка через $1 с...|
|$menu_logintext|Вход в систему...|
...
|$se_fishinghat_description|Викинги хотят тебя, а рыбы - боятся.|
...
|$xbox_error_crossplayprivilege|Настройки вашей платформы не позволяют вам играть на серверах, допускающих режим кроссплатформенной игры.|
