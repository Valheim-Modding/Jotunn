...
|$dream_random09|Ты лежишь на поле боя, мечтательные глаза обращены вверх, к затянутому дымом небу. Призывы твоих воинов становятся слабее, и твои глаза закрываются во второй раз. Огромные когти скользят под тобой, и ты чувствуешь, как поднимаешься, отрываешься от своего тела, как младенец из колыбели…|
...
|$dream_random16|Вам снится могучий медведь, спящий глубоко под землей зимой мира. Он ворочается во сне, складывается складками плоти и меха. У него нет ни головы, ни конечностей. Огромная масса медвежьей плоти, милостиво тихая.|
...
|$error_worldfileload|Не удалось загрузить файл мира. Проверьте бэкапы!|
|$event_bats_end|Котёл остывает|
|$event_bats_start|Вы размешали котёл|
...
|$menu_addserverfailedincorrectformatting|Это не IP, URL или код приглашения!|
|$menu_addserverfailedresolvejoincode|Не удалось использовать код|
|$menu_back|Назад|
|$menu_backupcount|Бэкапов: $1|
|$menu_backuprestorefailedheader|Не удалось восстановить бэкап!|
|$menu_backuprestorepromptheader|Восстановить бэкап?|
|$menu_backuprestorepromptrecover|Удаленный файл «$1» будет восстановлен из «$2».|
|$menu_backuprestorepromptreplace|Текущая версия «$1» будет архивирована и заменена на «$2».|
|$menu_beard|Борода|
...
|$menu_cloudstoragefull|Облачное хранилище заполнено!|
|$menu_cloudstoragefullcharacterprompt|Сохранить этого персонажа на устройстве?|
|$menu_cloudstoragefullmovingsave|Чтобы предотвратить потерю данных, текущее сохранение будет перемещено на устройство.|
|$menu_cloudstoragefulloperationfailed|Произошла ошибка, поскольку облачное хранилище заполнено. Пожалуйста, переместите часть миров на свое устройство и повторите попытку.|
|$menu_cloudstoragefullworldprompt|Сохранить этот мир на устройстве?|
|$menu_cloudstorageused|Облачное хранилище: $1/$2|
...
|$menu_crossplayserver|Кроссплатформенная игра|
|$menu_deleted|Удалено|
|$menu_disallowedcharactername|Can't create a character with this name|
|$menu_done|Готово|
|$menu_duplicatefilepromptheader|Невозможно переместить сохранение|
|$menu_duplicatefileprompttext|В месте назначения уже есть сохранение под названием «$1».|
...
|$menu_filter|Фильтр|
|$menu_friends|Друзья|
|$menu_gamepreviewpopupheader|Valheim находится в режиме просмотра|
|$menu_gamepreviewpopuptext|Некоторые функции игры или платформы могут работать неправильно. Игра может самопроизвольно закрыться.|
|$menu_hair|Прическа|
|$menu_hairtone|Оттенок волос|
|$menu_ipportorinvitecode|[IP/URL]:[порт] или [6-значный код приглашения]|
|$menu_joincode|Код приглашения $1|
|$menu_joindifferentserver|Вы собираетесь перейти на другой сервер!|
...
|$menu_logoutprompt|Выйти из текущего сеанса?|
|$menu_male|Мужской|
...
|$menu_newworldalreadyexistsmessage|Мир под названием «$1» уже существует|
|$menu_no|Нет|
|$menu_ok|ОК|
...
|$menu_remove|Удалить|
|$menu_removebackup|Удалить бэкап?|
...
|$menu_restorebackup|Восстановить бэкап|
...
|$menu_tryagainorrestart|Попробуйте еще раз или перезапустите игру|
...
|$msg_worldsavedcloudstoragefull|Облачное хранилище заполнено! Мир перемещен на устройство и сохранен|
...
|$piece_jackoturnip|Фонарь из тыквы|
...
|$settings_audio|Звук|
|$settings_autobackup|История автобэкапов|
|$settings_autopickup|Переключить автоподбор|
|$settings_autorun|Автобег|
|$settings_backward|Назад|
|$settings_bigpicturetext|* Поле для введения текста и чат с использованием контроллера доступны только с использованием режима Steam Big Picture.|
|$settings_block|Блок|
