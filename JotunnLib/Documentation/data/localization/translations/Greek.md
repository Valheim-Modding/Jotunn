...
|$menu_enterseed|Εισαγωγή Σπόρου|
...
|$menu_new|Νέο|
|$menu_newcharacter|Νέος Χαρακτήρας|
...
|$msg_nocookitems|Δεν έχετε αντικείμενα μαγειρέματος|
...
|$msg_wrongbiome|Δεν μπορεί να τοποθετηθεί σε αυτό το περιβάλλον|
