...
|$chat_entertext|Εισαγωγή κειμένου...|
...
|$hud_remove|Αφαίρεση|
|$hud_removepin|Αφαίρεση καρφίτσας|
|$hud_rename|Rename|
|$hud_repair|Επισκευή|
...
|$item_trophy_blob_lore|Its origins remain mysterious.|
...
|$item_trophy_draugr_lore|What should have been left to rest in peace has been awoken, twisted and corrupted.|
...
|$item_trophy_greydwarf_lore|Woe be upon those who disturb their forests...|
...
|$item_trophy_greydwarfbrute_lore|Roots and stones, twisted by dark intents.|
...
|$item_trophy_greydwarfshaman_lore|Primal magic once coursed through it. Perhaps some still lingers...|
...
|$item_trophy_surtling_description|Wreathed in pale flame, it still smoulders like an ember.|
|$item_trophy_surtling_lore|A fiendish creature, born of fire.|
...
|$item_trophy_wolf_lore|This animal has the potential to be a viking's greatest friend – or their greatest enemy.|
...
|$item_trophy_wraith_lore|At last, this restless spirit has been set free.|
...
|$location_enter|Είσοδος|
|$location_exit|Έξοδος|
|$location_forestcave|Σπήλαιο Τρολ|
|$location_forestcrypt|Θάλαμοι ταφής|
...
|$location_sunkencrypt|Βυθισμένες κρύπτες|
...
|$menu_beard|Γενειάδα|
|$menu_blondness|Ξανθότητα|
|$menu_cancel|Ακύρωση|
|$menu_changelog|Changelog|
|$menu_characterexist|Ο χαρακτήρας με αυτό το όνομα υπάρχει ήδη.|
...
|$menu_community|Κοινότητα|
|$menu_communityserver|Κοινοτικό Server|
...
|$menu_entername|Εισάγετε Όνομα|
|$menu_enterpassword|Εισαγάγετε Κωδικό|
|$menu_enterseed|Enter Seed|
|$menu_events|Raid Rate|
|$menu_events_tooltip|Governs how often enemies may raid your base.|
|$menu_exit|Τερματισμός|
|$menu_exitconfirm|Τερματισμός παιχνιδιού?|
|$menu_expand|Expand|
...
|$menu_joingame|Σύνδεση Στο Παιχνίδι|
|$menu_joinip|Join IP|
...
|$menu_name|Όνομα|
|$menu_ndaaccept|Αποδοχή|
|$menu_ndadecline|Άρνηση|
|$menu_new|Νέο|
|$menu_newcharacter|New Character|
|$menu_newworld|Νέος Κόσμος|
...
|$menu_password|Κωδικός|
|$menu_passwordfieldempty|Empty|
|$menu_passwordinvalid|Μη έγκυρος κωδικός|
|$menu_passwordshort|Ο κωδικός είναι πολύ μικρός|
...
|$menu_remove|Διαγραφή|
|$menu_removebackup|Remove backup?|
|$menu_removecharacter|Διαγραφή Χαρακτήρα?|
|$menu_removefavoritecategory|Remove favorite category?|
|$menu_removeserver|Remove server?|
|$menu_removeworld|Κατάργηση Κόσμου?|
|$menu_resettutorial|Επαναφορά Εκμάθησης|
...
|$menu_seed|Σπόρος|
|$menu_selectcharacter|Επιλογή Χαρακτήρα|
|$menu_selectserver|Επιλογή Server|
|$menu_selectworld|Επιλογή Κόσμου|
...
|$menu_serverpassword|Κωδικός Server|
|$menu_settings|Ρυθμίσεις|
|$menu_sex|Φύλο|
|$menu_skintone|Τόνος Δέρματος|
|$menu_skipcutscene|Skip Intro|
|$menu_start|Έναρξη|
|$menu_startgame|Έναρξη Παιχνιδιού|
|$menu_startserver|Εκκίνηση Server|
...
|$menu_worldnametip|τουλάχιστον 5 χαρακτήρες|
|$menu_worlds|Worlds|
|$menu_yes|Ναι|
...
|$msg_bedenemiesnearby|Υπάρχουν εχθροί κοντά|
|$msg_bedneedroof|Κρεβάτι χρειάζεται στέγη|
|$msg_bednofire|Το κρεβάτι χρειάζεται φωτιά κοντά|
|$msg_bedtooexposed|Το κρεβάτι είναι πολύ εκτεθειμένο|
|$msg_bedwet|Είσαι βρεγμένος|
|$msg_biome_found|Ανακαλύφθηκε $1|
|$msg_blocked|Μπλοκάρισμα|
|$msg_blockedbyboss|Blocked by an evil force.|
|$msg_broke|$1 έσπασε|
|$msg_broke_OLD|έσπασε|
|$msg_cantaddmore|Δεν μπορείτε να προσθέσετε περισσότερα $1|
|$msg_cantconsume|Δεν μπορείτε να το καταναλώνετε αυτή τη στιγμή|
|$msg_cantdrop|Δεν μπορείτε να το ρίξετε|
|$msg_cantoffer|Η προσφορά σας δεν απαντήθηκε|
|$msg_cantopen|Δεν μπορείτε να το ανοίξετε|
|$msg_cantpickup|Δεν μπορείτε να το παραλάβετε|
|$msg_cantremovenow|Αυτό δεν μπορεί να αφαιρεθεί αυτή τη στιγμή|
|$msg_cantsleep|Δεν μπορείτε να κοιμηθείτε αυτή τη στιγμή|
|$msg_cantuseon|Δεν μπορείτε να χρησιμοποιήσετε $1 στο $2|
...
|$msg_dlcrequired|Απαιτείται DLC|
|$msg_doesnotneedrepair|δεν χρειάζεται επισκευές|
|$msg_donthaveany|Δεν έχετε κανένα|
|$msg_door_needkey|Χρειάζεστε κλειδί: $1|
|$msg_door_usingkey|Χρήση κλειδιού: $1|
|$msg_dropped|Έπεσε|
|$msg_extensionmissingstation|Πρέπει να τοποθετηθεί κοντά στον κατάλληλο σταθμό κατασκευής|
|$msg_fireadding|Προσθήκη $1 στη φωτιά|
|$msg_firenotburning|Δεν καίει|
|$msg_fireportalalready|Η πύλη έχει ήδη ενεργοποιηθεί|
|$msg_fishing_catched|Πιάστηκε|
|$msg_fishing_hooked|Γαντζώθηκε|
|$msg_fishing_linebroke|Πετονιά εσπασε|
|$msg_fishing_lost|Χάσαμε την ψαριά|
|$msg_fishing_wrongbait|It's not taking the bait|
|$msg_food_done|Θα μπορούσες να φάς άλλη μια μπουκιά|
|$msg_goodmorning|Καλημέρα|
|$msg_goodnight|Καλή νύχτα|
...
|$msg_incompleteoffering|Ελλιπής προσφορά|
|$msg_incompleteoffering_fader|The bells are not in place|
|$msg_incompleteoffering_memorial|The Ancestors still lie dormant|
|$msg_inuse|Κάποιος άλλος το χρησιμοποιεί|
|$msg_invalidplacement|Μη έγκυρη τοποθέτηση|
|$msg_isfull|Είστε ήδη γεμάτοι|
|$msg_itsfull|Είναι γεμάτο|
|$msg_level|επίπεδο|
...
|$msg_missingitem|Δεν έχετε το σωστό αντικείμενο|
|$msg_missingrequirement|Λείπει απαίτηση|
|$msg_missingstation|Λείπει ο απαιτούμενος σταθμός κατασκευής|
|$msg_needcultivated|Χρειάζεται καλλιεργούμενο έδαφος|
|$msg_needdirt|This area can't be cultivated|
|$msg_needfire|Θα πρέπει να έχετε αναμμένη φωτιά κάτω από το σταθμό μαγειρικής|
|$msg_needspace|Χρειάζεται περισσότερο χώρο|
|$msg_newday|Ημέρα $1|
|$msg_newdish|New dish|
|$msg_newitem|Νέο αντικείμενο|
|$msg_newmaterial|Νέο υλικό|
|$msg_newpiece|Νέο δομικό κομμάτι|
|$msg_newrecipe|Νέα συνταγή κατασκευής|
|$msg_newstation|Νέος σταθμός κατασκευής|
|$msg_newstation_level|Νέο επίπεδο σταθμού|
|$msg_newtext|$1 προστέθηκε στην επιτομή|
|$msg_newtrophy|Τρόπαιο έχει συλλέχθει|
|$msg_nobuildzone|Μια μυστικιστική δύναμη σε αυτή την περιοχή σας σταματά|
|$msg_nocookitems|You don't have any cookable items|
|$msg_nocookroom|Δεν υπάρχει χώρος|
|$msg_nomore|Δεν μπορείτε να φάτε περισσότερα $1|
|$msg_noprocessableitems|Δεν έχετε αντικείμενα για επεξεργασία|
|$msg_noroom|Δεν υπάρχει χώρος στο απόθεμα|
|$msg_nosnow|No snow to shovel|
|$msg_noteleport|Ένα αντικείμενο σας εμποδίζει από την τηλεμεταφορά|
|$msg_noteleportarea|Μπορεί να χτιστεί μόνο μέσα σε πέτρινο κύκλο|
|$msg_notindungeon|Δεν μπορεί να τοποθετηθεί σε μπουντρούμι|
|$msg_noturretammo|No ballista missiles|
|$msg_offerdone|Κάνετε τη θυσία|
|$msg_offerdone_fader|You ring the bells|
|$msg_offerdone_memorial|The Ancestors heed your call|
|$msg_offerwrong|Τίποτα δεν συμβαίνει|
|$msg_outof|Έχετε έλλειψη από|
|$msg_pin_added|Προστέθηκε τοποθεσία χάρτη|
|$msg_pin_exist|Η τοποθεσία του χάρτη έχει ήδη προστεθεί|
|$msg_portal_blocked|Μπλοκάρισμα|
|$msg_privatezone|Ο φρουρός σας σταματά|
|$msg_pvpoff|Η ζημιά PVP απενεργοποιήθηκε|
|$msg_pvpon|Ενεργοποίηση ζημιάς PVP|
|$msg_removed|Αφαιρέθηκε|
|$msg_repaired|Επισκευάστηκε $1|
|$msg_ship_ladder|Ladder|
|$msg_skills_lowered|Οι ικανότητες μειώθηκαν|
|$msg_skillup|Βελτίωση ικανότητας|
|$msg_snapping|Snapping:|
|$msg_snapping_auto|Auto|
|$msg_snapping_manual|Manual|
|$msg_snowtoodeep|Snow is too deep|
|$msg_softdeath|Οι θεοί είναι ευσεβείς|
|$msg_sold|Πωλήθηκε $1 για $2|
|$msg_spawnpointset|Ορισμός σημείου αναγέννησης|
|$msg_stackall|Items stacked:|
|$msg_stackall_hover|(Hold to stack)|
|$msg_stackall_none|No items to stack|
|$msg_stationneedroof|Σταθμός κατασκευής χρειάζεται στέγη|
|$msg_stationtooexposed|Ο σταθμός είναι πολύ εκτεθειμένος|
|$msg_throwinfire|Ρίχνεις μερικά $1μέσα στη φωτιά|
|$msg_toofew|Πολύ λίγα|
|$msg_toohard|Πολύ σκληρό|
...
|$msg_useonwhat|Χρήση $1 σε τι?|
|$msg_walk|Περπάτημα|
|$msg_wontwork|Αυτό δεν θα λειτουργήσει|
|$msg_worldsaveblockedonserver|The server does not have enough space left on disk to save your game.|
|$msg_worldsaved|Ο κόσμος αποθηκεύτηκε|
...
|$msg_wrongitem|Λάθος αντικείμενο|
|$msg_wrongtool|Λάθος εργαλείο|
|$msg_youdied|ΠΕΘΑΝΕΣ!|
...
|$piece_artisanstation|Χειροτεχνικό τραπέζι|
...
|$piece_bed|Κρεβάτι|
|$piece_bed_claim|Διεκδίκηση|
|$piece_bed_currentspawn|Τρέχον σημείο γένεσης|
|$piece_bed_description|When night falls, you'll want somewhere to sleep.|
|$piece_bed_setspawn|Ορισμός σημείου γένεσης|
|$piece_bed_sleep|Ύπνος|
|$piece_bed_unclaimed|Αδιεκδίκητο κρεβάτι|
|$piece_bed02|Dragon Bed|
|$piece_bed02_description|Draped in furs, this bed is sure to give you a good night's sleep.|
|$piece_beehive|Κυψέλη|
|$piece_beehive_area|Στις μέλισσες δεν αρέσει αυτό το οικοσύστημα|
|$piece_beehive_check|Ελέγξτε τις μελισσες|
|$piece_beehive_description|When they're happy, the bees will produce tasty honey.|
|$piece_beehive_extract|Εξόρυξη|
|$piece_beehive_freespace|Οι μέλισσες χρειάζονται περισσότερο ανοιχτό χώρο|
|$piece_beehive_happy|Οι μέλισσες είναι ευχαριστημένες|
|$piece_beehive_sleep|Οι μέλισσες κοιμούνται|
...
|$piece_charcoalkiln|Κάρβουνο κάμινος|
...
|$piece_chest|Ενισχυμένο σεντούκι|
...
|$piece_chestprivate|Προσωπικό σεντούκι|
...
|$piece_container_empty|ΆΔΕΙΟ|
|$piece_container_open|Ανοιχτό|
|$piece_cookingstation|Σταθμός μαγειρέματος|
...
|$piece_craftingstation|Σταθμός κατασκευής|
|$piece_crate|Crate|
...
|$piece_cstand_cook|Μαγειρεμα αντικείμενου|
|$piece_cultivate|Καλλιέργεια|
...
|$piece_door_close|Κλείσιμο|
|$piece_door_open|Άνοιγμα|
...
|$piece_fermenter|Ζύμωτης|
|$piece_fermenter_add|Προσθήκη αντικειμένου|
|$piece_fermenter_description|Mead needs to sit and ferment for a while, for all its intended properties to emerge.|
|$piece_fermenter_exposed|Πολύ εκτεθειμένο|
|$piece_fermenter_fermenting|Ζύμωση|
|$piece_fermenter_needroof|Requires a roof|
|$piece_fermenter_ready|Έτοιμο|
|$piece_fermenter_tap|Πάτημα|
|$piece_fire|Φωτιά|
|$piece_fire_fuel|Καύσιμα|
|$piece_firepit|Φωτιά|
...
|$piece_forge_ext6|Εργαλειοθήκη Σιδηρουργείο|
...
|$piece_groundtorch|Όρθια σιδερένια δάδα|
...
|$piece_groundtorchgreen|Όρθια σιδερένια δάδα πρασινης-φλόγας|
|$piece_groundtorchgreen_description|A sturdy iron torch, burning with a green flame.|
|$piece_groundtorchwood|Όρθια ξύλινη δάδα|
|$piece_groundtorchwood_description|A torch to stick in the ground, for when you need your hands free.|
|$piece_guardstone|Φρουρός|
|$piece_guardstone_activate|Ενεργοποίηση|
|$piece_guardstone_active|Ενεργό|
|$piece_guardstone_add|Σύνδεση|
|$piece_guardstone_additional|Επιτρέπεται|
|$piece_guardstone_deactivate|Απενεργοποίηση|
|$piece_guardstone_description|Εκπέμπει μια μαγική σφραγίδα στο κοντινό περιβάλλον που εμποδίζει άλλους παίκτες να κατασκευάσουν κτίρια ή να ανοίγουν πόρτες.|
|$piece_guardstone_inactive|Ανενεργό|
|$piece_guardstone_owner|Ιδιοκτήτης|
|$piece_guardstone_remove|Αποσύνδεση|
...
|$piece_itemstand|Βάση αντικειμένων|
|$piece_itemstand_attach|Επισύναψη αντικειμένου|
|$piece_itemstand_cantattach|Δεν μπορείτε να συνδέσετε αυτό το αντικείμενο|
|$piece_itemstand_h_description|Place items on horizontal surfaces with this item stand.|
|$piece_itemstand_missingitem|Λείπει το απαιτούμενο αντικείμενο|
|$piece_itemstand_take|Λήψη αντικειμένου|
...
|$piece_levelground|Επίπεδο εδάφους|
...
|$piece_noaccess|Δεν υπάρχει πρόσβαση|
...
|$piece_pavedroad|Πεζοδρόμος|
|$piece_pavedroad_description|A sure mark of civilisation.|
|$piece_plant_healthy|Υγιείς|
|$piece_plant_nospace|Χρειάζεται περισσότερο χώρο για να μεγαλώσει|
|$piece_plant_nosun|Χρειάζεται ανοιχτό ουρανό|
|$piece_plant_notcultivated|Χρειάζεται καλλιεργούμενο έδαφος|
|$piece_plant_nowall|Needs nearby wall|
|$piece_plant_toocold|Too cold|
|$piece_plant_toohot|Too hot|
|$piece_plant_wrongbiome|Δεν μπορεί να μεγαλώσει σε αυτό το περιβάλλον|
|$piece_portal|Πύλη|
|$piece_portal_censored_warning|Censored words found, potential crossplay issue.|
|$piece_portal_connected|ΣΥΝΔΕΣΗ|
|$piece_portal_description|Συνδέεται σε άλλη πύλη με το ιδιο ονομα ή χωρίς.|
...
|$piece_raise|Ανύψωση εδάφους|
|$piece_raise_description|Fill holes and create elevated platforms.|
|$piece_readmap|Read map|
|$piece_register_location|Καταχώρηση τοποθεσίας|
|$piece_repair|Επισκευή|
|$piece_replant|Γρασίδι|
...
|$piece_sapling_seedturnip|Σπόροι-γογγυλιού|
|$piece_sapling_seedturnip_description|Φυτέψτε γογγύλι για να πάρετε περισσότερους σπόρους.|
|$piece_sapling_turnip|Γογγύλι|
...
|$piece_smelter_add|Προσθήκη|
|$piece_smelter_additem|Προσθήκη αντικειμένου|
|$piece_smelter_description|Fuel and ore go in, beautiful metal ingots come out.|
|$piece_smelter_empty|Άδειο|
|$piece_smelter_ready|Επεξεργασμένο|
|$piece_smelter_reqroof|Απαιτεί στέγη|
...
|$piece_stonecutter|Κοπτικό για πέτρες|
...
|$piece_throne01|Θρόνος Κορακιού|
...
|$piece_upgrade|βελτίωση|
|$piece_upgradestation|Forge of Potential|
|$piece_use|Χρήση|
|$piece_useitem|Χρήση αντικειμένου|
|$piece_vegvisir|Βεγκβίσιρ|
...
|$piece_workbench|Πάγκος Εργασίας|
...
|$piece_workbench_ext1|Κύβος κοπής|
...
|$settings_altplace|Εναλλακτική Τοποθέτηση|
...
|$settings_autorun|Αυτόματο-Τρέξιμο|
...
|$settings_block|Μπλοκάρισμα|
|$settings_blocked_player_list|Blocked Players|
|$settings_bloom|Άνθιση|
|$settings_buildcat|Κατηγορία Κατασκευής|
|$settings_buildmenu|Μενού Κατασκευής|
|$settings_buildnext|Επόμενο Αντικείμενο Κατασκευής|
|$settings_buildprev|Προηγούμενο Αντικείμενο Κατασκευής|
|$settings_ca|Χρωματική Απόκλιση|
|$settings_camera_sensitivity|Camera sensitivity|
|$settings_camerashake|Κούνημα Κάμερας|
...
|$settings_continousmusic|Συνεχής Μουσική|
...
|$settings_controls|Χειρισμοί|
|$settings_crouch|Σκύψιμο|
...
|$settings_dodge|Ελιγμός|
|$settings_dof|Βάθος πεδίου|
...
|$settings_guicale_note|Ελάχιστη ανάλυση οθόνης 2560x1440|
|$settings_guiscale|Κλιμάκωση GUI|
|$settings_hide|Απόκρυψη/Εμφάνιση Όπλων|
|$settings_high|Υψηλά|
...
|$settings_invertmouse|Αντιστροφή Ποντικιού|
...
|$settings_left|Αριστερά|
|$settings_legacysave|Legacy save|
|$settings_lights|Φωτισμός Σωματιδίων|
|$settings_localsave|Local save|
|$settings_lod|Σχεδίαση απόστασης/επιπέδου λεπτομέρειας|
|$settings_lod2|Level of detail|
|$settings_look|Look|
|$settings_low|Χαμηλά|
|$settings_map|Χάρτης|
|$settings_mapzoom|Zoom in/out minimap|
|$settings_mastervol|Ένταση|
|$settings_medium|Μεσαία|
|$settings_menu|Menu|
|$settings_minimapzoomin|Zoom minimap|
|$settings_misc|Διάφορα|
|$settings_motionblur|Θόλωμα Κίνησης|
|$settings_mousesens|Ευαισθησία Ποντικιού|
|$settings_move|Move|
|$settings_musicvol|Ένταση Μουσικής|
...
|$settings_quickselect|Επιλογή Κατασκευής Δεξιού Κλικ|
...
|$settings_requirerestart|Απαιτεί επανεκκίνηση|
|$settings_res|Ανάλυση|
|$settings_resetcontrols|Επαναφορά Χειρισμών|
|$settings_resok|Μήπως λειτουργεί σωστά?|
|$settings_right|Δεξιά|
|$settings_rotate|Rotate|
|$settings_run|Τρέξιμο|
|$settings_secondaryattack|Δευτερεύουσα Επίθεση|
|$settings_sfxvol|Effect volume|
|$settings_shadowquality|Ποιότητα Σκιάς|
|$settings_shipcameratilt|Εμβυθιστική Καμερα Πλοίου|
...
|$settings_showkeyhints|Εμφάνιση Συμβουλών Πλήκτρων|
...
|$settings_sit|Κάθισμα|
|$settings_softpart|Μαλακά Σωματίδια|
...
|$settings_ssao|SSAO|
|$settings_sunshafts|Άξονας Ήλιου|
|$settings_swap_triggers|Swap triggers|
|$settings_tesselation|Επιδιόρθωση|
|$settings_test|Δοκιμή|
...
|$settings_vegetation|Ποιότητα Βλάστησης|
|$settings_veryhigh|Very High|
|$settings_vsync|Κατακόρυφος συγχρονισμός|
|$settings_walk|Μετακίνηση με τα Πόδια|
|$settings_zoomin|Μεγέθυνση|
|$settings_zoomout|Σμίκρυνση|
