...
|$error_platformexcluded|Właściciel serwera nie pozwala użytkownikom z innych platform niż jego własna na dołączenie do jego serwera.|
...
|$item_helmet_fishinghat_description|Ten zgrabny kapelusz może być złowiony tylko przez najbardziej zaprawionych podróżników.|
...
|$menu_addserverfaileddnslookup|Wyszukiwanie DNS zawiodło!|
...
|$menu_loginfailedtext|Nie udało się zalogować. Upewnij się, że masz dostęp do internetu.|
|$menu_loginheader|Logowanie do serwera...|
|$menu_loginretrycountdowntext|Ponowna próba za $1 ...|
...
|$piece_turret_target_set|Ustaw cel używając trofeum|
...
|$settings_reduceflashinglights|Ogranicz błyski świetlne|
...
|$xbox_error_crossplayprivilege|Ustawienia przywilejów twojej platformy zabraniają ci grać na serwerach, które pozwalają na grę multiplatformową.|
