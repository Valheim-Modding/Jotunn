...
|$menu_vulkancrashwarning_header|Valheim może się zawiesić na twoim systemie podczas korzystania z Vulkan|
|$menu_vulkancrashwarning_text|Obecnie używasz Vulkan. Badamy znany problem z awariami podczas korzystania z Vulkan na niektórych systemach, a Twój system został wykryty jako potencjalnie zagrożony. Jeśli napotkasz problemy ze stabilnością, użyj domyślnego interfejsu API renderowania (DirectX 11). Przepraszamy za niedogodności!|
