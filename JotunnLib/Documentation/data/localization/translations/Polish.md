...
|$item_jotunpuffs_description|Nabrzmiałe od magii, te złociste kule bulgoczą z ziemi w miejscu, gdzie spadł Jotun.|
...
|$item_trophy_gjall_description|Miejmy nadzieję, że odpłynie.|
|$item_trophy_gjall_lore|Miejmy nadzieję, że odpłynie.|
...
|$settings_altkeys|(Alternatywne klawisze)|
...
|$skill_fishing_description|Zużycie wytrzymałości i prędkość wciągania przy wędkowaniu.|
