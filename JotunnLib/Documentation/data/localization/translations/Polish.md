...
|$error_worldfileload|Błąd wczytywania pliku świata. Sprawdź kopie zapasowe!|
...
|$menu_acceptedinvite|Akceptujesz zaproszenie!|
|$menu_addserver|Dodaj serwer|
|$menu_addserverfailed|Nieudane dodanie serwera!|
|$menu_addserverfailedincorrectformatting|Dane nie są prawidłowym IP, URL lub kodem zaproszenia!|
|$menu_addserverfailedresolvejoincode|Nieudane wykorzystanie kodu zaproszenia|
|$menu_back|Powrót|
|$menu_backupcount|Kopie zapasowe $1|
|$menu_backuprestorefailedheader|Nieudane przywrócenie kopii zapasowej!|
...
|$menu_backuprestorepromptreplace|Bieżąca wersja $1 zostanie zapisana i zastąpiona przez $2.|
|$menu_beard|Broda|
...
|$menu_cloudstoragefull|Brak wolnej przestrzeni w chmurze!|
|$menu_cloudstoragefullcharacterprompt|Czy chcesz zamiast tego zapisać tę postać lokalnie?|
|$menu_cloudstoragefullmovingsave|Dane zapisu bieżącej sesji mogą zostać zapisane lokalnie, by zapobiec utracie danych.|
|$menu_cloudstoragefulloperationfailed|Operacja nie powiodła się z powodu braku wolnej przestrzeni w chmurze. Przenieś światy do zapisu lokalnego i spróbuj ponownie.|
|$menu_cloudstoragefullworldprompt|Czy chcesz zamiast tego zapisać ten świat lokalnie?|
|$menu_cloudstorageused|Zajęta przestrzeń w chmurze: $1/$2|
|$menu_collapse|Zwiń|
...
|$menu_crossplayserver|Gra międzyplatformowa|
|$menu_deleted|Usunięto|
|$menu_disallowedcharactername|Can't create a character with this name|
|$menu_done|Zakończ|
|$menu_duplicatefilepromptheader|Przeniesienie zapisu niemożliwe|
|$menu_duplicatefileprompttext|Zapis z nazwą $1 już istnieje w wybranym miejscu docelowym.|
|$menu_enteripinvite|Wpisz IP lub kod zaproszenia|
...
|$menu_gamepreviewpopupheader|Valheim jest w trybie próbnym|
|$menu_gamepreviewpopuptext|Niektóre funkcje platformy lub gry mogą nie działać poprawie. Gra może ulec awarii.|
|$menu_hair|Włosy|
...
|$menu_logoutprompt|Czy na pewno chcesz się wylogować z bieżącej sesji?|
|$menu_male|Mężczyzna|
...
|$menu_movefailedheader|Nieudane przeniesienie pliku!|
...
|$menu_newworldalreadyexistsmessage|Świat o nazwie $1 już istnieje|
|$menu_no|Nie|
|$menu_ok|OK|
|$menu_password|Hasło|
...
|$menu_tryagainorrestart|Spróbuj ponownie lub uruchom grę ponownie, jeśli problem nie zniknie|
...
|$msg_worldsavedcloudstoragefull|Brak przestrzeni w chmurze! Świat został przeniesiony i zapisany lokalnie|
...
|$settings_autobackup|Historia automatycznych kopii zapasowych|
