...
|$dvergr_buff|Puterea Piticilor|
|$dvergr_buff_description|Ești infuzat cu o puterea stranie de pitic ce îți mărește puterea.|
...
|$enemy_dvergr|Pitic tâlhar|
|$enemy_dvergr_mage|Pitic mag|
...
|$item_demister|Lumină de duh|
|$item_demister_description|Un duh ce te va ghida prin cele mai dense cețuri.|
...
|$item_dvergrkey_description|Un obiect folosit pentru a sparge un sigiliu piticesc.|
|$item_dvergrkeyfragment|Fragment de distrugătorul sigiliului|
|$item_dvergrkeyfragment_description|Un fragment din distrugătorul de sigiliu piticesc.|
|$item_dvergrneedle|Extractor piticesc|
|$item_dvergrneedle_description|Pare perfect pentru a străpunge ceva...|
|$item_dvergrtankard|Cană piticescă|
...
|$item_eitr_description|Acesta e materialul vieții, otrava care se consumă singură. Piticii o rafinează pentru a o folosi în construcțiile lor ezoterice.|
...
|$item_fishingbait_description|Momeală obișnuită piticească. Undița este vândută separat.|
...
|$item_fishingrod_description|O undiță piticească standard.|
...
|$item_juteblue_description|Fabricat din fibre naturale și păr de pitic.|
...
|$item_mechanicalspring_description|O mașinărie misterioasă construită de pitici și folosită pentru a pune capcane.|
...
|$item_trophy_dvergr|Trofeu de pitic|
...
|$lore_dvergr_label|Munin: Piticii|
|$lore_dvergr_text|Ai grijă, luptătorule. Ai ajuns la un avanpost al clanurilor singuratice de pitici, separate de mult de neamurile lor din Nidavellir. Rămași aici ei încă trudesc, așteptând o păsuire ce nu va veni niciodată. E o soartă tristă...|
|$lore_dvergrhalls_label|Munin: Case piticești|
|$lore_dvergrhalls_text|Acestea sunt casele piticilor, construite de demult într-o epocă de aur... Splendoarea lor întrece Sala de Aur însăși!<br/><br/>Din păcate, nimic nu ține pentru totdeauna. Sălile de dedesubt și comorile rămase acolo sunt păzite de noi locatari și mai siniștrii.|
...
|$npc_dvergrmage_random_aggravated1|O să îți arăt ce poate să facă magia!|
...
|$npc_dvergrmage_random_aggravated4|Pitici, la mine!|
...
|$npc_dvergrmage_random_goodbye2|Fii mereu pe atent la gjall.|
|$npc_dvergrmage_random_goodbye3|La revedere.|
...
|$npc_dvergrmage_random_private_area_alarm8|Ești pe muchie de cuțit.|
...
|$npc_dvergrmage_random_talk2|Mă întreb dacă putem duce marfa asta acasă curând.|
...
|$npc_dvergrrogue_random_aggravated7|Îți place să-ți pui bățul în roată, e? Te pot ajuta cu asta!|
|$npc_dvergrrogue_random_aggravated8|Deci vrei să ne batem?|
|$npc_dvergrrogue_random_aggravated9|Am să te fac ciulama!|
|$npc_dvergrrogue_random_goodbye1|Pe data viitoare.|
|$npc_dvergrrogue_random_goodbye2|Să ai grijă!|
|$npc_dvergrrogue_random_goodbye3|La revedere.|
|$npc_dvergrrogue_random_goodbye4|Să nu te pierzi.|
|$npc_dvergrrogue_random_goodbye5|Ține lumina duhului aproape, nu ai vrea să o pierzi.|
...
|$npc_dvergrrogue_random_private_area_alarm2|Ține-ți mâinile la tine!|
...
|$npc_dvergrrogue_random_talk_in_faction_base2|Dacă muncești și ții ordinea, vinerea vin banii.|
|$npc_dvergrrogue_random_talk_in_faction_base3|Fortul ăsta mic nu se poate compara cu cetățile noastre de acasă...|
|$npc_dvergrrogue_random_talk_in_faction_base4|Când e timpul cinei? Mi-e foame.|
|$npc_dvergrrogue_random_talk_in_faction_base5|Rămânem fără țuică? Cred că rămânem fără țuică...|
|$npc_dvergrrogue_random_talk_in_faction_base6|Niște reparații în locul ăsta n-ar strica.|
|$npc_dvergrrogue_random_talk_in_faction_base7|Nu înțeleg de ce nu au luat totul atunci când au părăsit minele. De ce au lăsat miezurile acolo?|
|$npc_dvergrrogue_random_talk_in_faction_base8|Iscoadele blestemate ne-au spart Miezurile Negre! În cazula ăsta, înapoi în adâncuri...|
...
|$npc_dvergrrogue_random_talk10|Dacă noi am putut ajunge aici, oare ce altceva ar mai putea veni...|
|$npc_dvergrrogue_random_talk2|E bine să fii mereu atent.|
|$npc_dvergrrogue_random_talk3|Cum e Midgardul? Am auzit doar povești despre el.|
...
|$npc_dvergrrogue_random_talk6|Noi piticii avem grijă de ai noștri.|
|$npc_dvergrrogue_random_talk7|Iscoade blestemate! Sper să se zbârcească și să moară toate.|
|$npc_dvergrrogue_random_talk8|Era să fiu supt complet de o căpușă odată... Dar piticii nu mor așa ușor.|
...
|$piece_crate|Cutie|
|$piece_crate_long|Cutie cu componente ale piticilor|
...
|$piece_dv_gate|Poartă veche piticească|
|$piece_dvergr_door|Ușă piticească|
|$piece_dvergr_lantern|Felinar de zid piticesc|
|$piece_dvergr_lantern_pole|Stâlp de felinar piticesc|
|$piece_dvergr_metal_wall|Zid piticesc de metal|
|$piece_dvergr_pole|Stâlp piticesc|
|$piece_dvergr_sharpstakes|Țepușe ascuțite piticești|
|$piece_dvergr_spiralstair|Scări în spirală piticești, stânga|
|$piece_dvergr_spiralstair_right|Scări în spirală piticești, dreapta|
|$piece_dvergr_stake_wall|Zid piticesc de țepușe|
|$piece_dvergr_woodwall|Zid piticesc|
|$piece_dvergrchest|Cufăr piticesc cu comori|
...
|$piece_groundtorchdemister|Torță de duh|
...
|$piece_wisplure|Fântâna duhurilor|
|$piece_wisplure_description|Atrage duhuri, ce vin la noapte... de obicei.|
|$piece_wisplure_full|Duhurile dansează|
|$piece_wisplure_light|Duhurile așteaptă întunericul|
|$piece_wisplure_nospace|Duhurile doresc mai mult spațiu|
|$piece_wisplure_ok|Duhurile se apropie|
...
|$se_demister_start|Ai dezlănțuit duhul|
...
|$tutorial_dvergr_label|Hugin: Piticii|
|$tutorial_dvergr_text|Cra-craa! Neghiobi încăpățânați! Piticii tolerează străinii și vagabonzii, dar se înfurie ușor dacă îi superi... Ce sigur vei face mai devreme sau mai târziu.|
|$tutorial_dvergrhalls_label|Hugin: Case piticești|
...
|$tutorial_wispattractor_label|Hugin: Fântâna duhurilor|
