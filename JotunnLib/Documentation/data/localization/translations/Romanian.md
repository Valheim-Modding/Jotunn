...
|$animal_fish2|Pike|
|$animal_fish3|Tuna|
|$biome_ashland|Taram de cenusa|
|$biome_blackforest|Black forest|
|$biome_darklands|Pamanturi intunecate|
|$biome_deepnorth|Nordul indepartat|
|$biome_edge|Capatul lumii|
|$biome_forest|Padure|
|$biome_heath|Sanatate|
|$biome_meadows|Meadows|
|$biome_mistlands|Mistlands|
|$biome_mountain|Munte|
|$biome_ocean|Ocean|
|$biome_plains|Plains|
|$biome_swamp|Mlastina|
|$button_lalt|L-Alt|
|$button_lctrl|L-Ctrl|
...
|$chat_resetspawn|Reseteaza punctul de start|
|$chat_shout|Striga|
|$chat_whisper|Sopteste|
...
|$error_banned|Banat|
|$error_disconnected|Deconectare|
|$error_failedconnect|Nu s-a putut conecta|
|$error_incompatibleversion|Versiune incompatibila|
|$error_password|Parola gresita|
|$error_serverfull|Server full|
|$event_bonemassarmy_end|Mirosul dispare incet|
...
|$event_foresttrolls_start|Pamantul se cutremura|
|$event_gdkingarmy_end|Linistea se lasa peste padure...|
...
|$event_wolves_end|Vanatoarea a luat sfarsit|
|$event_wolves_start|Te simti urmarit..|
|$feedback_bug|Bug|
...
|$hud_addpin|Marcheaza|
|$hud_altplace|Toggle snapping / options|
|$hud_autopickup|Auto-Pickup|
|$hud_build|Construieste|
|$hud_building|Construieste|
...
|$hud_showmap|Arata harta|
|$hud_switchcategory|Schimba categoria|
|$hud_switchitem|Schimba item|
|$hud_tame|Tame|
|$hud_tamecheck|Check|
...
|$inventory_pickaxe|Tarnacop|
|$inventory_pickup|Aduna|
|$inventory_pierce|Impungere|
|$inventory_poison|Otravit|
|$inventory_pvp|Primesti damage de la alti jucatori|
|$inventory_quality|Calitate|
|$inventory_recipes|Retete|
|$inventory_repairbutton|Repair an item|
|$inventory_resistant|Resistant|
|$inventory_selectedgp|Selected Forsaken power|
|$inventory_skills|Deprinderi|
|$inventory_slash|Sfartecare|
|$inventory_spirit|Spirit|
|$inventory_split|Separa|
|$inventory_splitstack|Separa stack-ul|
...
|$inventory_use|Foloseste/Echipeaza|
...
|$item_food|Mancare|
|$item_food_duration|Duratie|
|$item_food_health|Viata|
|$item_food_regen|Vindecare|
|$item_food_stamina|Anduranta|
...
|$item_trophy_bonemass_lore|O gramada de pamant negru si oase vechi, din fericire linistite acum|
...
|$item_trophy_deer_description|Un specimen bun, dar vei avea nevoie de mai mult decat caprioare pentru a intra in Valhalla|
|$item_trophy_deer_lore|Un specimen bun, dar vei avea nevoie de mai mult decat caprioare pentru a intra in Valhalla|
...
|$item_trophy_draugr_lore|Acopera gura daca incepe sa sopteasca noaptea|
...
|$item_trophy_foresttroll_lore|Pielea carpita are semne antice pe ea|
...
|$item_trophy_greydwarf_description|Capul|
|$item_trophy_greydwarf_lore|Capul|
...
|$menu_characterexist|Un personaj cu numele acela exista deja|
|$menu_close|Inchide|
...
|$menu_enterseed|Introdu samanta|
|$menu_exit|Quit|
|$menu_exitconfirm|Iesi din joc?|
...
|$menu_hair|Par|
|$menu_hairtone|Culoarea parului|
|$menu_joingame|Alătura-te unui joc|
|$menu_joinip|Join IP|
|$menu_loading|Incarcare...|
...
|$menu_newworld|Lume noua|
|$menu_no|Nu|
|$menu_ok|Ok|
|$menu_password|Parola|
|$menu_passwordfieldempty|Empty|
|$menu_passwordinvalid|Parola invalida|
|$menu_passwordshort|Parola prea scurta|
|$menu_public|Public|
|$menu_remove|Șterge|
|$menu_removecharacter|Sterge personajul?|
|$menu_removeworld|Sterge lumea?|
|$menu_resettutorial|Reset Tutorial|
|$menu_seed|Seed|
|$menu_selectcharacter|Alege personaj|
|$menu_selectserver|Alege un server|
|$menu_selectworld|Selecteaza lumea|
...
|$menu_startserver|Porneste serverul|
...
|$msg_bedneedroof|Patul necesita un acoperis|
|$msg_bednofire|Patul are nevoie de un foc in apropiere|
|$msg_bedtooexposed|Patul este prea expus|
|$msg_bedwet|You are wet|
|$msg_biome_found|Discovered $1 |
|$msg_blocked|Blocat|
|$msg_broke|$1 broke|
|$msg_broke_OLD|stricat|
|$msg_cantaddmore|Nu mai poti adauga $1|
|$msg_cantconsume|Nu poti consuma asta acum|
|$msg_cantdrop|Nu poti lasa asta jos|
|$msg_cantoffer|Ofranda ta nu primeste raspuns|
|$msg_cantopen|Nu o poti deschide|
|$msg_cantpickup|Nu poti ridica asta|
|$msg_cantremovenow|Nu poate fi distrus momentan|
|$msg_cantsleep|Nu poti dormi|
|$msg_cantuseon|Nu poti utiliza $1 pe $2|
...
|$msg_invalidplacement|Plasare invalida|
|$msg_isfull|Esti plin deja.|
|$msg_itsfull|E plin|
|$msg_level|nivel|
...
|$msg_missingrequirement|Cerinte lipsa|
|$msg_missingstation|Lipseste statia de constructie potrivita|
|$msg_needcultivated|Needs cultivated soil|
|$msg_needfire|Ai nevoie de un foc sub statia de gatit|
|$msg_needspace|Ai nevoie de mai mult spatiu|
|$msg_newday|Day $1|
|$msg_newitem|Obiect nou|
|$msg_newmaterial|Material nou|
|$msg_newpiece|Bucata de constructie noua|
|$msg_newrecipe|Reteta de constructie noua|
|$msg_newstation|Statie de constructie noua|
|$msg_newstation_level|Nou nivel|
|$msg_newtext|$1 added to the compendium|
|$msg_newtrophy|Trofeu colectat|
|$msg_nobuildzone|O forta mistica te opreste in aceasta zona|
|$msg_nocookitems|Nu ai ingrediene pentru gatit|
|$msg_nocookroom|Nu e destul spatiu|
|$msg_nomore|Nu poti manca mai mult(e) $1|
|$msg_noprocessableitems|Nu ai iteme procesabile|
|$msg_noroom|Nu mai ai spatiu in inventar|
...
|$msg_stationneedroof|Statia de constructie necesita acoperis|
|$msg_stationtooexposed|Statia este prea expusa|
|$msg_throwinfire|Ai aruncat niste $1 in foc|
|$msg_toofew|Prea putin|
|$msg_toohard|Prea greu|
|$msg_useonwhat|Foloseste $1 pe ce?|
|$msg_walk|Walk|
|$msg_wontwork|Nu va functiona|
|$msg_worldsaved|Lume salvata|
|$msg_worldsavewarning|World save in|
|$msg_wrongbiome|Can't be placed in this environment|
|$msg_wrongitem|Obiect gresit|
|$msg_wrongtool|Unealta gresita|
...
|$piece_bed|Pat|
|$piece_bed_claim|Foloseste|
|$piece_bed_currentspawn|Punctul de spawnare curent|
|$piece_bed_setspawn|Alege punctul de spawnare|
|$piece_bed_sleep|Dormi|
|$piece_bed_unclaimed|Pat neales|
|$piece_bed02|Dragon bed|
|$piece_beehive|Beehive|
|$piece_beehive_area|Albinelor nu le place aceassta locatie|
|$piece_beehive_check|Verifica albinele|
|$piece_beehive_extract|Extrage|
|$piece_beehive_freespace|Albinele au nevoie de mai mult spatiu|
...
|$piece_craftingstation|Statie de craftare|
|$piece_crystalwall1x1|Crystal wall 1x1|
|$piece_cstand_cook|Gateste item|
...
|$piece_itemstand_attach|Ataseaza obiectul|
|$piece_itemstand_cantattach|Nu poti atasa acest obiect|
...
|$piece_sign|Sign|
|$piece_sign_input|Adauga text|
|$piece_smelter|Smelter|
|$piece_smelter_add|Adauga|
|$piece_smelter_additem|Adauga item|
...
|$se_cold_name|Cold|
|$se_cold_repeat|Iti este foarte frig|
|$se_cold_start|Iti este frig|
|$se_cold_stop|Te incalzesti|
...
|$se_freezing_repeat|Incepi sa ingheti|
|$se_freezing_start|Ingheti|
|$se_freezing_stop|Te incalzesti|
...
|$se_healthupgrade_stop|Te simti mai puternic|
...
|$se_shelter_start|Esti acoperit|
|$se_shelter_stop|Esti expus  vremii|
|$se_shelter_tooltip|You are sheltered from the weather.|
|$se_smoked_name|Smoked|
|$se_smoked_start|Nu poti respira din cauza fumului|
...
|$se_staminaupgrade_stop|Te simti mai puternic|
...
|$se_warm_name|Warm|
|$se_warm_start|Iti este cald|
|$se_warm_tooltip|You are warm.|
|$se_wet_name|Wet|
|$se_wet_repeat|Esti din ce in ce mai ud|
|$se_wet_start|Esti ud leoarca|
|$se_wet_stop|Esti uscat|
...
|$settings_apply|Aplica|
|$settings_attack|Atac|
|$settings_audio|Setari audio|
|$settings_autopickup|Toggle Auto-Pickup|
|$settings_autorun|Alergare automata|
|$settings_backward|Inapoi|
|$settings_block|Blocaj|
|$settings_bloom|Bloom|
|$settings_buildcat|Categorie de constructie|
|$settings_buildmenu|Build Menu|
|$settings_buildnext|Urmatoarea constructie|
|$settings_buildprev|Constructia precedenta|
...
|$settings_controls|Setari control|
|$settings_crouch|Ghemuit|
|$settings_dodge|Dodge|
|$settings_dof|Adancime (DOF)|
|$settings_draw|Draw|
|$settings_forward|Inainte|
|$settings_fullscreen|Fullscreen|
|$settings_gamepadenabled|Gamepad Enabled|
|$settings_gp|Forsaken Power|
|$settings_graphics|Setari grafice|
|$settings_guicale_note|Rezolutie minima 2560x1440|
|$settings_guiscale|Scaleaza interfata grafica|
|$settings_hide|Ascunde/Arata arma|
|$settings_high|Inalt|
|$settings_infinite|Inf.|
|$settings_inventory|Inventar|
|$settings_invertmouse|Inverseaza mouse|
|$settings_joysens|Gamepad Sensitivity|
|$settings_jump|Sari|
|$settings_langchange_community|*Traducere comunitară|
|$settings_langchange_notice|Game restart is required when changing language.|
|$settings_language|Limba|
|$settings_left|Stanga|
|$settings_lights|Particule de lumina|
...
|$settings_motionblur|Blur in miscare|
|$settings_mousesens|Sensitivitate mouse|
|$settings_musicvol|Volum muzica|
...
|$settings_requirerestart|Necesita restartare|
|$settings_res|Rezolutie|
|$settings_resetcontrols|Reseteaza setarile|
|$settings_resok|Functioneaza corect?|
...
|$settings_sit|Sit|
|$settings_softpart|Particule usoare|
|$settings_ssao|SSAO|
|$settings_sunshafts|Raze de soare|
|$settings_tesselation|Tessellation|
|$settings_test|Testeaza|
|$settings_use|Foloseste|
|$settings_vegetation|Calitate vegetatie|
|$settings_veryhigh|Very High|
|$settings_vsync|Sincronizare Verticala (VSync)|
|$settings_walk|Toggle Walk|
|$settings_zoomin|Mareste|
|$settings_zoomout|Micsoreaza|
...
|$tutorial_cold_topic|Iti este frig|
...
|$tutorial_start_topic|Bine ai venit in Valheim|
