...
|$menu_beard|Brada|
|$menu_blondness|Plavokosi|
|$menu_cancel|Otkaži|
|$menu_changelog|Changelog|
|$menu_characterexist|Karakter sa tim imenom već postoji.|
...
|$menu_communityserver|Javni server|
|$menu_connect|Konektuj se|
...
|$menu_entername|Unesi ime|
|$menu_enterpassword|Unesi lozinku|
|$menu_enterseed|Unesi seme|
...
|$menu_joingame|Pridruži se igri|
|$menu_joinip|Join IP|
...
|$menu_new|Nova|
|$menu_newcharacter|Novi karakter|
|$menu_newworld|Novi Svet|
...
|$menu_passwordinvalid|Pogrešna lozinka|
...
|$menu_seed|Seme|
|$menu_selectcharacter|Izaberi karaktera|
|$menu_selectserver|Odaberi server|
|$menu_selectworld|Odaberi Svet|
...
|$menu_serverpassword|Server lozinka|
...
|$menu_startserver|Pokreni server|
...
|$menu_worldnametip|5 karaktera je minimum|
|$menu_worlds|Worlds|
|$menu_yes|Da|
...
|$msg_bedneedroof|The bed must be placed under a roof|
|$msg_bednofire|The bed needs to be placed near a fire|
|$msg_bedtooexposed|The bed is too exposed|
...
|$msg_fireportalalready|The portal is already activated|
...
|$msg_needfire|You need to have a lit fire below the cooking station|
...
|$msg_stationneedroof|The crafting station needs a roof|
|$msg_stationtooexposed|The crafting station is too exposed|
...
|$piece_beehive_check|Check the bees|
...
|$settings_antialiasing|Ublažavanje ivica|
|$settings_apply|Primeni|
...
|$settings_bloom|Cvetanje|
|$settings_buildcat|Kategorija Gradnje|
|$settings_buildmenu|Meni gradnje|
|$settings_buildnext|Sledeći predmet za gradnju|
|$settings_buildprev|Prethodni predmet za gradnju|
|$settings_ca|Hromatske aberacije|
|$settings_camera_sensitivity|Camera sensitivity|
|$settings_camerashake|Drmanje kamere|
...
|$settings_continousmusic|Neprekidna muzika|
...
|$settings_fullscreen|Čitav ekran|
...
|$settings_quickselect|Odabir gradnje na desni-klik|
...
|$settings_remove|Dekonstruisati|
...
|$settings_showkeyhints|Prikaži savet na dugmićima|
...
|$settings_ssao|SSAO|
|$settings_sunshafts|Sunčevi zraci|
|$settings_swap_triggers|Swap triggers|
|$settings_tesselation|Mozaik|
|$settings_test|Test|
...
|$settings_vegetation|Kvalitet vegetacije|
|$settings_veryhigh|Very High|
|$settings_vsync|VSync|
|$settings_walk|Toggle walk|
|$settings_zoomin|Približi|
|$settings_zoomout|Odalji|
