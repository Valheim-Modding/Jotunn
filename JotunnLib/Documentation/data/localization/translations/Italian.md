...
|$item_fishingbait_swamp|Esca puzzolente|
...
|$item_magicallystuffedmushroomuncooked|Fungo ripieno magico crudo|
...
|$item_yggdrasilporridge_description|Un solo boccone di questo porridge fatto con la linfa del grande albero provoca un bagliore caldo intorno a tutto il tuo corpo.|
...
|$menu_ipportorinvitecode|[IP/URL]:[port] o [codice d'invito a 6 cifre]|
...
|$npc_dvergrrogue_random_talk1|Non sai mai in cosa puoi imbatterti nella nebbia.|
...
|$text_mistlands_bosshint|Il cancello è sigillato. La chiave è stata nascosta nelle miniere, in profondità, per impedire che fosse riaperto.<br/>Il cancello è sigillato.|
|$tool_cart|Carretto|
