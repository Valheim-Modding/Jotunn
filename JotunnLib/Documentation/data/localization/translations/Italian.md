...
|$error_worldfileload|Errore nel caricamento del file mondiale. Controlla i backup!|
...
|$menu_addserverfailed|Aggiunta del server non riuscita!|
|$menu_addserverfailedincorrectformatting|Indirizzo IP, URL o codice di invito inseriti non validi.|
|$menu_addserverfailedresolvejoincode|Impossibile utilizzare il codice di partecipazione|
|$menu_back|Indietro|
|$menu_backupcount|$1 backup|
|$menu_backuprestorefailedheader|Ripristino del backup non riuscito!|
|$menu_backuprestorepromptheader|Vuoi ripristinare il backup?|
|$menu_backuprestorepromptrecover|Il file eliminato $1 verrà ripristinato da $2.|
|$menu_backuprestorepromptreplace|La versione attuale di $1 verrà salvata e sostituita da $2.|
|$menu_beard|Barba|
...
|$menu_cloudstoragefull|Il tuo spazio di archiviazione nel cloud è pieno!|
|$menu_cloudstoragefullcharacterprompt|Vuoi salvare questo personaggio nella memoria interna?|
|$menu_cloudstoragefullmovingsave|Per prevenire le perdite di dati, i dati di salvataggio della sessione in corso possono essere spostati nella memoria interna.|
|$menu_cloudstoragefulloperationfailed|Questa operazione non è riuscita perché il tuo spazio di archiviazione nel cloud è pieno. Sposta alcuni mondi nella memoria interna e riprova.|
|$menu_cloudstoragefullworldprompt|Vuoi salvare questo mondo nella memoria interna?|
|$menu_cloudstorageused|Spazio di archiviazione nel cloud utilizzato: $1/$2|
...
|$menu_duplicatefileprompttext|Esiste già un salvataggio con il nome $1 nella posizione selezionata.|
|$menu_enteripinvite|Inserisci un indirizzo IP o un codice d'invito|
...
|$menu_filter|Filtro|
|$menu_friends|Amici|
|$menu_gamepreviewpopupheader|Valheim è disponibile su Game Preview|
|$menu_gamepreviewpopuptext|Potrebbero verificarsi problemi con le piattaforme o con alcune funzionalità e il gioco potrebbe subire un arresto anomalo.|
|$menu_hair|Capelli|
|$menu_hairtone|Tonalità capelli|
|$menu_ipportorinvitecode|[IP/URL]:[ingresso] o [codice d'invito a 6 cifre]|
|$menu_joincode|Codice di partecipazione $1|
|$menu_joindifferentserver|Stai per accedere a un server diverso!|
...
|$menu_logoutprompt|Vuoi davvero uscire dalla sessione in corso?|
|$menu_male|Maschio|
...
|$menu_movefailedheader|Trasferimento del file non riuscito!|
...
|$menu_newworldalreadyexistsmessage|Esiste già un mondo con il nome $1|
|$menu_no|No|
|$menu_ok|Ok|
...
|$msg_worldsavedcloudstoragefull|Spazio di archiviazione nel cloud pieno! Il mondo è stato spostato nella memoria interna e salvato|
