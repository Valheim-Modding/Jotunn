...
|$ach_allbosses|Il Vichingo|
|$ach_allbosses_desc|Sconfiggi tutti i boss a qualsiasi livello di difficoltà.|
|$ach_allbosseshard|Il Vichingo più tenace di tutti|
|$ach_allbosseshard_desc|Sconfiggi tutti i boss in modalità difficile.|
|$ach_allbossesnormal|Il Vichingo tenace|
|$ach_allbossesnormal_desc|Sconfiggi tutti i boss in modalità normale o superiore.|
|$ach_allbossesunarmed|Il pugile|
|$ach_allbossesunarmed_desc|Sconfiggi tutti i boss usando solo i pugni.|
|$ach_allbuildpieces|Il Falegname|
|$ach_allbuildpieces_desc|Costruisci tutto.|
|$ach_allfoodcooked|Lo Chef|
|$ach_allfoodcooked_desc|Cucina ogni tipo di piatto.|
|$ach_allfoodeaten|Il Gourmet|
|$ach_allfoodeaten_desc|Mangia ogni tipo di cibo.|
|$ach_allitemcraft|L'Artigiano|
|$ach_allitemcraft_desc|Crea ogni tipo di oggetto.|
|$ach_allminibosses|Odino è compiaciuto|
|$ach_allminibosses_desc|Sconfiggi tutti i miniboss.|
|$ach_allweaponcraft|Il Fabbro|
|$ach_allweaponcraft_desc|Fabbrica ogni tipo di arma.|
|$ach_arrived|Eccomi!|
|$ach_arrived_desc|Entra nel decimo mondo.|
|$ach_bigfish|Una pesca degna di Njord|
|$ach_bigfish_desc|Cattura un pesce da quattro stelle.|
|$ach_boss1eikthyr|Eikthyr|
|$ach_boss1eikthyr_desc|Sconfiggi il Cervo Fulmineo.|
|$ach_boss2elder|L'Anziano|
|$ach_boss2elder_desc|Sconfiggi la Foresta vivente.|
|$ach_boss3bonemass|Catasta d'Ossa|
|$ach_boss3bonemass_desc|Sconfiggi i Morti contorti.|
|$ach_boss4moder|Moder|
|$ach_boss4moder_desc|Sconfiggi la Madre dei Draghi.|
|$ach_boss5yagluth|Yagluth|
|$ach_boss5yagluth_desc|Sconfiggi l'Anima contorta.|
|$ach_boss6queen|La Regina dei Cercatori|
|$ach_boss6queen_desc|Sconfiggi la Matriarca strisciante.|
|$ach_boss7fader|Fader|
|$ach_boss7fader_desc|Sconfiggi la Fiamma smeraldina.|
|$ach_boss8frozenking|Kall Fimbulbringer|
|$ach_boss8frozenking_desc|Sconfiggi l'Incatenato.|
|$ach_builddyrnwyn|Il Prescelto|
|$ach_builddyrnwyn_desc|Assembla Dyrnwyn.|
|$ach_buildhigh|Sale maestose|
|$ach_buildhigh_desc|Costruisci una struttura molto alta.|
|$ach_buildhighworld|In cima al mondo|
|$ach_buildhighworld_desc|Costruisci qualcosa di molto alto.|
|$ach_buildhouse|Il Colono|
|$ach_buildhouse_desc|Costruisci una casa.|
|$ach_buildvillage|L'Architetto|
|$ach_buildvillage_desc|Costruisci un villaggio.|
|$ach_childofodin|Figlio di Odino|
|$ach_childofodin_desc|Incarna lo spirito del vichingo tenace, del maestro cacciatore, del sopravvissuto e dell'apripista.|
|$ach_deathbyalltypes|Stai bene?|
|$ach_deathbyalltypes_desc|Muori in ogni modo possibile.|
|$ach_deathbyobliterator|Obliterato|
|$ach_deathbyobliterator_desc|Sei un po' troppo vicino.|
|$ach_deathbytree|Capita a tutti|
|$ach_deathbytree_desc|Muori a causa di un albero.|
|$ach_deathbytreeall|Non può essere un caso|
|$ach_deathbytreeall_desc|Muori a causa di ogni tipo di albero.|
|$ach_everyachievement|Il più degno|
|$ach_everyachievement_desc|Sblocca tutte le altre imprese.|
|$ach_explorensew|L'Esploratore|
|$ach_explorensew_desc|Viaggia in lungo e in largo in tutte e quattro le direzioni.|
|$ach_explorensewnomap|L'Apripista|
|$ach_explorensewnomap_desc|Viaggia in lungo e in largo in tutte e quattro le direzioni, senza usare una mappa.|
|$ach_findalltrophies|Il Collezionista di trofei|
|$ach_findalltrophies_desc|Raccogli tutti i trofei.|
|$ach_firstdeath|Il primo di una lunga serie|
|$ach_firstdeath_desc|Affronta il tuo destino, poi preparati a ricominciare da capo...|
|$ach_grindbuild|Il Costruttore|
|$ach_grindbuild_desc|Costruisci 500 elementi.|
|$ach_grindcomfort|Il comfort è tutto|
|$ach_grindcomfort_desc|Raggiungi un livello di comodità pari a 20.|
|$ach_grindcook|Il Cuoco|
|$ach_grindcook_desc|Prepara 100 piatti.|
|$ach_grinddays|Il Sopravvissuto|
|$ach_grinddays_desc|Sopravvivi per 30 giorni consecutivi.|
|$ach_grindeat|Non si parte all'avventura a stomaco vuoto|
|$ach_grindeat_desc|Mangia 500 porzioni di cibo.|
|$ach_grindfish|Il Pescatore|
|$ach_grindfish_desc|Pesca ogni tipo di pesce.|
|$ach_grindforager|Il Raccoglitore|
|$ach_grindforager_desc|Raccogli 250 bacche e 250 funghi.|
|$ach_grindharvest|Il Contadino|
|$ach_grindharvest_desc|Mieti 500 raccolti.|
|$ach_grindhoney|L'Apicoltore|
|$ach_grindhoney_desc|Raccogli 500 porzioni di miele.|
|$ach_grindleviathan|Non c'è tempo per sonnecchiare|
|$ach_grindleviathan_desc|Risveglia una creatura marina.|
|$ach_grindsail|Il Marinaio|
|$ach_grindsail_desc|Naviga abbastanza a lungo da fare due volte il giro del mondo.|
|$ach_grindsailhelm|Il Capitano|
|$ach_grindsailhelm_desc|Naviga abbastanza a lungo da fare il giro del mondo, mentre sei al timone.|
|$ach_grindtreasure|Il Cacciatore di tesori|
|$ach_grindtreasure_desc|Scopri 10 forzieri del tesoro nascosti.|
|$ach_grindtrees|Il Boscaiolo|
|$ach_grindtrees_desc|Abbatti 500 alberi.|
|$ach_killallcreatures|Il Cacciatore|
|$ach_killallcreatures_desc|Uccidi ogni tipo di creatura.|
|$ach_killallcreatureshard|Il Maestro cacciatore|
|$ach_killallcreatureshard_desc|Uccidi ogni tipo di creatura in modalità difficile.|
|$ach_kingsqueens|Re e regine di Valheim|
|$ach_kingsqueens_desc|Incarna lo spirito di vichinghi, cacciatori, artigiani, chef, falegnami ed esploratori.|
|$ach_multiplayerboss|Più forti insieme|
|$ach_multiplayerboss_desc|Sconfiggi un boss insieme a un amico.|
|$ach_sailedge|Le leggende sono vere|
|$ach_sailedge_desc|Naviga oltre i confini del mondo.|
|$ach_soloboss|Lupo solitario|
|$ach_soloboss_desc|Sconfiggi un boss da solo.|
|$achievement_details|Dettagli delle imprese|
|$achievements_cheated_item_inventory|Questo oggetto è stato ottenuto con dei trucchi.|
|$achievements_confirm_cheat|Quel comando è un trucco; per utilizzare i trucchi, digita "confirmcheats" nella console. <color=red>L'uso dei trucchi disabiliterà in modo permanente la possibilità di sbloccare le imprese per questo personaggio e questo mondo.</color>|
|$achievements_permanently_cheated_character|I progressi relativi alle imprese sono permanentemente disattivati per questo personaggio perché hai usato dei trucchi.|
|$achievements_permanently_cheated_world|I progressi relativi alle imprese sono permanentemente disattivati per questo mondo perché hai usato dei trucchi che modificano il mondo.|
|$achievements_picked_up_cheated_item|Hai raccolto un oggetto truccato. I progressi relativi alle imprese sono temporaneamente disattivati.|
|$achievements_temporarily_cheated|I progressi relativi alle imprese sono temporaneamente disattivati per questo personaggio a causa del possesso di oggetti ottenuti con mezzi illeciti.|
...
|$biome_swamp|Palude|
|$black_ice_combo|Ghiaccio maligno|
|$blackice_core|Ghiaccio maligno|
|$blackice_triggeritem|Ghiaccio maligno|
|$blocking_joined_world_with_blocked_player|Questo mondo contiene contenuti generati dagli utenti (CGU) di un giocatore che hai bloccato. Per giocare in questo mondo, devi sbloccarlo. Vuoi sbloccare l'utente seguente:|
|$boss_hive_end|Ci siamo dispersi.|
|$boss_hive_start|Ci siamo.|
|$build_piece_author_built_by|Autore:|
|$build_piece_author_unknown|Ignoto|
|$button_a|A|
|$button_b|B|
...
|$cinematics_end_credits|Riconoscimenti finali|
|$cinematics_intro|Introduzione|
|$cinematics_outro|Epilogo|
|$codeofconduct_ban_appeals_body|Se pensi che il tuo ban sia stato emesso per errore, puoi contattare il nostro supporto per una revisione. Tuttavia, le decisioni finali saranno prese in conformità con le nostre politiche e i requisiti della piattaforma.|
|$codeofconduct_ban_appeals_header|Ricorsi contro i ban|
|$codeofconduct_bodytext_first|Quando giochi tramite piattaforme crossplay, devi rispettare tutte le regole e le linee guida della community da noi stabilite. Ti invitiamo a comportarti nel modo migliore possibile.|
|$codeofconduct_enforcement_and_bans_body|Ci riserviamo il diritto di intraprendere azioni contro i giocatori che violano queste regole, tra cui:<br/><br/>• Ban temporaneo o permanente dal gioco online.<br/><br/>• Restrizioni alle funzionalità cross-play.|
|$codeofconduct_enforcement_and_bans_header|Provvedimenti e ban|
|$codeofconduct_header|Comportamento dei giocatori e ban: gioca in modo responsabile|
|$codeofconduct_prohibited_behavior_body|Le seguenti azioni possono comportare il ban temporaneo o permanente dal gioco online:<br/><br/>• Molestie, incitamento all'odio, minacce o discriminazione.<br/><br/>• Condivisione di contenuti offensivi o inappropriati tramite chat, costruzioni nel gioco o altri mezzi.|
|$codeofconduct_prohibited_behavior_header|Comportamenti vietati|
|$codeofconduct_reporting_violations_body|Se noti comportamenti inaccettabili: <br/><br/>• In gioco: usa la funzione “Segnala giocatore” integrata (Opzioni->Elenco giocatori->Segnala)<br/><br/>• Fuori dal gioco: usa questo modulo online: https://valheim.com/report-a-player|
|$codeofconduct_reporting_violations_header|Segnalazione di violazioni|
...
|$customization_beard22|Baffi|
|$customization_beard23|Barba|
|$customization_beard24|Rasato e lucido|
|$customization_beard25|Corta|
|$customization_beard26|Baffi a manubrio|
...
|$customization_hair32|Taglio mullet|
|$customization_hair33|Rasatura Vinland|
|$customization_hair34|Taglio castellano|
|$customization_hair35|Campione|
|$customization_hair36|Cronista|
|$customization_hair37|Portatore di sole|
|$customization_hair38|Maschile|
...
|$dream_deepnorth01|Nel tuo sogno, sei in piedi, senza vestiti, in mezzo a una pozza d'acqua così limpida da non poterla vedere, ma solo percepire come una fascia ondeggiante attorno ai tuoi fianchi. Tre figure stanno in piedi sul bordo dell'acqua e ti osservano in silenzio. Quando la figura in primo piano sfiora la superficie dell'acqua con la punta del piede, l'increspatura dissolve il sogno e ti svegli.|
|$dream_deepnorth02|Scivoli lungo il tunnel di un sogno inquieto verso un vuoto così totale che nessuna parola potrà descriverlo…|
|$dream_deepnorth03|Sogni una sala in inverno, che risplende di luci e risate nel cuore di una notte innevata. Man mano che ti avvicini, le luci si trasformano in alte fiamme e le risate in urla. Corri verso la sala, ma questa sprofonda sibilando nella neve mentre ti avvicini.|
|$dream_deepnorth04|Corri giù per una collina senza fine, con il cuore che ti batte forte di gioia nel petto. Due sagome scure volano al tuo fianco e il battito delle loro ali ti accompagna anche nelle ore di veglia.|
|$dream_deepnorth05|Vedi il volto di un bambino che ride e piange allo stesso tempo. Gli occhi sono limpidi e blu dietro le lacrime, la bocca è un groviglio di dentini. Nel sogno ti dice qualcosa, ma le parole svaniscono quando ti svegli.|
|$dream_deepnorth06|Nel tuo sogno c'è una porta senza chiavistello né catenaccio. Hai la sensazione che basterebbe una spinta per aprirla, ma il tuo corpo è paralizzato da una raffica di vento gelido. Dietro quella porta si sentono le voci delle persone che ami, ma di cui non riesci a ricordare il nome. Ti protendi in avanti verso un risveglio vuoto.|
|$dream_deepnorth07|I fantasmi di tutti coloro che sono morti per mano tua ti vengono a trovare nel sonno e indugiano ai confini del tuo sogno. Non vogliono nulla, non hanno bisogno di nulla, non dicono nulla.|
|$dream_deepnorth08|Ti addentri nei meandri del sonno fino a raggiungere una vasta sala dove una sagoma scura è rannicchiata sotto un groviglio di pesanti catene. Quando si gira verso di te, le sue sfere oculari blu trafiggono il sogno e ti svegli in un bagno di sudore.|
|$dream_deepnorth09|Non ricordi nulla del sogno di questa notte, ma la sua atmosfera arcobaleno ti accompagna verso il nuovo giorno con un sorriso sulle labbra.|
|$dream_deepnorth10|Odino ti appare in sogno e ti offre un corno colmo fino all'orlo di una bevanda schiumosa. Ne bevi un sorso abbondante e accogli il nuovo giorno sentendoti forte e pieno di vita.|
...
|$elaking_trashpile|Mucchio di macerie|
|$enemy_abomination|Abominio|
|$enemy_asksvin|Cenerale|
|$enemy_asksvin_hatchling|Pulcino di cenerale|
|$enemy_aspect_bonemass|Aspetto dei Morti contorti|
|$enemy_aspect_dragon|Aspetto della Madre dei Draghi|
|$enemy_aspect_eikthyr|Aspetto del Cervo fulmineo|
|$enemy_aspect_fader|Aspetto della Fiamma smeraldina|
|$enemy_aspect_gdking|Aspetto della Foresta vivente|
|$enemy_aspect_goblinking|Aspetto dell'Anima contorta|
|$enemy_aspect_seekerqueen|Aspetto della Matriarca strisciante|
|$enemy_babyseeker|Covata di cercatori|
|$enemy_barka|Barka|
|$enemy_bat|Pipistrello|
|$enemy_bigblob|Pulp esaedrico|
|$enemy_bjorn|Orso|
|$enemy_blob|Blob|
|$enemy_blobelite|Oozer|
|$enemy_blobfrost|Blob di gelo|
|$enemy_bloblava|Blob di lava|
|$enemy_blobmork|Pulp informe|
|$enemy_blobmorkmini|Pulp minuscolo|
...
|$enemy_boss_frozenking_alertmessage|Il suo odio corrompe tutto!|
|$enemy_boss_frozenking_deathmessage|La pace scende sul mondo|
...
|$enemy_dvergr_deepnorth|Dvergr imprigionato|
|$enemy_dvergr_mage|Mago dvergr|
|$enemy_dvergrs|Dvergr|
|$enemy_eikthyr|Eikthyr|
|$enemy_eikthyr_alertmessage|Eikthyr scatena la tempesta|
|$enemy_eikthyr_deathmessage|Eikthyr è stato ucciso|
|$enemy_elaking|Elaking|
|$enemy_elakingmole|Il Senza Occhi|
|$enemy_fader|Fader|
|$enemy_fader_codename|La Fiamma di Smeraldo|
|$enemy_fallenvalkyrie|Valchiria caduta|
|$enemy_fallenwarrior|Guerriero caduto|
...
|$enemy_gdking_alertmessage|L'Anziano emerge dalla foresta|
|$enemy_gdking_deathmessage|L'Anziano è stato abbattuto|
|$enemy_gemgoblin|Riktig Fuling|
|$enemy_ghost|Fantasma|
|$enemy_ghost_void|Il Vuoto|
|$enemy_gjall|Scoria|
|$enemy_goblin|Fuling|
|$enemy_goblin_deepnorth|Fuling in cattività|
...
|$enemy_hare|Lepre|
|$enemy_hen|Gallina|
|$enemy_holespawner|Passaggio del guardaroba|
...
|$eula_acceptance|SELEZIONANDO “ACCETTO” O UTILIZZANDO IL PRODOTTO, DICHIARI DI AVER LETTO, COMPRESO E ACCETTATO I VINCOLI DEL PRESENTE ACCORDO EULA.|
|$eula_header|CONTRATTO DI LICENZA PER L'UTENTE FINALE (EULA)|
|$eula_important_first_text|IMPORTANTE: LEGGI ATTENTAMENTE L'ACCORDO DISPONIBILE AL SITO VALHEIM.COM/EULA. SCARICANDO, INSTALLANDO O USANDO “VALHEIM” (IL "PRODOTTO") SU UN SISTEMA DI TUA PROPRIETÀ O SOTTO IL TUO CONTROLLO, ACCETTI DI ESSERE VINCOLATO AI TERMINI DEL PRESENTE ACCORDO DI LICENZA PER L'UTENTE FINALE (“EULA”). SE NON ACCETTI, NON UTILIZZARE IL PRODOTTO.|
...
|$event_elakingarmy_end|Tornano nelle loro tane...|
|$event_elakingarmy_start|Emergono dal basso...|
...
|$event_ghosts_end|Sono stati esiliati, per ora...|
|$event_ghosts_start|Senti un brivido lungo la schiena…|
...
|$event_jotunarmy_end|Gli Jotun si ritirano|
|$event_jotunarmy_start|Gli Jotun ti hanno trovato|
...
|$fallen_viking_randomend_1|Sei un degno avversario.|
|$fallen_viking_randomend_10|Sembra che tu sia all’altezza.|
|$fallen_viking_randomend_11|Apprezzo le tue capacità.|
|$fallen_viking_randomend_12|Gli antenati ti sorridono.|
|$fallen_viking_randomend_13|Le Valchirie hanno fatto un'ottima scelta.|
|$fallen_viking_randomend_14|Finalmente.|
|$fallen_viking_randomend_15|Ora posso riposare.|
|$fallen_viking_randomend_16|Una battaglia ben combattuta.|
|$fallen_viking_randomend_17|Va' pure. Hai la nostra benedizione.|
|$fallen_viking_randomend_18|Ora combatti per tutti noi.|
|$fallen_viking_randomend_19|Seguiremo con interesse i tuoi progressi.|
|$fallen_viking_randomend_2|Hai dimostrato il tuo valore.|
|$fallen_viking_randomend_20|Sei davvero capace.|
|$fallen_viking_randomend_3|Ben fatto, guerriero.|
|$fallen_viking_randomend_4|Un vero campione.|
|$fallen_viking_randomend_5|La vittoria sarà tua.|
|$fallen_viking_randomend_6|Una battaglia davvero notevole.|
|$fallen_viking_randomend_7|È stato un onore.|
|$fallen_viking_randomend_8|Combatti bene.|
|$fallen_viking_randomend_9|Sei formidabile con le armi.|
|$fallen_viking_randomstart_1|Vediamo di cosa sei capace!|
|$fallen_viking_randomstart_10|Vuoi sfidarmi?|
|$fallen_viking_randomstart_11|Ecco, era proprio questo che stavo aspettando!|
|$fallen_viking_randomstart_12|Allora affrontami!|
|$fallen_viking_randomstart_13|Dimostra la tua forza!|
|$fallen_viking_randomstart_14|Sei in cerca di sangue?|
|$fallen_viking_randomstart_15|Per la vittoria!|
|$fallen_viking_randomstart_16|Allora iniziamo!|
|$fallen_viking_randomstart_17|Cerchi una sfida?|
|$fallen_viking_randomstart_18|Finalmente!|
|$fallen_viking_randomstart_19|Ci sfidiamo a duello?|
|$fallen_viking_randomstart_2|Fammi vedere cosa sai fare!|
|$fallen_viking_randomstart_20|Non lasciarti sconfiggere dalla timidezza, affrontami!|
|$fallen_viking_randomstart_3|Mettiti alla prova!|
|$fallen_viking_randomstart_4|Sei all'altezza?|
|$fallen_viking_randomstart_5|Vediamo se sei all'altezza!|
|$fallen_viking_randomstart_6|Pensi di potermi battere?|
|$fallen_viking_randomstart_7|Che vinca il migliore!|
|$fallen_viking_randomstart_8|Vediamo chi è il più forte?|
|$fallen_viking_randomstart_9|Finalmente un rivale!|
|$fallen_viking_randomtaunt_1|È tutto qui quello che sai fare?|
|$fallen_viking_randomtaunt_10|È uno scherzo?|
|$fallen_viking_randomtaunt_11|È tutto qui quello che sai fare?|
|$fallen_viking_randomtaunt_12|Cos'altro sai fare?|
|$fallen_viking_randomtaunt_13|Questa sì che è una bella battaglia!|
|$fallen_viking_randomtaunt_14|Che il sangue macchi il suolo!|
|$fallen_viking_randomtaunt_15|Dimostralo, allora! Forza!|
|$fallen_viking_randomtaunt_16|Colpisci con tutta la tua forza!|
|$fallen_viking_randomtaunt_17|Ho visto topi più feroci di te!|
|$fallen_viking_randomtaunt_18|Un vecchio cucchiaio colpirebbe più forte di te!|
|$fallen_viking_randomtaunt_19|Che campione da quattro soldi!|
|$fallen_viking_randomtaunt_2|Dai! Allora combatti contro di me!|
|$fallen_viking_randomtaunt_20|Non sono riusciti a trovare di meglio?|
|$fallen_viking_randomtaunt_21|Ma dai, al giorno d'oggi lasciano davvero che chiunque prenda in mano un'arma!|
|$fallen_viking_randomtaunt_22|Non umiliare i tuoi antenati!|
|$fallen_viking_randomtaunt_23|Un bambino saprebbe difendersi meglio!|
|$fallen_viking_randomtaunt_24|Ma almeno sei un vichingo?|
|$fallen_viking_randomtaunt_25|Ma dai, non sarà mica tutto qui?|
|$fallen_viking_randomtaunt_26|Che tristezza! Di nuovo!|
|$fallen_viking_randomtaunt_27|E questo lo chiami combattere?|
|$fallen_viking_randomtaunt_28|E ti definisci un campione?|
|$fallen_viking_randomtaunt_29|Ma nessuno ti ha mai insegnato come muovere bene i piedi?|
|$fallen_viking_randomtaunt_3|Puoi fare di meglio!|
|$fallen_viking_randomtaunt_30|È davvero questa l'arma che userai in battaglia?|
|$fallen_viking_randomtaunt_31|Un giovane nano grigio ha più classe di te!|
|$fallen_viking_randomtaunt_32|Le Valchirie hanno commesso un errore con te?|
|$fallen_viking_randomtaunt_33|Non trattenerti!|
|$fallen_viking_randomtaunt_34|Un campione deve colpire nel segno!|
|$fallen_viking_randomtaunt_35|Qui non c'è spazio per la debolezza!|
|$fallen_viking_randomtaunt_36|È da tanto che aspettavo questo momento!|
|$fallen_viking_randomtaunt_37|Vuoi che ti uccida?|
|$fallen_viking_randomtaunt_38|So che puoi fare di meglio!|
|$fallen_viking_randomtaunt_39|Non hai fatto tutta questa strada per niente!|
|$fallen_viking_randomtaunt_4|Non è certo questa la tua piena potenza, vero?|
|$fallen_viking_randomtaunt_40|Devi diventare un tutt'uno con la tua arma!|
|$fallen_viking_randomtaunt_5|Tutto qui?|
|$fallen_viking_randomtaunt_6|Devi essere più forte di così!|
|$fallen_viking_randomtaunt_7|E tu saresti alla mia altezza?|
|$fallen_viking_randomtaunt_8|Non farci vergognare!|
|$fallen_viking_randomtaunt_9|Dimentichi il tuo posto!|
|$fallenwarrior_title1_f|{name}, l'Avventuriera|
|$fallenwarrior_title1_m|{name}, l'Avventuriero|
|$fallenwarrior_title10_f|{name} la Coraggiosa|
|$fallenwarrior_title10_m|{name} il Coraggioso|
|$fallenwarrior_title100_f|{name} la Lupa|
|$fallenwarrior_title100_m|{name} il Lupo|
|$fallenwarrior_title101_f|{name} la Giovane|
|$fallenwarrior_title101_m|{name} il Giovane|
|$fallenwarrior_title11_f|{name} la Luminosa|
|$fallenwarrior_title11_m|{name} il Luminoso|
|$fallenwarrior_title12_f|{name} la Distrutta|
|$fallenwarrior_title12_m|{name} il Distrutto|
|$fallenwarrior_title13_f|{name} la Costruttrice di Città|
|$fallenwarrior_title13_m|{name} il Costruttore di Città|
|$fallenwarrior_title14_f|{name} la Calma|
|$fallenwarrior_title14_m|{name} il Calmo|
|$fallenwarrior_title15_f|{name} la Campionessa|
|$fallenwarrior_title15_m|{name} il Campione|
|$fallenwarrior_title16_f|{name} l'Allegra|
|$fallenwarrior_title16_m|{name} l'Allegro|
|$fallenwarrior_title17_f|{name} la Prescelta|
|$fallenwarrior_title17_m|{name} il Prescelto|
|$fallenwarrior_title18_f|{name} la Furba|
|$fallenwarrior_title18_m|{name} il Furbo|
|$fallenwarrior_title19_f|{name} la Fredda|
|$fallenwarrior_title19_m|{name} il Freddo|
|$fallenwarrior_title2_f|{name} la Malefica|
|$fallenwarrior_title2_m|{name} il Malefico|
|$fallenwarrior_title20_f|{name} la Conquistatrice|
|$fallenwarrior_title20_m|{name} il Conquistatore|
|$fallenwarrior_title21_f|{name}, la Corteggiatrice della Morte|
|$fallenwarrior_title21_m|{name}, il Corteggiatore della Morte|
|$fallenwarrior_title22_f|{name} la Maledetta|
|$fallenwarrior_title22_m|{name} il Maledetto|
|$fallenwarrior_title23_f|{name} la Pericolosa|
|$fallenwarrior_title23_m|{name} il Pericoloso|
|$fallenwarrior_title24_f|{name} la Portatrice di Morte|
|$fallenwarrior_title24_m|{name} il Portatore di Morte|
|$fallenwarrior_title25_f|{name} l'Ingannatrice|
|$fallenwarrior_title25_m|{name} l'Ingannatore|
|$fallenwarrior_title26_f|{name} l'Esigente|
|$fallenwarrior_title26_m|{name} l'Esigente|
|$fallenwarrior_title27_f|{name} la Dragonessa|
|$fallenwarrior_title27_m|{name} il Dragone|
|$fallenwarrior_title28_f|{name} l'Aquila|
|$fallenwarrior_title28_m|{name} l'Aquila|
|$fallenwarrior_title29_f|{name} l'Esploratrice|
|$fallenwarrior_title29_m|{name} l'Esploratore|
|$fallenwarrior_title3_f|{name} l'Orsa|
|$fallenwarrior_title3_m|{name} l'Orso|
|$fallenwarrior_title30_f|{name} la Temuta|
|$fallenwarrior_title30_m|{name} il Temuto|
|$fallenwarrior_title31_f|{name} la Feroce|
|$fallenwarrior_title31_m|{name} il Feroce|
|$fallenwarrior_title32_f|{name} la Combattente|
|$fallenwarrior_title32_m|{name} il Combattente|
|$fallenwarrior_title33_f|{name} la Dimenticata|
|$fallenwarrior_title33_m|{name} il Dimenticato|
|$fallenwarrior_title34_f|{name} la Generosa|
|$fallenwarrior_title34_m|{name} il Generoso|
|$fallenwarrior_title35_f|{name} l'Avida|
|$fallenwarrior_title35_m|{name} l'Avido|
|$fallenwarrior_title36_f|{name} la Sinistra|
|$fallenwarrior_title36_m|{name} il Sinistro|
|$fallenwarrior_title37_f|{name} la Tormentatrice|
|$fallenwarrior_title37_m|{name} il Tormentatore|
|$fallenwarrior_title38_f|{name} la Kingmaker|
|$fallenwarrior_title38_m|{name} il Kingmaker|
|$fallenwarrior_title39_f|{name} la Sapiente|
|$fallenwarrior_title39_m|{name} il Sapiente|
|$fallenwarrior_title4_f|{name} la Maltrattata|
|$fallenwarrior_title4_m|{name} il Maltrattato|
|$fallenwarrior_title40_f|{name} la Leggendaria|
|$fallenwarrior_title40_m|{name} il Leggendario|
|$fallenwarrior_title41_f|{name} la Ripugnante|
|$fallenwarrior_title41_m|{name} il Ripugnante|
|$fallenwarrior_title42_f|{name} la Solitaria|
|$fallenwarrior_title42_m|{name} il Solitario|
|$fallenwarrior_title43_f|{name} la Perduta|
|$fallenwarrior_title43_m|{name} il Perduto|
|$fallenwarrior_title44_f|{name} la Leale|
|$fallenwarrior_title44_m|{name} il Leale|
|$fallenwarrior_title45_f|{name} la Fortunata|
|$fallenwarrior_title45_m|{name} il Fortunato|
|$fallenwarrior_title46_f|{name} la Segnata|
|$fallenwarrior_title46_m|{name} il Segnato|
|$fallenwarrior_title47_f|{name} la Potente|
|$fallenwarrior_title47_m|{name} il Potente|
|$fallenwarrior_title48_f|{name} la Camminamonti|
|$fallenwarrior_title48_m|{name} il Camminamonti|
|$fallenwarrior_title49_f|{name} la Misteriosa|
|$fallenwarrior_title49_m|{name} il Misterioso|
|$fallenwarrior_title5_f|{name} la Bella|
|$fallenwarrior_title5_m|{name} il Bello|
|$fallenwarrior_title50_f|{name} l'Antica|
|$fallenwarrior_title50_m|{name} l'Antico|
|$fallenwarrior_title51_f|{name} la Predatrice|
|$fallenwarrior_title51_m|{name} il Predatore|
|$fallenwarrior_title52_f|{name} l'Orgogliosa|
|$fallenwarrior_title52_m|{name} l'Orgoglioso|
|$fallenwarrior_title53_f|{name} la Veloce|
|$fallenwarrior_title53_m|{name} il Veloce|
|$fallenwarrior_title54_f|{name} la Predona|
|$fallenwarrior_title54_m|{name} il Predone|
|$fallenwarrior_title55_f|{name} la Devastatrice|
|$fallenwarrior_title55_m|{name} il Devastatore|
|$fallenwarrior_title56_f|{name} la Cornacchia|
|$fallenwarrior_title56_m|{name} il Corvo|
|$fallenwarrior_title57_f|{name} la Ricostruttrice|
|$fallenwarrior_title57_m|{name} il Ricostruttore|
|$fallenwarrior_title58_f|{name} la Rossa|
|$fallenwarrior_title58_m|{name} il Rosso|
|$fallenwarrior_title59_f|{name} la Festaiola|
|$fallenwarrior_title59_m|{name} il Festaiolo|
|$fallenwarrior_title6_f|{name} la Berserker|
|$fallenwarrior_title6_m|{name} il Berserker|
|$fallenwarrior_title60_f|{name} la Ricca|
|$fallenwarrior_title60_m|{name} il Ricco|
|$fallenwarrior_title61_f|{name} la Sovrana|
|$fallenwarrior_title61_m|{name} il Sovrano|
|$fallenwarrior_title62_f|{name} la Sfregiata|
|$fallenwarrior_title62_m|{name} lo Sfregiato|
|$fallenwarrior_title63_f|{name} la Marinaia|
|$fallenwarrior_title63_m|{name} il Marinaio|
|$fallenwarrior_title64_f|{name} la Cercatrice di gloria|
|$fallenwarrior_title64_m|{name} il Cercatore di gloria|
|$fallenwarrior_title65_f|{name} la Mercenaria|
|$fallenwarrior_title65_m|{name} il Mercenario|
|$fallenwarrior_title66_f|{name} l'Ombra|
|$fallenwarrior_title66_m|{name} l'Ombra|
|$fallenwarrior_title67_f|{name} l'Acuta|
|$fallenwarrior_title67_m|{name} l'Acuto|
|$fallenwarrior_title68_f|{name} la Costruttrice di Navi|
|$fallenwarrior_title68_m|{name} il Costruttore di Navi|
|$fallenwarrior_title69_f|{name} la Naufraga|
|$fallenwarrior_title69_m|{name} il Naufrago|
|$fallenwarrior_title7_f|{name} l'Assetata di Sangue|
|$fallenwarrior_title7_m|{name} l'Assetato di Sangue|
|$fallenwarrior_title70_f|{name} Lingua d'Argento|
|$fallenwarrior_title70_m|{name} Lingua d'Argento|
|$fallenwarrior_title71_f|{name} la Skald|
|$fallenwarrior_title71_m|{name} lo Skald|
|$fallenwarrior_title72_f|{name} la Massacratrice|
|$fallenwarrior_title72_m|{name} il Massacratore|
|$fallenwarrior_title73_f|{name} la Cacciatrice|
|$fallenwarrior_title73_m|{name} il Cacciatore|
|$fallenwarrior_title74_f|{name} la Soldatessa|
|$fallenwarrior_title74_m|{name} il Soldato|
|$fallenwarrior_title75_f|{name} la Solenne|
|$fallenwarrior_title75_m|{name} il Solenne|
|$fallenwarrior_title76_f|{name} la Maligna|
|$fallenwarrior_title76_m|{name} il Maligno|
|$fallenwarrior_title77_f|{name} la Severa|
|$fallenwarrior_title77_m|{name} il Severo|
|$fallenwarrior_title78_f|{name} la Stoica|
|$fallenwarrior_title78_m|{name} lo Stoico|
|$fallenwarrior_title79_f|{name} la Figlia della Tempesta|
|$fallenwarrior_title79_m|{name} il Figlio della Tempesta|
|$fallenwarrior_title8_f|{name} la Sanguinaria|
|$fallenwarrior_title8_m|{name} il Sanguinario|
|$fallenwarrior_title80_f|{name} la Strana|
|$fallenwarrior_title80_m|{name} lo Strano|
|$fallenwarrior_title81_f|{name} la Forte|
|$fallenwarrior_title81_m|{name} il Forte|
|$fallenwarrior_title82_f|{name} la Cantastorie|
|$fallenwarrior_title82_m|{name} il Cantastorie|
|$fallenwarrior_title83_f|{name} la Viaggiatrice|
|$fallenwarrior_title83_m|{name} il Viaggiatore|
|$fallenwarrior_title84_f|{name} l’Imbrogliona|
|$fallenwarrior_title84_m|{name} l’Imbroglione|
|$fallenwarrior_title85_f|{name} la Vera|
|$fallenwarrior_title85_m|{name} il Vero|
|$fallenwarrior_title86_f|{name} l'Imbattuta|
|$fallenwarrior_title86_m|{name} l'Imbattuto|
|$fallenwarrior_title87_f|{name} la Perdente|
|$fallenwarrior_title87_m|{name} il Perdente|
|$fallenwarrior_title88_f|{name} l'Immortale|
|$fallenwarrior_title88_m|{name} l'Immortale|
|$fallenwarrior_title89_f|{name} l'Unificatrice|
|$fallenwarrior_title89_m|{name} l'Unificatore|
|$fallenwarrior_title9_f|{name} l'Audace|
|$fallenwarrior_title9_m|{name} l'Audace|
|$fallenwarrior_title90_f|{name} l'Impassibile|
|$fallenwarrior_title90_m|{name} l'Impassibile|
|$fallenwarrior_title91_f|{name} la Vagabonda|
|$fallenwarrior_title91_m|{name} il Vagabondo|
|$fallenwarrior_title92_f|{name} l'Annientatrice|
|$fallenwarrior_title92_m|{name} l'Annientatore|
|$fallenwarrior_title93_f|{name} la Vincitrice|
|$fallenwarrior_title93_m|{name} il Vincitore|
|$fallenwarrior_title94_f|{name} la Violenta|
|$fallenwarrior_title94_m|{name} il Violento|
|$fallenwarrior_title95_f|{name} la Vipera|
|$fallenwarrior_title95_m|{name} la Vipera|
|$fallenwarrior_title96_f|{name} la Girovaga|
|$fallenwarrior_title96_m|{name} il Girovago|
|$fallenwarrior_title97_f|{name} la Vigile|
|$fallenwarrior_title97_m|{name} il Vigile|
|$fallenwarrior_title98_f|{name} la Selvaggia|
|$fallenwarrior_title98_m|{name} il Selvaggio|
|$fallenwarrior_title99_f|{name} la Saggia|
|$fallenwarrior_title99_m|{name} il Saggio|
|$feedback_bug|Bug|
...
|$fimbulvinterorb|Sfera di Fimbulvinter|
|$fimbulvinterorb_destroyed|I Jotun si ritirano|
|$fimbulvinterorb_start|I Jotun avanzano|
...
|$hover_memorialstone|Memoriale degli antenati|
|$hud_addfavorite|Aggiungi ai preferiti|
|$hud_addfavoritecategory|Aggiungi categoria...|
|$hud_addfavoritecategory_popupheader|Aggiungi categoria|
|$hud_addfavoritecategory_popuptext|Inserisci il nome della categoria:|
|$hud_addpin|Aggiungi punto|
|$hud_all|Mostra tutto|
...
|$hud_bymaterial|Per materiale|
|$hud_byusage|Per utilizzo|
|$hud_categories|Categorie|
|$hud_category|Categoria|
|$hud_changeorientation|Cambiare orientamento|
|$hud_copypiece|Copia|
|$hud_crafting|Lavorazione|
|$hud_crossoffpin|Segnalino di spunta|
|$hud_cyclesnap|Passa in rassegna i punti di aggancio|
|$hud_deletecategory|Elimina categoria|
|$hud_eitrrequired|Eitr necessari|
|$hud_emotes_blowkiss|Manda un bacio|
|$hud_emotes_bow|Inchinati|
|$hud_emotes_challenge|Sfida|
|$hud_emotes_cheer|Fai il tifo|
|$hud_emotes_comehere|Vieni qui|
|$hud_emotes_cower|Rannicchiati|
|$hud_emotes_cry|Piangi|
|$hud_emotes_dance|Balla|
|$hud_emotes_despair|Disperati|
|$hud_emotes_flex|Mostra i muscoli|
|$hud_emotes_headbang|Sbatti la testa|
|$hud_emotes_kneel|Inginocchiati|
|$hud_emotes_laugh|Ridi|
|$hud_emotes_loveyou|Ti voglio bene|
|$hud_emotes_nonono|No no no|
|$hud_emotes_point|Indica|
|$hud_emotes_relax|Rilassati|
|$hud_emotes_rest|Riposa|
|$hud_emotes_roar|Ruggisci|
|$hud_emotes_shrug|Alza le spalle|
|$hud_emotes_sit|Siediti|
|$hud_emotes_thumbsup|Pollice in su|
|$hud_emotes_toast|Brinda|
|$hud_emotes_vibe|Balletto|
|$hud_emotes_wave|Saluta|
|$hud_equipping|Equipaggiamento|
|$hud_extrainvslot1|Tasche più capienti|
|$hud_extrainvslot1_tooltip|Una pratica tasca da cintura dove riporre i tuoi oggetti.|
|$hud_extrainvslot2|Tasche più profonde|
|$hud_extrainvslot2_tooltip|Un pratico marsupio per riporre i tuoi oggetti.|
|$hud_favorites|Preferiti|
|$hud_feasts|Banchetti|
|$hud_food|Cibo|
|$hud_furniture|Arredo|
|$hud_hidden_messagehud_notification|Interfaccia disattivata. Per attivarla, premi Ctrl + F3|
|$hud_hidden_messagehud_notification_gamepad|Interfaccia disattivata. Per attivarla, premi|
...
|$hud_mapday|Giorno|
|$hud_materials|Materiali|
|$hud_maxsummonsreached|Il tuo Anima-defunti non è abbastanza forte da controllare ulteriori evocazioni.|
|$hud_maxsummonsreached_greenroots|Il tuo Bastone della Natura Selvaggia non è abbastanza forte da controllare ulteriori evocazioni.|
|$hud_maxsummonsreached_spiritcaller|Il tuo Evocatore di spiriti non è abbastanza potente per controllare altre evocazioni|
|$hud_maxsummonsreached_trollstav|Il tuo Trollstav non è abbastanza forte da controllare ulteriori evocazioni.|
|$hud_meads|Idromele|
|$hud_misc|Varie|
|$hud_namepin|Nomina|
...
|$hud_on|Attivo|
|$hud_pet|Coccola|
|$hud_pin_dnboss|Passaggio degli Aesir|
...
|$invalid_keybind_header|Input non valido|
|$invalid_keybind_text|Questa azione non può essere associata al tasto selezionato|
|$inventory_achievement_secret|Nascosti|
|$inventory_achievement_secret_description|Solo Odino sa cosa si nasconde qui.|
|$inventory_achievements|Imprese|
...
|$inventory_needspace|Ti serve più spazio nell'inventario|
...
|$inventory_slightlyresistant|Leggermente resistente|
|$inventory_slightlyweak|Leggermente debole|
...
|$inventory_stats|Statistiche del giocatore|
...
|$inventory_upgraderbutton|Tenta la raffinazione|
|$inventory_upgraderwarning|Massima qualità in tutta sicurezza. La raffinazione potrebbe danneggiare il tuo articolo.|
...
|$item_ancientcoin|Moneta antica|
|$item_ancientcoin_description|Una reliquia di un'epoca passata. La sua superficie porta ancora le tracce di simboli misteriosi.|
|$item_ancientgemstone_black|Draumyx|
|$item_ancientgemstone_black_description|Una gemma scura e opaca con una superficie liscia e levigata.|
|$item_ancientgemstone_green|Grimvarn|
|$item_ancientgemstone_green_description|Una splendida gemma verde, il cui colore ricorda le foreste più fitte.|
|$item_ancientgemstone_orange|Solryth|
|$item_ancientgemstone_orange_description|Una pietra di un arancione vivace, come un tramonto estivo.|
|$item_ancientgemstone_purple|Veydris|
|$item_ancientgemstone_purple_description|Una pietra dal colore viola intenso, degna di un re.|
...
|$item_armor|Armatura|
|$item_arrow_bloodgold|Freccia di Orosangue|
|$item_arrow_bloodgold_description|Una freccia forgiata forse con i materiali più duri al mondo...|
...
|$item_atgeir_gold|Atgeir del nord|
|$item_atgeir_gold_bloodlightning|Atgeir di Sangue tonante|
|$item_atgeir_gold_bloodlightning_description|I cieli intoneranno le loro lodi mentre tu farai sanguinare i tuoi nemici.|
|$item_atgeir_gold_bloodlightning_uncooked|Colata: Atgeir di Sangue tonante|
|$item_atgeir_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_atgeir_gold_description|Il filo di quest'arma è tanto letale quanto lucente.|
|$item_atgeir_gold_frostfire|Atgeir di Fuocoghiaccio|
|$item_atgeir_gold_frostfire_description|Che le fiamme inizino a divorare, mentre il ghiaccio si impossessa di ciò che resta.|
|$item_atgeir_gold_frostfire_uncooked|Colata: Atgeir di Fuocoghiaccio|
|$item_atgeir_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_atgeir_gold_uncooked|Colata: Atgeir del nord|
|$item_atgeir_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_atgeir_wood|Atgeir di legno|
|$item_atgeir_wood_description|Non farà molto male, ma ha una lunga gittata!|
...
|$item_axe_early|Asce anticipate|
|$item_axe_early_description|Armi potenti di tanto tempo fa, di un'epoca in cui il mondo era ancora giovane e incompleto...|
|$item_axe_flint|Ascia di selce|
|$item_axe_flint_description|Più affilata della pietra.|
|$item_axe_gold|Ascia del nord|
|$item_axe_gold_bloodlightning|Ascia di Sangue tonante|
|$item_axe_gold_bloodlightning_description|Mentre questa ascia fende sia il legno che il sangue, un fragore possente risuonerà in tutta la terra.|
|$item_axe_gold_bloodlightning_uncooked|Colata: Ascia di Sangue tonante|
|$item_axe_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_axe_gold_description|Un'ascia finemente lavorata, per abbattere con grande precisione i tuoi nemici.|
|$item_axe_gold_frostfire|Ascia di Fuocoghiaccio|
|$item_axe_gold_frostfire_description|Riduci tutto in cenere, oppure congelalo in un eterno istante di distruzione...|
|$item_axe_gold_frostfire_uncooked|Colata: Ascia di Fuocoghiaccio|
|$item_axe_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_axe_gold_uncooked|Colata: Ascia del nord|
|$item_axe_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_axe_wood|Ascia di legno|
|$item_axe_wood_description|Se quest'ascia potesse tagliare il legno, non sarebbe strano?|
|$item_axe2h_gold|Ascia grande del nord|
|$item_axe2h_gold_bloodlightning|Ascia grande di Sangue tonante|
|$item_axe2h_gold_bloodlightning_description|Mentre tagli in due i tuoi nemici, il loro sangue canterà come un temporale.|
|$item_axe2h_gold_bloodlightning_uncooked|Colata: Ascia grande di Sangue tonante|
|$item_axe2h_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_axe2h_gold_description|Un'ascia possente, degna di un grande guerriero.|
|$item_axe2h_gold_frostfire|Ascia grande di Fuocoghiaccio|
|$item_axe2h_gold_frostfire_description|Colpisci i tuoi nemici con un inferno gelido!|
|$item_axe2h_gold_frostfire_uncooked|Colata: Ascia grande di Fuocoghiaccio|
|$item_axe2h_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_axe2h_gold_uncooked|Colata: Ascia grande del nord|
|$item_axe2h_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
|$item_axehead1|Testa d'ascia curiosa|
|$item_axehead1_description|Il metallo brilla in modo strano alla luce del sole. In qualche modo, sai che non potrà mai sentirsi al completo da sola…|
|$item_axehead2|Testa d'ascia misteriosa|
|$item_axehead2_description|A quali battaglie ha assistito quest'arma? Non puoi vedere il suo passato, ma solo plasmare il suo futuro...|
|$item_backstab|Attacco vile|
|$item_bakedpoteitr|Pateitr al forno|
|$item_bakedpoteitr_description|Né bollite, né schiacciate, né in umido. Ma comunque deliziose!|
|$item_bakedpoteitr_uncooked|Pateitr cruda|
|$item_bakedpoteitr_uncooked_description|Pronta per essere infornata.|
|$item_barberkit|Kit da barbiere|
|$item_barberkit_description|Un kit per i migliori barbieri.|
|$item_barkabranch|Ramo ghiacciato|
|$item_barkabranch_description|Questo pezzo di legno un tempo era animato e vivo. Eppure è ancora avvolto da un'aura strana e magica.|
|$item_barley|Orzo|
...
|$item_battleaxe_blackmetal|Ascia da battaglia in metallo nero|
|$item_battleaxe_blackmetal_description|Il verde sarà l'ultima cosa che i tuoi nemici vedranno prima che li taglierai a metà.|
...
|$item_battleaxe_gold_uncooked|Colata: Ascia grande del nord|
|$item_battleaxe_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
|$item_battleaxe_skullsplittur|Scheggiacrani|
|$item_battleaxe_skullsplittur_description|Troverai crani da spaccare anche nelle nebbie della boscaglia.|
|$item_battleaxe_wood|Ascia da battaglia di legno|
|$item_battleaxe_wood_description|Intimidatoria, ma non quanto una vera ascia.|
...
|$item_bjorn_meat|Carne di orso|
|$item_bjorn_meat_cooked|Carne di orso cotta|
|$item_bjorn_meat_cooked_description|Ha il gusto della vittoria.|
|$item_bjorn_meat_description|Questa carne grassa era un tempo destinata a sostentare il corpo durante l'ibernazione.|
|$item_bjornhide|Pelle di orso|
|$item_bjornhide_description|Una pelle spessa e pelosa, resistente ma incredibilmente morbida.|
|$item_bjornpaw|Zampa di orso|
|$item_bjornpaw_description|Artigli affilati adatti alla raccolta di bacche o… allo smembramento.|
...
|$item_blobvial|Fiala con tappo|
|$item_blobvial_description|Abbastanza spessa da contenere qualcosa di volatile, eppure fragile da essere frantumata.|
...
|$item_bloodgoldkey|Chiave intricata|
|$item_bloodgoldkey_description|Se c'è una chiave, allora ci deve essere sicuramente una serratura.|
|$item_bloodpudding|Pudding di sangue|
|$item_bloodpudding_description|Sa di sangue.|
|$item_blubber|Grasso di foca|
|$item_blubber_cooked|Grasso di foca cotto|
|$item_blubber_cooked_description|Una carne gommosa, con un retrogusto di rimorso.|
|$item_blubber_description|Il grasso isolante di un animale adattato alle acque del nord.|
...
|$item_bolt_bloodgold|Dardo di Orosangue|
|$item_bolt_bloodgold_description|Un dardo forgiato forse con i materiali più duri al mondo...|
...
|$item_bomb_dynamite|Carica di braci|
|$item_bomb_dynamite_description|Braci intrappolate, pronte a divampare. Attenzione.|
|$item_bombblob_frost|Bomba blob: gelo|
|$item_bombblob_frost_description|Se la si tiene troppo a lungo, la mano potrebbe congelarsi.|
|$item_bombblob_lava|Bomba blob: lava|
|$item_bombblob_lava_description|La fiala è calda e promette una distruzione infuocata.|
|$item_bombblob_morkhalla|Bomba blob: Pulp|
|$item_bombblob_morkhalla_description|Dungeon dolce dungeon.|
|$item_bombblob_poison|Bomba blob: veleno|
|$item_bombblob_poison_description|Se questa fiala si dovesse rompere, usare la massima cautela.|
|$item_bombblob_poisonelite|Bomba blob: veleno d'élite|
|$item_bombblob_poisonelite_description|Si sconsiglia di inalarne le esalazioni.|
|$item_bombblob_tar|Bomba blob: catrame|
|$item_bombblob_tar_description|La sostanza appiccicosa al suo interno pulsa minacciosamente.|
...
|$item_bow_gold|Arco del nord|
|$item_bow_gold_bloodlightning|Arco di Sangue tonante|
|$item_bow_gold_bloodlightning_description|Il fulmine danza lungo la corda, in attesa di essere liberato.|
|$item_bow_gold_bloodlightning_uncooked|Colata: Arco di Sangue tonante|
|$item_bow_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_bow_gold_description|Questo arco colpirà il bersaglio con precisione impeccabile.|
|$item_bow_gold_frostfire|Arco di Fuocoghiaccio|
|$item_bow_gold_frostfire_description|Mantieni la calma mentre prendi la mira, poi scatena la tua furia con le frecce.|
|$item_bow_gold_frostfire_uncooked|Colata: Arco di Fuocoghiaccio|
|$item_bow_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_bow_gold_uncooked|Colata: Arco del nord|
|$item_bow_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_cape_deepnorth|Tunica in pelle di alce|
|$item_cape_deepnorth_description|Una tunica calda con raffinati dettagli in filo d'oro.|
|$item_cape_deepnorth_mage|Tunica dell'Evocatore|
|$item_cape_deepnorth_mage_description|In questa tunica è racchiusa una strana magia che la rende leggera e calda allo stesso tempo.|
...
|$item_catapult_bloodgold_ammo|Proiettile di Orosangue|
|$item_catapult_bloodgold_ammo_description|Colpiscili forte e falli sanguinare.|
...
|$item_chest_berserker|Marchi dell'orso|
|$item_chest_berserker_description|Se questi disegni intricati riescono a proteggere i guerrieri di terre lontane, possono sicuramente proteggere anche te.|
|$item_chest_berserker_undead|Armatura di ossa dell'orso nefasto|
|$item_chest_berserker_undead_description|Ricavato dalle ossa frantumate di un orso tormentato.|
...
|$item_chest_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_chest_heavy_deepnorth|Pettorale del Protettore|
|$item_chest_heavy_deepnorth_description|Pelle, cuoio e metallo lavorano in sinergia per respingere i colpi del nemico.|
|$item_chest_heavy_gold_uncooked|Colata: Pettorale del Protettore|
|$item_chest_heavy_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_chest_lox|Giacca in pelliccia Lox|
|$item_chest_lox_description|È ancora pervasa da un intenso profumo di muschio.|
...
|$item_chest_mage_deepnorth|Vesti dell'Evocatore|
|$item_chest_mage_deepnorth_description|Abiti bordati d'oro, adatti solo ai maghi più potenti.|
...
|$item_chest_mage_gold_uncooked|Colata: Vesti dell'Evocatore|
|$item_chest_mage_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_chest_medium_deepnorth|Pettorale dell'Avanguardia|
|$item_chest_medium_deepnorth_description|Armatura in pelle realizzata con maestria, che offre un'eccellente protezione senza limitare i movimenti del guerriero.|
|$item_chest_medium_gold_uncooked|Colata: Pettorale dell'Avanguardia|
|$item_chest_medium_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_crossbow_bloodlightning_gold|Balestra di Sangue tonante|
|$item_crossbow_bloodlightning_gold_description|L'arco è teso, carico di una forza repressa, come l'aria prima che cada un fulmine.|
|$item_crossbow_bloodlightning_gold_uncooked|Colata: Balestra di Sangue tonante|
|$item_crossbow_bloodlightning_gold_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_crossbow_frostfire_gold|Balestra di Fuocoghiaccio|
|$item_crossbow_frostfire_gold_description|Se i tuoi nemici non restano fermi mentre prendi la mira, lo faranno sicuramente una volta colpiti.|
|$item_crossbow_frostfire_gold_uncooked|Colata: Balestra di Fuocoghiaccio|
|$item_crossbow_frostfire_gold_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_crossbow_gold|Balestra del nord|
|$item_crossbow_gold_description|In quest'arma è racchiusa una forza incredibile, che attende solo di essere liberata.|
|$item_crossbow_gold_uncooked|Colata: Balestra del nord|
|$item_crossbow_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_crownjewel|Gioiello della corona|
|$item_crownjewel_description|In questa gemma si sprigiona uno strano potere, diverso da qualsiasi cosa tu abbia mai provato prima.|
...
|$item_cultivator_remove_description|Recupera i semi dal terreno, per piantarli in un altro momento.|
...
|$item_ectoplasm_description|Un'essenza inquieta di un essere un tempo vivente…|
...
|$item_eitrhitreturn|Rimborso in eitr|
|$item_eitrregen_modifier|Rigenerazione di eitr|
|$item_eitruse|Usa eitr|
|$item_elakinghairbundle|Ciocche di capelli di Elaking|
|$item_elakinghairbundle_description|La pelliccia è folta, ruvida e sorprendentemente pulita.|
...
|$item_faderember|Braci|
|$item_faderember_description|Ogni scintilla di brace volante è un desiderio ardente di pentirsi.|
...
|$item_feastdeepnorth|Colazione del nord|
|$item_feastdeepnorth_description|Calda e sostanziosa, questa pietanza ti darà la carica anche nelle giornate più fredde. Il porridge e i pancake si sposano alla perfezione con marmellate e salsicce: impossibile resistere alla tentazione di un bis!|
...
|$item_feaster_remove_description|<color=yellow>Una volta consumato un banchetto, smantellarlo non restituirà alcuna risorsa.</color>|
...
|$item_fircone_big|Pigna di legna da costruzione|
|$item_fircone_big_description|Piantalo per far crescere un albero di legna da costruzione.|
...
|$item_fishsoup|Zuppa di pesce|
|$item_fishsoup_description|Un bagno di sapore!|
|$item_fishwraps|Involtini di pesce|
|$item_fishwraps_description|Pesce e pane, cos'altro desiderare?|
|$item_fistweapon_bjorn|Zampe dell'orso|
|$item_fistweapon_bjorn_description|Fatte per strappare e lacerare.|
|$item_fistweapon_bjorn_undead|Artigli orso nefasto|
|$item_fistweapon_bjorn_undead_description|Questi artigli lacerano carne e ossa.|
...
|$item_fistweapon_frostfire_gold|Tirapugni di Fuocoghiaccio|
|$item_fistweapon_frostfire_gold_description|Un leggero rischio di congelamento è inevitabile.|
|$item_fistweapon_frostfire_gold_uncooked|Colata: Tirapugni di Fuocoghiaccio|
|$item_fistweapon_frostfire_gold_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_fistweapon_gold|Tirapugni del nord|
|$item_fistweapon_gold_bloodlightning|Tirapugni di Sangue tonante|
|$item_fistweapon_gold_bloodlightning_description|Mentre combatti con queste armi, ti assale una furia e il sangue ti rimbomba nelle orecchie come un tuono... Sembra appropriato.|
|$item_fistweapon_gold_bloodlightning_uncooked|Colata: Tirapugni di Sangue tonante|
|$item_fistweapon_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_fistweapon_gold_description|Avvolgi i pugni nel metallo più duro che ci sia, affinché i tuoi nemici sentano tutta la potenza dei tuoi colpi.|
|$item_fistweapon_gold_uncooked|Colata: Tirapugni del nord|
|$item_fistweapon_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_frostcore|Nucleo di gelo|
|$item_frostcore_description|Terribilmente freddo al tatto, pieno di energia congelata.|
|$item_frostorbs_uncooked|Colata: Vendetta del nord|
|$item_frostorbs_uncooked_description|Questo oggetto magico deve essere temprato con il gelo.|
|$item_frostwood|Legna da costruzione|
|$item_frostwood_description|Un tipo di legno robusto, perfetto per sale imponenti.|
|$item_frozenfuel|Ghiaccio liquido|
|$item_frozenfuel_description|La magia ha pervaso questo ghiaccio, trasformandolo in qualcosa di completamente diverso.|
|$item_frozenking_drop|Sangue sacrificale|
|$item_frozenking_drop_description|L'ultima traccia di una fine predetta da tempo.|
|$item_fryslingcore|Nucleo Frysling|
|$item_fryslingcore_description|Un gelo insopportabile scintilla al suo interno.|
|$item_fulladrenaline|Effetto dell'adrenalina|
...
|$item_glowworm_description|Viscida, ma saziante.|
|$item_goblintotem|Totem dei Fuling|
|$item_goblintotem_description|Canalizza l'antico potere di Yagluth.|
|$item_gold|Orosangue|
|$item_gold_description|Un metallo prezioso, intriso dell'essenza di un essere vivente.|
|$item_goldore|Tessuto pietrificato|
|$item_goldore_description|Un materiale duro e resistente con un grande potenziale. Deve essere lavorato in un altoforno.|
|$item_graplinghook|Gancio da arrampicata|
|$item_graplinghook_description|Per un ingresso in scena di grande effetto o una fuga veloce.|
...
|$item_hardrock|Roccia misteriosa|
|$item_hardrock_description|È solo un sasso...|
|$item_hardrock_knowledge1|Non temere la morte, poiché l'ora del tuo destino è già stabilita e nessuno può sfuggirle.|
|$item_hardrock_knowledge10|Puoi stare tranquillo quanto vuoi, ma un giorno qualcuno ti troverà.|
|$item_hardrock_knowledge11|Per quante sofferenze tu abbia dovuto sopportare, non vorrai mai dimenticare quei ricordi.|
|$item_hardrock_knowledge12|Quando ne uscirai, non sarai più la stessa persona che ci è entrata. È proprio questo il senso della tempesta.|
|$item_hardrock_knowledge13|Una roccia non prova dolore, e un'isola non piange mai.|
|$item_hardrock_knowledge2|Meglio combattere e cadere che vivere senza speranza.|
|$item_hardrock_knowledge3|Troverai delle rune, e le saprai interpretare correttamente: rune dal significato profondo e dalla potente magia.|
|$item_hardrock_knowledge4|L'uomo non può scoprire nuovi oceani se non ha il coraggio di perdere di vista la riva.|
|$item_hardrock_knowledge5|Chi ha un motivo per vivere può sopportare quasi qualsiasi cosa.|
|$item_hardrock_knowledge6|La ferita è il punto da cui la luce entra in te.|
|$item_hardrock_knowledge7|Soffriamo di più nell'immaginazione che nella realtà.|
|$item_hardrock_knowledge8|Il dolore è inevitabile. La sofferenza è una scelta.|
|$item_hardrock_knowledge9|Qualunque cosa tu stia cercando, non la troverai nella forma che ti aspetti.|
...
|$item_hatefulblood|Sangue maligno|
|$item_hatefulbood_description|C'è qualcosa d'inquietante in questa massa compatta e congelata.|
|$item_healthhitreturn|Salute ripristinata quando colpisci|
|$item_healthuse|Usa salute|
|$item_heat_modifier|Resistenza al calore|
|$item_helmet_berserker|Copricapo dell'orso|
|$item_helmet_berserker_description|Lascia che la rabbia primordiale di un orso possente ti consumi.|
|$item_helmet_berserker_undead|Mascella orso nefasto|
|$item_helmet_berserker_undead_description|Quando viene indossato, incute timore ai nemici e coraggio agli amici.|
...
|$item_helmet_celebration|Cappellino celebrativo|
|$item_helmet_celebration_description|Non puoi fare a meno di sentirti felice quando indossi questo cappellino!|
|$item_helmet_crown_of_valheim|Corona di Valheim|
|$item_helmet_crown_of_valheim_description|Una ricompensa gloriosa per chi ne è davvero degno.|
...
|$item_helmet_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_helmet_heavy_deepnorth|Elmo del Protettore|
|$item_helmet_heavy_deepnorth_description|Impreziosito dalle ali della vittoria.|
|$item_helmet_heavy_gold_uncooked|Colata: Elmo del Protettore|
|$item_helmet_heavy_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_helmet_lox|Cappuccio in pelliccia Lox|
|$item_helmet_lox_description|Guarda il mondo con gli occhi di un Lox.|
...
|$item_helmet_mage_deepnorth|Copricapo dell'Evocatore|
|$item_helmet_mage_deepnorth_description|Gli spiriti della terra accorrono quando li chiami. Si lasceranno ingannare dal tuo travestimento?|
...
|$item_helmet_mage_gold_uncooked|Colata: Copricapo dell'Evocatore|
|$item_helmet_mage_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_helmet_medium_deepnorth|Cappuccio dell'Avanguardia|
|$item_helmet_medium_deepnorth_description|Qualcosa per proteggere il collo dalle intemperie e dai denti affilati del nemico.|
|$item_helmet_medium_gold_uncooked|Colata: Cappuccio dell'Avanguardia|
|$item_helmet_medium_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_helmet_rootcrown|Corona di radici|
|$item_helmet_rootcrown_description|Un copricapo doloroso, ma allo stesso tempo intricato.|
|$item_helmet_strawhat|Cappello di paglia|
|$item_helmet_strawhat_description|Il modo migliore per evitare insolazioni.|
|$item_helmet_sweatband|Fascia per capelli|
|$item_helmet_sweatband_description|È un po'… umida.|
...
|$item_hook|Gancio|
|$item_hook_description|Un oggetto di pregiata fattura, con un grande potenziale per agganciarsi.|
|$item_ice|Ghiaccio|
|$item_ice_description|Freddissimo...|
|$item_iron|Ferro|
...
|$item_jotunpuffs_description|Un fungo dal sapore rinvigorente, ideale per cucinare.|
...
|$item_kale|Cavolo riccio|
|$item_kale_description|Una verdura a foglia verde molto versatile.|
|$item_kalechips|Chip di cavolo riccio|
|$item_kalechips_description|Verdure croccanti!|
|$item_kalechips_uncooked|Chips di cavolo riccio crudo|
|$item_kalechips_uncooked_description|Pronte per essere infornate.|
|$item_kaleseeds|Semi di cavolo riccio|
|$item_kaleseeds_description|Pianta per far crescere del cavolo riccio.|
|$item_keys_gold_uncooked|Colata: Chiave intricata|
|$item_keys_gold_uncooked_description|Queste chiavi devono essere temprate con il gelo.|
...
|$item_knife_gold|Pugnale del nord|
|$item_knife_gold_bloodlightning|Pugnale di Sangue tonante|
|$item_knife_gold_bloodlightning_description|La lama è già insanguinata, eppure brama altro sangue.|
|$item_knife_gold_bloodlightning_uncooked|Colata: Pugnale di Sangue tonante|
|$item_knife_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_knife_gold_description|Un lampo dorato sarà l'ultima cosa che vedranno i tuoi nemici.|
|$item_knife_gold_frostfire|Pugnale di Fuocoghiaccio|
|$item_knife_gold_frostfire_description|Un taglio inflitto da questa lama punge come il ghiaccio, poi brucia come una fiamma.|
|$item_knife_gold_frostfire_uncooked|Colata: Pugnale di Fuocoghiaccio|
|$item_knife_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_knife_gold_uncooked|Colata: Pugnale del nord|
|$item_knife_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_knife_void_description|Chi risponderà al richiamo del Vuoto?|
|$item_knife_wood|Coltello di legno|
|$item_knife_wood_description|Alcuni sostengono che questo coltello sia utile solo per spalmare burro.|
...
|$item_lanternDN|Lanterna recuperata|
|$item_lanternDN_description|Un antico cimelio, lasciato cadere e dimenticato da qualcuno scomparso da tempo.|
...
|$item_leatherstraps|Cinturini in cuoio|
|$item_leatherstraps_description|Un materiale resistente ma flessibile.|
|$item_legs_berserker|Panno dell'orso|
|$item_legs_berserker_description|Copre le parti più intime… ma niente più.|
|$item_legs_berserker_undead|Gonnella orso nefasto|
|$item_legs_berserker_undead_description|Pelli spesse e frammenti di ossa intrecciati in una gonnella robusta.|
...
|$item_legs_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
|$item_legs_heavy_deepnorth|Pantaloni del Protettore|
|$item_legs_heavy_deepnorth_description|Stivali e pantaloni pesanti, per tenerti al caldo mentre arranchi nella neve alta.|
|$item_legs_heavy_gold_uncooked|Colata: Pantaloni del Protettore|
|$item_legs_heavy_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_legs_lox|Pantaloni in pelliccia Lox|
|$item_legs_lox_description|Morbidi, silenziosi e flessibili.|
...
|$item_legs_mage_deepnorth|Pantaloni dell'Evocatore|
|$item_legs_mage_deepnorth_description|Calzari aderenti per impedire al freddo di raggiungere la pelle.|
...
|$item_legs_mage_gold_uncooked|Colata: Pantaloni dell'Evocatore|
|$item_legs_mage_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_legs_medium_deepnorth|Pantaloni dell'Avanguardia|
|$item_legs_medium_deepnorth_description|Pantaloni caldi adatti al freddo. Gli stivali garantiscono un'ottima aderenza sui terreni ghiacciati.|
|$item_legs_medium_gold_uncooked|Colata: Pantaloni dell'Avanguardia|
|$item_legs_medium_gold_uncooked_description|Questa armatura deve essere temprata con il gelo.|
...
|$item_lingonberries|Mirtilli rossi|
|$item_lingonberries_description|Queste bacche dal sapore aspro possono crescere anche nei climi freddi.|
|$item_lingondricka|Succo di mirtillo rosso|
|$item_lingondricka_description|Si abbina bene alla maggior parte dei piatti.|
...
|$item_mace_gold|Mazza del nord|
|$item_mace_gold_bloodlightning|Mazza di Sangue tonante|
|$item_mace_gold_bloodlightning_description|Un'arma in grado di rivaleggiare forse persino con quella dello stesso dio del tuono...|
|$item_mace_gold_bloodlightning_uncooked|Colata: Mazza di Sangue tonante|
|$item_mace_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_mace_gold_description|Colpisci con forza e rapidità, senza lasciare al tuo avversario il tempo di riprendersi.|
|$item_mace_gold_frostfire|Mazza di Fuocoghiaccio|
|$item_mace_gold_frostfire_description|Sono scintille quelle che schizzano quando quest'arma colpisce il bersaglio, o sono schegge di ghiaccio?|
|$item_mace_gold_frostfire_uncooked|Colata: Mazza di Fuocoghiaccio|
|$item_mace_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_mace_gold_uncooked|Colata: Mazza del nord|
|$item_mace_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_mace_wood|Mazza di legno|
|$item_mace_wood_description|C'è da chiedersi perché qualcuno abbia realizzato questa mazza invece di usare un semplice bastone.|
|$item_mace2h_gold|Mazzuolo del nord|
|$item_mace2h_gold_bloodlightning|Mazzuolo di Sangue tonante|
|$item_mace2h_gold_bloodlightning_description|Quando quest'arma colpirà nel segno, il suo fragore risuonerà in tutto il mondo...|
|$item_mace2h_gold_bloodlightning_uncooked|Colata: Mazzuolo di Sangue tonante|
|$item_mace2h_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_mace2h_gold_description|Con quest'arma, i tuoi colpi saranno potenti come quelli di un troll.|
|$item_mace2h_gold_frostfire|Mazzuolo di Fuocoghiaccio|
|$item_mace2h_gold_frostfire_description|È così freddo da bruciare, o è così ardente che congela?|
|$item_mace2h_gold_frostfire_uncooked|Colata: Mazzuolo di Fuocoghiaccio|
|$item_mace2h_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_mace2h_gold_uncooked|Colata: Mazzuolo del nord|
|$item_mace2h_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
|$item_magecap|Copricapo del mago|
|$item_magecap_description|Un fungo comunemente utilizzato nella dieta di uno stregone.|
...
|$item_meatballsmashedpoteitr|Polpette e pateitr|
|$item_meatballsmashedpoteitr_description|Non c'è niente di più iconico di questo!|
...
|$item_memorialcoal|Carbone commemorativo|
|$item_memorialcoal_description|Da qualche parte, nel profondo di quel bagliore caldo e sfocato, sembra quasi di vedere un vecchio ricordo che prende vita...|
...
|$item_mold_armor_gold_chest|Stampo: Pettorale del Protettore|
|$item_mold_armor_gold_chest_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_gold_helmet|Stampo: Elmo del Protettore|
|$item_mold_armor_gold_helmet_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_gold_legs|Stampo: Pantaloni del Protettore|
|$item_mold_armor_gold_legs_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_mage_chest|Stampo: Vesti dell'Evocatore|
|$item_mold_armor_mage_chest_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_mage_helmet|Stampo: Copricapo dell'Evocatore|
|$item_mold_armor_mage_helmet_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_mage_legs|Stampo: Pantaloni dell'Evocatore|
|$item_mold_armor_mage_legs_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_medium_chest|Stampo: Pettorale dell'Avanguardia|
|$item_mold_armor_medium_chest_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_medium_helmet|Stampo: Cappuccio dell'Avanguardia|
|$item_mold_armor_medium_helmet_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_armor_medium_legs|Stampo: Pantaloni dell'Avanguardia|
|$item_mold_armor_medium_legs_description|Se riempito con il materiale giusto, questo stampo darà vita a un pezzo d'armatura davvero formidabile.|
|$item_mold_atgeir|Stampo: Atgeir del nord|
|$item_mold_atgeir_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_axe|Stampo: Ascia del nord|
|$item_mold_axe_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_axe2h|Modello: Ascia grande del nord|
|$item_mold_axe2h_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_bow|Stampo: Arco del nord|
|$item_mold_bow_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_crossbow|Stampo: Balestra del nord|
|$item_mold_crossbow_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_fistweapon|Stampo: Tirapugni del nord|
|$item_mold_fistweapon_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_keys|Stampo: Chiave intricata|
|$item_mold_keys_description|Se riempito con il materiale giusto, questo stampo darà vita a una chiave veramente potente.|
|$item_mold_knife|Stampo: Pugnale del nord|
|$item_mold_knife_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_mace|Stampo: Mazza del nord|
|$item_mold_mace_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_mace2h|Stampo: Mazzuolo del nord|
|$item_mold_mace2h_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_shield_buckler|Stampo: Brocchiero del nord|
|$item_mold_shield_buckler_description|Se riempito con il materiale giusto, questo stampo darà vita a uno scudo molto resistente.|
|$item_mold_shield_round|Stampo: Scudo del nord|
|$item_mold_shield_round_description|Se riempito con il materiale giusto, questo stampo darà vita a uno scudo molto resistente.|
|$item_mold_shield_tower|Stampo: Grande scudo del nord|
|$item_mold_shield_tower_description|Se riempito con il materiale giusto, questo stampo darà vita a uno scudo molto resistente.|
|$item_mold_spear|Stampo: Lancia del nord|
|$item_mold_spear_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_stafffrostorbs|Stampo: Vendetta del nord|
|$item_mold_stafffrostorbs_description|Se riempito con il materiale giusto, questo stampo darà vita a un oggetto magico potente.|
|$item_mold_stafforbofahri|Stampo: Spuntone dell'eco|
|$item_mold_stafforbofahri_description|Se riempito con il materiale giusto, questo stampo darà vita a un oggetto magico potente.|
|$item_mold_staffspiritcaller|Stampo: Bastone evoca spiriti|
|$item_mold_staffspiritcaller_description|Se riempito con il materiale giusto, questo stampo darà vita a un oggetto magico potente.|
|$item_mold_staffthunderblood|Stampo: Bastone dei fulmini|
|$item_mold_staffthunderblood_description|Se riempito con il materiale giusto, questo stampo darà vita a un oggetto magico potente.|
|$item_mold_sword|Stampo: Spada del nord|
|$item_mold_sword_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_mold_sword2h|Stampo: Spadone del nord|
|$item_mold_sword2h_description|Se riempito con il materiale giusto, questo stampo darà vita a un'arma davvero formidabile.|
|$item_moleclaws|Artigli lunghi|
|$item_moleclaws_description|Un'arma letale, se riesci a tenerla in mano senza ferirti.|
...
|$item_moose_meat|Carne di alce|
|$item_moose_meat_cooked|Carne di alce cotta|
|$item_moose_meat_cooked_description|Questa carne è magra ma ricca di sapore.|
|$item_moose_meat_description|Una volta cucinata, questa carne garantirà sicuramente un pasto sostanzioso.|
|$item_moosehide|Pelle di alce|
|$item_moosehide_description|Questa pelliccia è perfettamente adatta ai climi nordici.|
|$item_moosekebab|Carne nel pane|
|$item_moosekebab_description|Un pasto pratico, spesso preferito dai mercanti in viaggio.|
|$item_moosesinew|Tendine di alce|
|$item_moosesinew_description|Robusto e resistente, ti tornerà sicuramente utile.|
...
|$item_nornthread|Fil di Norna|
|$item_nornthread_description|Non lasciarti ingannare dalla loro apparente delicatezza. Questi fili sono stati filati dalla forza stessa dell'Albero del Mondo.|
...
|$item_oat|Avena|
|$item_oat_description|Grani gustosi, da consumare così o da macinare per ottenere la farina.|
|$item_oatflour|Farina d'avena|
|$item_oatflour_description|Avena macinata finemente, con un grande potenziale.|
|$item_oatmeallingonberryjam|Fiocchi d'avena|
|$item_oatmeallingonberryjam_description|Servito con una porzione abbondante di marmellata di mirtilli rossi.|
|$item_oatmilk|Latte d'avena|
|$item_oatmilk_description|Ha il sapore dell'innovazione.|
|$item_oatseeds|Semi di avena|
|$item_oatseeds_description|Macinali nel mulino per ottenere fiocchi d’avena, oppure piantali per ottenere altri semi.|
...
|$item_ooze_mork|Pulp morto|
|$item_ooze_mork_description|Meglio non pensare da cosa sia fatto.|
|$item_oozebomb|Bomba di melma|
|$item_oozebomb_description|Il fetore è insopportabile ...|
|$item_orbfrostfire|Essenza di Fuocoghiaccio|
|$item_orbfrostfire_description|Sembra caldo e freddo al tempo stesso.|
|$item_orbthunderblood|Essenza di Sangue tonante|
|$item_orbthunderblood_description|Instabile, imprevedibile e... viva?|
|$item_ovenpancake|Pancake al forno|
|$item_ovenpancake_description|Caldo e soffice.|
|$item_ovenpancake_uncooked|Pastella per pancake|
|$item_ovenpancake_uncooked_description|Pronta per essere infornata.|
|$item_pancakes|Pancake|
|$item_pancakes_description|Esiste forse un cibo più squisito?|
|$item_parryadrenaline|Adrenalina da parata|
...
|$item_poteitr|Pateitr|
|$item_poteitr_description|Le possibilità sono praticamente infinite. Chi non vorrebbe provarne una?|
|$item_poteitrseeds|Semi di Pateitr|
|$item_poteitrseeds_description|Pianta per far crescere delle Pateitr.|
...
|$item_pulledbear|Carne d'orso sfilacciata|
|$item_pulledbear_description|Carne tenerissima cotta per ore e ore, fino a quando non si sfalda praticamente da sola.|
...
|$item_saddlemoose|Sella per alce|
|$item_saddlemoose_description|L'alce è un animale maestoso, ma con una sella così bella potrebbe lasciarsi cavalcare anche da un cavaliere.|
|$item_salad|Insalata|
...
|$item_sealhide|Pelliccia di foca|
|$item_sealhide_description|Il folto pelo aiuta l'animale a stare al caldo e all'asciutto.|
|$item_sealsoup|Zuppa di carne di foca|
|$item_sealsoup_description|Un piatto caldo e gustoso, perfetto da gustare in una giornata fredda.|
...
|$item_shield_buckler_gold_uncooked|Colata: Brocchiero del nord|
|$item_shield_buckler_gold_uncooked_description|Questo scudo deve essere temprato con il gelo.|
...
|$item_shield_gold|Scudo del nord|
|$item_shield_gold_description|Resta al sicuro, e fallo con stile.|
|$item_shield_gold_tower|Grande scudo del nord|
|$item_shield_goldbuckler|Brocchiero del nord|
|$item_shield_goldbuckler_description|Un metodo di protezione efficace, se applicato con la dovuta competenza.|
...
|$item_shield_roots|Scudo di radici|
|$item_shield_roots_description|Le radici malleabili sono state intrecciate fino a formare uno scudo davvero robusto.|
|$item_shield_round_gold_uncooked|Colata: Scudo del nord|
|$item_shield_round_gold_uncooked_description|Questo scudo deve essere temprato con il gelo.|
...
|$item_shield_silver|Scudo d'argento|
|$item_shield_silver_description|Uno scudo di argento radioso.|
|$item_shield_tower_gold_description|I tuoi nemici non possono colpirti se non ti vedono!|
|$item_shield_tower_gold_uncooked|Colata: Grande scudo del nord|
|$item_shield_tower_gold_uncooked_description|Questo scudo deve essere temprato con il gelo.|
...
|$item_sledge_gold|Mazzuolo del nord|
|$item_sledge_gold_description|Con quest'arma, i tuoi colpi saranno potenti come quelli di un troll.|
|$item_sledge_gold_uncooked|Colata: Mazzuolo del nord|
|$item_sledge_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
|$item_sledge_iron|Mazza di ferro|
|$item_sledge_iron_description|Un martello potente, degno di un campione.|
|$item_sledge_wood|Mazzuolo di legno|
|$item_sledge_wood_description|Probabilmente dovrebbe fare più male di quanto non sembri.|
|$item_smokebomb|Fumogeno|
|$item_smokebomb_description|Lo sanno tutti che non si può respirare nel fumo.|
|$item_smokedfish|Pesce affumicato|
|$item_smokedfish_description|Pesce preparato in modo delizioso.|
|$item_smokedmoosemeat|Carne di alce affumicata|
|$item_smokedmoosemeat_description|Affumicarla non fa che esaltarne il sapore.|
|$item_smokepuff|Sporafumo|
|$item_smokepuff_description|Speriamo sia più buono una volta cotto.|
|$item_snowball|Palla di neve|
|$item_snowball_description|Sembra un oggetto perfetto per essere lanciato...|
|$item_snowshovel|Pala da neve|
|$item_snowshovel_description|Utile per rimuovere anche la neve più alta.|
...
|$item_spear_gold|Lancia del nord|
|$item_spear_gold_bloodlightning|Lancia di Sangue tonante|
|$item_spear_gold_bloodlightning_description|Possa colpire come un fulmine, veloce e violento.|
|$item_spear_gold_bloodlightning_uncooked|Colata: Lancia di Sangue tonante|
|$item_spear_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_spear_gold_description|Un'occasione d'oro per colpire.|
|$item_spear_gold_frostfire|Lancia di Fuocoghiaccio|
|$item_spear_gold_frostfire_description|Avvolta da fiamme gelide, questa lancia porta con sé una morte certa.|
|$item_spear_gold_frostfire_uncooked|Colata: Lancia di Fuocoghiaccio|
|$item_spear_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_spear_gold_uncooked|Colata: Lancia del nord|
|$item_spear_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_spear_wood|Lancia di legno|
|$item_spear_wood_description|È affilata come una vera lancia… se una vera lancia fosse fatta di legno.|
...
|$item_spicedeepnorth|Spezia alla zucca|
|$item_spicedeepnorth_description|Utilizzando corteccia di cannella e radice di zenzero, con un pizzico di noce moscata, l'erborista ha viaggiato a lungo per creare questa miscela di spezie raffinata e avvolgente.|
...
|$item_staff_frostorbs|Vendetta del nord|
|$item_staff_frostorbs_description|Un fiocco di neve imprigionato, motivi infiniti che emergono dal suo interno...|
|$item_staff_lightning|Dundr|
|$item_staff_lightning_description|Ciò che accadrà ora, potrebbe sconvolgerti.|
|$item_staff_orbofahri|Spuntone dell'eco|
|$item_staff_orbofahri_description|Un freddo che ti gela fino alle ossa.|
|$item_staff_orbofahri_uncooked|Colata: Spuntone dell'eco|
|$item_staff_orbofahri_uncooked_description|Questo oggetto magico deve essere temprato con il gelo.|
|$item_staff_spiritcaller|Evocatore di spiriti|
|$item_staff_spiritcaller_description|Evoca un aiuto ultraterreno. Ti costerà solo una goccia del tuo sangue...|
|$item_staff_spiritcaller_uncooked|Colata: Bastone evoca spiriti|
|$item_staff_spiritcaller_uncooked_description|Questo oggetto magico deve essere temprato con il gelo.|
|$item_staff_thunderblood|Fulmine|
|$item_staff_thunderblood_description|Basta puntare il dito e scatenerai l'ira del cielo.|
|$item_staff_thunderblood_uncooked|Colata: Bastone dei fulmini|
|$item_staff_thunderblood_uncooked_description|Questo oggetto magico deve essere temprato con il gelo.|
...
|$item_stonerock|Roccia|
|$item_stonerock_description|È una pietra.|
...
|$item_swimspeed_modifier|Nuoto rapido|
...
|$item_sword_gold|Spada del nord|
|$item_sword_gold_bloodlightning|Spada di Sangue tonante|
|$item_sword_gold_bloodlightning_description|Mentre il sangue scorre lungo la lama, ridesta la tempesta interiore.|
|$item_sword_gold_bloodlightning_uncooked|Colata: Spada di Sangue tonante|
|$item_sword_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_sword_gold_description|Anche alla luce più fioca del sole, quest'arma brilla.|
|$item_sword_gold_frostfire|Spada di Fuocoghiaccio|
|$item_sword_gold_frostfire_description|Le fiamme danzano lungo questa lama, ma sono calde o fredde?|
|$item_sword_gold_frostfire_uncooked|Colata: Spada di Fuocoghiaccio|
|$item_sword_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_sword_gold_uncooked|Colata: Spada del nord|
|$item_sword_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_sword_sword_2h_description|Maneggialo con cura, ok?|
|$item_sword_wood|Spada di legno|
|$item_sword_wood_2h|Spadone di legno|
|$item_sword_wood_description|Abbastanza innocua, sempre che non insisti troppo.|
|$item_sword2h_gold|Spadone del nord|
|$item_sword2h_gold_bloodlightning|Spadone di Sangue tonante|
|$item_sword2h_gold_bloodlightning_description|Chiunque impugni quest'arma incuterà sicuramente grande timore.|
|$item_sword2h_gold_bloodlightning_uncooked|Colata: Spadone di Sangue tonante|
|$item_sword2h_gold_bloodlightning_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_sword2h_gold_description|Un'arma imponente, tanto nell’aspetto quanto nella letalità.|
|$item_sword2h_gold_frostfire|Spadone di Fuocoghiaccio|
|$item_sword2h_gold_frostfire_description|La scelta tra una fine infuocata e una gelida è semplice: entrambe allo stesso tempo.|
|$item_sword2h_gold_frostfire_uncooked|Colata: Spadone di Fuocoghiaccio|
|$item_sword2h_gold_frostfire_uncooked_description|Lo stesso stampo, ma incline a dare un risultato più spettacolare... Il gelo svelerà tutto, col tempo.|
|$item_sword2h_gold_uncooked|Colata: Spadone del nord|
|$item_sword2h_gold_uncooked_description|Quest'arma deve essere temprata con il gelo.|
...
|$item_total|Totale|
|$item_trinket|Gingillo|
|$item_trinketblackdamagedealth|Pelle di ferro|
|$item_trinketblackdamagedealth_description|Una pelle indurita infusa di violenza.|
|$item_trinketblackdtamina|Velo d'ombra|
|$item_trinketblackdtamina_description|Perfetto per chi danza con la morte e schiva i colpi del nemico.|
|$item_trinketbloodgoldhealth|Collo-tello|
|$item_trinketbloodgoldhealth_description|Artigli, ossa e oro: dona loro del sangue e ti concederanno un favore.|
|$item_trinketbloodgoldstamina|Corona della Strega|
|$item_trinketbloodgoldstamina_description|Si dice che l'anima di una strega possa conferire strani poteri ai mortali...|
|$item_trinketbronzehealth|Cuore della foresta|
|$item_trinketbronzehealth_description|Pulsa con frammenti di vita antica.|
|$item_trinketbronzestamina|Ciondolo di bronzo|
|$item_trinketbronzestamina_description|Un bellissimo ciondolo che rappresenta la resistenza di un orso.|
|$item_trinketcarapaceeitr|Orecchini pulsanti|
|$item_trinketcarapaceeitr_description|Ascoltando attentamente, è possibile sentire i deboli echi di anime magiche perdute…|
|$item_trinketchitinswim|Pinna del destino|
|$item_trinketchitinswim_description|Svuota la mente e l'anima, perdi la tua forma e diventa un tutt'uno con l'acqua.|
|$item_trinketflametaleitr|Jörmundling|
|$item_trinketflametaleitr_description|Urla tormentate di agonia risuonano dalla pietra luminosa.|
|$item_trinketflametalstaminahealth|Cuore di fuoco|
|$item_trinketflametalstaminahealth_description|A ogni battito del cuore si sente che arde, arde di desiderio.|
|$item_trinketironhealth|Spillone di ferro|
|$item_trinketironhealth_description|Un grazioso pezzo di equipaggiamento e di difesa.|
|$item_trinketironstamina|Cavigliera|
|$item_trinketironstamina_description|Leggera e infusa di velocità.|
|$item_trinketscalestaminadamage|Cavigliera sonora|
|$item_trinketscalestaminadamage_description|Una catena da caviglia affilatissima.|
|$item_trinketsilverdamage|Vista del lupo|
|$item_trinketsilverdamage_description|Una fascia per capelli ispirata alla mente acuta e furiosa di un lupo.|
|$item_trinketsilverresist|Cuore di cristallo|
|$item_trinketsilverresist_description|Un frammento di dolore e disperazione congelati.|
...
|$item_trophy_barka|Trofeo di Barka|
|$item_trophy_barka_description|La chioma ghiacciata di un albero che un tempo era vivo.|
|$item_trophy_barka_lore|Una creatura della foresta, trasformata in ghiaccio vivente.|
|$item_trophy_bjorn|Trofeo di orso|
|$item_trophy_bjorn_description|Il suo sguardo è ancora minaccioso…|
|$item_trophy_bjorn_lore|Erroneamente, si riteneva il padrone della foresta.|
|$item_trophy_bjorn_undead|Trofeo di orso nefasto|
|$item_trophy_bjorn_undead_description|Uno sguardo vuoto...|
|$item_trophy_bjorn_undead_lore|L'ombra più temuta della notte.|
|$item_trophy_blob|Trofeo del sangue|
|$item_trophy_blob_description|Un mucchio puzzolente di materia appiccicosa|
|$item_trophy_blob_frost|Trofeo Blob del gelo|
|$item_trophy_blob_frost_description|È come una scheggia di ghiaccio, solo... viscida?|
|$item_trophy_blob_frost_lore|Nonostante il passare del tempo, rimane congelato.|
|$item_trophy_blob_lava|Trofeo Blob di lava|
|$item_trophy_blob_lava_description|È morto, vero? Vero?!|
|$item_trophy_blob_lava_lore|Ancora adesso, è incandescente al tatto.|
|$item_trophy_blob_lore|Un mucchio puzzolente di materia appiccicosa|
|$item_trophy_blob_morkhalla|Trofeo Pulp|
|$item_trophy_blob_morkhalla_description|Resti di sfortunati avventurieri, digeriti e trasformati in gelatina nel corso del tempo.|
|$item_trophy_blob_morkhalla_lore|Trema ancora un po', ma è abbastanza certo che sia morto.|
...
|$item_trophy_elaking|Trofeo di Elaking|
|$item_trophy_elaking_description|Dei piccoli occhi maligni ti fissano.|
|$item_trophy_elaking_lore|È stato per crudeltà o per malizia? Forse non lo sapremo mai.|
...
|$item_trophy_fader_description|Il drago verde, corrotto oltre ogni possibilità di redenzione.<br/><br/>Offrilo alle pietre sacrificali.|
...
|$item_trophy_ghost|Trofeo fantasma|
|$item_trophy_ghost_description|Sussurra ancora di questioni in sospeso?|
|$item_trophy_ghost_lore|C'è ancora qualcosa di inquietante nella sua presenza…|
...
|$item_trophy_jotunwarrior|Trofeo di Krigen|
|$item_trophy_jotunwarrior_description|Un tempo era un potente guerriero, ora non ne rimane altro che un guscio vuoto.|
|$item_trophy_jotunwarrior_lore|Un soldato temprato. A quali battaglie ha assistito?|
|$item_trophy_jotunwitch|Trofeo di Hexen|
|$item_trophy_jotunwitch_description|Prima di morire, i suoi occhi brillavano di magia. Ora sono vuoti e spenti.|
|$item_trophy_jotunwitch_lore|Una strega potente. Di quali strani misteri era a conoscenza?|
...
|$item_trophy_mole|Trofeo del Senza Occhi|
|$item_trophy_mole_description|Essere graffiati da questi artigli sarebbe davvero spiacevole.|
|$item_trophy_mole_lore|Questo Senza Occhi non scaverà mai più.|
|$item_trophy_moose|Trofeo dell'alce|
|$item_trophy_moose_description|Il potente sovrano delle foreste del nord.|
|$item_trophy_moose_lore|Una bestia maestosa e un elemento d'arredo iconico.|
...
|$item_trophy_seal|Trofeo di foca|
|$item_trophy_seal_description|Questo animale non ha mai fatto del male a nessuno, eppure ha trovato una fine prematura.|
|$item_trophy_seal_lore|Quegli occhi grandi e tristi ti fissano. Che cosa hai fatto?|
...
|$item_trophy_writhan|Trofeo di Writhan|
|$item_trophy_writhan_description|Anche se è morto, probabilmente bisognerebbe trattarlo con delicatezza.|
|$item_trophy_writhan_lore|Rimane inattivo, almeno per ora…|
|$item_turnip|Rapa|
...
|$item_turretbolt_bloodgold|Missile di Orosangue|
|$item_turretbolt_bloodgold_description|Il tuo avversario non avrà alcuna possibilità quando questo proiettile colpirà il bersaglio.|
...
|$item_UndeadBjornRibcage|Gabbia toracica di orso nefasto|
|$item_UndeadBjornRibcage_description|Una reliquia di forza selvaggia, perfetta per forgiare armature che sopportano la furia della natura.|
|$item_upgrader_armor|Protezione|
|$item_upgrader_description|Questo misterioso idolo contiene il potere degli dei. Potrebbe concedere un dono potente, oppure esigere un grande sacrificio.|
|$item_upgrader_name|Idolo|
|$item_upgrader_tier0|Legno|
|$item_upgrader_tier1|Bronzo|
|$item_upgrader_tier2|Ferro|
|$item_upgrader_tier3|Argento|
|$item_upgrader_tier4|Metallo nero|
|$item_upgrader_tier5|Marmo nero|
|$item_upgrader_tier6|Fiammetal|
|$item_upgrader_tier7|Orosangue|
|$item_upgrader_weapon|Battaglia|
|$item_utility|Oggetto funzionale|
|$item_value|Valore|
|$item_vikingcupcake|Pane dolce glassato|
|$item_vikingcupcake_description|Una dolce e gustosa delizia, per festeggiare un'impresa!|
|$item_vikingcupcake_uncooked|Pane dolce non cotto|
|$item_vikingcupcake_uncooked_description|Pronto per essere infornato.|
...
|$item_wood|Legna|
|$item_wood_description|Legno per costruzioni, resistente e di buona qualità.|
|$item_writhanroots|Writhan di radici|
|$item_writhanroots_description|Parti del corpo nodose di una strana creatura che incute repulsione.|
...
|$jotuninvasion|I Jotun ti stanno invadendo|
...
|$location_bearcave|Grotta dell'orso|
|$location_darkesthole|La Fossa|
|$location_dnbossroom|La prima prigione|
|$location_dnbossroomnew|La prigione|
...
|$lore_deepnorth_hervor01|L'Alto nord. L'ultimo ostacolo prima di poter dimostrare il mio valore.<br/><br/><br/><br/>Le prove sono state tante, così come le morti. Ho perso amici a me cari.<br/><br/><br/><br/>Ma finalmente sono qui.|
|$lore_deepnorth_hervor02|Sembra un posto abbastanza tranquillo. Per ora, la fauna selvatica non sembra curarsi granché della mia presenza qui.<br/><br/><br/><br/>Se necessario, dovrei riuscire a procurarmi alcune risorse preziose da loro. Dopotutto, o sopravvivo io o sopravvivono loro.|
|$lore_deepnorth_hervor03|Devo stare in guardia. Da quando sono qui, pochi luoghi sono stati tranquilli, e sarebbe sciocco credere che queste terre siano diverse.<br/><br/><br/><br/>Per quanto io combatta bene, potrei comunque cadere vittima dall’inevitabile freddezza di questo posto.<br/><br/><br/><br/>Farò meglio a trovare un riparo.|
|$lore_deepnorth_hervor04|Finora mi hanno lasciato in pace. Nonostante ciò, non riesco a scrollarmi di dosso la sensazione che qualcosa mi stia osservando.|
|$lore_deepnorth_hervor05|Ho trovato un vecchio edificio, ma era abbandonato. È difficile dire da quanto tempo, ma non credo che qui troverò degli amici.|
|$lore_deepnorth_hervor06|Non mi piace pensare a cosa sarebbe potuto accadere se la mia ascia non fosse stata così affilata o i miei sensi così acuti. Dopotutto, non c’è più nessuno che possa venire in mio aiuto.<br/><br/><br/><br/>Avrò anche perso i miei compagni, ma è per il loro bene che devo andare avanti. Il sovrano di queste terre deve morire.|
|$lore_deepnorth_hervor07|È strano. Non posso fare a meno di pensare che qui dovrebbero esserci delle persone, pronte ad accogliermi.<br/><br/><br/><br/>Credo che gli inverni fossero così durante la mia infanzia, e che da un momento all’altro mio padre dovrebbe accogliermi a casa. Ma lui non c’è. Non c’è nessuno.|
|$lore_deepnorth_hervor08|Ultimamente faccio strani sogni in cui sono un corvo. Su grandi ali nere sorvolo questo mondo che ho imparato a conoscere, ma non è più lo stesso.<br/><br/><br/><br/>Il paesaggio è passato dall’essere verde e fertile a freddo e brullo. Forse è solo questo nord gelido che mi sta influenzando. Eppure... e se non fosse così?|
|$lore_deepnorth_hervor09|Ora so dove devo andare. Gli Antenati mi hanno indicato la via verso colui che governa queste terre, colui che hanno cercato di tenere in catene ma il cui potere ora tiene incatenato il mondo intero.<br/><br/><br/><br/>Se solo riuscissi a sconfiggere questo nemico, questo essere odioso, avrei dato prova di me una volta per tutte.|
|$lore_deepnorth_memorial_description|Memoriale degli antenati|
|$lore_deepnorth_memorial_label|Storia: Memoriale degli antenati|
|$lore_deepnorth_memorial1|Qui riposano i potenti che ci hanno preceduto.<br/><br/>Procedi con cautela, poiché il loro sonno potrebbe ancora essere turbato.|
|$lore_deepnorth_memorial2|Alla fine, la morte arriva per tutti, persino per i guerrieri più potenti.<br/><br/>Un giorno potresti entrare a far parte delle loro fila.|
|$lore_deepnorth_memorial3|Rendiamo omaggio ai nostri antenati, che hanno plasmato questo mondo in cui viviamo oggi.<br/><br/>E possano essi ritenerci degni.|
|$lore_deepnorth_random01|All’inizio sembrava una bella casa per Ulf, a cui piacevano il freddo e la neve. Poi sono arrivate quelle piccole creature cattive, decise a trascinarmi giù, e ho dovuto ricredermi.|
|$lore_deepnorth_random02|Se ciò che dice il corvo è vero, mi resta solo un Rinnegato da uccidere. Ma poi cosa succederà? Mio figlio tornerà davvero da me, o sarò io a tornare da lui?<br/><br/><br/><br/>Astrid ha eretto questa lapide per suo figlio, nel caso in cui lui seguisse le sue orme prima che lei potesse rivederlo.|
|$lore_deepnorth_random03|Quei luoghi ci sembravano così familiari, risvegliando ricordi sepolti nel profondo della nostra mente. Avremmo dovuto capire che non erano proprio come sembravano.|
|$lore_deepnorth_random04|Ascolta le parole di Kata, che un tempo credeva che i troll della foresta fossero nemici formidabili. I loro simili in queste terre sono alti come le torri più alte e duri come le pietre più dure, ma chi riesce a sconfiggerli otterrà una ricompensa scintillante.|
|$lore_deepnorth_random05|Quando siamo arrivati qui, questo posto era ricco e prospero. Ma ora gli inverni sono più freddi e più lunghi, e temiamo che presto possano prendere il sopravvento.<br/><br/><br/><br/>Eppure, qui abbiamo costruito le nostre case e qui abbiamo messo radici, quindi è qui che resteremo.|
|$lore_deepnorth_random06|Nel nord più lontano<br/><br/>Dove la magia danza nel cielo<br/><br/>Offri per il richiamo arcano<br/><br/>Ciò che giace sotto il velo<br/><br/><br/><br/>Lascia ardere il carbone<br/><br/>L’antico sapere attende chi osa<br/><br/>Chi combatte con decisione<br/><br/>Con le lame e gli archi dei padri, possenti e in posa|
|$lore_deepnorth_random07|Attenzione agli alberi finti! Il tintinnio dei ghiaccioli e lo scricchiolio dei rami potrebbero non essere causati dal vento...|
|$lore_deepnorth_random08|Signe eresse questa lapide in memoria di Eigil, caduto in battaglia. Non sapeva ancora che qui non tutto è così gelido come sembra a prima vista.|
|$lore_deepnorth_random09|Sepolti in profondità sotto la neve,<br/><br/>nello sperduto e remoto nord,<br/><br/>i legami si induriscono come antichi lord,<br/><br/>mentre la verità si scioglie lieve.|
...
|$lore_frozenking|FERMA L'INVASIONE|
...
|$lore_meadows_random01|Dove l'erba vermiglia cresce sotto i nostri piedi<br/><br/>E l'azzurro del cielo brilla sulle nostre teste<br/><br/>Ci sarà sempre un cuore e una casa|
|$lore_meadows_random02|Durante i secoli passati, quando il Padre del Tutto Odino unì i mondi, decise di sbarazzarsi dei Vanir, dei giganti e di tutte le creature più antiche. Le più potenti di queste non poterono essere uccisi e divennero dunque Rinnegati, esiliati qui a Valheim per l'eternità.<br/><br/>Quando vagano per la terra, le creature più deboli vengono sbalzate come briciole di pane su un tamburo. Li riconoscerai a prima vista.|
|$lore_meadows_random03|Lodate Freia per il sole e la pioggia<br/><br/>Per i germogli che spaccano la superfice della terra<br/><br/>E per i frutti delle viti<br/><br/>Lodate Odino per la carne e per le ossa<br/><br/>Il fumo emanato dai fuochi da cucina, le calde pelli<br/><br/>E la forza delle tue braccia|
...
|$lore_upgradestation_description|Ingrid e Torgunn decisero di rendere omaggio agli dei in quel luogo. Gli dei sorrisero a Ingrid, concedendole un grande dono. Torgunn, invece, si rese fin troppo conto del rischio che stava correndo, quando la sua lama andò in frantumi sull’altare. Alzò questa pietra per mettere in guardia gli altri dal pericolo di tentare la raffinazione in questa forgia!|
|$lore_upgradestation_label|Lore: la Forgia del Potenziale|
|$lore_windingtunnels|Queste creature luminose sono un'ottima fonte di luce al buio.<br/><br/>Forse una gabbia di legno potrebbe servire a tenerle al loro posto.|
...
|---|---|
|$mac_gamecenter_required_online_header|Accedi a Game Center per usufruire delle funzionalità online|
|$mac_gamecenter_required_online_text|Valheim utilizza Game Center per l'autenticazione: accedi a Game Center e riavvia Valheim per poter utilizzare le funzionalità online.|
|$memorialplace|Luogo commemorativo|
...
|$menu_codeofconduct_button|Codice di condotta|
...
|$menu_done|Fatto|
|$menu_dontshowagain|Non mostrare più|
...
|$menu_friendinvite_accepted_header|Invito da un amico accettato|
|$menu_friendinvite_accepted_text|In attesa che un amico avvii la partita…|
|$menu_friendinvite_selectcharacter_header|Accettato l'invito da|
|$menu_friendinvite_selectcharacter_text|Seleziona il personaggio con cui desideri partecipare alla partita.|
|$menu_friends|Amici|
...
|$menu_generating|Generazione in corso…|
|$menu_hair|Capelli|
|$menu_hairtone|Tonalità capelli|
|$menu_invite_friends_macos|Invita amici|
...
|$menu_locked|Bloccato|
|$menu_logging_in_played_failed_not_signed_in_to_platform|Assicurati di aver effettuato l'accesso alla piattaforma su cui stai giocando prima di provare a giocare online.|
|$menu_logging_in_played_failed_not_signed_in_to_platform_gamecenter|Assicurati di aver effettuato l'accesso a Game Center prima di provare a giocare online. Potrebbe essere necessario riavviare il gioco affinché le modifiche abbiano effetto.|
|$menu_logging_in_playfab_failed_header|Impossibile effettuare l'accesso a PlayFab.|
|$menu_logging_in_playfab_task_header|Accesso a PlayFab in corso…|
...
|$menu_loginwithplayfab_header|Accedi con PlayFab|
|$menu_loginwithplayfab_text|Valheim utilizza PlayFab per metterti in contatto con altri giocatori online. Vuoi accedere a PlayFab? In questo modo verrà creato automaticamente un account PlayFab anonimo in base alla piattaforma che utilizzi per giocare.|
|$menu_logout|Disconnetti|
|$menu_logoutconfirm|Disconnetti?|
|$menu_logoutprompt|Vuoi davvero uscire dalla sessione attuale?|
|$menu_lowdisk_block_exitanyway_header|Spazio su disco esaurito: vuoi uscire comunque?|
|$menu_lowdisk_block_exitanyway_prompt|Non c'è spazio sufficiente sul disco per salvare la partita. Vuoi uscire comunque? (Il tuo mondo e il tuo personaggio NON verranno salvati!)|
...
|$menu_player_list_block_tooltip|Blocca|
|$menu_player_list_block_warning_as_client|Bloccando questo giocatore non potrai più giocarci insieme. Questo serve a rispettare le politiche della piattaforma, che non consentono di visualizzare i contenuti generati dagli utenti (CGU) dei giocatori bloccati. Perderai la connessione e non potrai entrare in nessun server su cui stanno giocando gli utenti bloccati. Vuoi procedere con il blocco?|
|$menu_player_list_block_warning_as_server|Bloccando questo giocatore non potrai più giocarci insieme. Questa azione espellerà l'altro giocatore. A causa delle politiche della piattaforma relative ai contenuti generati dagli utenti (CGU), ti sarà inoltre impedito di accedere a questo mondo per tutta la durata del blocco, il che significa che anche tu perderai la connessione dal mondo. Vuoi procedere con il blocco?|
|$menu_player_list_kick_tooltip|Espelli dal server|
|$menu_player_list_mute_tooltip|Silenzia|
|$menu_player_list_report_tooltip|Segnala|
...
|$menu_removefavoritecategory|Rimuovere la categoria preferita?|
...
|$menu_storagefull|La tua memoria di archiviazione è piena!|
|$menu_storagefulloperationfailed|L'operazione non è andata a buon fine perché lo spazio di archiviazione è pieno. Elimina i dati di salvataggio non utilizzati e riprova.|
|$menu_storageused|Spazio di archiviazione usato: $1|
...
|$menu_vulkancrashwarning_header|Valheim potrebbe arrestarsi sul tuo sistema quando usi Vulkan|
|$menu_vulkancrashwarning_text|Al momento stai usando Vulkan. Stiamo indagando sugli arresti anomali che si verificano con Vulkan su alcuni sistemi, e il tuo è stato identificato come potenzialmente interessato dal problema. Se riscontri problemi di stabilità, utilizza l'API di rendering predefinita (DirectX 11). Ci scusiamo per l'inconveniente!|
|$menu_worldnametip|Minimo 5 lettere|
|$menu_worlds|Mondi|
|$menu_yes|Si|
|$message_dream|Stanotte sognerai|
|$morkhalla_drawbridge|Ponte levatoio|
|$msg_added|Aggiunto|
...
|$msg_food_done|Hai di nuovo fame|
...
|$msg_incompleteoffering_memorial|Gli antenati giacciono ancora dormienti|
...
|$msg_offerdone_memorial|Gli antenati rispondono al tuo richiamo|
...
|$msg_snowtoodeep|La neve è troppo profonda|
...
|$msg_upgrader_broke|La raffinazione dell'oggetto $1 non è andata a buon fine e si è interrotta al livello $2|
|$msg_upgrader_fail|La raffinazione dell'oggetto $1 non è riuscita e il livello è stato abbassato a $2|
|$msg_upgrader_success|L'oggetto $1 è stato raffinato con successo al livello $2|
|$msg_useonwhat|Usa $1 con cosa?|
|$msg_walk|Cammina|
|$msg_wontwork|Non funzionerà|
|$msg_worldsaveblockedonserver|Il server non dispone di spazio sufficiente sul disco per salvare la partita.|
...
|$msg_worldsavewarningonserver|Il server sta esaurendo lo spazio su disco; ti consigliamo di liberare spazio per poter salvare i dati in futuro.|
...
|$npc_dvergr_deepnorth_random_goodbye1|Non preoccuparti per me, me la caverò benissimo anche senza di te.|
|$npc_dvergr_deepnorth_random_goodbye2|Immagino che troverò una via d'uscita senza di te.|
|$npc_dvergr_deepnorth_random_goodbye3|Uccidi tutti i giganti che riesci!|
|$npc_dvergr_deepnorth_random_goodbye4|Allora, alla prossima.|
|$npc_dvergr_deepnorth_random_goodbye5|Cosa stai guardando?|
|$npc_dvergr_deepnorth_random_goodbye6|Sono così lontano da casa...|
|$npc_dvergr_deepnorth_random_goodbye7|Te ne vai?|
|$npc_dvergr_deepnorth_random_greet1|Chi va là?|
|$npc_dvergr_deepnorth_random_greet2|Sei amico o nemico?|
|$npc_dvergr_deepnorth_random_greet3|Ehi! Tu lì!|
|$npc_dvergr_deepnorth_random_greet4|Aiutami a uscire di qui!|
|$npc_dvergr_deepnorth_random_greet5|Una mano, magari?|
|$npc_dvergr_deepnorth_random_greet6|Da questa parte!|
|$npc_dvergr_deepnorth_random_greet7|Ti aiuterò, se aiuterai me.|
...
|$npc_dvergrmage_random_talk_in_faction_base1|Spero che questa miniera non sia infestata come l'ultima.|
|$npc_dvergrmage_random_talk_in_faction_base10|Qui c'è un'umidità tremenda, ma almeno non fa quel caldo insopportabile che c'è al sud.|
|$npc_dvergrmage_random_talk_in_faction_base2|Chissà se riusciremo a portare questo carico a casa presto.|
|$npc_dvergrmage_random_talk_in_faction_base3|Abbiamo costruito noi queste miniere, sai? E ora guardaci...|
|$npc_dvergrmage_random_talk_in_faction_base4|Ti chiedi mai cosa sia accaduto a Haldor?|
|$npc_dvergrmage_random_talk_in_faction_base5|A volte mi chiedo se l'eitr valga davvero tutta questa fatica.|
|$npc_dvergrmage_random_talk_in_faction_base6|Non vedo l'ora di scoprire cosa mi riserverà il fuoco.|
|$npc_dvergrmage_random_talk_in_faction_base7|Ma dove avrò messo quella bottiglia...?|
|$npc_dvergrmage_random_talk_in_faction_base8|Giuro che da qualche parte qui c'era un estrattore di ricambio...|
|$npc_dvergrmage_random_talk_in_faction_base9|Ancora un po' di estrazione e poi potremo riportare il ricavato a Myrkheim.|
...
|$npc_dvergrrogue_random_talk_in_faction_base10|Ho sentito che ci avventureremo di nuovo verso sud. Forse questa volta mi candiderò per la spedizione.|
...
|$npc_munin_deepnorth_general01|Questo è un luogo di trasformazione. Alcune creature trovano qui un nuovo scopo, diventando qualcosa di più di ciò che erano un tempo. Mi chiedo se tu sia una di queste creature…|
|$npc_munin_deepnorth_general02|Kraa! I primi che si avventurarono da queste parti non sapevano dell’esistenza dei ladri sotterranei. Se lo avessero saputo, avrebbero sicuramente scelto posti migliori dove costruire le loro dimore.|
|$npc_munin_deepnorth_general03|Cerca in queste terre i monumenti eretti in onore dei guerrieri che ti hanno preceduto. Potrebbero concederti un dono, se dimostrerai di essere degno ai loro occhi.|
|$npc_munin_deepnorth_general04|Molto prima che il Padre del Tutto ti chiamasse, altri erano stati incaricati di proteggere questo mondo. Anche se sono passati molti anni dalla loro scomparsa, sembra che non riescano ancora a trovare pace. Sii gentile e non disturbarli.|
|$npc_munin_deepnorth_morkborg|Kraa! Qui vivono creature strane, nate dal male stesso...|
|$npc_munin_deepnorth_ship|Molto tempo fa, altri tentarono di raggiungere queste terre via mare. Sembra che siano riusciti ad arrivare fin qui, ma che non abbiano avuto modo d'intraprendere il viaggio di ritorno...|
...
|$npc_valkyrie_end|Valchiria|
|$npc_valkyrie_end_interact|Viaggio verso il Valhalla|
...
|$online_kickedfromsession_header|Disconnesso dalla sessione|
|$online_kickedfromsession_suspendresume_xbox_text|La tua sessione online è terminata perché la console è entrata in modalità Riposo, interrompendo l'attività di rete.|
|$piece_ancient_pot|Vaso antico|
|$piece_ancientmetalbarstack|Pila di metallo antico|
|$piece_ancientmetalbarstack_description|Non è chiaro a cosa possa servire...|
|$piece_archerytarget|Bersaglio per il tiro con l'arco|
|$piece_archerytarget_description|Mira al centro.|
|$piece_archerytarget_hits|colpi|
|$piece_archerytarget_lastscores|Colpi|
|$piece_archerytarget_reset|Recupera le frecce per azzerare|
|$piece_archerytarget_total|Totale|
|$piece_armorstand|Armor stand|
|$piece_armorstand_cantattach|L'oggetto non può essere sostenuto dall' armor stand|
|$piece_armorstand_description|Alcuni capi sono semplicemente troppo belli per essere piegati e nascosti. Perché non metterli invece in bella mostra?|
|$piece_artisan_ext1|Pressa artigianale|
|$piece_artisan_ext1_description|Questo strumento complesso è necessario per realizzare progetti più complessi.|
|$piece_artisanstation|Tavolo da artigiano|
|$piece_artisanstation_description|Per costruire macchinari e realizzare progetti complessi, è necessario un banco da lavoro.|
...
|$piece_ashwood_bed_description|Riposati tranquillamente su questo letto di pregiata fattura, rivestito con pelli di cenerale che ti proteggono sia dal caldo che dal freddo.|
|$piece_ashwood_decowall|Parete decorativa di cenerlegno|
|$piece_ashwood_decowall_description|Potresti guardare questo disegno per ore...|
|$piece_ashwood_decowall_divider|Dvisorio in cenerlegno|
|$piece_ashwood_decowall_divider_description|Aggiunge un tocco di stile a qualsiasi stanza.|
|$piece_ashwood_decowall_tree|Finestra decorativa in cenerlegno|
|$piece_ashwood_decowall_tree_description|Stai guardando fuori dalla finestra o la finestra stessa? Non c'è bisogno che lo sappia nessuno.|
|$piece_ashwood_door|Porta di cenerlegno|
|$piece_ashwood_door_description|Le decorazioni così elaborate potrebbero indurti a fermarti e guardarle invece di proseguire.|
...
|$piece_ashwood_floor_deco_description|I motivi stanno benissimo anche sul pavimento.|
|$piece_ashwood_floor_description|Tavole di cenerlegno, posate in diagonale.|
...
|$piece_ashwood_poles_description|Questi supporti sono sempre caldi al tatto.|
...
|$piece_ashwoodbeam67|Trave di cenerlegno 67°|
...
|$piece_ashwoodstair_description|Queste scale sono più robuste di quanto possano sembrare.|
|$piece_ashwoodwall_description|Entrambi i lati di questo muro hanno il loro fascino. A te la scelta!|
...
|$piece_ashwoodwallroof67|Muro di cenerlegno 67°|
|$piece_ashwoodwallroof67upsidedown|Muro di cenerlegno 67° (invertito)|
|$piece_ashwoodwallrooftop67|Tetto a croce di cenerlegno 67°|
|$piece_asksvinskeleton|Scheletro di cenerale|
|$piece_asksvinskeleton_description|Raccapricciante o decorativo? A te la scelta.|
|$piece_banner01|Stendardo nero|
|$piece_banner01_description|Uno stendardo nero, simile alle profondità di Hel.|
|$piece_banner02|Stendardo blu|
|$piece_banner02_description|Uno stendardo blu, come gli oceani che circondano Midgard.|
|$piece_banner03|Stendardo a strisce bianche e rosse|
|$piece_banner03_description|Uno stendardo a strisce rosse, simile alla vela di una nave.|
|$piece_banner04|Stendardo rosso|
|$piece_banner04_description|Uno stendardo rosso, come il sangue dei nemici di Odino.|
|$piece_banner05|Stendardo verde|
|$piece_banner05_description|Uno stendardo verde, come le rigogliose foreste di Alfheim.|
|$piece_banner06|Stendardo blu, rosso e bianco|
|$piece_banner06_description|Uno striscione a strisce rosse e blu, perché a volte non si riesce a scegliere un solo colore.|
|$piece_banner07|Stendardo a strisce blu e bianche|
|$piece_banner07_description|Uno stendardo a strisce blu, simile alla vela di una nave.|
|$piece_banner08|Stendardo giallo|
|$piece_banner08_description|Uno stendardo giallo, come i campi dorati di Vanaheim.|
|$piece_banner09|Stendardo viola|
|$piece_banner09_description|Uno stendardo viola, come una strana magia.|
|$piece_banner10|Stendardo arancione|
|$piece_banner10_description|Uno stendardo arancione, simile alle fiamme di Muspelheim.|
|$piece_banner11|Stendardo bianco|
|$piece_banner11_description|Uno stendardo bianco, come la neve di Niflheim.|
...
|$piece_bathtub_description|I vichinghi ben educati fanno il bagno perfino una volta alla settimana!|
|$piece_bed|Letto non reclamato|
|$piece_bed_claim|Reclama|
|$piece_bed_currentspawn|Punto di spawn attuale|
|$piece_bed_description|Quando cala la notte, avrai bisogno di un posto dove dormire.|
...
|$piece_bed02_description|Rivestito di pellicce, questo letto ti garantirà sicuramente una buona notte di riposo.|
|$piece_beehive|Alveare|
|$piece_beehive_area|Le api non gradiscono questo ambiente|
|$piece_beehive_check|Controlla api|
|$piece_beehive_description|Quando sono felici, le api producono un miele delizioso.|
...
|$piece_bench_runed|Panca intagliata|
|$piece_bench_runed_description|Un posto rustico ma comodo dove sedersi.|
|$piece_bench01|Panca|
|$piece_bench01_description|Se c'è spazio nel tuo cuore, c'è spazio anche per il tuo didietro.|
|$piece_benchlog|Panca di tronco|
|$piece_benchlog_description|Non è nulla di speciale, ma è meglio che stare seduti per terra.|
|$piece_birdnest|Nido di uccelli|
|$piece_birdnest_area|Agli uccelli non piace stare qui|
|$piece_birdnest_check|Controlla il Nido degli uccelli|
|$piece_birdnest_description|Gli uccelli sani e felici possono perdere una o due piume.|
|$piece_birdnest_extract|Raccogli le piume|
|$piece_birdnest_freespace|Gli uccelli hanno bisogno di più spazio|
|$piece_birdnest_happy|Gli uccelli sono appollaiati|
|$piece_birdnest_sleep|Gli uccelli stanno riposando|
|$piece_blackforge|Forgia nera|
|$piece_blackforge_description|Alcuni metalli, specialmente se combinati con altri materiali, devono essere lavorati in una fucina più attrezzata.|
|$piece_blackforge_ext1|Raffreddamento forgia nera|
|$piece_blackforge_ext1_description|Lascia raffreddare le tue nuove creazioni prima di toccarle.|
|$piece_blackforge_ext2|Morsa|
|$piece_blackforge_ext2_description|È comodo tenere il progetto fermo mentre si lavora.|
|$piece_blackforge_ext3|Taglia metallo|
|$piece_blackforge_ext3_description|Per tagliare il metallo con precisione. Attenzione ai bordi taglienti!|
|$piece_blackforge_ext4|Taglia gemme|
|$piece_blackforge_ext4_description|Per lavorare le gemme, servono strumenti specifici.|
|$piece_blackforge_ext5|Grembiuli da fabbro|
|$piece_blackforge_ext5_description|Quando si ha a che fare con temperature estreme, la sicurezza sul lavoro è della massima importanza.|
...
|$piece_blackmarble_bench_description|Accomodati con dignità su questa panca, finemente scolpita nel marmo nero.|
...
|$piece_blackmarble_floor_description|I pavimenti scuri nascondono le macchie.|
...
|$piece_blackmarble_stair_description|Si possono usare sia per salire che per scendere. Che comodità!|
|$piece_blackmarble_table|Tavolo di marmo nero|
|$piece_blackmarble_table_description|Divora il pasto come un nano a questo tavolo!|
|$piece_blackmarble_throne|Trono di marmo nero|
|$piece_blackmarble_throne_description|Un trono intagliato in autentico stile dvergr, ma abbastanza grande da consentire a un essere umano di sedersi comodamente.|
...
|$piece_blackmarbleblock_description|Un oggetto in marmo nero ispirato all'architettura dei nani. L'unico limite è la tua creatività.|
|$piece_blackmetalbarstack|Pila di metallo nero|
|$piece_blackmetalbarstack_description|Sarà sicuramente l'invidia di tutti i Fuling!|
|$piece_blackwoodbench01|Panchina di cenerlegno|
|$piece_blackwoodbench01_description|Questa panchina presenta un'elegante linea curva, pensata per favorire la conversazione.|
|$piece_blackwoodstack|Catasta di cenerlegno|
|$piece_blackwoodstack_description|In ogni caso, questa catasta di legna trasmette sempre un senso di calore.|
|$piece_BlackwoodStakewall|Palizzata di cenerlegno|
|$piece_BlackwoodStakewall_description|Pali appuntiti, che feriscono di sicuro.|
|$piece_blastfurnace|Altoforno|
|$piece_blastfurnace_description|Alcuni metalli richiedono temperature più elevate per fondersi.|
|$piece_bloodgoldbarstack|Pila di Orosangue|
|$piece_bloodgoldbarstack_description|Questo genere di metallo ha davvero un'atmosfera più sinistra rispetto agli altri, non è vero?|
|$piece_bone_throne|Trono di ossa|
|$piece_bone_throne_description|Questo trono susciterà sicuramente rispetto sia negli amici che nei nemici.|
|$piece_bonestack|Cumulo di ossa|
|$piece_bonestack_description|Non si sa mai quando potrebbero tornare utili!|
|$piece_bonfire|Falò|
|$piece_bonfire_description|Quando un semplice falò non è abbastanza stupefacente!|
|$piece_brazierceiling01|Braciere sospeso|
|$piece_brazierceiling01_description|Se il tuo braciere è appeso al soffitto, non rischi di urtarci contro per sbaglio.|
|$piece_brazierfloor01|Braciere eretto|
|$piece_brazierfloor01_description|Un modo elegante per illuminare la stanza.|
|$piece_brazierfloor02|Braciere eretto blu|
|$piece_brazierfloor02_description|È difficile dire se questa fiamma sia incredibilmente calda o incredibilmente fredda.|
|$piece_bronzebarstack|Pila di bronzo|
|$piece_bronzebarstack_description|Bella, versatile... E ora anche impilabile!|
|$piece_candle|Candela di resina|
|$piece_candle_description|Una fonte di luce piccola ma incredibilmente accogliente.|
|$piece_cartographytable|Tavolo per la cartografia|
|$piece_cartographytable_description|Segna i luoghi che hai scoperto su questa mappa e condividili con i tuoi amici.|
...
|$piece_cauldron_description|Mescola gli ingredienti e preparati un pasto gustoso: è fondamentale per tutti i vichinghi!|
|$piece_cauldron_ext1_spice|Portaspezie|
|$piece_cauldron_ext1_spice_description|Per seguire una dieta varia e gustosa servono molti ingredienti.|
|$piece_cauldron_ext3_butchertable|Tavolo da macellaio|
|$piece_cauldron_ext3_butchertable_description|I piatti più raffinati richiedono i tagli migliori.|
|$piece_cauldron_ext4_pans|Pentole e padelle|
|$piece_cauldron_ext4_pans_description|A volte un calderone non basta.|
|$piece_cauldron_ext5_mortarandpestle|Pestello e mortaio|
|$piece_cauldron_ext5_mortarandpestle_description|Alcuni ingredienti devono essere macinati fino a ottenere una polvere fine prima di poter essere utilizzati in cucina.|
|$piece_cauldron_ext6_rollingpins|Matterelli e taglieri|
|$piece_cauldron_ext6_rollingpins_description|Questi oggetti tornano sempre utili, soprattutto per preparare torte.|
|$piece_cauldron_ext7_smoker|Affumicatore|
|$piece_cauldron_ext7_smoker_description|I cibi affumicati si conservano più a lungo e hanno un sapore migliore!|
|$piece_celebrationgarland|Ghirlanda di fiori|
|$piece_celebrationgarland_description|Qualche fiore per rallegrarti la giornata!|
|$piece_chair|Sedia|
|$piece_chair_description|Appoggiati allo schienale e rilassati.|
|$piece_chair_runed|Sedia intagliata|
|$piece_chair_runed_description|La forma di questa sedia sarà anche semplice, ma le sue decorazioni non lo sono affatto.|
|$piece_charcoalkiln|Forno a carbone|
|$piece_charcoalkiln_description|Utile per trasformare qualsiasi tipo di legno in carbone.|
|$piece_charredballista|Ballombra|
|$piece_charredchest|Forziere carbonizzato|
|$piece_chest|Scrigno rinforzato|
|$piece_chest_description|Un forziere più robusto, con più spazio per riporre gli oggetti.|
|$piece_chestbarrel|Botte|
|$piece_chestbarrel_description|Una botte è perfetta per conservare tante cose, tra cui cibo e bevande.|
|$piece_chestblackmetal|Baule di metallo nero|
|$piece_chestblackmetal_description|La robusta struttura in metallo nero di questo forziere ti permette di riporvi quasi ogni cosa.|
|$piece_chestgrausten|Forziere di Grausten|
|$piece_chestgrausten_description|La pietra e il metallo garantiranno la sicurezza dei tuoi oggetti personali. Anche i teschi carbonizzati contribuiscono.|
|$piece_chestprivate|Scrigno personale|
|$piece_chestprivate_description|Ci sono cose che preferiresti tenere lontane da occhi indiscreti.|
|$piece_chesttreasure|Baule del tesoro|
|$piece_chesttreasure_description|Quale modo migliore per mettere in mostra la propria ricchezza di un forziere traboccante di oro e gioielli?|
|$piece_chestwarderobe|Guardaroba|
|$piece_chestwarderobe_description|Un posto elegante dove riporre gli oggetti.|
|$piece_chestwood|Scrigno|
|$piece_chestwood_description|Un posto ideale dove riporre gli oggetti che non devi portare con te.|
|$piece_clothdoor|Tenda di stoffa rossa|
|$piece_clothdoor_description|Pesanti tende in juta rossa, ideali per essere usate come drappi.|
|$piece_coalpile|Pila di carbone|
|$piece_coalpile_description|Avere sempre una buona scorta di carburante a disposizione non guasta mai.|
|$piece_container_empty|Vuoto|
|$piece_container_open|Apri|
|$piece_cookingstation|Cucina|
|$piece_cookingstation_description|Ideale per cuocere la carne cruda alla griglia.|
|$piece_cookingstation_iron|Cucina in ferro|
|$piece_cookingstation_iron_description|Un sistema robusto, con spazio sufficiente per cucinare la carne di animali di grossa taglia.|
|$piece_copperbarstack|Pila di rame|
|$piece_copperbarstack_description|Rame di prima qualità. Non c'è proprio nulla da ridire!|
|$piece_craftingstation|Banco di creazione|
|$piece_crate|Cassa|
|$piece_crate_long|Cassa di componenti dvergr|
|$piece_crystalwall_description|Bello e fragile.|
|$piece_crystalwall1x1|Pannello di cristallo 1x1|
|$piece_cstand_cook|Cucina oggetto|
|$piece_cultivate|Coltivare|
|$piece_cultivate_description|Prepara il terreno per la semina.|
...
|$piece_darkwoodchair_description|Questa sedia è rivestita di pelliccia ed è adatta per ospiti illustri.|
|$piece_darkwooddecowall|Divisorio di legno scuro intagliato|
|$piece_darkwooddecowall_description|Un design elegante per arredare la tua casa e tenere lontani sguardi indiscreti.|
|$piece_darkwoodgate|Portone di legno scuro|
|$piece_darkwoodgate_description|Un cancello elegante e robusto. Da utilizzare singolarmente o in coppia.|
|$piece_darkwoodpole|Palo di legno scuro 2m|
|$piece_darkwoodpole4|Palo di legno scuro 4m|
|$piece_darkwoodpoles_description|Motivi intricati si snodano lungo questa struttura portante.|
|$piece_darkwoodraven|Corvo intagliato|
|$piece_darkwoodraven_description|I corvi sono fedeli compagni del Padre del Tutto; è ovvio che anche tu ne vorresti uno a casa tua.|
|$piece_darkwoodroof26|Tetto con scandole 26°|
|$piece_darkwoodroof26_description|Questo tetto a bassa inclinazione terrà sicuramente fuori la pioggia, senza rinunciare all'estetica.|
|$piece_darkwoodroof45|Tetto con scandole 45°|
|$piece_darkwoodroof45_description|Questo tetto ad alta inclinazione terrà sicuramente fuori la pioggia, senza rinunciare all'estetica.|
|$piece_darkwoodroof67|Tetto con scandole 67°|
|$piece_darkwoodroof67_description|Questo tetto a inclinazione molto accentuata terrà sicuramente fuori la pioggia, senza rinunciare all'estetica.|
|$piece_darkwoodrooficorner|Tetto con scandole concavo 26°|
|$piece_darkwoodrooficorner45|Tetto con scandole concavo 45°|
|$piece_darkwoodrooficorner67|Angolo interno tetto con scandole 67°|
|$piece_darkwoodroofocorner|Tetto con scandole convesso 26°|
|$piece_darkwoodroofocorner45|Tetto con scandole convesso 45°|
|$piece_darkwoodroofocorner67|Angolo esterno tetto con scandole 67°|
|$piece_darkwoodrooftop|Colmo con scandole 26°|
|$piece_darkwoodrooftop45|Colmo con scandole 45°|
|$piece_darkwoodrooftop67|Colmo tetto con scandole 67°|
|$piece_darkwoodwolf|Testa di lupo intagliata|
|$piece_darkwoodwolf_description|I lupi sono animali da branco, ma questo sembra abbastanza felice da solo.|
|$piece_deco_stave_wall|Parete in legno a listelli|
|$piece_deco_stave_wall_description|Questo muro non servirà a tenere fuori il freddo, ma è davvero bello da vedere.|
|$piece_deposit_copper|Deposito di rame|
|$piece_deposit_goldvein|Gammeltroll pietrificato|
...
|$piece_drawbridge|Ponte levatoio|
|$piece_drawbridge_description|È sia un ponte che un cancello: un'idea geniale!|
|$piece_drawbridge_dn|Ponte levatoio di legna da costruzione|
|$piece_drawbridge_log|Ponte levatoio rustico|
|$piece_drawbridge_log_description|Utile per attraversare voragini o per tenere lontani i nemici.|
|$piece_dv_gate|Vecchio cancello dvergr|
|$piece_dvergr_door|Porta dvergr|
|$piece_dvergr_lantern|Lanterna da parete dvergr|
|$piece_dvergr_lantern_description|Una lanterna di raffinata fattura, realizzata da un vero artigiano. Il sistema di fissaggio a muro è comunque abbastanza intuitivo!|
|$piece_dvergr_lantern_pole|Palo per lanterna dvergr|
|$piece_dvergr_lantern_pole_description|Costruire un palo è abbastanza facile, ma quella lanterna può essere stata realizzata solo da un vero maestro.|
|$piece_dvergr_metal_wall|Muro di metallo dvergr|
|$piece_dvergr_metal_wall_description|Il design Dvergr va molto di moda in questo periodo.|
|$piece_dvergr_pole|Palo dvergr|
|$piece_dvergr_sharpstakes|Paletti affilati dvergr|
|$piece_dvergr_sharpstakes_description|I Dvergr sanno come tenere lontani i visitatori indesiderati.|
|$piece_dvergr_spiralstair|Scala a chiocciola dvergr sinistra|
|$piece_dvergr_spiralstair_description|Sale e gira!|
|$piece_dvergr_spiralstair_right|Scala a chiocciola dvergr destra|
|$piece_dvergr_stake_wall|Picchetto dvergr|
|$piece_dvergr_stake_wall_description|Rinforzata con metallo, questa struttura garantirà sicuramente una buona difesa.|
|$piece_dvergr_woodwall|Muro dvergr|
|$piece_dvergrchest|Baule del tesoro dvergr|
|$piece_eitrrefinery|Raffineria di eitr|
|$piece_eitrrefinery_description|Questa macchina trasformerà i tessuti molli nella sostanza magica chiamata eitr. Il processo è piuttosto instabile, quindi non avvicinarti troppo!|
|$piece_faderember|Pira eterna|
|$piece_faderember_description|La sua rabbia e il suo rimpianto sono in conflitto e la loro lotta alimenterà questo fuoco fino alla fine.|
|$piece_faderember_full|Le braci ardono vivacemente|
|$piece_faderember_light|Le braci stanno ravvivandosi|
|$piece_faderember_nospace|Le braci si stanno spegnendo|
|$piece_faderember_ok|Le braci stanno ravvivandosi|
|$piece_fairylightgarland|Luce fatata|
|$piece_fairylightgarland_description|Dona una luce delicata ai tuoi festeggiamenti.|
|$piece_fermenter|Fermentatore|
|$piece_fermenter_add|Aggiungi oggetto|
|$piece_fermenter_description|L'idromele deve riposare e fermentare per un po' affinché si sviluppino tutte le sue proprietà.|
|$piece_fermenter_exposed|Troppo esposto|
|$piece_fermenter_fermenting|Fermentazione|
|$piece_fermenter_needroof|Necessita un tetto|
|$piece_fermenter_ready|Completato|
|$piece_fermenter_tap|Spilla|
|$piece_fire|Fuoco|
|$piece_fire_fuel|Rifornisci|
|$piece_firepit|Fuocarello|
|$piece_firepit_description|Utile per cucinare, riscaldarsi o semplicemente riposarsi un po'.|
|$piece_firepit_iron|Attizzatoio|
|$piece_firepit_iron_description|Se non vuoi accendere il falò direttamente a terra, questa è un'alternativa di classe.|
|$piece_flametal_beam|Trave di fiammetal|
|$piece_flametal_pillar|Pilastro di fiammetal|
|$piece_flametal_pillar_description|Metallo puro e infuocato.|
|$piece_flametalbarstack|Pila di fiammetal|
|$piece_flametalbarstack_description|Questa pila sembra quasi sprigionare calore...|
|$piece_flametalgate|Cancello di fiammetal|
|$piece_flametalgate_description|Un modo davvero suggestivo per dare il benvenuto ai tuoi amici o per tenere alla larga i tuoi nemici.|
|$piece_flintpile|Pila di selce|
|$piece_flintpile_description|Occhio a dove metti i piedi!|
|$piece_forge|Forgia|
|$piece_forge_description|Quando vuoi lavorare il metallo, serve una fucina.|
|$piece_forge_ext1|Mantice|
|$piece_forge_ext1_description|Premendo su questi soffietti si genera più calore, il che è molto utile per la lavorazione del ferro.|
|$piece_forge_ext2|Incudini|
|$piece_forge_ext2_description|Per lavori più complessi, può essere utile disporre di diversi tipi d'incudini.|
|$piece_forge_ext3|Mola|
|$piece_forge_ext3_description|Per affilare qualsiasi tipo di spada è necessaria una mola.|
|$piece_forge_ext4|Incudine del fabbro|
|$piece_forge_ext4_description|Un'incudine di grandi dimensioni per lavorare oggetti voluminosi. Assicurati che non ti cada sui piedi.|
|$piece_forge_ext5|Refrigeratore della forgia|
|$piece_forge_ext5_description|Una volta forgiato l'oggetto, questo barile d’acqua raffredderà il metallo fino a una temperatura gestibile.|
|$piece_forge_ext6|Portautensili della forgia|
|$piece_forge_ext6_description|Per lavorare servono molti attrezzi diversi. Questi sono forniti con un pratico supporto per riporli.|
|$piece_frostfoundry|Fonderia del gelo|
|$piece_frostfoundry_additem|Posiziona colata|
|$piece_frostfoundry_description|Questa fonderia può essere utilizzata per indurire le colate e trasformarle in oggetti finiti.|
|$piece_frostfoundry_takeitem|Prendi oggetto|
|$piece_frostkiln|Forno glaciale|
|$piece_frostkiln_description|All'interno di questa fornace ha luogo un processo strano e inquietante, che porta alla produzione di un combustibile estremamente potente...|
...
|$piece_grausten_floor_description|Queste piastrelle sottili sono sorprendentemente resistenti.|
...
|$piece_grausten_pillars_description|Abbastanza forti da resistere a una terra di fuoco.|
...
|$piece_grausten_roof_description|Un design di tetto all'altezza delle sale più maestose.|
...
|$piece_grausten_stair_description|Basta fare un passo alla volta.|
|$piece_grausten_stoneladder|Scale di grigietra ripide|
|$piece_grausten_stoneladder_description|Ottima per raggiungere livelli più alti.|
|$piece_grausten_wall_description|Muri in pietra ispirati a una civiltà ormai scomparsa.|
...
|$piece_graustenpile_description|Grausten, disposti con cura in una pila.|
|$piece_groundtorch|Torcia di ferro|
|$piece_groundtorch_description|Una robusta torcia in ferro per illuminare l'ambiente circostante.|
|$piece_groundtorchblue|Torcia di ferro a fiamma blu|
|$piece_groundtorchblue_description|Una robusta torcia di ferro che emette una luce blu inquietante.|
|$piece_groundtorchdemister|Torcia del fuoco fatuo|
|$piece_groundtorchdemister_description|Fissa il bagliore in un punto preciso, in modo che quel luogo sia sempre privo di nebbia.|
|$piece_groundtorchgreen|Torcia di ferro a fiamma verde|
|$piece_groundtorchgreen_description|Una robusta torcia di ferro, con una fiamma verde.|
|$piece_groundtorchwood|Torcia di legno|
|$piece_groundtorchwood_description|Una torcia da piantare nel terreno, per quando hai bisogno di avere le mani libere.|
...
|$piece_hanging_cloth_blue1_description|La iuta blu conferisce a qualsiasi edificio un aspetto solenne e imponente.|
|$piece_hanging_cloth_blue2|Tende di iuta blu|
|$piece_harvest|Raccolto|
|$piece_hearth|Focolare|
|$piece_hearth_description|Un elemento fondamentale di qualsiasi dimora.|
|$piece_hexagonalgate|Portone esagonale|
|$piece_hexagonalgate_description|Questo design nanico è perfetto per tenere lontani gli ospiti indesiderati.|
|$piece_hoodedlantern|Lanterna con cappuccio|
|$piece_hoodedlantern_description|Se diretta in una sola direzione, la luce diventa più intensa. Comoda per i ladri furtivi o per chi vuole lasciare una scia.|
|$piece_horizontal|Orizzontale|
|$piece_icecube|Blocco di ghiaccio|
|$piece_icecube_description|Un solido blocco di ghiaccio.|
|$piece_incinerator|Obliteratore|
|$piece_incinerator_conversion|Thor ti ha fatto un dono!|
|$piece_incinerator_description|Riduci, riusa, oblitera.|
...
|$piece_ironbarstack|Pila di ferro|
|$piece_ironbarstack_description|Se hai del ferro, hai tutto.|
|$piece_ironcage_description|Barre di ferro di pregiata fattura, che non fanno rumore!|
...
|$piece_irongate_description|Un cancello molto importante.|
|$piece_ironwall|Inferriata 2x2|
|$piece_ironwallSmall|Inferriata 1x1|
|$piece_ironwoodbeam67|Trave di legno e ferro 67°|
...
|$piece_itemstand_h_description|Appoggia gli oggetti su superfici orizzontali con questo supporto.|
|$piece_itemstand_missingitem|Oggetto richiesto mancante|
|$piece_itemstand_take|Prendi oggetto|
|$piece_itemstand_v_description|Utilizza questo supporto per appendere oggetti su superfici verticali.|
|$piece_jackoturnip|Lanterna di rapa|
|$piece_jackoturnip_description|Il volto scolpito in questo ortaggio... fa paura o è simpatico?|
|$piece_jotunchest|Forziere degli Jotun|
|$piece_jotungate|Cancelli di Mörkhalla|
|$piece_jute_carpet|Tappeto di stoffa rossa|
|$piece_jute_carpet_description|Questo tessuto a trama larga è perfetto per proteggersi dal freddo.|
|$piece_juteblue_carpet|Tappeto di iuta blu|
|$piece_juteblue_carpet_description|Per quanto l'aria sia umida, questo tappeto non sembra bagnarsi.|
|$piece_lavalantern|Lanterna di lava|
|$piece_lavalantern_description|È... ipnotizzante da guardare...|
|$piece_levelground|Terreno pianeggiante|
|$piece_levelground_description|Se il terreno è troppo irregolare, basta livellarlo.|
...
|$piece_magetable_description|Forze misteriose del galdr si raccolgono su questo altare. Sta a te sfruttarle...|
|$piece_magetable_ext|Tavolo runico|
|$piece_magetable_ext_description|Le rune sono uno strumento ben noto per canalizzare la magia, se si sa come interpretarle.|
|$piece_magetable_ext2|Candele infinite|
|$piece_magetable_ext2_description|Queste candele emanano una luce strana, che sembra attirare intorno a sé una magia più potente.|
|$piece_magetable_ext3|Corona di piume|
|$piece_magetable_ext3_description|Un'offerta alle forze misteriose sparse per i regni. Forse ti presteranno il loro aiuto.|
|$piece_magetable_ext4|Telaio a colonna|
|$piece_magetable_ext4_description|Le Norne intrecciano i fili del destino in un arazzo magico. Cosa intreccerai tu?|
...
|$piece_marblepile_description|Ideale per costruzioni ispirate ai Dvergr.|
|$piece_maypole|Majstang|
|$piece_maypole_description|Nel giorno più lungo dell'anno, lasciamo che questo monumento si protenda verso il sole!|
|$piece_meadcauldron|Bollitore per idromele|
|$piece_meadcauldron_description|Questa pentola di rame mantiene la temperatura ideale per preparare l'idromele.|
|$piece_mistletoe|Vischio|
|$piece_mistletoe_description|Non si può fare a meno di pensare che ci sia qualcosa di romantico in tutto questo...|
|$piece_moose_throne|Trono di corna|
|$piece_moose_throne_description|Sebbene rustico e robusto, questo trono è perfetto anche per i reali più nobili.|
|$piece_morkborg_gate|Cancelli di Mörkhalla|
|$piece_morkhallachestancient|Forziere antico|
|$piece_mudpile|Pila di rottame infangati|
|$piece_noaccess|Non hai accesso|
|$piece_obsidianpile|Pila di ossidiana|
|$piece_obsidianpile_description|Un cumulo scuro come la notte stessa.|
...
|$piece_offerbowl_frozenking|Strana ciotola|
|$piece_offerbowl_hive|Sede dell'alveare|
|$piece_offerbowl_makeoffer|Presenta offerta|
|$piece_offerbowl_memorial|Altare antico|
|$piece_offerbowl_offeritem|Offri oggetto|
|$piece_offerbowl_offeritem_fader|Suonare le campane|
|$piece_offerbowl_offeritem_memorial|Accendi l'altare|
|$piece_offerbowl_yagluth|Altrare mistico|
|$piece_oven|Forno di pietra|
|$piece_oven_additem|Inforna|
|$piece_oven_description|Per tutte le tue esigenze in cucina.|
|$piece_path|Percorso|
|$piece_path_description|Segna il percorso migliore.|
|$piece_pavedroad|Strada pavimentata|
|$piece_pavedroad_description|Un segno inequivocabile di civiltà.|
...
|$piece_portal_censored_warning|Trovate parole censurate, possibile problema di crossplay.|
...
|$piece_pot_large_green_description|Un vaso davvero imponente! Ci starebbe quasi un vichingo intero lì dentro.|
...
|$piece_pot_medium_green_description|Un oggetto in ceramica, abbastanza profondo da poter contenere un paio di cose.|
...
|$piece_pot_small_green_description|Un piccolo oggetto di terracotta, con uno spazio al suo interno.|
|$piece_pot_small_red|Vaso rosso piccolo|
|$piece_preptable|Tavolo per la preparazione del cibo|
|$piece_preptable_description|Non tutto può essere versato direttamente nel calderone, quindi ti serve un piano d’appoggio adeguato su cui lavorare!|
|$piece_pulllever|Tira la leva|
|$piece_queendoor|Cassaforte dvergr|
|$piece_raise|Inalzare suolo|
|$piece_raise_description|Riempi i buchi e crea piattaforme rialzate.|
|$piece_readmap|Leggi la mappa|
|$piece_register_location|Salva posizione|
|$piece_repair|Riparare|
|$piece_replant|Erba|
|$piece_replant_description|Ripristina la vegetazione originaria del terreno.|
|$piece_rock_01|Masso ornamentale|
|$piece_rock_01_description|Dà un tocco rustico a qualsiasi giardino.|
|$piece_rock_02|Masso decorativo|
|$piece_rock_02_description|È un bel masso.|
|$piece_rug_asksvin|Tappeto di cenerale|
|$piece_rug_asksvin_description|Data la struttura irregolare della pelle di cenerale, è difficile ricavarne qualcosa di utile da un unico pezzo. Richiede assemblaggio.|
|$piece_rug_bjorn|Tappeto in pelle di orso|
|$piece_rug_bjorn_description|Il pelo è morbido, anche se i denti sono ancora affilati.|
|$piece_rug_deer|Tappeto di cervo|
|$piece_rug_deer_description|Protegge i piedi dalle schegge di legno.|
|$piece_rug_hare|Tappeto di lepre|
|$piece_rug_hare_description|Ha una trama bizzarra, ma è un elemento d'arredo davvero interessante.|
|$piece_rug_lox|Tappeto di Lox|
|$piece_rug_lox_description|È incredibilmente soffice!|
|$piece_rug_moose|Tappeto in pelle di alce|
|$piece_rug_moose_description|Questo tappeto è cucito con cura, per garantire una superficie ampia e morbida.|
|$piece_rug_seal|Tappeto in pelle di foca|
|$piece_rug_seal_description|Questo tappeto è così morbido… come l'innocenza.|
|$piece_rug_straw|Fieno|
|$piece_rug_straw_description|Ai tuoi animali piacerà molto.|
|$piece_rug_wolf|Tappeto di lupo|
|$piece_rug_wolf_description|Caldo e accogliente, soprattutto in montagna.|
...
|$piece_sapling_barley_description|Un cereale resistente che può essere macinato per ottenere farina.|
|$piece_sapling_carrot|Carota|
|$piece_sapling_carrot_description|Si può consumare così com'è oppure utilizzare per preparazioni più elaborate.|
|$piece_sapling_flax|Lino|
|$piece_sapling_flax_description|Bei fiori con fibre che possono essere filate per ottenere del filo.|
|$piece_sapling_jotunpuffs|Embrioni di nuvole degli Jotunn|
|$piece_sapling_kale|Cavolo riccio|
|$piece_sapling_kale_description|Una pianta resistente e nutriente.|
|$piece_sapling_magecap|Embrioni di copricapi dei maghi|
|$piece_sapling_oat|Paglia d'avena|
|$piece_sapling_oat_description|Pianta per far crescere dell'avena.|
|$piece_sapling_onion|Cipolla|
|$piece_sapling_onion_description|Utile in molte ricette.|
|$piece_sapling_poteitr|Pateitr|
|$piece_sapling_poteitr_description|Un tubero potente dal sapore intenso e straordinario.|
|$piece_sapling_seedcarrot|Semi di carota|
|$piece_sapling_seedcarrot_description|Pianta una carota per ottenere più semi.|
|$piece_sapling_seedkale|Seme di cavolo riccio|
|$piece_sapling_seedkale_description|Pianta i semi di cavolo riccio per ottenerne altri.|
...
|$piece_sapling_turnip_description|Un ortaggio sostanzioso utilizzato in cucina.|
...
|$piece_scale_26|Muro in legno a scaglie 26° a sinistra|
|$piece_scale_26_flipped|Muro in legno a scaglie 26° a destra|
|$piece_scale_26_upsidedown|Muro in legno a scaglie 26° a destra (invertito)|
|$piece_scale_26_upsidedown_flipped|Muro in legno a scaglie 26° a sinistra (invertito)|
|$piece_scale_45|Muro in legno a scaglie 45° a sinistra|
|$piece_scale_45_flipped|Muro in legno a scaglie 45° a destra|
|$piece_scale_45_upsidedown|Muro in legno a scaglie 45° a destra (invertito)|
|$piece_scale_45_upsidedown_flipped|Muro in legno a scaglie 45° a sinistra (invertito)|
|$piece_scale_67|Muro in legno a scaglie 67° a sinistra|
|$piece_scale_67_flipped|Muro in legno a scaglie 67° a destra|
|$piece_scale_67_upsidedown|Muro in legno a scaglie 67° a destra (invertito)|
|$piece_scale_67_upsidedown_flipped|Muro in legno a scaglie 67° a sinistra (invertito)|
|$piece_scale_halfwall|Mezzo muro in legno a scaglie|
|$piece_scale_quarterwall|Quarto di muro in legno a scaglie|
|$piece_scale_wall|Muro in legno a scaglie|
|$piece_scale_walls_description|Il legno a incastro di queste pareti offre un'eccellente protezione dalle intemperie.|
|$piece_sconce|Applique|
|$piece_sconce_description|Perché piantare una torcia nel terreno quando puoi appenderla al muro?|
|$piece_secretdoor|Porta nascosta|
|$piece_sharpstakes|Paletti affilati|
|$piece_sharpstakes_description|Se qualcuno si avvicina troppo, verrà infilzato.|
...
|$piece_sign|Cartello|
|$piece_sign_description|Il caos è il peggior nemico di chi vuole sopravvivere. Proteggiti da esso posizionando dei cartelli.|
|$piece_sign_input|Inserisci testo|
|$piece_silverbarstack|Pila d'argento|
|$piece_silverbarstack_description|Un modo elegante per mettere in mostra la propria ricchezza.|
|$piece_skullpile|Pila di teschi|
|$piece_skullpile_description|Una prova indiscutibile della tua abilità in combattimento.|
|$piece_smelter|Fonderia|
|$piece_smelter_add|Aggiungi|
|$piece_smelter_additem|Aggiungi oggetto|
|$piece_smelter_description|Si inseriscono carburante e minerale, e ne escono bellissimi lingotti di metallo.|
|$piece_smelter_empty|Vuota|
|$piece_smelter_ready|Lavorato|
|$piece_smelter_reqroof|Necessita un tetto|
|$piece_snowlantern|Lanterna di neve|
|$piece_snowlantern_description|Dà un tocco d'intimità a un paesaggio invernale.|
|$piece_spinningwheel|Ruota|
|$piece_spinningwheel_description|Questa macchina automatizzata accelera il processo di trasformazione dei fili partendo dalle fibre.|
|$piece_stakewall|Picchetto|
|$piece_stakewall_description|Ottimo per tenere lontani gli intrusi.|
|$piece_stave_deco_beam_2m|Trave in legno decorata da 2 m|
|$piece_stave_deco_beams_description|Questi elementi aggiungono un tocco di stile e decorativo.|
|$piece_stave_deco_pole_2m|Palo in legno decorato da 2 m|
|$piece_stave_pole_2m|Palo di legno da 2 m|
|$piece_stave_pole_4m|Palo di legno da 4 m|
|$piece_stave_wall|Muro di legno|
|$piece_stave_walls_description|Le pareti in legno massiccio sono ottime per isolare dal freddo.|
|$piece_stavebeam2|Trave di legno da 2 m|
|$piece_stavebeam26|Trave di legno 26°|
|$piece_stavebeam4|Trave di legno da 4 m|
|$piece_stavebeam45|Trave di legno 45°|
|$piece_stavebeam67|Trave di legno 67°|
|$piece_stavebeams_description|Questi grossi pezzi di legno saranno sicuramente un ottimo supporto per le tue costruzioni.|
|$piece_stavecross26|Trave trasversale per tetto in legno 26°|
|$piece_stavecross45|Trave trasversale per tetto in legno 45°|
|$piece_stavedecobeam26|Trave in legno decorata 26°|
|$piece_stavedecobeam45|Trave in legno decorata 45°|
|$piece_stavedecobeam67|Trave in legno decorata 67°|
|$piece_stavegate|Cancello di legna da costruzione|
|$piece_stavegate_description|Non proprio maestoso come le porte del Valhalla, ma ci si avvicina molto!|
|$piece_stavewallrooftop67|Trave trasversale per tetto in legno 67°|
|$piece_stonearch|Arco di pietra|
|$piece_stonearch_description|Solido come una roccia.|
|$piece_stonecutter|Tagliapietre|
|$piece_stonecutter_description|Se vuoi costruire in pietra, avrai bisogno di un tagliapietre che lavori il materiale.|
|$piece_stonefence|Recinzione in pietra|
|$piece_stonefence_description|Pietre accuratamente assemblate a formare una robusta recinzione.|
|$piece_stonefloor_description|Meglio stendere un tappeto, altrimenti potresti prendere freddo!|
|$piece_stonefloor2x2|Pavimento di pietra 2x2|
|$piece_stonefloor4x4|Pavimento di pietra 4x4|
|$piece_stonepile|Pila di pietre|
|$piece_stonepile_description|È un enorme cumulo di pietre.|
|$piece_stonepillar|Pilastro di pietra|
|$piece_stonestair|Scala di pietra|
|$piece_stonestair_description|Utile per spostarsi all'interno di una grande fortezza.|
|$piece_stonethrone|Trono in pietra|
|$piece_stonethrone_description|Un buon leader deve essere solido come una roccia, ma deve anche sapere quando essere morbido come una pelliccia...|
|$piece_stonewall1x1|Muro di pietra 1x1|
|$piece_stonewall2x1|Muro di pietra 2x1|
|$piece_stonewall4x2|Muro di pietra 4x2|
|$piece_stonewalls_description|Un blocco di pietra lavorato grossolanamente.|
|$piece_stool|Sgabello|
|$piece_stool_description|Un posto dove sedersi.|
|$piece_table|Tavolo|
|$piece_table_description|Un tavolino piccolo ma robusto.|
|$piece_table_oak|Lungo tavolo pesante|
|$piece_table_oak_description|Questo tavolo è perfetto per un grande banchetto, con spazio a sufficienza per tanti piatti diversi!|
|$piece_table_round|Tavolo tondo|
|$piece_table_round_description|A una tavola rotonda, nessun posto è più importante di un altro.|
|$piece_table_runed|Lungo tavolo intagliato|
|$piece_table_runed_description|La storia incisa su questo tavolo è perfetta da leggere durante i lunghi banchetti.|
|$piece_table_runed_small|Tavolo quadrato intagliato|
|$piece_table_runed_small_description|Un tavolo per incontri più intimi.|
|$piece_tarpile|Barile di pece|
|$piece_throne01|Trono del corvo|
|$piece_throne01_description|Forse è così che si presenta il trono di Odino nel Valhalla... Comunque sia, è comodissimo!|
|$piece_tinbarstack|Pila di stagno|
|$piece_tinbarstack_description|Con questo si può ricavare un bel po' di bronzo...|
|$piece_tombstone|Qui giace|
|$piece_tombstone_container|Tomba|
|$piece_tombstone_recovered|Oggetti recuperati|
|$piece_toofar|Troppo lontano|
|$piece_trainingdummy|Fratello di battaglia|
|$piece_trainingdummy_description|Avvicinati a tuo rischio e pericolo!|
|$piece_trap|Trappola|
|$piece_trap_arm|Trappola da braccio|
|$piece_trap_armed|Armata|
|$piece_trap_cooldown|La trappola per troll non è ancora pronta|
|$piece_trap_description|Questa trappola scatterà su chiunque ci cammini sopra. Attenzione!|
|$piece_treasure_pile|Pila di monete|
|$piece_treasure_pile_description|Una piccola fortuna, luccicante e scintillante.|
|$piece_treasure_stack|Catasta di monete|
|$piece_treasure_stack_description|È importante tenere il conto delle proprie monete.|
...
|$piece_upgradestation|Fucina del potenziale|
|$piece_use|Usa|
|$piece_useitem|Usa oggetto|
|$piece_vegvisir|Vegvísir|
|$piece_vertical|Verticale|
|$piece_windmill|Mulino|
|$piece_windmill_description|Trasforma il grano in farina. Funziona meglio nei giorni ventosi!|
...
|$piece_woodbeam67|Trave in legno 67°|
|$piece_woodcorestack|Catasta di legno robusto|
|$piece_woodcorestack_description|Una grande catasta di tronchi, appena tagliati.|
|$piece_wooddoor|Porta di legno|
|$piece_wooddoor_description|Una semplice porta da aprire e chiudere.|
|$piece_wooddragon|Ornamento di drago in legno|
|$piece_wooddragon_description|Rendi la tua casa leggendaria decorandola con un drago.|
|$piece_woodfence|Recinzione a palo tondo|
|$piece_woodfence_description|Una buona recinzione, sia per il bestiame che per i raccolti!|
|$piece_woodfencegate|Cancello a palo tondo|
|$piece_woodfencegate_description|Un cancello è decisamente più pratico che saltare la recinzione ogni volta.|
|$piece_woodfinestack|Catasta di legno pregiato|
|$piece_woodfinestack_description|Questa catasta di legna aspetta solo di essere trasformata in mobili.|
|$piece_woodfloor_description|Una solida tavola di legno per pavimenti.|
|$piece_woodfloor1x1|Pavimento di legno 1x1|
|$piece_woodfloor2x2|Pavimento di legno 2x2|
|$piece_woodfroststack|Pila di legname|
|$piece_woodfroststack_description|È come se ci fosse appena caduta sopra della neve fresca...|
|$piece_woodgate|Cancello di legno|
|$piece_woodgate_description|Un semplice cancello in legno. Da utilizzare singolarmente o in coppia.|
...
|$piece_woodironpoles_description|Il supporto più resistente che tu abbia mai realizzato.|
|$piece_woodledge|Battente di legno|
|$piece_woodlog26|Tronco 26°|
|$piece_woodlog45|Tronco 45°|
|$piece_woodlog67|Tronco 67°|
|$piece_woodlogs_description|Sostieni le tue costruzioni con questo stile rustico.|
|$piece_woodpole|Palo di legno 1m|
|$piece_woodpole2|Palo di legno 2m|
|$piece_woodpoles_description|Un robusto supporto in legno.|
|$piece_woodroof26|Tetto di paglia 26°|
|$piece_woodroof26_description|Un tetto semplice per ripararsi dalla pioggia, costruito con una leggera inclinazione.|
|$piece_woodroof45|Tetto di paglia 45°|
|$piece_woodroof45_description|Un tetto semplice per ripararsi dalla pioggia, con una pendenza più accentuata.|
|$piece_woodroof67|Tetto di paglia 67°|
|$piece_woodroof67_description|Un tetto semplice per ripararsi dalla pioggia, costruito con una pendenza molto accentuata.|
|$piece_woodrooficorner|Tetto di paglia 26° concavo|
|$piece_woodrooficorner45|Tetto di paglia 45° concavo|
|$piece_woodrooficorner67|Angolo interno del tetto di paglia 67°|
|$piece_woodroofocorner|Tetto di paglia 26° convesso|
|$piece_woodroofocorner45|Tetto di paglia 45° convesso|
|$piece_woodroofocorner67|Angolo esterno del tetto di paglia 67°|
|$piece_woodrooftop|Displuvio del tetto di paglia 26°|
|$piece_woodrooftop45|Displuvio del tetto di paglia 45°|
|$piece_woodrooftop67|Colmo del tetto di paglia 67°|
|$piece_woodstack|Pila di legno|
|$piece_woodstack_description|Metti in mostra tutto il tuo duro lavoro!|
|$piece_woodstair|Scale di legno|
|$piece_woodstair_description|Ottimo per sollevarsi da terra.|
|$piece_woodstepladder|Scala in legno|
|$piece_woodstepladder_description|Utile per salire più in alto.|
|$piece_woodwall|Muro di legno|
|$piece_woodwall_description|Le pareti sono una parte importante di ogni casa!|
...
|$piece_woodwallroof67|Muro di legno 67°|
|$piece_woodwallroof67upsidedown|Muro di legno 67° (invertito)|
|$piece_woodwallrooftop|Tetto a croce di legno 26°|
|$piece_woodwallrooftop45|Tetto a croce di legno 45°|
|$piece_woodwallrooftop67|Tetto a croce di legno 67°|
|$piece_woodwindowshutter|Persiana di legno|
|$piece_woodwindowshutter_description|Aperta o chiusa, tienila come preferisci o cambiala quando vuoi!|
|$piece_workbench|Banco di lavoro|
|$piece_workbench_description|Un banco da lavoro è indispensabile in ogni casa. Serve per costruire strutture in legno e realizzare nuovi attrezzi.|
|$piece_workbench_ext1|Ceppo|
|$piece_workbench_ext1_description|L'ascia è uno strumento molto versatile per il fai da te.|
|$piece_workbench_ext2|Cremagliera da conciatore|
|$piece_workbench_ext2_description|Pelle e cuoio devono essere trattati adeguatamente prima di poter essere utilizzati.|
|$piece_workbench_ext3|Ascia|
|$piece_workbench_ext3_description|A volte è necessario affrontare il problema da una prospettiva diversa.|
|$piece_workbench_ext4|Ripiano utensili|
|$piece_workbench_ext4_description|Un lavoro di precisione richiede strumenti altrettanto precisi.|
|$piece_writemap|Tieni traccia delle tue scoperte|
|$piece_yggdrasilstack|Catasta di legna di Yggdrasil|
|$piece_yggdrasilstack_description|Rami sottili, vibranti di un'energia misteriosa.|
|$piece_yulecrown|Corona fiorita di Yule|
|$piece_yulecrown_description|È difficile immaginare qualcosa di più festoso di una ghirlanda!|
|$piece_yulegarland|Ghirlanda di Yule|
|$piece_yulegarland_description|Addobba la casa!|
|$piece_yuleklapp|Regalo di Jól|
|$piece_yuleklapp_description1|Un piccolo regalo per una persona a cui vuoi bene.|
|$piece_yuleklapp_description2|Un regalo per qualcuno che si è comportato bene quest'anno.|
|$piece_yuleklapp_description3|Un regalo importante per una persona a cui tieni molto.|
|$piece_yuletree|Albero di Jól|
|$piece_yuletree_description|Questo abete è stato addobbato con luci festive.|
|$placeofmystery|Luogo misterioso|
|$playfab_couldnotloadplayfabparty_header|Impossibile caricare PlayFab|
|$playfab_couldnotloadplayfabparty_text_linux|È necessario per utilizzare il crossplay. Assicurati di aver installato le dipendenze necessarie per PlayFab Party su Linux, elencate qui: https://learn.microsoft.com/en-us/gaming/playfab/features/multiplayer/networking/linux-specific-requirements|
|$playfab_couldnotloadplayfabparty_text_linux_steamdeck|È necessario per utilizzare il crossplay. Finché non sarà disponibile una correzione, puoi utilizzare il livello di compatibilità Proton sul tuo Steam Deck per accedere alle funzionalità di crossplay.|
|$playfab_couldnotloadplayfabparty_text_otherplatforms|È necessario per utilizzare il crossplay. Se l'errore persiste, segnalalo come bug.|
|$playfab_couldnotloadplayfabparty_text_windows|È necessario per utilizzare il crossplay. Di solito ciò è dovuto al fatto che non hai installato i pacchetti ridistribuibili di Microsoft Visual C++. Scaricali qui: https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist|
|$playstation_activity_name|Sta esplorando il 10° Mondo|
|$playstation_trophy_set_online_only|Trofei riservati alla modalità multigiocatore|
...
|$prop_beech_sapling_description|Il faggio produce un legno di ottima qualità.|
|$prop_birch|Betulla|
|$prop_birch_sapling|Arboscello di betulla|
|$prop_birch_sapling_description|Una delle principali fonti di legno pregiato.|
...
|$prop_fir|Abete|
|$prop_fir_big_sapling|Alberello di legna da costruzione|
|$prop_fir_big_sapling_description|Sebbene sia originario delle regioni settentrionali, questo albero può crescere nella maggior parte dei climi.|
|$prop_fir_sapling|Arboscello di abete|
|$prop_fir_sapling_description|Un albero incantevole, in ogni stagione.|
|$prop_oak|Quercia|
|$prop_oak_sapling|Arboscello di quercia|
|$prop_oak_sapling_description|Con il tempo, questa pianta diventerà una grande quercia.|
|$prop_offerbowl_makeoffer|Offri in sacrificio|
|$prop_pine|Pino|
|$prop_pine_sapling|Arboscello di pino|
|$prop_pine_sapling_description|Questi alberi a fusti alti possono essere abbattuti per ricavarne legname da costruzione.|
|$prop_pine_snow|Albero da legname|
|$prop_timberwoodtree|Albero da legname|
|$prop_treelog|Tronco|
|$prop_treestump|Ceppo|
|$prop_yggashoot|Germoglio di Yggdrasil|
|$ps_codeofconduct_platform_specific_text|Devi anche seguire il Codice di condotta della community di PlayStation™Network, che si aggiunge alle nostre regole.|
|$ps_codeofconduct_reporting_violations_body|Se noti comportamenti inaccettabili:<br/>• In gioco: usa la funzione “Segnala giocatore” (Opzioni->Elenco giocatori->Segnala)<br/>• Fuori dal gioco: usa questo modulo online: https://valheim.com/report-a-player<br/>• Tramite PlayStation™Network: https://www.playstation.com/it-it/support/account/ps5-report-behaviour/?country-selector=true|
|$ps_crossplay_user_id_with_name|ID utente crossplay: $1|
|$ps_error_crossplayprivilege|Hai attivato l'impostazione “Solo PlayStation™Network” nelle impostazioni di gioco, che ti impedisce di giocare su server che permettono il crossplay con altre piattaforme.|
|$ps_eula_important_first_text|(Valheim – Edizione per PlayStation®5)<br/>IMPORTANTE: LEGGERE ATTENTAMENTE L'ACCORDO DISPONIBILE AL SITO VALHEIM.COM/EULA. SCARICANDO, INSTALLANDO O USANDO “VALHEIM” (IL "PRODOTTO") SU UNA CONSOLE PLAYSTATION®5 DI TUA PROPRIETÀ O SOTTO IL TUO CONTROLLO, ACCETTI DI ESSERE VINCOLATO AI TERMINI DEL PRESENTE ACCORDO DI LICENZA PER L'UTENTE FINALE (“EULA”). SE NON ACCETTI, NON UTILIZZARE IL PRODOTTO.|
|$ps_loading_savenotification|Questo gioco ha una funzione di salvataggio automatico. Non spegnere il gioco o la console quando vedi l'icona del salvataggio automatico.|
|$ps_loadscreen_tip24|Puoi filtrare i segnaposti sulla mappa usando il tasto direzionale destro|
|$ps_menu_cloudstoragefull|La memoria di archiviazione della console è piena!|
|$ps_menu_codeofconduct_button|Codice di condotta|
|$ps_menu_crossplayserver|Crossplay|
|$ps_menu_invite_friends|Invita amici|
|$ps_menu_localstoragefullcharacterprompt|Hai esaurito lo spazio di archiviazione, quindi non è stato possibile creare il personaggio.|
|$ps_menu_localstoragefullworldprompt|Hai esaurito lo spazio di archiviazione, quindi non è stato possibile creare il mondo.|
|$ps_menu_storagefull|La tua memoria di archiviazione della console è piena!|
|$ps_menu_storagefulloperationfailed|L'operazione non è andata a buon fine perché la memoria di archiviazione è piena. Elimina i dati di salvataggio non utilizzati e riprova.|
|$ps_menu_storageused|Memoria di archiviazione della console usata: $1|
|$ps_online_id_with_name|ID online: $1|
|$ps_online_kickedfromsession_suspendresume_text|La tua sessione online è terminata perché la console PlayStation®5 è entrata in modalità di riposo, interrompendo l'attività di rete.|
|$ps_online_kickedfromsession_text|La tua sessione online è terminata. Assicurati di aver effettuato l'accesso al PlayStation™Network e di avere un abbonamento PlayStation®Plus attivo.|
|$ps_report_user_banned_account|Il tuo account è stato bannato dal gioco online per aver violato i termini di servizio elencati nell'EULA e nel Codice di condotta. Questa azione è stata intrapresa da Coffee Stain Publishing. Per maggiori informazioni, consulta l'EULA nell'angolo in basso a sinistra.|
|$ps_settings_3d_audio|Audio 3D|
|$ps_settings_controller|Controller|
|$ps_settings_controller_layout|Layout del controller|
|$ps_settings_controller_motion_sensor|Sensore di movimento|
|$ps_settings_controller_motion_sensor_settings_off|Il sensore di movimento è disattivato! Controlla le impostazioni.|
|$ps_settings_controller_motion_sensor_toggled_off|Disattiva sensore di movimento|
|$ps_settings_controller_motion_sensor_toggled_on|Attiva sensore di movimento|
|$ps_settings_controller_motion_sensor_x_axis_sensitivity|Sensibilità del sensore di movimento asse X|
|$ps_settings_controller_motion_sensor_y_axis_sensitivity|Sensibilità del sensore di movimento asse Y|
|$ps_settings_controller_sensitivity|Sensibilità controller|
|$ps_settings_controller_speaker_volume|Volume dell’altoparlante del controller|
|$ps_settings_controller_use_adaptive_triggers|Utilizza i grilletti adattivi|
|$ps_settings_controller_use_controller_speaker|Utilizza l'altoparlante del controller|
|$ps_settings_controller_use_vibration|Utilizza la vibrazione|
|$ps_settings_controller_vibration_strength|Intensità delle vibrazioni|
|$ps_settings_double_tap_descr|Toccare rapidamente la levetta verso lo stesso elemento due volte per interagirci.|
|$ps_settings_flick_interact_descr|Spostare rapidamente la levetta verso un elemento per interagirci.|
|$ps_settings_gamepadenabled|Controller attivo|
|$ps_settings_persistentbackbtn|Tasto Indietro permanente|
|$ps_settings_persistentbackbtn_descr|Quando navighi nel menu radiale composto da più pagine, l'elemento più in alto sarà sempre un tasto per tornare indietro.|
|$ps_settings_same_online_platform_only|Solo PlayStation™Network|
|$ps_settings_same_online_platform_only_desc|Gioca solo con giocatori su PlayStation™Network. Disattiva tutte le interazioni con utenti di altre piattaforme. Può essere attivato solo dal menu principale.|
|$ps_settings_show_button_hints|Mostra suggerimenti tasti|
|$ps_settings_swap_triggers|Inverti i tasti R2 e L2|
|$ps_ugc_character_name|Nome personaggio di contenuti generati dagli utenti (UGC)|
|$ps_ugc_server_name|Nome server di contenuti generati dagli utenti (UGC)|
|$ps_ugc_text|Testo di contenuti generati dagli utenti (UGC)|
|$ps_ugc_world_name|Nome mondo di contenuti generati dagli utenti (UGC)|
|$radial_all|Tutto|
|$radial_armor_utility|Armature e oggetti utili|
|$radial_back|Indietro|
|$radial_close|Chiudi|
|$radial_consumables|Consumabili|
|$radial_drop|Lascia|
|$radial_drop_multiple|Lascia multipli|
|$radial_emotes|Emote|
|$radial_half|Metà|
|$radial_hammer|Equipaggia il martello|
|$radial_handitems|Oggetti manuali|
|$radial_hold|(Tieni premuto)|
|$radial_hotbar|Barra rapida|
|$radial_interact|Usa/Apri|
|$radial_speed_fast|Veloce|
|$radial_speed_medium|Medio|
|$radial_speed_off|Disattivato|
|$radial_speed_slow|Lento|
|$radial_weapons_tools|Armi e strumenti|
|$raven_interact|Parla|
|$report_server_window_explanation_text|Se questo server contiene contenuti generati dagli utenti (CGU) che violano il Codice di condotta, è possibile segnalarlo. Ti consigliamo di rimuovere manualmente i CGU tramite gli strumenti disponibili in gioco; tuttavia, se ciò non fosse possibile, è possibile segnalare il server.|
|$report_server_window_header|Segnala server|
|$report_user_already_reported_header|Già segnalato|
|$report_user_already_reported_text|Hai già segnalato questo utente.|
|$report_user_banned_account|Il tuo account è stato bannato dal gioco online per aver violato i termini di servizio elencati nell'EULA e nel Codice di condotta. Questa azione è stata intrapresa da Coffee Stain Publishing. Per maggiori informazioni, consulta l'EULA nell'angolo in basso a sinistra.|
|$report_user_banned_account_steam|Il tuo account è stato bannato dai server crossplay per aver violato i termini di servizio elencati nell'EULA e nel Codice di condotta. Questa azione è stata intrapresa da Coffee Stain Publishing. Per maggiori informazioni, consulta l'EULA nell'angolo in basso a sinistra.|
|$report_user_banned_bodytext_permanentBan|Questo ban è permanente.|
|$report_user_banned_bodytext_unbannedLocalTime|Il tuo ban scadrà il|
|$report_user_banned_header|Bannato.|
|$report_user_failed_header|Segnalazione non riuscita!|
|$report_user_failed_text|Impossibile inviare la segnalazione! Riprova più tardi.|
|$report_user_send_report_cancel|Annulla segnalazione|
|$report_user_send_report_cant_send_not_enough_text|Aggiungi maggiori dettagli nel campo di testo prima di inviare la segnalazione!|
|$report_user_send_report_failed|Segnalazione non riuscita|
|$report_user_send_report_send|Invia segnalazione|
|$report_user_successful_header|Segnalazione inviata!|
|$report_user_successful_text|La tua segnalazione è stata registrata. Verrà presa in carico al più presto.|
|$report_user_window_explanation_text|La cronologia della chat e il nome vengono inclusi automaticamente. Spiega perché stai segnalando questo utente nella finestra di testo qui sopra. Non includere informazioni personali sensibili o non pertinenti.|
|$report_user_window_header|Segnala utente|
|$rock_abyssalbarnacle|Cirripede abissale|
|$rotate_build_mode|Ruota (Costruzione)|
|$se_adrenaline|Uso di adrenalina|
|$se_adrenaline_upfront|Uso di adrenalina|
|$se_adrenalinerush|Scarica d'adrenalina|
|$se_adrenalinerush_tooltip|L'adrenalina scorre nelle tue vene|
|$se_ashlandsmediumarmorseteffect_name|Resistenza di Ask|
|$se_ashlandsmediumarmorseteffect_tooltip|Un'armatura più leggera ti permette di muoverti con maggiore libertà, poiché ogni movimento richiede meno energia.|
...
|$se_berserker_undead_effect_name|Ira orso nefasto|
|$se_berserker_undead_effect_tooltip|Aumenta i danni e la rigenerazione, ma ti indebolisce contro i danni fisici.|
|$se_berserkereffect_name|Furore|
|$se_berserkerteffect_tooltip|Aumenta i danni e la rigenerazione, ma ti indebolisce contro i danni fisici.|
|$se_blockstamina|Utilizzo della resistenza al blocco|
|$se_blockstaminaflat|Uso di resistenza|
|$se_blockstaminaflat_minus|Blocca il recupero di resistenza|
...
|$se_crowned_name|Diritti d'autore|
|$se_crowned_start|Passi senza che nessuno ti ferma.|
|$se_crowned_tooltip|Le creature di Valheim non faranno del male a chi le ha domate.|
|$se_deepnorthmediumarmorseteffect_name|Avanguardia|
|$se_deepnorthmediumarmorseteffect_tooltip|Ti senti più forte, più veloce, e in grado di attaccare i tuoi nemici!|
...
|$se_eitr|Eitr|
|$se_eitr_upfront|Aumento di eitr|
...
|$se_frostorbs|Sfera della vendetta|
|$se_frostorbs_description|Se il tuo nemico ti ferisce, si ritorcerà immediatamente contro di lui.|
...
|$se_health|Salute|
|$se_health_upfront|Aumento di salute|
...
|$se_loxseteffect_name|Favore dei Lox|
|$se_loxseteffect_tooltip|La pelliccia ti permette di mimetizzarti con la natura selvaggia e di muoverti senza che nessuno ti veda.|
...
|$se_stagger|Resistenza allo stordimento|
|$se_stamina|Resistenza|
|$se_stamina_upfront|Aumento di resistenza|
...
|$se_trinketblackdamagedealth|Pelle di ferro|
|$se_trinketblackdamagedealth_description|Danni da mazza aumentati e una rapida scarica di rigenerazione della salute.|
|$se_trinketblackdtamina|Velo d'ombra|
|$se_trinketblackdtamina_description|Migliora l'abilità Schivare e riduce il costo di resistenza per bloccare.|
|$se_trinketbloodgoldhealth|Collo-tello|
|$se_trinketbloodgoldhealth_description|La salute si rigenera più velocemente, mentre correre e attaccare consumano meno resistenza. Inoltre, ricevi un incremento immediato della salute e dell'armatura.|
|$se_trinketbloodgoldstamina|Corona della Strega|
|$se_trinketbloodgoldstamina_description|La salute, la resistenza e l'eitr si rigenerano più velocemente e ricevi un incremento immediato di resistenza ed eitr.|
|$se_trinketbronzehealth|Cuore della foresta|
|$se_trinketbronzehealth_description|Rigenerazione della salute aumentata.|
|$se_trinketbronzestamina|Ciondolo di bronzo|
|$se_trinketbronzestamina_description|Rigenerazione della resistenza aumentata.|
|$se_trinketcarapaceeitr|Orecchini pulsanti|
|$se_trinketcarapaceeitr_description|Rigenerazione dell'eitr aumentata.|
|$se_trinketchitinswim|Pinna del destino|
|$se_trinketchitinswim_description|Riduce il costo di resistenza per nuotare e aumenta la velocità di nuoto.|
|$se_trinketflametaleitr|Jörmundling|
|$se_trinketflametaleitr_description|Aumenta l'abilità della magia elementale e del sangue, e una rapida scarica di rigenerazione dell'eitr.|
|$se_trinketflametalstaminahealth|Cuore di fuoco|
|$se_trinketflametalstaminahealth_description|Una rapida scarica di rigenerazione della salute e della resistenza.|
|$se_trinketironhealth|Spillone di ferro|
|$se_trinketironhealth_description|Aumenta l'armatura e una rapida scarica di rigenerazione della salute.|
|$se_trinketironstamina|Cavigliera|
|$se_trinketironstamina_description|Aumenta la velocità della corsa e una rapida scarica di rigenerazione della resistenza.|
|$se_trinketscalestaminadamage|Cavigliera sonora|
|$se_trinketscalestaminadamage_description|Aumenta la velocità dei fendenti e una rapida scarica di rigenerazione della resistenza.|
|$se_trinketsilverdamage|Vista del lupo|
|$se_trinketsilverdamage_description|Aumenta l'abilità con l'arco e la lancia, e aumenta i danni da perforazione.|
|$se_trinketsilverresist|Cuore di cristallo|
|$se_trinketsilverresist_description|Aumenta la resistenza ai danni contundenti, da taglio e da perforazione.|
|$se_trollseteffect_name|Furtivo|
|$se_trollseteffect_tooltip|Ti rende più furtivo.|
|$se_ttl|Durata dell'effetto|
|$se_warm_name|Caldo|
...
|$settings_3dresolution|Limite di risoluzione 3D|
|$settings_accessibility|Accessibilità|
|$settings_account|Account|
|$settings_altkeys|(Pulsanti alternativi)|
|$settings_altplace|Posizione Alternativa|
|$settings_animateradial|Animazione radiale|
|$settings_animateradial_descr|Aggiunge animazioni all'apertura e alla chiusura del menu radiale e alla selezione di un elemento.|
...
|$settings_autopickup|Racc. automatico sì/no|
...
|$settings_bilinear|Uniforme|
|$settings_block|Blocco|
|$settings_blocked_player_list|Giocatori bloccati|
...
|$settings_camzoom|Aumenta/Diminuisci visuale|
|$settings_camzoomin|Ing. visuale|
|$settings_camzoomout|Diminuisci visuale|
|$settings_chat|Chat|
|$settings_close_radial|Chiudi menu radiale/menu radiale delle emote|
|$settings_clothquality|Qualità del tessuto|
...
|$settings_console|Attiva console|
|$settings_console_desc|Consente di aprire la console di gioco, utilizzata per accedere a comandi e funzioni speciali di debug. L'argomento della riga di comando -console sovrascrive questa impostazione.|
|$settings_continousmusic|Musica a ripetizione|
|$settings_controller|Controller|
|$settings_controller_classic|Classico|
|$settings_controller_default|Layout|
|$settings_controller_layout|Layout del controller|
|$settings_controller_sensitivity|Sensibilità controller|
|$settings_controller_speaker_volume|Regolazione del volume dell'altoparlante|
|$settings_controller_use_adaptive_triggers|Utilizza i grilletti adattivi|
|$settings_controller_use_controller_speaker|Utilizza l'altoparlante del controller|
|$settings_controller_use_vibration|Utilizza la vibrazione|
|$settings_controller_vibration_strength|Intensità della vibrazione|
|$settings_controls|Controlli|
|$settings_crouch|Accovacciati|
|$settings_deleteplayfab_task_header|Eliminazione dell'account PlayFab in corso…|
|$settings_deleteplayfabaccount|Elimina l'account PlayFab|
|$settings_deleteplayfabaccount_failure|Impossibile eliminare l'account PlayFab. Motivo:|
|$settings_deleteplayfabaccount_ingamewarning|Non è possibile eliminare l'account PlayFab mentre sei all'interno di un mondo. Per eliminare il tuo account, torna al menu principale.|
|$settings_deleteplayfabaccount_not_logged_in|Non hai effettuato l'accesso a PlayFab|
|$settings_deleteplayfabaccount_success|L'account PlayFab è stato eliminato con successo!|
|$settings_deleteplayfabaccount_text|Vuoi davvero eliminare il tuo account PlayFab e tutti i dati associati? I tuoi mondi, i tuoi personaggi e qualsiasi contenuto generato dagli utenti, come gli edifici, NON verranno rimossi. Potrai creare facilmente un nuovo account la prossima volta che proverai ad accedere ai servizi online all'interno di Valheim.|
...
|$settings_double_tap|Tocca due volte|
|$settings_double_tap_descr|Toccare rapidamente la levetta verso lo stesso elemento due volte per interagirci.|
|$settings_draw|Tira|
|$settings_enable_show_build_piece_author|Mostra l'autore dell'elemento di costruzione|
|$settings_enable_show_build_piece_author_desc|Quando passi con il cursore su un elemento di costruzione in modalità costruzione, viene mostrato chi lo ha posizionato.|
|$settings_extreme|Estremo|
|$settings_fishingcast|Lancia|
|$settings_fishingpull|Trascina|
|$settings_flick_interact|Interazione picchietto|
|$settings_flick_interact_descr|Spostare rapidamente la levetta verso lo stesso elemento per interagirci.|
...
|$settings_graphics_preset|Impostazioni predefinite per la grafica|
|$settings_graphics_preset_balanced_description|Se la frequenza di 120 Hz è supportata e abilitata, punta a 40 fps con una qualità grafica superiore; in caso contrario, utilizza l'impostazione predefinita a 60 fps|
|$settings_graphics_preset_high_description|Grafica mozzafiato per sistemi potenti|
|$settings_graphics_preset_low_description|Graficamente piacevole e funziona bene anche su sistemi poco potenti|
|$settings_graphics_preset_medium_description|Offre un buon equilibrio tra qualità grafica e prestazioni|
|$settings_graphics_preset_performance_description|Obiettivo: 60 fps con qualità grafica standard|
|$settings_graphics_preset_quality_description|Obiettivo: 30 fps con la massima qualità grafica|
...
|$settings_high|Alto|
|$settings_hotbarright|Cerchio hotbar|
|$settings_hotbaruse|Usa l'oggetto nell'hotbar|
|$settings_hoverselectspd|Velocità di selezione al passaggio del cursore|
|$settings_hoverselectspd_descr|La velocità con la quale un elemento viene selezionato quando ci si passa sopra col cursore. Imposta su "Disattivato" per disattivare la selezione al passaggio del cursore.|
...
|$settings_lod2|Livello di dettaglio|
|$settings_look|Guardati attorno|
|$settings_low|Basso|
|$settings_map|Mappa|
|$settings_mapzoom|Aumenta/Diminuisci minimappa|
|$settings_mastervol|Volume|
|$settings_medium|Medio|
|$settings_menu|Menu|
|$settings_minimapzoomin|Zoom minimappa|
|$settings_misc|Varie|
...
|$settings_nearestneighbor|Pixelato|
|$settings_nextsnap|Prossimo punto di aggancio|
|$settings_open_emote_wheel|Apri menu radiale delle emote|
|$settings_open_radial|Apri menu radiale|
|$settings_persistentbackbtn|Pulsante Indietro permanente|
|$settings_persistentbackbtn_descr|Quando navighi nel menu radiale composto da più pagine, l'elemento più in alto sarà sempre un pulsante per tornare indietro.|
|$settings_place|Posiziona|
|$settings_playfab_timed_out_header|Risposta da PlayFab non arrivata entro il tempo massimo! Assicurati di avere una connessione stabile a Internet.|
...
|$settings_prevsnap|Aggancio precedente|
...
|$settings_radial|Menu radiale|
|$settings_radial_big|Grande|
|$settings_radial_small|Piccolo|
|$settings_radial_small_edge|Bordo piccolo|
|$settings_radialback|Indietro (radiale)|
|$settings_radialclose|Chiudi (radiale)|
|$settings_radialinteract|Interagire (Rad.)|
|$settings_radialsecondaryinteract|Lascia (radiale)|
|$settings_radialsize|Dimensione radiale|
|$settings_radialsize_descr|Controlla le dimensioni e la posizione del menu radiale|
...
|$settings_release_to_use_mode|Modalità Lascia per usare|
|$settings_release_to_use_mode_descr|Lascia per usare|
...
|$settings_simulationdistance|Distanza di rendering|
|$settings_simulationdistance_circular|circolare da $1 m|
|$settings_simulationdistance_square|quadrato da $1 m|
|$settings_simulationdistance_warning|Aumentare la distanza di rendering potrebbe compromettere gravemente le prestazioni!|
|$settings_sit|Siediti|
|$settings_softpart|Particelle soffici|
|$settings_spiral_normal|Normale|
|$settings_spiral_off|Disattivato|
|$settings_spiral_slight|Leggero|
|$settings_spiraleffect|Effetto spirale|
|$settings_spiraleffect_descr|Determina l'intensità dell'effetto a spirale. Quando si scorre un menu radiale con più pagine, gli elementi accanto a quello selezionato vengono ridimensionati e spostati per creare un effetto simile a una scala a chiocciola. Se disattivato, gli elementi appariranno e scompariranno solo gradualmente. Nota che questa impostazione richiede l'attivazione di Animazione radiale.|
|$settings_ssao|SSAO|
...
|$settings_unlimited|Illimitato|
|$settings_upscalingalgorithm|Metodo di upscaling|
|$settings_use|Usa|
|$settings_useradial|Usa radiale|
|$settings_useradial_descr|Permette l'uso del menu radiale per navigare nell'inventario.|
...
|$shadowperson_randomtalk_01|La sua lama era intinta nel veleno, non avevo alcuna possibilità...|
|$shadowperson_randomtalk_02|Un dolore acuto e lancinante. E poi più nulla.|
|$shadowperson_randomtalk_03|Il fuoco non mi riscalda più, né mi offre una vera luce.|
|$shadowperson_randomtalk_04|Non ricordo più com'è non sentirsi intorpiditi e infreddoliti.|
|$shadowperson_randomtalk_05|Il suo coltello mi ha trafitto il cuore proprio mentre le tagliavo la gola. Siamo morti uno accanto all’altro.|
|$shadowperson_randomtalk_06|Questo non è il Valhalla, né Hel. No, è qualcosa di ben peggiore.|
|$shadowperson_randomtalk_07|Chi è morto, è dimenticato...|
|$shadowperson_randomtalk_08|Padre... ti ho deluso. Mi dispiace...|
|$shadowperson_randomtalk_09|Perdonami, sorella, perché non ho potuto seguire le tue orme.|
|$shadowperson_randomtalk_10|Sono rimasto con lui fino alla fine...|
|$shadowperson_randomtalk_11|C'è qualcuno? Io... avrei giurato di aver visto qualcuno.|
|$shadowperson_randomtalk_12|Da tempo dimenticato... Solo...|
|$shadowperson_randomtalk_13|Ancora un passo. Solo un altro.|
|$shadowperson_randomtalk_14|Queste erano le ultime terre che conoscevamo...|
|$shadowperson_randomtalk_15|Non conosco queste distese, né questa notte oscura...|
|$shadowperson_randomtalk_16|Mi è sembrato di vedere qualcuno che camminava al mio fianco, ma era solo un'ombra.|
|$shadowperson_randomtalk_17|Non sento più il sole sul viso, né il terreno sotto i piedi.|
|$shadowperson_randomtalk_18|Mi... mi sento davvero intorpidito.|
|$shadowperson_randomtalk_19|Il mio scopo è stato raggiunto, eppure non ho ricevuto alcuna ricompensa. Ora cammino qui, senza alcuna utilità...|
|$shadowperson_randomtalk_20|C'è così tanto sangue... Quanto sangue può perdere una persona prima di morire?|
|$shadowperson_randomtalk_21|Il dolore della mia sconfitta, eterno...|
|$shadowperson_randomtalk_22|Sento ancora le corna affilate che mi trafiggono il petto. Quando riuscirò a liberarmi di questo dolore?|
|$shadowperson_randomtalk_23|Pensavo che mi stesse tendendo la mano, ma poi dai suoi polpastrelli è scaturito un lampo.|
|$shadowperson_randomtalk_24|Che strane creature si trovano qui. Speravo fossero amichevoli.|
|$shadowperson_randomtalk_25|Riesci a sentire le loro voci? Sono ancora lì...|
|$shadowperson_randomtalk_26|Il mio viaggio mi ha fatto raggiungere questo luogo… solo perché tutto finisse in un batter d'occhio.|
|$shadowperson_randomtalk_27|Che colori belli, cangianti e ondulati... Perché non riesco a raggiungerli?|
|$shadowperson_randomtalk_28|Era questo il mio destino? Crollare prima ancora di aver raggiunto la mia meta?|
|$shadowperson_randomtalk_29|Quanto sangue è stato versato, e per cosa?|
|$shadowperson_randomtalk_30|Chi racconterà la mia storia?|
|$ship_ashlandocean_warning|Le acque bollenti stanno corrodendo il tuo scafo. Torna indietro!|
|$ship_cargo|Merce|
|$ship_holdfast|Aggrappati all'albero maestro|
|$ship_karve|Karve|
|$ship_karve_description|Una nave piccola ed elegante, pronta a salpare.|
|$ship_longship|Dreki|
|$ship_longship_ashlands|Drakkar|
|$ship_longship_ashlands_description|Una nave imponente, abbastanza robusta da solcare anche i mari più pericolosi.|
|$ship_longship_description|Una possente nave vichinga per navigare verso lidi lontani.|
|$ship_raft|Zattera|
|$ship_raft_description|Potrebbe non sembrare granché, ma su una zattera si va più lontano che a nuoto!|
|$skill_axes|Asce|
...
|$skill_dodge|Schivata|
|$skill_dodge_description|Diminuzione della resistenza durante la schivata.|
...
|$spiritcaller_moose||
|$spiritcaller_wolf||
|$stat_BeesHarvested|Miele raccolto|
|$stat_BuiltPiecesNoDebt|Pezzi di costruzione posizionati|
|$stat_ConsecutiveDaysSurvivedMax|Numero massimo di giorni consecutivi di sopravvivenza|
|$stat_CraftFood|Cibo creato|
|$stat_DeathByAshlandsOcean|Morte nell'oceano delle Lande desolate|
|$stat_DeathByBoat|Morte in barca|
|$stat_DeathByBurning|Morte causata dal fuoco|
|$stat_DeathByCart|Morte per carrello|
|$stat_DeathByCatapult|Morte per catapulta|
|$stat_DeathByCinderFire|Morte per incendio da cenere|
|$stat_DeathByDrawBridge|Morte causata da un ponte levatoio|
|$stat_DeathByDrowning|Morte per annegamento|
|$stat_DeathByEdgeOfWorld|Morte per caduta dal bordo del mondo|
|$stat_DeathByEnemyHit|Morte per mano del nemico|
|$stat_DeathByFall|Morte per caduta|
|$stat_DeathByFreezing|Morte per assideramento|
|$stat_DeathByImpact|Morte per impatto|
|$stat_DeathByIncinerator|Morte per mano dell'Obliteratore|
|$stat_DeathByPoisoned|Morte per avvelenamento|
|$stat_DeathBySelf|Morte causata da un giocatore|
|$stat_DeathBySmoke|Morte per fumo|
|$stat_DeathByStalagtite|Morte per via di una stalagmite|
|$stat_DeathByStructural|Morte per cause strutturali|
|$stat_DeathByTree|Morte causata da un albero|
|$stat_DeathByTurret|Morte causata da una balista|
|$stat_DeathByWater|Morte causata dall'acqua|
|$stat_DistanceSail|Distanza percorsa in mare|
|$stat_DistanceSailHelm|Distanza percorsa in mare al timone|
|$stat_ExploreEast|Esplora l'estremo est|
|$stat_ExploreEastNoMap|Esplora l'estremo est, senza usare una mappa|
|$stat_ExploreNorth|Esplora l'estremo nord|
|$stat_ExploreNorthNoMap|Esplora l'estremo nord, senza usare una mappa|
|$stat_ExploreSouth|Esplora l'estremo sud|
|$stat_ExploreSouthNoMap|Esplora l'estremo sud, senza usare una mappa|
|$stat_ExploreWest|Esplora l'estremo ovest|
|$stat_ExploreWestNoMap|Esplora l'estremo ovest, senza usare una mappa|
|$stat_FoodEaten|Cibo consumato|
|$stat_HarvestBerry|Bacche raccolte|
|$stat_HarvestCrop|Grano raccolto|
|$stat_HarvestMushroom|Funghi raccolti|
|$stat_MaxBuildingHeight|Edificio più alto|
|$stat_MaxBuildingHeightWorld|La posizione più alta al mondo di un edificio|
|$stat_MaxComfort|Massimo livello di comfort|
|$stat_TreasureBuriedFound|Tesori sepolti ritrovati|
|$stat_Tree|Alberi abbattuti|
|$stat_TreeAshlands|Morte causata dall'albero delle Lande desolate|
|$stat_TreeBeech|Morte per faggio|
|$stat_TreeBirch|Morte per betulla|
|$stat_TreeFir|Morte per abete|
|$stat_TreeOak|Morte per quercia|
|$stat_TreePine|Morte per pino|
|$stat_TreeSnowFir|Morte per abete delle nevi|
|$stat_TreeSnowPine|Morte per pino delle nevi|
|$stat_TreeSwamp|Morte causata dall'albero della palude|
|$stat_TreeYggdrasilShoot|Morte per colpo di Yggdrasil|
|$stonecircle_hook_name|Piattaforma scolpita|
|$stonecircle_itemplaced|Hai dimostrato il tuo valore|
|$store_buy|Compra|
|$store_sell|Vendi|
|$store_topic|Negozio|
|$switch_codeofconduct_prohibited_behavior_body|Le seguenti azioni possono comportare il ban temporaneo o permanente dal gioco online:<br/>• Molestie, incitamento all'odio, minacce o discriminazione.<br/>• Condivisione di contenuti offensivi o inappropriati tramite chat, costruzioni nel gioco o altri mezzi.|
|$switch_eula_header|CONTRATTO DI LICENZA PER L'UTENTE FINALE (EULA)|
|$switch_eula_important_first_text|(Valheim – Nintendo Switch 2)<br/>IMPORTANTE: LEGGERE ATTENTAMENTE L'ACCORDO DISPONIBILE AL SITO VALHEIM.COM/EULA. SCARICANDO, INSTALLANDO O USANDO “VALHEIM” (IL "PRODOTTO") SU UNA CONSOLE NINTENDO SWITCH 2 DI TUA PROPRIETÀ O SOTTO IL TUO CONTROLLO, ACCETTI DI ESSERE VINCOLATO AI TERMINI DEL PRESENTE ACCORDO DI LICENZA PER L'UTENTE FINALE (“EULA”). SE NON ACCETTI, NON UTILIZZARE IL PRODOTTO.|
|$switch_loading_savenotification|Questo gioco ha una funzione di salvataggio automatico. Non spegnere il gioco o la console quando vedi l'icona del salvataggio automatico.|
|$switch_loadscreen_tip24|Puoi filtrare i segnaposti sulla mappa in base al tipo utilizzando il pulsante Destra (pulsante ZR con i comandi stile mouse del Joy-Con 2)|
|$switch_menu_cloudstoragefull|La memoria di sistema è piena!|
|$switch_menu_friendinvite_accepted_header|Invito di amicizia accettato|
|$switch_menu_friends|Amici|
|$switch_menu_invite_friends|Invita amici|
|$switch_menu_localstoragefullcharacterprompt|Hai esaurito la memoria di sistema, quindi non è stato possibile creare il personaggio.|
|$switch_menu_localstoragefullworldprompt|Hai esaurito la memoria di sistema, quindi non è stato possibile creare il mondo.|
|$switch_menu_storagefull|La memoria di sistema è piena!|
|$switch_menu_storagefulloperationfailed|L'operazione non è andata a buon fine perché la memoria di sistema è piena. Elimina i dati di salvataggio non utilizzati e riprova.|
|$switch_menu_storageused|Memoria di sistema usata: $1|
|$switch_online_kickedfromsession_suspendresume_text|La tua sessione online è terminata perché la console è entrata in modalità Riposo, interrompendo l'attività di rete.|
|$switch_settings_controller|Controller|
|$switch_settings_controller_default|Console|
|$switch_settings_controller_layout|Layout del controller|
|$switch_settings_controller_motion_sensor|Comandi di movimento|
|$switch_settings_controller_motion_sensor_settings_off|I comandi di movimento sono disattivati! Controlla le impostazioni.|
|$switch_settings_controller_motion_sensor_toggled_off|Disattiva comandi di movimento|
|$switch_settings_controller_motion_sensor_toggled_on|Attiva comandi di movimento|
|$switch_settings_controller_motion_sensor_x_axis_sensitivity|Sensibilità dei comandi di movimento asse X|
|$switch_settings_controller_motion_sensor_y_axis_sensitivity|Sensibilità dei comandi di movimento asse Y|
|$switch_settings_controller_sensitivity|Sensibilità controller|
|$switch_settings_controller_use_vibration|Usa vibrazione|
|$switch_settings_controller_vibration_strength|Forza della vibrazione|
|$switch_settings_double_tap_descr|Toccare rapidamente lo stick verso lo stesso elemento due volte per interagirci.|
|$switch_settings_flick_interact_descr|Spostare rapidamente lo stick verso un elemento per interagirci.|
|$switch_settings_gamepadenabled|Controller attivo|
|$switch_settings_mouse_layout|Layout del mouse|
|$switch_settings_mouse_layout_controller|Comandi stile mouse della console|
|$switch_settings_mouse_layout_pc|Mouse del PC|
|$switch_settings_mouse_sensitivity|Sensibilità mouse|
|$switch_settings_mouse_tab|Comandi stile mouse Joy-Con 2|
|$switch_settings_persistentbackbtn|Pulsante Indietro permanente|
|$switch_settings_persistentbackbtn_descr|Quando navighi nel menu radiale composto da più pagine, l'elemento più in alto sarà sempre un pulsante per tornare indietro.|
|$switch_settings_show_button_hints|Mostra suggerimenti pulsanti|
|$switch_settings_swap_triggers|Inverti i pulsanti ZR e ZL|
|$switch_settings_switch_mouse_enabled|Comandi stile mouse attivi|
|$switch_ugc_character_name|Nome personaggio di contenuti generati dagli utenti (UGC)|
|$switch_ugc_server_name|Nome server di contenuti generati dagli utenti (UGC)|
|$switch_ugc_text|Testo di contenuti generati dagli utenti (UGC)|
|$switch_ugc_world_name|Nome mondo di contenuti generati dagli utenti (UGC)|
|$tag_architecture|Architettura|
|$tag_building|Edificio|
|$tag_crafting|Creazione|
|$tag_decor|Decorazioni|
|$tag_defense|Difesa|
|$tag_doors|Porte e finestre|
|$tag_feasts|Banchetti|
|$tag_floor|Pavimentazione|
|$tag_food|Cibo|
|$tag_furniture|Arredamento|
|$tag_lighting|Illuminazione|
|$tag_mead|Idromele|
|$tag_misc|Varie|
|$tag_roof|Tetto|
|$tag_seasonal|Oggetti stagionali|
|$tag_stacks|Pile e cumuli|
|$tag_stairs|Scale|
|$tag_storage|Deposito|
|$tag_transport|Trasporti|
|$tag_wall|Muri|
|$tamed_name_01|Il tuo migliore amico|
|$text_hidden_notification_muted|TESTO NASCOSTO, AUTORE SILENZIATO|
|$text_hidden_notification_ugc_settings|TESTO NASCOSTO, CONTROLLA IMPOSTAZIONI CGU|
...
|$tinyrom_download_patch_to_play|Scarica la patch per giocare|
|$tool_batteringram|Ariete da sfondamento|
|$tool_batteringram_description|È una forza da non sottovalutare. Riforniscilo e portalo alla roccaforte dei tuoi nemici per aumentare le tue possibilità di successo.|
|$tool_cart|Carretto|
|$tool_cart_description|Utile quando devi spostare molte risorse.|
|$tool_catapult|Catapulta|
|$tool_catapult_description|Se non riesci ad attraversarlo, magari puoi passarci sopra...|
...
|$tutorial_artisan_extension_text|Adesso sei in grado di creare delle mattonelle di ceramica, che hanno un ottimo isolamento termico.<br/>Ti serviranno, se vorrai addentrarti più a sud!|
|$tutorial_artisan_extension_topic|Un nuovo strumento|
|$tutorial_ashlandocean_label|Hugin: Acque bollenti|
|$tutorial_ashlandocean_text|Si direbbe che hai fatto rotta per le acque bollenti a sud. Avrai sicuramente notato che può essere un tentativo letale.<br/>Per attraversare queste acque dovrai costruire qualcosa di più robusto se non vuoi finire sul fondale dell'oceano.|
|$tutorial_ashlandocean_topic|Ehilà!|
|$tutorial_ashlands_label|Hugin: Lande desolate|
|$tutorial_ashlands_text|Hai scoperto le Lande desolate. Sono la zona più calda del decimo mondo.<br/>Qui, l'acqua bolle senza calderone e qualsiasi oggetto combustibile prende fuoco anche con la minima scintilla. Fai attenzione!|
...
|$tutorial_end_hugin_label|Hugin: Verso il Valhalla|
|$tutorial_end_hugin_text|Complimenti, guerriero!<br/><br/>Finalmente hai sconfitto tutti i Rinnegati e hai dimostrato il tuo valore. Le porte del Valhalla sono ora aperte per te: non ti resta che lasciarti trasportare lì dalla Valchiria.<br/><br/>Ma non preoccuparti: sarai sempre il benvenuto qui nel decimo mondo, se mai volessi tornare.|
|$tutorial_end_hugin_topic|Viaggio verso il Valhalla|
|$tutorial_end_munin_label|Munin: I Rinnegati sono stati sconfitti|
|$tutorial_end_munin_text|Hai combattuto valorosamente, guerriero.<br/><br/>Grazie a te, i Rinnegati non esistono più e questo mondo potrà ricongiungersi nuovamente con il resto di Yggdrasil. Ma questa è una storia per un’altra volta! Per ora, dovresti riscuotere la tua ricompensa nel Valhalla, non credi?|
|$tutorial_end_munin_topic|E così la saga giunge al termine…|
|$tutorial_faderember_label|Hugin: La pira eterna|
|$tutorial_faderember_text|Non è solo il soffio del drago a brillare di luce propria, ma anche la sua stessa essenza. Con abbastanza abilità e pazienza, potresti sfruttarla...|
...
|$tutorial_jotuninvasion_hugin_label|Hugin: Invasioni degli Jotun|
|$tutorial_jotuninvasion_hugin_text|"Guardati dall'avanzata dell'esercito degli Jotun. Devi affrontarli nel punto della loro invasione e fermare la loro avanzata, se vuoi davvero riportare il decimo mondo al suo giusto equilibrio..."|
|$tutorial_jotuninvasion_hugin_topic|Forze misteriose ci stanno invadendo!|
...
|$tutorial_mould_hugin_label|Hugin: Stampi|
|$tutorial_mould_hugin_text|Gli stampi possono dare risultati affascinanti! Ma non basta semplicemente riempirli di materiale: devono anche essere temprati con l'aiuto di temperature estreme...|
|$tutorial_mould_hugin_topic|Hai trovato uno stampo!|
...
|$tutorial_prison_label|Hugin: La prigione|
|$tutorial_prison_text|Fai attenzione! L'essere imprigionato oltre questo cancello è potentissimo, più di qualsiasi altro in tutta Valheim. Faresti bene a prepararti adeguatamente prima di affrontare questo nemico finale.|
|$tutorial_prison_topic|Un ultimo tentativo…|
...
|$tutorial_sacrificialblood_label|Hugin: Kall Fimbulbringer sconfitto|
|$tutorial_sacrificialblood_text|Complimenti, guerriero! Hai trovato il sangue sacrificale, la chiave finale per riportare alla normalità questo regno. Ora il Padre degli Dei ha un ultimo compito per te: dimostra di esserne degno tornando nel luogo dove tutto ha avuto inizio!|
|$tutorial_sacrificialblood_topic|È giunto il momento…|
...
|$tutorial_trinket_label|Hugin: gingilli|
|$tutorial_trinket_text|Cra-craaa! Guerriero, è un gingillo scintillante quello che vedo nelle tue mani? Indossalo con orgoglio! Lascia che il suo potere scorra in te e colpisci i tuoi nemici nel suo nome. Se lo fai, riceverai come ricompensa una furia alimentata da pura adrenalina!|
|$tutorial_trinket_topic|L'adrenalina scorre nelle tue vene!|
|$tutorial_upgrader_hugin_label|Hugin: la forgia del potenziale|
|$tutorial_upgrader_hugin_text|Trovare questo luogo dal potere antico non è affatto facile, e chi ci riesce ha molto da guadagnarci! Un avvertimento, però: sebbene la Forgia possa agire a tuo vantaggio in modo straordinario, potrebbe distruggere con altrettanta facilità ciò che cerchi di perfezionare...|
|$tutorial_upgrader_hugin_topic|Ascolta, viandante!|
...
|$xbox_codeofconduct_platform_specific_text|Devi anche seguire le Norme della community di Xbox, che si aggiungono alle nostre regole.|
|$xbox_codeofconduct_reporting_violations_body|Se noti comportamenti inaccettabili:<br/>• In gioco: usa la funzione “Segnala giocatore” (Opzioni->Elenco giocatori->Segnala)<br/>• Fuori dal gioco: usa questo modulo online: https://valheim.com/report-a-player<br/>• Tramite Xbox: https://support.xbox.com/it-IT/help/family-online-safety/enforcement/file-a-complaint-on-xbox-app|
...
|$xbox_eula_important_first_text|(Valheim – Edizione per Xbox®)<br/>IMPORTANTE: LEGGERE ATTENTAMENTE L'ACCORDO DISPONIBILE AL SITO VALHEIM.COM/EULA. SCARICANDO, INSTALLANDO O USANDO “VALHEIM” (IL "PRODOTTO") SU UNA CONSOLE XBOX DI TUA PROPRIETÀ O SOTTO IL TUO CONTROLLO, ACCETTI DI ESSERE VINCOLATO AI TERMINI DEL PRESENTE ACCORDO DI LICENZA PER L'UTENTE FINALE (“EULA”). SE NON ACCETTI, NON UTILIZZARE IL PRODOTTO.|
|$xbox_loading_savenotification|Questo gioco ha una funzione di salvataggio automatico. Non spegnere il gioco o la console quando vedi l'icona del salvataggio automatico.|
|$xbox_menu_resolve_privilege|Risolvere il problema relativo ai privilegi?|
|$xbox_menu_storagefull|Il tuo spazio di archiviazione è pieno!|
|$xbox_menu_storagefulloperationfailed|L'operazione non è andata a buon fine perché lo spazio di archiviazione è pieno. Elimina i dati di salvataggio non utilizzati e riprova.|
|$xbox_menu_storageused|Spazio di archiviazione usato: $1|
|$xbox_online_kickedfromsession_suspendresume_text|La tua sessione online è terminata perché la console è entrata in modalità Sospensione, interrompendo l'attività di rete.|
...
|$xbox_settings_controller_sensitivity|Sensibilità controller|
|$xbox_settings_controller_use_vibration|Utilizza la vibrazione|
|$xbox_settings_controller_vibration_strength|Intensità delle vibrazioni|
|$xbox_settings_double_tap_descr|Toccare rapidamente la levetta verso lo stesso elemento due volte per interagirci.|
|$xbox_settings_flick_interact_descr|Spostare rapidamente la levetta verso un elemento per interagirci.|
|$xbox_settings_gamepadenabled|Controller abilitato|
|$xbox_settings_persistentbackbtn|Pulsante Indietro permanente|
|$xbox_settings_persistentbackbtn_descr|Quando navighi nel menu radiale composto da più pagine, l'elemento più in alto sarà sempre un pulsante per tornare indietro.|
|$xbox_settings_show_button_hints|Mostra suggerimenti pulsanti|
|$xbox_ugc_character_name|Nome personaggio di contenuti generati dagli utenti (UGC)|
|$xbox_ugc_server_name|Nome server di contenuti generati dagli utenti (UGC)|
|$xbox_ugc_text|Testo di contenuti generati dagli utenti (UGC)|
|$xbox_ugc_world_name|Nome mondo di contenuti generati dagli utenti (UGC)|
