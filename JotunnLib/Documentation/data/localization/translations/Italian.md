...
|$error_platformexcluded|Il proprietario del server non permette agli utenti di altre piattaforme di giocare sul proprio server.|
...
|$item_helmet_fishinghat_description|Questo cappello decorato con ami può essere ottenuto solo dagli avventurieri più esperti.|
...
|$menu_addserverfaileddnslookup|Ricerca DNS fallita!|
...
|$menu_kick_player|Vuoi davvero cacciare $1?|
|$menu_kick_player_title|Cacciare il giocatore?|
...
|$menu_loginfailedtext|Impossibile effettuare l'accesso. Assicurati che la connessione a Internet sia attiva.|
|$menu_loginheader|Accesso al servizio di back-end in corso...|
|$menu_loginretrycountdowntext|Nuovo tentativo tra $1 secondo/i...|
|$menu_logintext|Accesso in corso...|
...
|$xbox_error_crossplayprivilege|Le impostazioni dei tuoi privilegi di piattaforma ti impediscono di giocare sui server che permettono il crossplay con altre piattaforme.|
