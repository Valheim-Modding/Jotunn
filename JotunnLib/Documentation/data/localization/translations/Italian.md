...
|$menu_vulkancrashwarning_header|Valheim potrebbe bloccarsi sul tuo sistema quando usi Vulkan|
|$menu_vulkancrashwarning_text|Stai attualmente utilizzando Vulkan. Stiamo indagando su un crash noto che si verifica con Vulkan su alcuni sistemi, e il tuo sistema è stato rilevato come potenzialmente interessato. Se riscontri problemi di stabilità, utilizza invece l'API de rendering predefinita (DirectX 11). Ci scusiamo per l'inconveniente!|
