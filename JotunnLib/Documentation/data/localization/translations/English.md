...
|$menu_beard|Beard|
|$menu_blondness|Blondness|
|$menu_cancel|Cancel|
|$menu_changelog|Changelog|
|$menu_characterexist|A character with this name already exists|
...
|$menu_logout|Log Out|
|$menu_logoutconfirm|Log out from server?|
...
|$menu_passwordinvalid|Invalid password|
|$menu_passwordshort|The password is too short|
...
|$menu_selectserver|Select Server|
