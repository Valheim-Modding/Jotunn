...
|$menu_vulkancrashwarning_text|Actualmente estás usando Vulkan. Estamos investigando un fallo conocido que ocurre al usar Vulkan en ciertos sistemas, y se ha detectado que tu sistema podría verse afectado. Si experimentas problemas de estabilidad, utiliza la API de renderizado predeterminada en su lugar (DirectX 11). ¡Perdón por las molestias!|
