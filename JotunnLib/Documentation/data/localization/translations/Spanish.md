...
|$error_worldfileload|Error al cargar archivo de mundo. Comprueba las copias de seguridad.|
...
|$menu_addserver|Añadir servidor|
|$menu_addserverfailed|Error al añadir un servidor|
|$menu_addserverfailedincorrectformatting|El texto introducido no constituye una IP, URL o código de invitación válidos.|
|$menu_addserverfailedresolvejoincode|Error al procesar el código de unión|
|$menu_back|Atrás|
|$menu_backupcount|$1 copias de seguridad|
|$menu_backuprestorefailedheader|Error al restaurar la copia de seguridad.|
|$menu_backuprestorepromptheader|¿Restaurar copia de seguridad?|
|$menu_backuprestorepromptrecover|Se restaurará el archivo eliminado $1 a partir de $2.|
|$menu_backuprestorepromptreplace|La versión actual de $1 será sustituida por $2.|
|$menu_beard|Barba|
...
|$menu_cloudstoragefull|No queda espacio en tu almacenamiento en la nube.|
|$menu_cloudstoragefullcharacterprompt|¿Prefieres guardar este personaje en almacenamiento local?|
|$menu_cloudstoragefullmovingsave|Para evitar pérdidas de datos, los datos de guardado de la sesión actual se podrían guardar en almacenamiento local.|
|$menu_cloudstoragefulloperationfailed|No se ha podido realizar la operación dado que tu espacio de almacenamiento en la nube está lleno. Mueve algunos mundos al almacenamiento local e inténtalo de nuevo.|
|$menu_cloudstoragefullworldprompt|¿Prefieres guardar este mundo en almacenamiento local?|
|$menu_cloudstorageused|Almacenamiento en la nube en uso: $1/$2|
...
|$menu_crossplayserver|Juego multiplataforma|
|$menu_deleted|Eliminadas|
|$menu_disallowedcharactername|Can't create a character with this name|
|$menu_done|Listo|
|$menu_duplicatefilepromptheader|Error al mover datos de guardado.|
|$menu_duplicatefileprompttext|Ya existen datos de guardado con el nombre «$1» en la ubicación de destino.|
|$menu_enteripinvite|Introduce una IP o código de unión|
...
|$menu_gamepreviewpopuptext|Puede que algunas funciones del juego o la plataforma no funcionen correctamente y el juego se cierre inesperadamente.|
|$menu_hair|Pelo|
|$menu_hairtone|Tono de pelo|
|$menu_ipportorinvitecode|[IP/URL]:[puerto] o [código de invitación de 6 dígitos]|
|$menu_joincode|Código de unión $1|
...
|$menu_logoutprompt|¿Seguro que quieres cerrar tu sesión actual?|
|$menu_male|Hombre|
|$menu_managesaves|Gestionar datos de guardado|
...
|$menu_movefailedheader|Error al mover el archivo.|
...
|$menu_newworldalreadyexistsmessage|Ya existe un mundo llamado $1.|
|$menu_no|No|
|$menu_ok|Aceptar|
...
|$menu_remove|Borrar|
|$menu_removebackup|¿Eliminar copia de seguridad?|
...
|$menu_restorebackup|Restaurar copia de seguridad|
|$menu_seed|Semilla|
...
|$menu_tryagainorrestart|Inténtalo de nuevo o reinicia el juego si el problema persiste.|
...
|$msg_worldsavedcloudstoragefull|Espacio de almacenamiento en la nube completo. El mundo se ha guardado en el almacenamiento local.|
...
|$settings_autobackup|Historial de copias de seguridad automáticas|
