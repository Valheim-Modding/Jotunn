...
|$error_platformexcluded|El dueño no permite jugar en el servidor a los jugadores que usen plataformas distintas a la suya.|
...
|$hud_mapday|Día|
|$hud_maxsummonsreached|Tu Levantador de Muertos no es lo suficientemente fuerte como para controlar más invocaciones.|
|$hud_misc|Misceláneo|
...
|$item_bow_snipesnap|Estallido de columna|
...
|$item_dvergrtankard_description|¡Puede contener un montón de malta!|
...
|$item_stafficeshards|Bastón de Frío|
...
|$item_staffskeleton|Levantador de Muertos|
...
|$menu_loginfailedtext|No ha sido posible iniciar sesión. Asegúrate de contar con conexión a internet.|
|$menu_loginheader|Iniciando sesión en el servicio de administrador...|
|$menu_loginretrycountdowntext|Próximo reintento: $1 s|
...
|$msg_worldsavewarning|Salvación del mundo:|
...
|$tutorial_eitr|Parece que hasta tomado un sorbo de una rama de Yggdrasil, y apuesto a que te gustó. Esas divertidas luces coloridas que ves girando a tu alrededor pueden que ya no estén en tu cabeza.<br/>Solo no lo conviertas en un hábito. Podrían haber efectos a largo plazo que pueden ser de todo menos mágicos.|
...
|$xbox_error_crossplayprivilege|Tus configuraciones de privilegio de la plataforma evitan que juegues en servidores que permitan el juego multiplataforma.|
