...
|$item_armor|Защита|
|$item_arrow_bronze|Бронзововърха Стрела|
|$item_arrow_bronze_description|По-остра от кремък. Лъскав пратеник на смъртта.|
...
|$item_arrow_fire_description|Тази стрела изгаря всичко, което пронизва.|
|$item_arrow_flint|Кремъчна Стрела|
|$item_arrow_flint_description|Разкъсвач на кожи с връх от кремък.|
|$item_arrow_frost|Ледена Стрела|
|$item_arrow_frost_description|Къс пронизващ лед.|
|$item_arrow_iron|Желязновърха Стрела|
|$item_arrow_iron_description|Облечена с желязо и с оперение от тъмни пера.|
|$item_arrow_needle|Стрела от игла|
|$item_arrow_needle_description|Последният шев.|
|$item_arrow_obsidian|Обсидианова Стрела|
|$item_arrow_obsidian_description|Късче тъма.|
|$item_arrow_poison|Отровна Стрела|
|$item_arrow_poison_description|Горчиво ожилване отдалеч.|
|$item_arrow_silver|Сребърновърха Стрела|
|$item_arrow_silver_description|Игла, успокояваща неуморните духове.|
...
|$item_atgeir_blackmetal|Атгеир от Черен Метал|
|$item_atgeir_blackmetal_description|Свирепа сечаща брадва от почти неразрушим черен метал.|
|$item_atgeir_bronze|Бронзов Атгейр|
|$item_atgeir_bronze_description|Инструмент за истински воин.|
...
|$item_atgeir_iron|Железен Атгеир|
|$item_atgeir_iron_description|Кръвопиец, разбивач на черепи, носител на смърт.|
...
|$item_axe_blackmetal|Брадва от Черен Метал|
|$item_axe_blackmetal_description|Перфектно балансирана брадва, изкована от черен метал с изумруден блясък.|
|$item_axe_bronze|Бронзова Брадва|
|$item_axe_bronze_description|Светло и лъскаво острие, извито, като усмивка.|
...
|$item_axe_iron_description|Остра и силна. Най-добър приятел на дървосекача.|
...
|$item_bow_description|Груб, но функционален лък.|
|$item_bow_draugrfang|Зъба на Драугр|
|$item_bow_draugrfang_description|Тъмно дърво, опънато с блещукащи сухожилия. Свирепо оръжие.|
|$item_bow_finewood|Лък от Фина дървесина|
|$item_bow_finewood_description|Прост лък от здрава и еластична дървесина.|
|$item_bow_huntsman|Ловен Лък|
|$item_bow_huntsman_description|Фино обработен и опънат. Радост за всеки ловец.|
...
|$item_cape_odin_description|Най-добрите воини на Один заслужават най-добрата тъкан.|
...
|$item_cloudberries|Диви къпини|
|$item_cloudberries_description|Златото на гората.|
|$item_club|Бухалка|
|$item_club_description|Примитивно, но полезно оръжие.|
|$item_coal|Въглен|
...
|$item_feaster_remove_description|<color=yellow>След като пирът бъде изяден, няма да възвърне ресурси, ако бъде разглобен</color>|
...
|$item_helmet_odin_description|Най-добрите воини на Один заслужават най-добрата тъкан.|
...
|$item_knife_blackmetal|Нож от Черен Метал|
|$item_knife_blackmetal_description|Чернеещо се острие. Здраво и остро.|
...
|$item_knife_chitin|Бръснач от Бездната|
|$item_knife_chitin_description|Нож от дълбочините.|
|$item_knife_copper|Меден Нож|
|$item_knife_copper_description|Бляскав меден нож.|
|$item_knife_flint|Кремъчен Нож|
|$item_knife_flint_description|Подострен кремък. Надежден инструмент.|
...
|$item_loxmeat_description|Суров къс мраморно месо.|
...
|$item_meadbase_description|Има нужда от ферментация.|
...
|$item_meadbasefrostresist|Основа за медовина: Устойчивост на мраз|
|$item_meadbasehasty|Mead base: Ratatosk|
|$item_meadbasehealth|Основа за медовина: Леко лечение|
...
|$item_meadbasepoisonresist|Основа за медовина: Устойчивост на отрова|
|$item_meadbasestamina|Основа за медовина: Лека издръжливост|
...
|$item_mushroomcommon_description|Даровете на гората.|
...
|$item_mushroomyellow_description|Енергично светеща гъба.|
...
|$item_parrybonus|Бонус за париране|
|$item_parts|части|
...
|$item_pickaxe_antler_description|Този инструмент е достатъчно здрав, за да разбие дори най-упоритите скали.|
...
|$item_pickaxe_bronze_description|Добра бронзова кирка. Разбива много здрави скали.|
|$item_pickaxe_iron|Желязна Кирка|
|$item_pickaxe_iron_description|Здрав инструмент от закалено желязо.|
|$item_pickaxe_stone|Каменна Кирка|
|$item_pickaxe_stone_description|Разбивач на скали от камък.|
...
|$item_queensjam|Конфитюрът на кралицата|
|$item_queensjam_description|Тази класическа вкусна комбинация от малини и боровинки.|
|$item_raspberries|Малини|
|$item_raspberries_description|Сладки и вкусни.|
|$item_repairlevel|Ниво на ремонтна станция|
|$item_resin|Resin|
...
|$item_spear_flint_description|Ако окото ти отбележи нещо за смърт, нека ръката ти изпрати вестителя.|
...
|$item_spear_wolffang|Копие от Зъб|
|$item_spear_wolffang_description|Дори мъртъв, вълчият зъб жадува за плът.|
...
|$item_stagbreaker|Rазбивач на елени|
|$item_stagbreaker_description|Оръжие, достойно за боговете! Ако те удари с това, ще усетиш...|
...
|$item_sword_blackmetal_description|Нещо изпълнено със смърт и красота. Улавя светлината със зеленикав блясък.|
...
|$item_sword_fire_description|Извадено от ножницата, съска и плюе с неугасващ огън. Невъзможно острие.|
|$item_sword_iron|Железен меч|
|$item_sword_iron_description|Правата линия между живота и смъртта върви по ръба на това острие.|
...
|$item_sword_silver_description|Най-чистия метал. Нищо нечисто не може да издържи на допира му.|
...
|$item_trophy_blob_description|Миризлива буца лепкава материя.|
|$item_trophy_blob_lore|Миризлива буца лепкава материя.|
|$item_trophy_boar|Трофей: глиган|
|$item_trophy_boar_description|Главата на този глиган, би била красива декорация за всяка къща.|
|$item_trophy_boar_lore|Главата на този глиган, би била красива декорация за всяка къща.|
|$item_trophy_bonemass|Трофей: Маса кости|
|$item_trophy_bonemass_description|Кости и вискозна слуз, споени от някаква невидима сила.<br/>Предложи го на Жертвените камъни.|
...
|$item_trophy_deathsquito_lore|Не ти харесва да докосваш това нещо, дори когато е мъртво.|
|$item_trophy_deer|Трофей: елен|
|$item_trophy_deer_description|Отличен екземпляр, но ще трябва да убиеш много повече от елени, за да влезеш във Валхала.|
|$item_trophy_deer_lore|Отличен екземпляр, но ще трябва да убиеш много повече от елени, за да влезеш във Валхала.|
|$item_trophy_dragonqueen|Трофей: Моудър|
|$item_trophy_dragonqueen_description|Главата на дракон, величествена дори изкривена от смъртта.<br/><br/>Предложи я на Жертвените камъни.|
|$item_trophy_dragonqueen_lore|Белязана с древни белези, тази глава бе последната гледка на безброй воини.|
|$item_trophy_draugr|Трофей: драуг|
|$item_trophy_draugr_description|Завържи устата, ако започне да шепти в нощта...|
|$item_trophy_draugr_lore|Завържи устата, ако започне да шепти в нощта...|
|$item_trophy_draugrelite|Елитен трофей: Драуг|
|$item_trophy_draugrelite_description|Мъртвешкият поглед на светещите червени очи те пронизва до костите.|
|$item_trophy_draugrelite_lore|Мъртвешкия погед на светещите червени очи изпраща тръпка по костите ти.|
...
|$item_trophy_eikthyr_description|Тази отсечена глава излъчва мощ.<br/>Предложи я на жертвените камъни.|
|$item_trophy_eikthyr_lore|Някога цар на гората, размерът на рогата е наистина впечатляващ.|
|$item_trophy_elder|Трофей: Старейшината|
|$item_trophy_elder_description|Тази отсечена глава излъчва мощ.<br/>Предложи я на жертвените камъни.|
|$item_trophy_elder_lore|Дори в смъртта, изглежда, че се усмихва със скрито знание.|
...
|$item_trophy_fenring_description|Нещо средно между вълк и човек, лицето му замръзнало в гримаса на болка.|
|$item_trophy_fenring_lore|Нещо средно между вълк и човек, лицето му замръзнало в гримаса на болка.|
|$item_trophy_foresttroll|Трофей: дървесен трол|
|$item_trophy_foresttroll_description|Кожата, като кожа на древно създание, носи избледнелите следи от древни символи.|
|$item_trophy_foresttroll_lore|Кожата, като кожа на древно създание, носи избледнелите следи от древни символи.|
|$item_trophy_frosttroll|Трофей: Леден трол|
|$item_trophy_frosttroll_description|Очите все още святкат със сребристи отблясъци. Не ги гледай твърде дълго...|
|$item_trophy_frosttroll_lore|Очите все още святкат със сребристи отблясъци. Не ги гледай твърде дълго...|
...
|$item_trophy_goblin_description|Свлечени гънки от зеленикава кожа се събират около чифт тъмни и злобни очи.|
|$item_trophy_goblin_lore|Свлечени гънки от зеленикава кожа се събират около чифт тъмни и злобни очи.|
|$item_trophy_goblinbrute|Трофей: гоблински неустрашим воин|
|$item_trophy_goblinbrute_description|Огромната сива глава е толкова тежка, колкото един камък.|
|$item_trophy_goblinbrute_lore|Огромната сива глава е толкова тежка, колкото един камък.|
|$item_trophy_goblinking|Трофей: Яглут|
|$item_trophy_goblinking_description|Безкоронната глава на мъртъв крал.<br/>Предложи я на Жертвените камъни.|
|$item_trophy_goblinking_lore|Понякога очите още мърдат, а устните безмълвно шепнат...|
|$item_trophy_goblinshaman|Трофей: гоблински шаман|
|$item_trophy_goblinshaman_description|Дори убийството му не можа да изтрие съзнателната усмивка от изкривените му устни...|
|$item_trophy_goblinshaman_lore|Дори убийството му не можа да изтрие съзнателната усмивка от изкривените му устни...|
|$item_trophy_greydwarf|Трофей: грейдуорф|
|$item_trophy_greydwarf_description|Покрита с мъх, отсечената глава на Сиво джудже.|
|$item_trophy_greydwarf_lore|Покрита с мъх, отсечената глава на Сиво джудже.|
|$item_trophy_greydwarfbrute|Трофей: грейдуорф-дивак|
|$item_trophy_greydwarfbrute_description|Отне седем удара, за да отсечеш възлестата глава от тялото му.|
|$item_trophy_greydwarfbrute_lore|Отне седем удара, за да отсечеш възлестата глава от тялото му.|
|$item_trophy_greydwarfshaman|Трофей: грейдуорф-шаман|
|$item_trophy_greydwarfshaman_description|Може да опита да се върне, затова се увери, че подрязваш всички нови филизи...|
|$item_trophy_greydwarfshaman_lore|Може да опита да се върне, затова се увери, че подрязваш всички нови филизи...|
...
|$item_trophy_hatchling_description|Все още студено на допир.|
|$item_trophy_hatchling_lore|Все още студено на допир.|
|$item_trophy_leech|Трофей: пиявица|
|$item_trophy_leech_description|Макар и лигава, кожата е красиво нашарена в червено и черно.|
|$item_trophy_leech_lore|Макар и лигава, кожата е красиво нашарена в червено и черно.|
|$item_trophy_lox|Трофей: локс|
|$item_trophy_lox_description|Главата на огромен звяр, покрита с гъста козина.|
|$item_trophy_lox_lore|Главата на огромен звяр, покрита с гъста козина.|
...
|$item_trophy_neck_description|Мънистените очи и бръснещо остри зъби опровергават привидно спокойната природа на този малък гущер.|
|$item_trophy_neck_lore|Мънистените очи и острите, като бръснач зъби, опровергават привидно спокойната природа на този малък гущер.|
...
|$item_trophy_serpent_description|Люспите са избледнели, но очите все още са ярки.|
|$item_trophy_serpent_lore|Люспите са избледнели, но очите все още са ярки.|
|$item_trophy_sgolem|Трофей: каменен голем|
|$item_trophy_sgolem_description|Тази кристална скална формация би била впечатляваща декорация за пода.|
|$item_trophy_sgolem_lore|Тази кристална скална формация би била впечатляваща декорация за пода.|
...
|$item_trophy_skeleton_lore|Безизразната усмивка на този череп ти напомня за неизбежността на смъртта.|
|$item_trophy_skeletonpoison|Трофей: гниещи останки|
|$item_trophy_skeletonpoison_description|Гниещ и зловонен череп. Не си сигурен защо си го запазил...|
|$item_trophy_skeletonpoison_lore|Гниещ и зловонен череп. Не си сигурен защо си го запазил...|
|$item_trophy_surtling|Трофей: суртлинг|
|$item_trophy_surtling_description|Обвито в бледо пламъче, все още тлее като жар.|
|$item_trophy_surtling_lore|Обвито в бледо пламъче, все още тлее като жар.|
...
|$item_trophy_troll_description|Кожата, като кожа на древно създание, носи избледнелите следи от древни символи.|
|$item_trophy_troll_lore|Кожата, като кожа на древно създание, носи избледнелите следи от древни символи.|
...
|$item_trophy_wolf_description|Замръзнал в смъртта, косата слепена с кръв, а безмълвен вик заседнал в гърлото му.|
|$item_trophy_wolf_lore|Замръзнал в смъртта, косата слепена с кръв, а безмълвен вик заседнал в гърлото му.|
|$item_trophy_wraith|Трофей: призрак|
|$item_trophy_wraith_description|Захвърлената кожа на призрак, плаваща роба, видима само на лунна светлина.|
|$item_trophy_wraith_lore|Захвърлената кожа на призрак, плаваща роба, видима само на лунна светлина.|
|$item_turnip|Turnip|
...
|$lore_blackforest_random07|Eight were the creatures banished to this world by mighty Odin in the first days of his kingship. Eight Gods and monsters too proud to bear his yoke. I have heard the tread of the Old Ones in the forest and have crouched in the shadow of the Mountain Mother when she flies. Of the others I know little. I will add to this stone when I have seen more.|
...
|$lore_swamp_random04|You who pass, remember me. I am a man whose home was once in the mountains of Midgard, carried here when I thought to earn my rest, to find a life after life in Valheim. There were seven of us before the Greydwarfs came. Now Odin will not hear me and the seas refuse me. Soon this stone will be all that remains.|
...
|$menu_enterseed|Въведи задоришен код|
...
|$msg_nocookitems|Нямате продукти за готвене|
...
|$msg_wrongbiome|Не може да бъде поставено в този биом|
...
|$piece_banner01|Черен банер|
|$piece_banner02|Син банер|
|$piece_banner03|Червено-бял раиран банер|
|$piece_banner04|Червен банер|
|$piece_banner05|Зелен банер|
...
|$piece_deposit_copper|Медно находище|
|$piece_deposit_obsidian|Находище на обсидиан|
|$piece_deposit_silver|Сребърно находище|
|$piece_deposit_silvervein|Silver Vein|
|$piece_deposit_tin|Калаено находище|
...
|$piece_logbeam2|Греда необработена 2 м|
|$piece_logbeam4|Греда необработена 4 м|
|$piece_logpole2|Необработен пилон 2 м|
|$piece_logpole4|Необработен пилон 4 м|
...
|$piece_offerbowl_makeoffer|Пренеси в жертва|
|$piece_offerbowl_offeritem|Предмет за жертвоприношение|
...
|$piece_spinningwheel|Шмиргел|
|$piece_stakewall|Палисада|
...
|$piece_wooddragon|Драконово украшение|
...
|$piece_workbench_ext2|Стелаж за щавене|
...
|$settings_draw|Опъване на тетива|
