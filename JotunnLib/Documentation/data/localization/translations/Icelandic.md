...
|$item_chest_flametal|Logamálmsbrynja|
...
|$item_helmet_flametal|Logamálmshjálmur|
...
|$item_legs_flametal|Logamálmslegghlífar|
...
|$item_mace_eldner|Logamálmskylfa|
...
|$item_mace_eldner_description|Þétt lagður og hnífbeittur logamálmur, fullkominn til þess að bæta nýjum holum í óvini þína.|
...
|$item_scythehandle|Handfang ljás|
...
|$item_trophy_goblinking_description|Kórónulaust höfuð dauðs konungs.<br/><br/>Farðu með hann til fórnarsteinanna.|
...
|$item_trophy_greydwarfbrute_description|Það tók sjö högg til þess að kljúfa hausinn af líkamanum.|
|$item_trophy_greydwarfbrute_lore|Það tók sjö högg til þess að kljúfa hausinn af líkamanum.|
...
|$item_turretbolt_flametal|Logamálmsör|
|$item_turretbolt_flametal_description|Smíðuð úr einum sterkasta málmi Valheims. Hún mun vissulega halda fjandmönnum þínum í skefjum.|
...
|$piece_flametal_beam|Logamálmsþversúla|
|$piece_flametal_pillar|Logamálmsstólpi|
|$piece_flametalgate|Logamálmshlið|
|$piece_forge|Smiðja|
...
|$tutorial_ashlands_text|Þú hefur fundið asklendin, heitasta partinn af tíunda heiminum.<br/>Hér sýður vatn án potts, og allt eldfimt brýst í loga við minnsta neista. Farðu varlega!|
