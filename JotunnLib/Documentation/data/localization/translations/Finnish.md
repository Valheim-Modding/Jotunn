...
|$deadspeak_fish_shared1|Älä stressaa.|
|$deadspeak_fish_shared2|Vie minut joelle... Pudota minut veteen...|
|$deadspeak_fish1|En mää oo meri- vaan järviahaven!|
|$deadspeak_fish10|Kerran olin vapaa hyppäämään ylävirtaan. Mutta en enää.|
|$deadspeak_fish11|Laske minut lepoon tulisijan äärellä...|
...
|$deadspeak_fish7|Olen kuollut, mutten poissa. Vapauttaisitko minut tästä kirotusta kiirastulesta?|
|$deadspeak_fish8|Ootko miettiny, mitä tuolla meren syvyyksissä luikertelee? Älä mieti. Ei kannata.|
|$deadspeak_fish9|Näetkö valon? Se kutsuu sinua...|
...
|$dream_random14|Näet unessasi, kuinka metsästät tovereittesi kanssa. Juoksette ylös vihreälle kukkulalle ja alas sumuisten laaksojen halki. Näet, kuinka saaliisi kompuroi edelläsi, joten loikkaat eteenpäin ja upotat hampaasi sen lämpimään lihaan.<br/><br/>Herätessäsi maistat metallin suussasi.|
...
|$dvergr_buff_description|Kehosi on vallannyt outo dvergrien voima, joka vahvistaa sinua.|
...
|$enemy_boss_bonemass_deathmessage|Massa on pysäytetty|
|$enemy_boss_bonemass_spawnmessage|Massa alkaa liikkumaan|
|$enemy_boss_dragon_deathmessage|Moder kyynelehtii|
...
|$error_worldfileload|Virhe ladattaessa maailmatiedostoa. Tarkista varmuuskopiot!|
...
|$event_caves_start|Syvyyksistä kaikuu ulvontaa|
...
|$fish11_description|Väitetään, että tämä kala kutee suoraan sulassa laavassa!|
|$fish12_description|Maukasta oikein laitettuna, mutta sivumaku on hieman pisteliäs.|
|$fish2_description|Makeassa vedessä elävä kala, joka kaipaa runsaasti mausteita.|
...
|$hud_eitrrequired|Eitr tarvitaan|
...
|$hud_mapday|Päivä|
|$hud_maxsummonsreached|Kuolleiden nostattajasi ei ole tarpeeksi voimakas komentamaan tätä useampia sieluja.|
|$hud_misc|Sekalaista|
...
|$item_ancientroot_empty|Muinainen juuri on kuivunut|
|$item_ancientroot_full|Muinainen juuri sykkii energiaa|
...
|$item_bolt_iron_description|Jykevä rautaammus.|
...
|$item_bow_draugrfang|Draugrin hammas|
...
|$item_chest_fenris|Fenris-turkki|
...
|$item_chicken_egg_cold|(Liian kylmää)|
...
|$item_chicken_meat_description|Kaikkien kanojen hentoja harteita painaa herkullisuuden ikivanha kirous.|
...
|$item_crafter|Tekijä|
|$item_crossbow_arbalest|Arbalesti|
...
|$item_demister|Wisp-valo|
|$item_demister_description|Sidottu virvatuli, joka ohjastaa sinut tiheimmänkin usvan läpi.|
...
|$item_dragontear_description|Tämä on kuolleen lohikäärmeen viimeinen jäätynyt kyynel. Se sykkii salaperäistä energiaa.|
...
|$item_fishingbait_ashlands_description|Jotkin kalat viihtyvät lämpimissä vesissä, ja tällä syötillä vesi lähes kiehuu.|
|$item_fishingbait_cave|Kylmä kalansyötti|
|$item_fishingbait_cave_description|Mitäänsanomaton syötti, mutta kylmässä ja pimeässä elävät kalat tykkäävät siitä.|
|$item_fishingbait_deepnorth|Huurteinen kalansyötti|
|$item_fishingbait_deepnorth_description|Ei tämä syötti kovin ravinteikas ole, mutta jäätä syömään tottuneet kalat kyllä voivat napata sen.|
...
|$item_fishingbait_forest_description|Metsään kuolleet peikot houkuttelevat joskus paikalle kalan tai kaksi. Nopeuta töitäsi tällä syötillä!|
|$item_fishingbait_mistlands|Sumuisa kalansyötti|
...
|$item_fishingbait_swamp_description|Haisee kauhealle, mutta tällä houkuteltavat kalat ovat vielä pahempia.|
...
|$item_helmet_fenris|Fenris-huppu|
...
|$item_helmet_midsummercrown_description|Kukista punottu keskikesän juhlapäähine.|
...
|$item_jutered_description|Karkeaa ja tukevaa kangasta.|
...
|$item_legs_fenris|Fenris-housut|
|$item_legs_fenris_description|Pedon jalat olivat hoikat ja vahvat, jotta se pystyi ottamaan suuria loikkia.|
...
|$item_meat_rotten|Mädäntynyttä lihaa|
...
|$item_pickable_meatpile|Kasa lihaa|
...
|$item_stafffireball|Tulenhehkuinen sauva|
|$item_stafffireball_description|Muspelheimin läkähdyttävä kuumuus kalpenee sen rinnalla mihin tämä sauva pystyy...|
|$item_stafficeshards|Jääsauva|
|$item_stafficeshards_description|Tämä sauva on yhtä kylmä kuin kolmivuotinen talvi, joka on lopun aikojen merkki.|
|$item_staffshield|Suojelluksen sauva|
|$item_staffshield_description|Uhraamalla hieman verta se ympäröi käyttäjänsä taianomaisen suojakuoren sisään.|
|$item_staffskeleton|Kuolleiden nostattaja|
|$item_staffskeleton_description|Uhraa hieman verta nostaaksesi kuolleita. Vahvista pääkalloa herättääksesi henkiin useita luurankoja, ja lisää veritaikuutta tehdäksesi niistä vahvempia.|
...
|$item_tankard|Tuoppi|
|$item_tankard_anniversary|Juhlan juomasarvi|
...
|$item_trophy_ulv_description|Ei-niin-kiltin pojan karkea häntä.|
|$item_trophy_ulv_lore|Ei-niin-kiltin pojan karkea häntä.|
...
|$item_wolfhairbundle|Fenriksen karvoja|
...
|$loadscreen_tip24|Voit suodattaa karttamerkintöjä oikealla hiiren painikkeella (DPad oikealle)|
...
|$lore_caveman01|Luolien syvyyksistä lupauksia rikkauksista.<br/>Alas pääsi helpommin kuin ylös, kävi ilmi.<br/>Järvestä oli vähän apua, muttei sekään riittänyt.<br/>Vaati voimaa olla tyhjentämättä sitä kokonaan ja jättää sinulle – väsyneelle matkustajalle – mahdollisuuden, kuten itsellänikin oli.<br/>Toivottavasti saavuit valmistautuneempana kuin minä.<br/>Jos et, vieressäni on huone, jossa voit asettua makuulle ja... levätä.|
|$lore_caveman02|Tätä kalliota kiipesin ja toivoin saavuttavani huipun.<br/>Valitettavasti luola oli liian syvä.<br/>...<br/>Taas täällä, harkitsemassa hyppyä.<br/>Pelkurina laskeudun kuitenkin takaisin alas.|
...
|$lore_intro|Kauan aikaa sitten kaikkivaltias Odin yhdisti maailmat. Hän kukisti ja syöksi vastustajansa alas aina kymmenenteen maailmaan asti ja katkoi suuret oksat, jotka pitivät näiden kukistettujen puolijumalten vankilaa kiinni maailmanpuussa. Tuo vankila jäi ajelehtimaan karkotettujen kotina...<br/><br/><br/>Vuosisatojen ajan tuo maailma uinui rauhattomasti, kuin horroksessa. Mutta se ei kuollut...<br/>Jääkausia tuli ja meni – kuningaskuntia nousi ja tuhoutui, kun jumalten katseet olivat kohdistettuina muualle.<br/><br/><br/>Kun Odin kuuli vihollistensa keräävän taas voimiaan, hän käänsi katseensa Midgårdiin. Jumalten kuningas lähetti valkyriansa koluamaan taistelukenttiä, joilta kannettiin pois kaikista vahvimmat soturit. Maailmalle kuolleina he tulisivat syntymään uudestaan…<br/><br/><br/>…VALHEIMISSA!|
...
|$lore_plains_random07|Maan alla on saleja, jotka kuuluivat kauan aikaa sitten kadonneille miehille ja naisille – heimoille, jotka asuivat Valheimissa jo ennen kuin kaikkien olentojen isä, Odin, loi katseensa tähän paikkaan. Selvitä tiesi syvälle kammioihin ja löydä heidän aarteensa, mutta varo: jotkut heistä eivät vielä tiedä olevansa kuolleita.|
...
|$menu_addserverfailedincorrectformatting|Syöte ei ole kelvollinen IP-osoite, web-osoite tai kutsukoodi!|
|$menu_addserverfailedresolvejoincode|Kutsukoodin varmentaminen ei onnistunut|
|$menu_back|Takaisin|
|$menu_backupcount|$1 varmuuskopiot|
|$menu_backuprestorefailedheader|Varmuuskopion palauttaminen epäonnistui!|
|$menu_backuprestorepromptheader|Palauta varmuuskopio?|
...
|$menu_cloudsavesdisabled|Olet poistanut pilvitallennuksen käytöstä asetuksista. Pilvitallennuksena tallennetut maailmat ja hahmot eivät näy täällä. Ota pilvitallennus käyttöön, mikäli haluat käyttää niitä jälleen.|
|$menu_cloudstoragefull|Pilvitallennustila on lopussa!|
|$menu_cloudstoragefullcharacterprompt|Tallennetaanko hahmo sittenkin paikallisena?|
|$menu_cloudstoragefullmovingsave|Nykyisen istunnon tallennus saatetaan tehdä paikallisesti, jotta vältetään tietojen menettäminen.|
|$menu_cloudstoragefulloperationfailed|Toiminto epäonnistui, koska pilvitallennustila on lopussa. Voit mahdollisesti vapauttaa tilaa siirtämällä joitain tallennuksia paikallisiksi.|
|$menu_cloudstoragefullworldprompt|Tallennetaanko maailma sittenkin paikallisena?|
...
|$menu_disallowedcharactername|Hahmoa ei voi luoda tällä nimellä|
|$menu_disallowedworldname|Maailmaa ei voi luoda tällä nimellä|
|$menu_done|Valmis|
...
|$menu_joindifferentserver|Olet liittymässä toiseen palvelimeen!|
...
|$menu_logoutprompt|Oletko varma että haluat lopettaa session?|
|$menu_male|Mies|
|$menu_managesaves|Hallinnoi tallennuksia|
...
|$menu_newworldalreadyexistsmessage|Maailma nimeltä $1 on jo olemassa|
|$menu_no|Ei|
|$menu_ok|OK|
|$menu_onlineprivilegetext|Käyttäjätilisi asetukset estävät sinua liittymästä moninpeliin verkossa.|
...
|$menu_reloadfailed|Tallennusten uudelleenlataaminen epäonnistui|
|$menu_remove|Poista|
|$menu_removebackup|Poista varmuuskopio?|
|$menu_removecharacter|Poista hahmo?|
|$menu_removeserver|Poista palvelin?|
...
|$menu_tryagainorrestart|Yritä uudelleen tai käynnistä peli uudelleen jos ongelma jatkuu|
|$menu_ugcwarningheader|Käyttäjän luoma sisältö estetty|
|$menu_ugcwarningtext|Alustan käyttöoikeusasetukset estävät sinua näkemästä muiden käyttäjien luomaa sisältöä. Viestejä muilta pelaajilta suodatetaan merkittävästi.|
...
|$npc_dvergrrogue_random_goodbye5|Pidä virvatulivalo lähelläsi, et halua hukata sitä.|
...
|$piece_blackmarble_column_1|Musta marmoripylväs, pieni|
...
|$piece_blackmarble1x1|Musta marmori 1x1x1|
|$piece_blackmarble2x1x1|Musta marmori 2x1x1|
|$piece_blackmarble2x2_enforced|Vahvistettu musta marmori|
|$piece_blackmarble2x2x1|Musta marmori 2x2x1|
|$piece_blackmarble2x2x2|Musta marmori 2x2x2|
...
|$se_demister_start|Vapautat sidotun virvatulen|
...
|$se_fenringseteffect_tooltip|Fenris-panssari nopeuttaa liikkeitäsi, joten voit kulkea läpi tulen samalla tuntien pedon voiman nyrkeissäsi.|
|$se_fire_name|Tuli|
...
|$se_rootseteffect_name|Parantaa jousiammuntaa|
...
|$se_shield|Taikamuuri|
|$se_shield_damage|Vahingon suojaaminen (perustuu taitoon):|
...
|$settings_altkeys|(Vaihtoehtoiset toiminnot)|
...
|$settings_cameratilt|Immersiivinen kamera|
...
|$settings_fishingcast|Heitto|
|$settings_fishingpull|Vedä|
...
|$settings_hotbarright|Pyöritä pikavalikkoa|
...
|$skill_bloodmagic_description|Veritaikuuden tuhovoima, Eitr & elinvoiman kulutus.|
|$skill_bows|Jouset|
...
|$skill_elementalmagic|Elementaalinen taikuus|
|$skill_elementalmagic_description|Elementaalisen taikuuden tuhovoima ja Eitr-kustannus.|
|$skill_firemagic|Tulitaikuus|
|$skill_firemagic_description|Kirjoita jotakin|
|$skill_fishing|Kalastus|
|$skill_fishing_description|Energian kulutus ja vetonopeus kalastaessa.|
