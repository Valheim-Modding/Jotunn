...
|$customization_hair19|Bukleler 1|
|$customization_hair20|Bukleler 2|
|$customization_hair21|İkili topuz|
|$customization_hair22|Tek topuz|
|$customization_hair23|Kısa bukleler|
...
|$deadspeak_fish11|Lütfen beni ateşin yanında dinlenmeye bırak...|
...
|$deadspeak_fish8|Okyanusun en derin yerlerinde nelerin dolaştığını hiç merak ediyor musun? Etme. Bilmemek daha iyi.|
|$deadspeak_fish9|Işığı görüyor musun? Seni çağırıyor...|
|$deadspeak_hive|Bizi alt edebileceğini mi sanıyorsun? Tekrar düşün... Biz hâlâ bir kovanız ve sonsuza dek öyle kalacağız. Kovan alt edilemez.|
...
|$deadspeak_queen|Odin'e soydaşlarımın yerime başkasını getireceğini söyle... Bir kraliyet asla ölmez.|
...
|$dream_mistlands01|Rüyanda, gülümseyen savaşçılar ve zarif kızların bulunduğu bir salonda yürüyorsun. Neşelerine katılıp devam ederken çıplak olduğunu ve taşıdığın küçük tunç kalkanın utancını saklamaya yeterli olmadığını fark ediyorsun.|
...
|$item_axe_jotunbane|Jötunn afeti|
...
|$item_bug_meat_cooked_description|Dolgun beyaz et, gerçek bir zarafet.|
...
|$item_dvergrtankard_description|Çok fazla şarap doldurulabilir!|
...
|$item_fishingbait_plains|Az balık yemi|
...
|$item_hare_meat_description|Bir yabantavşanının eti az ama lezzetlidir.|
...
|$item_jotunpuffs_description|Büyüyle şişirilmiş bu altın küreler, Jötunn'un düştüğü yerde fokurduyor.|
...
|$item_magicallystuffedmushroomuncooked|Pişmemiş büyü aromalı mantar|
|$item_mandible|Altçene|
|$item_mandible_description|Daha mükemmel bir silahı insan eli zor tasarlar.|
...
|$item_trophy_gjall_description|Uzaklaşmaz herhalde.|
|$item_trophy_gjall_lore|Uzaklaşmaz herhalde.|
...
|$item_trophy_seeker_description|Göründüğünden daha da rahatsız edici. Kanatlardaki deri uçmayı hatırlarcasına alev ışığını yakalıyor.|
|$item_trophy_seeker_lore|Göründüğünden daha da rahatsız edici. Kanatlardaki deri uçmayı hatırlarcasına alev ışığını yakalıyor.|
...
|$lore_queen|Kapıyı mühürleyip anahtarı fırlattık. Kendi haline bırak.|
...
|$menu_ugcwarningtext|Ayrıcalık ayarların, kullanıcı tarafından oluşturulan içerikleri görmeni önlüyor. Diğer oyunculardan gelen metinler yoğun bir şekilde filtrelenecek.|
...
|$npc_dvergrmage_random_goodbye2|Gjall'a dikkat etmeyi unutma.|
...
|$npc_dvergrmage_random_greet5|Merhaba. Uzun bir yol geldin.|
...
|$npc_dvergrmage_random_talk8|Bu haşereler korktuğumdan daha fazla etrafa yayılmış. Bu hızla giderse eski madenlerimizin tamamını ele geçirecekler.|
...
|$npc_dvergrrogue_random_talk1|Sislerde nelerle karşılaşacağını asla bilemezsin.|
...
|$npc_dvergrrogue_random_talk4|Bütün insanlar sana mı benziyor? Sen çok... Neyse boş ver.|
...
|$se_shield_description|Hasarı emen büyülü bir kalkan|
|$se_shield_ttl|Süre:|
...
|$tutorial_dvergr_text|Gak gaaak! İnatçı ahmaklar! Cüceler yabancılara ve berduşlara tahammül eder ama onları kızdırırsan çabuk sinirlenirler... Ve eminim eninde sonunda bunu başaracaksın.|
...
|$tutorial_giants_text|Gaak! Kemiklerini kır ve kafataslarına yapıştır!|
...
|$tutorial_random4|Meşgul musun savaşçı? Daha sonra tekrar gelebilirim...|
...
|$tutorial_yggroot_text|Gaak! Gövdesinden yarılmış olsa da eski dişbudak ağacının köklerinde hâlâ büyü olduğunu görebiliyorum.<br/><br/>Tabii ki tasarladığın hiçbir silah kabuğu kıramayacak. Daha kabiliyetli ellerin ürünü olan daha iyi bir şeye ihtiyacın var.|
