...
|$menu_vulkancrashwarning_header|Valheim, Vulkan kullanırken sisteminizde çökebilir|
|$menu_vulkancrashwarning_text|Şu anda Vulkan kullanıyorsunuz. Belirli sistemlerde Vulkan kullanırken yaşanan bilinen bir çökme sorununu araştırıyoruz ve sisteminizin potansiyel olarak etkilenebileceği tespit edildi. Kararlılık sorunları yaşıyorsanız lütfen varsayılan görüntüleme API'sini (DirectX 11) kullanın. Verdiğimiz rahatsızlıktan dolayı özür dileriz!|
