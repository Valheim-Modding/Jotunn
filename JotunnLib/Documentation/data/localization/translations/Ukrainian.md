...
|$online_kickedfromsession_header|Ви покинули поточну сесію|
...
|$settings_double_tap_descr|Подвійне швидке натискання на стики в сторону того ж самого елемента ввімкне взаємодію з ним.|
...
|$settings_flick_interact_descr|Швидкі рухи стиками в сторону елемента ввімкнуть взаємодію з ним.|
...
|$settings_radialsize|Розмір кругове меню|
|$settings_radialsize_descr|Визначає розмір та положення кругове меню.|
...
|$text_hidden_notification_ugc_settings|ТЕКСТ ПРИХОВАНО, ПЕРЕВІРТЕ НАЛАШТУВАННЯ UGC|
