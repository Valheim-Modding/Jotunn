...
|$enemy_fenringcultist_hildir|<color=orange>Ґейрргаф</color>|
...
|$event_hildirboss2_start|Холод біжить по шкірі…|
...
|$hud_on|Увімк.|
|$hud_pet|Приголубити|
|$hud_pin_hildir1|Зотліла могила|
|$hud_pin_hildir2|Галаслива яма|
...
|$item_fireworkrocket_blue|Блакитний феєрверк|
|$item_fireworkrocket_cyan|Ціановий феєрверк|
...
|$item_hildirkey_description|Схоже, що ключик сумує за власницею…|
...
|$item_trophy_brutebro_lore|Молодший з двох братів. Заздрив братовим чарам.|
...
|$item_trophy_shamanbro_description|Обираючи «умерти чи втекти» взяв перший варіант.|
...
|$menu_death_casual_tooltip|Спорядження не падає на землю, а вміння слабшають набагато менше аніж у звичайному режимі.|
|$menu_death_easy_tooltip|Всі предмети випадуть, а вміння слабшають менше аніж у звичайному режимі.|
|$menu_death_hard_tooltip|Спорядження випадає, а решта речей зникає назавжди — вміння слабшають сильніше.|
|$menu_death_hardcore_tooltip|Ви назавжди втратите всі наявні предмети та вміння.|
|$menu_death_normal_tooltip|Всі предмети випадуть, а вміння слабшають у нормальному співвідношенні.|
|$menu_death_veryeasy_tooltip|Всі предмети випадуть, а вміння слабшають набагато менше аніж у звичайному режимі.|
...
|$menu_modifier_casual|Оказійна гра|
|$menu_modifier_casual_tooltip|Оказійний режим пропонує спрощену боївку, бо вороги не нападатимуть, допоки їх не спровокують, а також ніхто не зачіпатиме вашу базу. Кількість ресурсів збільшено. У разі смерті предмети не випадають на землю, а вміння не втрачаються.|
...
|$menu_modifier_hammer|Режим будування|
|$menu_modifier_hammer_tooltip|У цьому режимі ви зможете створювати усе задарма, щойно знайдете креслення. На вашу базу ніхто не нападатиме, а вороги не помічатимуть, допоки ви їх не спровокуєте. Інші налаштування складності типові.|
...
|$menu_modifier_hardcore_tooltip|Надзвичайно складні бої та численні напади на базу. У разі смерті ви назавжди втиратимете всі речі та вміння. Також у вас відсутня мапа та можливість створювати проходи.|
|$menu_modifier_immersive|Повне занурення|
|$menu_modifier_immersive_tooltip|Цей режим передбачає відсутність мапи та проходів. Доведеться скористатися чуттями, щоби зрозуміти де ви є в цьому світі! Інші налаштування складності типові.|
|$menu_modifier_normal|Нормальна|
|$menu_modifier_normal_tooltip|Нормальна складність рекомендована для гри вперше. Тут присутня найбільша рівновага у всьому.|
...
|$menu_nobossportals_tooltip|У вас відсутня можливість використовувати проходи або виходити з підземелля, поки боси живі.|
|$menu_nobuildcost|Безоплатне будування|
...
|$menu_playerbasedevents_tooltip|Напади розраховуються на індивідуальному поступі гравців, а не на вбитих босах на сервері. Це налаштування рекомендовано, якщо ви хочете, щоби гра була приязнішою до гравців з різними рівнями особистого розвитку.|
|$menu_players|Список гравців|
|$menu_pleasewait|Зачекайте|
|$menu_portals|Проходи|
|$menu_portals_tooltip|Змініть поведінку проходів у грі.|
...
|$menu_teleportall_tooltip|Дозволяє проносити всі предмети крізь проходи, щоби спростити ігролад. Це зробить поступ та дослідження світу не таким складним, як задумувалося.|
...
|$npc_haldor_random_talk3|Таких як ти, я ніколи раніше не бачив.|
|$npc_haldor_random_talk4|На що витріщаєшся? Дворфи ніколи в житті не стрічалися?|
|$npc_haldor_random_talk5|Гальштайн, це ти повітря знову псуєш?|
...
|$npc_hildir_random_anylockedchest6|Вона попереджала мене, що сюди не варто йти… Але я не послухала й тепер частина мого запасу гниє в якомусь підземеллі.|
...
|$npc_hildir_random_greet1|Вітаю у моїй крамничці. Вона трохи елегантніша, аніж братова.|
|$npc_hildir_random_greet2|Привіт.|
|$npc_hildir_random_greet3|Твій зовнішній вигляд так і проситься, аби його дещо поліпшили.|
...
|$npc_hildir_random_sell2|Гм, я це зможу використати де-інде.|
...
|$npc_hildir_random_talk10|Якби тут не було весело бувати, але вдома зі своїми набагато ліпше.|
...
|$settings_togglehud|Перемикання інтерфейсу|
|$settings_togglerun|Перемикання бігу|
...
|$tutorial_haldor|Подейкують, що у десятому світі можна натрапити на торговців. Якщо знадобляться якісь особливі предмети, то можливо тобі захочеться пошукати таких осіб.<br/><br/>Один із них має бути десь у лісі, подібному до цього. Мені дуже прикро, що не можу допомогти більше… просто пильнуй навсібіч.|
...
|$tutorial_hildir|Я чув, що одну з торговельного люду бачили в місці, яке нічим не різниться від цього. Вона дивачка — це точно. Але може мати хороші товари на продаж.<br/><br/>Однак подейкують, що її нещодавно пограбували. Тож може статися, що їй потрібна допомога, а в тебе нині наче абсолютно гожі показники для цього.|
