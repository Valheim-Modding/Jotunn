...
|$enemy_charred_melee_Dyrnwyn|Лорд Рето|
...
|$item_staffclusterbomb|Ламка патериця|
...
|$item_staffgreenroots|Вітрова патериця|
...
|$item_stafflaser|Криговійна патериця|
...
|$lore_fader|Жахіття не дають спочину Смарагдовому Полум’ю, перериваючи дрімоту.|
...
|$npc_dvergrmage_random_talk_in_faction_base3|Знаєш, ми збудували ці копальні. І де ми тепер…|
...
|$npc_dvergrmage_random_talk_in_faction_base6|Дивлюся вперед, щоби побачити що вогонь покаже мені далі.|
|$npc_dvergrmage_random_talk_in_faction_base7|І де ж я занапастив ту пляшку?..|
|$npc_dvergrmage_random_talk_in_faction_base8|Присягаюся, у нас десь тут був ще один видобувач…|
|$npc_dvergrmage_random_talk_in_faction_base9|Ще трохи й можна буде повертатися у Міркгайм.|
