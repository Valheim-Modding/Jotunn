...
|Steel|$steelbar|A ingot of steel|Material|A cold bar of steel to craft new items with|
|BlueprintTestRune|$item_testblueprintrune|Blueprint Rune Test|Tool|Used to make copies of structures and rebuild exact copies of them somewhere else.|
|CapeIronBackpack|$item_cape_ironbackpack|Rugged Backpack|Shoulder|A Rugged backpack, complete with buckles and fine leather straps.|
|Cheaty|Shit Sword|Shit Sword|OneHandedWeapon|Cheater!|
|item_faulty|item_faulty|item_faulty|Misc|NULL|
|BlueprintRune|$item_blueprintrune|Blueprint Rune|Tool|Plan the construction of object, also used to make copies of structures and rebuild exact copies of them somewhere else.|
|CapeSilverBackpack|$item_cape_silverbackpack|Fine Backpack|Shoulder|A Fine backpack, comprised of high quality leather, adorned with silver furnishings.|
|EvilSword|$item_evilsword|Sword of Darkness|OneHandedWeapon|Bringing the light|
|item_lulvariants|$lulz_shield|Lulz Shield|Shield|Lough at your enemies|
|item_swordvariants|Lulz Sword|Lulz Sword|OneHandedWeapon|Lulz on a stick|
|item_lulzcape|Lulz Cape|Lulz Cape|Shoulder|Lulz to the rescue|
|item_lulzchest|Lulz Armor|Lulz Armor|Chest|Lol, that hit|
|PlanCrystal|$item_plan_crystal|Skuld Crystal|Utility|A crystal imbued with the power of Skuld. Allows the wearer to see into the future.|
