...
* [Unity 6000.0.61](https://unity3d.com/unity/whats-new/6000.0.61) - Game engine that Valheim runs in
...
Valheim uses Unity Version **6000.0.61**
...
To be able to use the game's components in your prefabs we need to copy these in the Unity project. We have included a [CopyToUnity Task](https://github.com/Valheim-Modding/JotunnModStub/blob/d8d48e6337bf842d57f0728d277c28543d016514/JotunnModStub/JotunnModStub.csproj#L83-L108) in the .csproj file of the code project which will handle copying the necessary dlls for you on every build of it, including your project's assembly, BepInEx/Harmony and Jötunn. The .meta files are already provided in the Unity project of the stub. So build your code project once to have the current assemblies in the Unity project.
